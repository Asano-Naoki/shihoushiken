(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const u of s.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&t(u)}).observe(document,{childList:!0,subtree:!0});function n(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(a){if(a.ep)return;a.ep=!0;const s=n(a);fetch(a.href,s)}})();function vl(e,c){const n=Object.create(null),t=e.split(",");for(let a=0;a<t.length;a++)n[t[a]]=!0;return c?a=>!!n[a.toLowerCase()]:a=>!!n[a]}function yl(e){if(ge(e)){const c={};for(let n=0;n<e.length;n++){const t=e[n],a=Ye(t)?hm(t):yl(t);if(a)for(const s in a)c[s]=a[s]}return c}else{if(Ye(e))return e;if(Ne(e))return e}}const vm=/;(?![^(]*\))/g,ym=/:([^]+)/,bm=/\/\*.*?\*\//gs;function hm(e){const c={};return e.replace(bm,"").split(vm).forEach(n=>{if(n){const t=n.split(ym);t.length>1&&(c[t[0].trim()]=t[1].trim())}}),c}function $t(e){let c="";if(Ye(e))c=e;else if(ge(e))for(let n=0;n<e.length;n++){const t=$t(e[n]);t&&(c+=t+" ")}else if(Ne(e))for(const n in e)e[n]&&(c+=n+" ");return c.trim()}const gm="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",jm=vl(gm);function _o(e){return!!e||e===""}const vn=e=>Ye(e)?e:e==null?"":ge(e)||Ne(e)&&(e.toString===Io||!_e(e.toString))?JSON.stringify(e,xo,2):String(e),xo=(e,c)=>c&&c.__v_isRef?xo(e,c.value):At(c)?{[`Map(${c.size})`]:[...c.entries()].reduce((n,[t,a])=>(n[`${t} =>`]=a,n),{})}:wo(c)?{[`Set(${c.size})`]:[...c.values()]}:Ne(c)&&!ge(c)&&!Ao(c)?String(c):c,Fe={},It=[],Uc=()=>{},qm=()=>!1,km=/^on[^a-z]/,ps=e=>km.test(e),bl=e=>e.startsWith("onUpdate:"),ac=Object.assign,hl=(e,c)=>{const n=e.indexOf(c);n>-1&&e.splice(n,1)},pm=Object.prototype.hasOwnProperty,Ee=(e,c)=>pm.call(e,c),ge=Array.isArray,At=e=>Ss(e)==="[object Map]",wo=e=>Ss(e)==="[object Set]",_e=e=>typeof e=="function",Ye=e=>typeof e=="string",gl=e=>typeof e=="symbol",Ne=e=>e!==null&&typeof e=="object",Vo=e=>Ne(e)&&_e(e.then)&&_e(e.catch),Io=Object.prototype.toString,Ss=e=>Io.call(e),Sm=e=>Ss(e).slice(8,-1),Ao=e=>Ss(e)==="[object Object]",jl=e=>Ye(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,cs=vl(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Cs=e=>{const c=Object.create(null);return n=>c[n]||(c[n]=e(n))},Cm=/-(\w)/g,$c=Cs(e=>e.replace(Cm,(c,n)=>n?n.toUpperCase():"")),_m=/\B([A-Z])/g,Dt=Cs(e=>e.replace(_m,"-$1").toLowerCase()),pn=Cs(e=>e.charAt(0).toUpperCase()+e.slice(1)),ns=Cs(e=>e?`on${pn(e)}`:""),ga=(e,c)=>!Object.is(e,c),ts=(e,c)=>{for(let n=0;n<e.length;n++)e[n](c)},is=(e,c,n)=>{Object.defineProperty(e,c,{configurable:!0,enumerable:!1,value:n})},gu=e=>{const c=parseFloat(e);return isNaN(c)?e:c},xm=e=>{const c=Ye(e)?Number(e):NaN;return isNaN(c)?e:c};let Vr;const wm=()=>Vr||(Vr=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let Cc;class Eo{constructor(c=!1){this.detached=c,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Cc,!c&&Cc&&(this.index=(Cc.scopes||(Cc.scopes=[])).push(this)-1)}get active(){return this._active}run(c){if(this._active){const n=Cc;try{return Cc=this,c()}finally{Cc=n}}}on(){Cc=this}off(){Cc=this.parent}stop(c){if(this._active){let n,t;for(n=0,t=this.effects.length;n<t;n++)this.effects[n].stop();for(n=0,t=this.cleanups.length;n<t;n++)this.cleanups[n]();if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!c){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0,this._active=!1}}}function ql(e){return new Eo(e)}function Vm(e,c=Cc){c&&c.active&&c.effects.push(e)}function Im(){return Cc}function Vc(e){Cc&&Cc.cleanups.push(e)}const kl=e=>{const c=new Set(e);return c.w=0,c.n=0,c},Po=e=>(e.w&Fn)>0,To=e=>(e.n&Fn)>0,Am=({deps:e})=>{if(e.length)for(let c=0;c<e.length;c++)e[c].w|=Fn},Em=e=>{const{deps:c}=e;if(c.length){let n=0;for(let t=0;t<c.length;t++){const a=c[t];Po(a)&&!To(a)?a.delete(e):c[n++]=a,a.w&=~Fn,a.n&=~Fn}c.length=n}},os=new WeakMap;let ia=0,Fn=1;const ju=30;let Dc;const ot=Symbol(""),qu=Symbol("");class pl{constructor(c,n=null,t){this.fn=c,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Vm(this,t)}run(){if(!this.active)return this.fn();let c=Dc,n=Bn;for(;c;){if(c===this)return;c=c.parent}try{return this.parent=Dc,Dc=this,Bn=!0,Fn=1<<++ia,ia<=ju?Am(this):Ir(this),this.fn()}finally{ia<=ju&&Em(this),Fn=1<<--ia,Dc=this.parent,Bn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Dc===this?this.deferStop=!0:this.active&&(Ir(this),this.onStop&&this.onStop(),this.active=!1)}}function Ir(e){const{deps:c}=e;if(c.length){for(let n=0;n<c.length;n++)c[n].delete(e);c.length=0}}let Bn=!0;const $o=[];function zt(){$o.push(Bn),Bn=!1}function Ht(){const e=$o.pop();Bn=e===void 0?!0:e}function kc(e,c,n){if(Bn&&Dc){let t=os.get(e);t||os.set(e,t=new Map);let a=t.get(n);a||t.set(n,a=kl()),Mo(a)}}function Mo(e,c){let n=!1;ia<=ju?To(e)||(e.n|=Fn,n=!Po(e)):n=!e.has(Dc),n&&(e.add(Dc),Dc.deps.push(e))}function bn(e,c,n,t,a,s){const u=os.get(e);if(!u)return;let l=[];if(c==="clear")l=[...u.values()];else if(n==="length"&&ge(e)){const r=Number(t);u.forEach((o,i)=>{(i==="length"||i>=r)&&l.push(o)})}else switch(n!==void 0&&l.push(u.get(n)),c){case"add":ge(e)?jl(n)&&l.push(u.get("length")):(l.push(u.get(ot)),At(e)&&l.push(u.get(qu)));break;case"delete":ge(e)||(l.push(u.get(ot)),At(e)&&l.push(u.get(qu)));break;case"set":At(e)&&l.push(u.get(ot));break}if(l.length===1)l[0]&&ku(l[0]);else{const r=[];for(const o of l)o&&r.push(...o);ku(kl(r))}}function ku(e,c){const n=ge(e)?e:[...e];for(const t of n)t.computed&&Ar(t);for(const t of n)t.computed||Ar(t)}function Ar(e,c){(e!==Dc||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}function Pm(e,c){var n;return(n=os.get(e))===null||n===void 0?void 0:n.get(c)}const Tm=vl("__proto__,__v_isRef,__isVue"),Bo=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(gl)),$m=Sl(),Mm=Sl(!1,!0),Bm=Sl(!0),Er=Rm();function Rm(){const e={};return["includes","indexOf","lastIndexOf"].forEach(c=>{e[c]=function(...n){const t=Ce(this);for(let s=0,u=this.length;s<u;s++)kc(t,"get",s+"");const a=t[c](...n);return a===-1||a===!1?t[c](...n.map(Ce)):a}}),["push","pop","shift","unshift","splice"].forEach(c=>{e[c]=function(...n){zt();const t=Ce(this)[c].apply(this,n);return Ht(),t}}),e}function Om(e){const c=Ce(this);return kc(c,"has",e),c.hasOwnProperty(e)}function Sl(e=!1,c=!1){return function(t,a,s){if(a==="__v_isReactive")return!e;if(a==="__v_isReadonly")return e;if(a==="__v_isShallow")return c;if(a==="__v_raw"&&s===(e?c?e0:No:c?Fo:Lo).get(t))return t;const u=ge(t);if(!e){if(u&&Ee(Er,a))return Reflect.get(Er,a,s);if(a==="hasOwnProperty")return Om}const l=Reflect.get(t,a,s);return(gl(a)?Bo.has(a):Tm(a))||(e||kc(t,"get",a),c)?l:We(l)?u&&jl(a)?l:l.value:Ne(l)?e?$a(l):sc(l):l}}const Lm=Ro(),Fm=Ro(!0);function Ro(e=!1){return function(n,t,a,s){let u=n[t];if(Mt(u)&&We(u)&&!We(a))return!1;if(!e&&(!ds(a)&&!Mt(a)&&(u=Ce(u),a=Ce(a)),!ge(n)&&We(u)&&!We(a)))return u.value=a,!0;const l=ge(n)&&jl(t)?Number(t)<n.length:Ee(n,t),r=Reflect.set(n,t,a,s);return n===Ce(s)&&(l?ga(a,u)&&bn(n,"set",t,a):bn(n,"add",t,a)),r}}function Nm(e,c){const n=Ee(e,c);e[c];const t=Reflect.deleteProperty(e,c);return t&&n&&bn(e,"delete",c,void 0),t}function Dm(e,c){const n=Reflect.has(e,c);return(!gl(c)||!Bo.has(c))&&kc(e,"has",c),n}function zm(e){return kc(e,"iterate",ge(e)?"length":ot),Reflect.ownKeys(e)}const Oo={get:$m,set:Lm,deleteProperty:Nm,has:Dm,ownKeys:zm},Hm={get:Bm,set(e,c){return!0},deleteProperty(e,c){return!0}},Um=ac({},Oo,{get:Mm,set:Fm}),Cl=e=>e,_s=e=>Reflect.getPrototypeOf(e);function za(e,c,n=!1,t=!1){e=e.__v_raw;const a=Ce(e),s=Ce(c);n||(c!==s&&kc(a,"get",c),kc(a,"get",s));const{has:u}=_s(a),l=t?Cl:n?wl:ja;if(u.call(a,c))return l(e.get(c));if(u.call(a,s))return l(e.get(s));e!==a&&e.get(c)}function Ha(e,c=!1){const n=this.__v_raw,t=Ce(n),a=Ce(e);return c||(e!==a&&kc(t,"has",e),kc(t,"has",a)),e===a?n.has(e):n.has(e)||n.has(a)}function Ua(e,c=!1){return e=e.__v_raw,!c&&kc(Ce(e),"iterate",ot),Reflect.get(e,"size",e)}function Pr(e){e=Ce(e);const c=Ce(this);return _s(c).has.call(c,e)||(c.add(e),bn(c,"add",e,e)),this}function Tr(e,c){c=Ce(c);const n=Ce(this),{has:t,get:a}=_s(n);let s=t.call(n,e);s||(e=Ce(e),s=t.call(n,e));const u=a.call(n,e);return n.set(e,c),s?ga(c,u)&&bn(n,"set",e,c):bn(n,"add",e,c),this}function $r(e){const c=Ce(this),{has:n,get:t}=_s(c);let a=n.call(c,e);a||(e=Ce(e),a=n.call(c,e)),t&&t.call(c,e);const s=c.delete(e);return a&&bn(c,"delete",e,void 0),s}function Mr(){const e=Ce(this),c=e.size!==0,n=e.clear();return c&&bn(e,"clear",void 0,void 0),n}function Wa(e,c){return function(t,a){const s=this,u=s.__v_raw,l=Ce(u),r=c?Cl:e?wl:ja;return!e&&kc(l,"iterate",ot),u.forEach((o,i)=>t.call(a,r(o),r(i),s))}}function Ka(e,c,n){return function(...t){const a=this.__v_raw,s=Ce(a),u=At(s),l=e==="entries"||e===Symbol.iterator&&u,r=e==="keys"&&u,o=a[e](...t),i=n?Cl:c?wl:ja;return!c&&kc(s,"iterate",r?qu:ot),{next(){const{value:d,done:f}=o.next();return f?{value:d,done:f}:{value:l?[i(d[0]),i(d[1])]:i(d),done:f}},[Symbol.iterator](){return this}}}}function In(e){return function(...c){return e==="delete"?!1:this}}function Wm(){const e={get(s){return za(this,s)},get size(){return Ua(this)},has:Ha,add:Pr,set:Tr,delete:$r,clear:Mr,forEach:Wa(!1,!1)},c={get(s){return za(this,s,!1,!0)},get size(){return Ua(this)},has:Ha,add:Pr,set:Tr,delete:$r,clear:Mr,forEach:Wa(!1,!0)},n={get(s){return za(this,s,!0)},get size(){return Ua(this,!0)},has(s){return Ha.call(this,s,!0)},add:In("add"),set:In("set"),delete:In("delete"),clear:In("clear"),forEach:Wa(!0,!1)},t={get(s){return za(this,s,!0,!0)},get size(){return Ua(this,!0)},has(s){return Ha.call(this,s,!0)},add:In("add"),set:In("set"),delete:In("delete"),clear:In("clear"),forEach:Wa(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(s=>{e[s]=Ka(s,!1,!1),n[s]=Ka(s,!0,!1),c[s]=Ka(s,!1,!0),t[s]=Ka(s,!0,!0)}),[e,n,c,t]}const[Km,Ym,Gm,Xm]=Wm();function _l(e,c){const n=c?e?Xm:Gm:e?Ym:Km;return(t,a,s)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?t:Reflect.get(Ee(n,a)&&a in t?n:t,a,s)}const Zm={get:_l(!1,!1)},Qm={get:_l(!1,!0)},Jm={get:_l(!0,!1)},Lo=new WeakMap,Fo=new WeakMap,No=new WeakMap,e0=new WeakMap;function c0(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function n0(e){return e.__v_skip||!Object.isExtensible(e)?0:c0(Sm(e))}function sc(e){return Mt(e)?e:xl(e,!1,Oo,Zm,Lo)}function t0(e){return xl(e,!1,Um,Qm,Fo)}function $a(e){return xl(e,!0,Hm,Jm,No)}function xl(e,c,n,t,a){if(!Ne(e)||e.__v_raw&&!(c&&e.__v_isReactive))return e;const s=a.get(e);if(s)return s;const u=n0(e);if(u===0)return e;const l=new Proxy(e,u===2?t:n);return a.set(e,l),l}function Et(e){return Mt(e)?Et(e.__v_raw):!!(e&&e.__v_isReactive)}function Mt(e){return!!(e&&e.__v_isReadonly)}function ds(e){return!!(e&&e.__v_isShallow)}function Do(e){return Et(e)||Mt(e)}function Ce(e){const c=e&&e.__v_raw;return c?Ce(c):e}function zo(e){return is(e,"__v_skip",!0),e}const ja=e=>Ne(e)?sc(e):e,wl=e=>Ne(e)?$a(e):e;function Ho(e){Bn&&Dc&&(e=Ce(e),Mo(e.dep||(e.dep=kl())))}function Uo(e,c){e=Ce(e);const n=e.dep;n&&ku(n)}function We(e){return!!(e&&e.__v_isRef===!0)}function $(e){return Wo(e,!1)}function Vl(e){return Wo(e,!0)}function Wo(e,c){return We(e)?e:new a0(e,c)}class a0{constructor(c,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?c:Ce(c),this._value=n?c:ja(c)}get value(){return Ho(this),this._value}set value(c){const n=this.__v_isShallow||ds(c)||Mt(c);c=n?c:Ce(c),ga(c,this._rawValue)&&(this._rawValue=c,this._value=n?c:ja(c),Uo(this))}}function dc(e){return We(e)?e.value:e}const s0={get:(e,c,n)=>dc(Reflect.get(e,c,n)),set:(e,c,n,t)=>{const a=e[c];return We(a)&&!We(n)?(a.value=n,!0):Reflect.set(e,c,n,t)}};function Ko(e){return Et(e)?e:new Proxy(e,s0)}function Il(e){const c=ge(e)?new Array(e.length):{};for(const n in e)c[n]=Y(e,n);return c}class u0{constructor(c,n,t){this._object=c,this._key=n,this._defaultValue=t,this.__v_isRef=!0}get value(){const c=this._object[this._key];return c===void 0?this._defaultValue:c}set value(c){this._object[this._key]=c}get dep(){return Pm(Ce(this._object),this._key)}}function Y(e,c,n){const t=e[c];return We(t)?t:new u0(e,c,n)}var Yo;class l0{constructor(c,n,t,a){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this[Yo]=!1,this._dirty=!0,this.effect=new pl(c,()=>{this._dirty||(this._dirty=!0,Uo(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!a,this.__v_isReadonly=t}get value(){const c=Ce(this);return Ho(c),(c._dirty||!c._cacheable)&&(c._dirty=!1,c._value=c.effect.run()),c._value}set value(c){this._setter(c)}}Yo="__v_isReadonly";function r0(e,c,n=!1){let t,a;const s=_e(e);return s?(t=e,a=Uc):(t=e.get,a=e.set),new l0(t,a,s||!a,n)}function Rn(e,c,n,t){let a;try{a=t?e(...t):e()}catch(s){xs(s,c,n)}return a}function Pc(e,c,n,t){if(_e(e)){const s=Rn(e,c,n,t);return s&&Vo(s)&&s.catch(u=>{xs(u,c,n)}),s}const a=[];for(let s=0;s<e.length;s++)a.push(Pc(e[s],c,n,t));return a}function xs(e,c,n,t=!0){const a=c?c.vnode:null;if(c){let s=c.parent;const u=c.proxy,l=n;for(;s;){const o=s.ec;if(o){for(let i=0;i<o.length;i++)if(o[i](e,u,l)===!1)return}s=s.parent}const r=c.appContext.config.errorHandler;if(r){Rn(r,null,10,[e,u,l]);return}}i0(e,n,a,t)}function i0(e,c,n,t=!0){console.error(e)}let qa=!1,pu=!1;const oc=[];let Jc=0;const Pt=[];let mn=null,ct=0;const Go=Promise.resolve();let Al=null;function Oe(e){const c=Al||Go;return e?c.then(this?e.bind(this):e):c}function o0(e){let c=Jc+1,n=oc.length;for(;c<n;){const t=c+n>>>1;ka(oc[t])<e?c=t+1:n=t}return c}function El(e){(!oc.length||!oc.includes(e,qa&&e.allowRecurse?Jc+1:Jc))&&(e.id==null?oc.push(e):oc.splice(o0(e.id),0,e),Xo())}function Xo(){!qa&&!pu&&(pu=!0,Al=Go.then(Qo))}function d0(e){const c=oc.indexOf(e);c>Jc&&oc.splice(c,1)}function f0(e){ge(e)?Pt.push(...e):(!mn||!mn.includes(e,e.allowRecurse?ct+1:ct))&&Pt.push(e),Xo()}function Br(e,c=qa?Jc+1:0){for(;c<oc.length;c++){const n=oc[c];n&&n.pre&&(oc.splice(c,1),c--,n())}}function Zo(e){if(Pt.length){const c=[...new Set(Pt)];if(Pt.length=0,mn){mn.push(...c);return}for(mn=c,mn.sort((n,t)=>ka(n)-ka(t)),ct=0;ct<mn.length;ct++)mn[ct]();mn=null,ct=0}}const ka=e=>e.id==null?1/0:e.id,m0=(e,c)=>{const n=ka(e)-ka(c);if(n===0){if(e.pre&&!c.pre)return-1;if(c.pre&&!e.pre)return 1}return n};function Qo(e){pu=!1,qa=!0,oc.sort(m0);const c=Uc;try{for(Jc=0;Jc<oc.length;Jc++){const n=oc[Jc];n&&n.active!==!1&&Rn(n,null,14)}}finally{Jc=0,oc.length=0,Zo(),qa=!1,Al=null,(oc.length||Pt.length)&&Qo()}}function v0(e,c,...n){if(e.isUnmounted)return;const t=e.vnode.props||Fe;let a=n;const s=c.startsWith("update:"),u=s&&c.slice(7);if(u&&u in t){const i=`${u==="modelValue"?"model":u}Modifiers`,{number:d,trim:f}=t[i]||Fe;f&&(a=n.map(v=>Ye(v)?v.trim():v)),d&&(a=n.map(gu))}let l,r=t[l=ns(c)]||t[l=ns($c(c))];!r&&s&&(r=t[l=ns(Dt(c))]),r&&Pc(r,e,6,a);const o=t[l+"Once"];if(o){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,Pc(o,e,6,a)}}function Jo(e,c,n=!1){const t=c.emitsCache,a=t.get(e);if(a!==void 0)return a;const s=e.emits;let u={},l=!1;if(!_e(e)){const r=o=>{const i=Jo(o,c,!0);i&&(l=!0,ac(u,i))};!n&&c.mixins.length&&c.mixins.forEach(r),e.extends&&r(e.extends),e.mixins&&e.mixins.forEach(r)}return!s&&!l?(Ne(e)&&t.set(e,null),null):(ge(s)?s.forEach(r=>u[r]=null):ac(u,s),Ne(e)&&t.set(e,u),u)}function ws(e,c){return!e||!ps(c)?!1:(c=c.slice(2).replace(/Once$/,""),Ee(e,c[0].toLowerCase()+c.slice(1))||Ee(e,Dt(c))||Ee(e,c))}let wc=null,e1=null;function fs(e){const c=wc;return wc=e,e1=e&&e.type.__scopeId||null,c}function Ae(e,c=wc,n){if(!c||e._n)return e;const t=(...a)=>{t._d&&Kr(-1);const s=fs(c);let u;try{u=e(...a)}finally{fs(s),t._d&&Kr(1)}return u};return t._n=!0,t._c=!0,t._d=!0,t}function Xs(e){const{type:c,vnode:n,proxy:t,withProxy:a,props:s,propsOptions:[u],slots:l,attrs:r,emit:o,render:i,renderCache:d,data:f,setupState:v,ctx:y,inheritAttrs:b}=e;let k,g;const p=fs(e);try{if(n.shapeFlag&4){const P=a||t;k=Qc(i.call(P,P,d,s,v,f,y)),g=r}else{const P=c;k=Qc(P.length>1?P(s,{attrs:r,slots:l,emit:o}):P(s,null)),g=c.props?r:y0(r)}}catch(P){ma.length=0,xs(P,e,1),k=m(yn)}let j=k;if(g&&b!==!1){const P=Object.keys(g),{shapeFlag:x}=j;P.length&&x&7&&(u&&P.some(bl)&&(g=b0(g,u)),j=hn(j,g))}return n.dirs&&(j=hn(j),j.dirs=j.dirs?j.dirs.concat(n.dirs):n.dirs),n.transition&&(j.transition=n.transition),k=j,fs(p),k}const y0=e=>{let c;for(const n in e)(n==="class"||n==="style"||ps(n))&&((c||(c={}))[n]=e[n]);return c},b0=(e,c)=>{const n={};for(const t in e)(!bl(t)||!(t.slice(9)in c))&&(n[t]=e[t]);return n};function h0(e,c,n){const{props:t,children:a,component:s}=e,{props:u,children:l,patchFlag:r}=c,o=s.emitsOptions;if(c.dirs||c.transition)return!0;if(n&&r>=0){if(r&1024)return!0;if(r&16)return t?Rr(t,u,o):!!u;if(r&8){const i=c.dynamicProps;for(let d=0;d<i.length;d++){const f=i[d];if(u[f]!==t[f]&&!ws(o,f))return!0}}}else return(a||l)&&(!l||!l.$stable)?!0:t===u?!1:t?u?Rr(t,u,o):!0:!!u;return!1}function Rr(e,c,n){const t=Object.keys(c);if(t.length!==Object.keys(e).length)return!0;for(let a=0;a<t.length;a++){const s=t[a];if(c[s]!==e[s]&&!ws(n,s))return!0}return!1}function g0({vnode:e,parent:c},n){for(;c&&c.subTree===e;)(e=c.vnode).el=n,c=c.parent}const j0=e=>e.__isSuspense;function q0(e,c){c&&c.pendingBranch?ge(e)?c.effects.push(...e):c.effects.push(e):f0(e)}function Ke(e,c){if(Ge){let n=Ge.provides;const t=Ge.parent&&Ge.parent.provides;t===n&&(n=Ge.provides=Object.create(t)),n[e]=c}}function Ve(e,c,n=!1){const t=Ge||wc;if(t){const a=t.parent==null?t.vnode.appContext&&t.vnode.appContext.provides:t.parent.provides;if(a&&e in a)return a[e];if(arguments.length>1)return n&&_e(c)?c.call(t.proxy):c}}function Kc(e,c){return Pl(e,null,c)}const Ya={};function ae(e,c,n){return Pl(e,c,n)}function Pl(e,c,{immediate:n,deep:t,flush:a,onTrack:s,onTrigger:u}=Fe){const l=Im()===(Ge==null?void 0:Ge.scope)?Ge:null;let r,o=!1,i=!1;if(We(e)?(r=()=>e.value,o=ds(e)):Et(e)?(r=()=>e,t=!0):ge(e)?(i=!0,o=e.some(j=>Et(j)||ds(j)),r=()=>e.map(j=>{if(We(j))return j.value;if(Et(j))return st(j);if(_e(j))return Rn(j,l,2)})):_e(e)?c?r=()=>Rn(e,l,2):r=()=>{if(!(l&&l.isUnmounted))return d&&d(),Pc(e,l,3,[f])}:r=Uc,c&&t){const j=r;r=()=>st(j())}let d,f=j=>{d=g.onStop=()=>{Rn(j,l,4)}},v;if(_a)if(f=Uc,c?n&&Pc(c,l,3,[r(),i?[]:void 0,f]):r(),a==="sync"){const j=i2();v=j.__watcherHandles||(j.__watcherHandles=[])}else return Uc;let y=i?new Array(e.length).fill(Ya):Ya;const b=()=>{if(g.active)if(c){const j=g.run();(t||o||(i?j.some((P,x)=>ga(P,y[x])):ga(j,y)))&&(d&&d(),Pc(c,l,3,[j,y===Ya?void 0:i&&y[0]===Ya?[]:y,f]),y=j)}else g.run()};b.allowRecurse=!!c;let k;a==="sync"?k=b:a==="post"?k=()=>qc(b,l&&l.suspense):(b.pre=!0,l&&(b.id=l.uid),k=()=>El(b));const g=new pl(r,k);c?n?b():y=g.run():a==="post"?qc(g.run.bind(g),l&&l.suspense):g.run();const p=()=>{g.stop(),l&&l.scope&&hl(l.scope.effects,g)};return v&&v.push(p),p}function k0(e,c,n){const t=this.proxy,a=Ye(e)?e.includes(".")?c1(t,e):()=>t[e]:e.bind(t,t);let s;_e(c)?s=c:(s=c.handler,n=c);const u=Ge;Bt(this);const l=Pl(a,s.bind(t),n);return u?Bt(u):dt(),l}function c1(e,c){const n=c.split(".");return()=>{let t=e;for(let a=0;a<n.length&&t;a++)t=t[n[a]];return t}}function st(e,c){if(!Ne(e)||e.__v_skip||(c=c||new Set,c.has(e)))return e;if(c.add(e),We(e))st(e.value,c);else if(ge(e))for(let n=0;n<e.length;n++)st(e[n],c);else if(wo(e)||At(e))e.forEach(n=>{st(n,c)});else if(Ao(e))for(const n in e)st(e[n],c);return e}function n1(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return vc(()=>{e.isMounted=!0}),jc(()=>{e.isUnmounting=!0}),e}const Ec=[Function,Array],p0={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ec,onEnter:Ec,onAfterEnter:Ec,onEnterCancelled:Ec,onBeforeLeave:Ec,onLeave:Ec,onAfterLeave:Ec,onLeaveCancelled:Ec,onBeforeAppear:Ec,onAppear:Ec,onAfterAppear:Ec,onAppearCancelled:Ec},setup(e,{slots:c}){const n=Ps(),t=n1();let a;return()=>{const s=c.default&&Tl(c.default(),!0);if(!s||!s.length)return;let u=s[0];if(s.length>1){for(const b of s)if(b.type!==yn){u=b;break}}const l=Ce(e),{mode:r}=l;if(t.isLeaving)return Zs(u);const o=Or(u);if(!o)return Zs(u);const i=pa(o,l,t,n);Sa(o,i);const d=n.subTree,f=d&&Or(d);let v=!1;const{getTransitionKey:y}=o.type;if(y){const b=y();a===void 0?a=b:b!==a&&(a=b,v=!0)}if(f&&f.type!==yn&&(!nt(o,f)||v)){const b=pa(f,l,t,n);if(Sa(f,b),r==="out-in")return t.isLeaving=!0,b.afterLeave=()=>{t.isLeaving=!1,n.update.active!==!1&&n.update()},Zs(u);r==="in-out"&&o.type!==yn&&(b.delayLeave=(k,g,p)=>{const j=a1(t,f);j[String(f.key)]=f,k._leaveCb=()=>{g(),k._leaveCb=void 0,delete i.delayedLeave},i.delayedLeave=p})}return u}}},t1=p0;function a1(e,c){const{leavingVNodes:n}=e;let t=n.get(c.type);return t||(t=Object.create(null),n.set(c.type,t)),t}function pa(e,c,n,t){const{appear:a,mode:s,persisted:u=!1,onBeforeEnter:l,onEnter:r,onAfterEnter:o,onEnterCancelled:i,onBeforeLeave:d,onLeave:f,onAfterLeave:v,onLeaveCancelled:y,onBeforeAppear:b,onAppear:k,onAfterAppear:g,onAppearCancelled:p}=c,j=String(e.key),P=a1(n,e),x=(q,C)=>{q&&Pc(q,t,9,C)},I=(q,C)=>{const w=C[1];x(q,C),ge(q)?q.every(V=>V.length<=1)&&w():q.length<=1&&w()},A={mode:s,persisted:u,beforeEnter(q){let C=l;if(!n.isMounted)if(a)C=b||l;else return;q._leaveCb&&q._leaveCb(!0);const w=P[j];w&&nt(e,w)&&w.el._leaveCb&&w.el._leaveCb(),x(C,[q])},enter(q){let C=r,w=o,V=i;if(!n.isMounted)if(a)C=k||r,w=g||o,V=p||i;else return;let _=!1;const M=q._enterCb=N=>{_||(_=!0,N?x(V,[q]):x(w,[q]),A.delayedLeave&&A.delayedLeave(),q._enterCb=void 0)};C?I(C,[q,M]):M()},leave(q,C){const w=String(e.key);if(q._enterCb&&q._enterCb(!0),n.isUnmounting)return C();x(d,[q]);let V=!1;const _=q._leaveCb=M=>{V||(V=!0,C(),M?x(y,[q]):x(v,[q]),q._leaveCb=void 0,P[w]===e&&delete P[w])};P[w]=e,f?I(f,[q,_]):_()},clone(q){return pa(q,c,n,t)}};return A}function Zs(e){if(Vs(e))return e=hn(e),e.children=null,e}function Or(e){return Vs(e)?e.children?e.children[0]:void 0:e}function Sa(e,c){e.shapeFlag&6&&e.component?Sa(e.component.subTree,c):e.shapeFlag&128?(e.ssContent.transition=c.clone(e.ssContent),e.ssFallback.transition=c.clone(e.ssFallback)):e.transition=c}function Tl(e,c=!1,n){let t=[],a=0;for(let s=0;s<e.length;s++){let u=e[s];const l=n==null?u.key:String(n)+String(u.key!=null?u.key:s);u.type===ve?(u.patchFlag&128&&a++,t=t.concat(Tl(u.children,c,l))):(c||u.type!==yn)&&t.push(l!=null?hn(u,{key:l}):u)}if(a>1)for(let s=0;s<t.length;s++)t[s].patchFlag=-2;return t}function $l(e){return _e(e)?{setup:e,name:e.name}:e}const as=e=>!!e.type.__asyncLoader,Vs=e=>e.type.__isKeepAlive;function s1(e,c){l1(e,"a",c)}function u1(e,c){l1(e,"da",c)}function l1(e,c,n=Ge){const t=e.__wdc||(e.__wdc=()=>{let a=n;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if(Is(c,t,n),n){let a=n.parent;for(;a&&a.parent;)Vs(a.parent.vnode)&&S0(t,c,n,a),a=a.parent}}function S0(e,c,n,t){const a=Is(c,e,t,!0);i1(()=>{hl(t[c],a)},n)}function Is(e,c,n=Ge,t=!1){if(n){const a=n[e]||(n[e]=[]),s=c.__weh||(c.__weh=(...u)=>{if(n.isUnmounted)return;zt(),Bt(n);const l=Pc(c,n,e,u);return dt(),Ht(),l});return t?a.unshift(s):a.push(s),s}}const Sn=e=>(c,n=Ge)=>(!_a||e==="sp")&&Is(e,(...t)=>c(...t),n),As=Sn("bm"),vc=Sn("m"),r1=Sn("bu"),Ml=Sn("u"),jc=Sn("bum"),i1=Sn("um"),C0=Sn("sp"),_0=Sn("rtg"),x0=Sn("rtc");function w0(e,c=Ge){Is("ec",e,c)}function He(e,c){const n=wc;if(n===null)return e;const t=Ts(n)||n.proxy,a=e.dirs||(e.dirs=[]);for(let s=0;s<c.length;s++){let[u,l,r,o=Fe]=c[s];u&&(_e(u)&&(u={mounted:u,updated:u}),u.deep&&st(l),a.push({dir:u,instance:t,value:l,oldValue:void 0,arg:r,modifiers:o}))}return e}function Gn(e,c,n,t){const a=e.dirs,s=c&&c.dirs;for(let u=0;u<a.length;u++){const l=a[u];s&&(l.oldValue=s[u].value);let r=l.dir[t];r&&(zt(),Pc(r,n,8,[e.el,l,e,c]),Ht())}}const Bl="components",V0="directives";function Le(e,c){return Rl(Bl,e,!0,c)||e}const o1=Symbol();function I0(e){return Ye(e)?Rl(Bl,e,!1)||e:e||o1}function pc(e){return Rl(V0,e)}function Rl(e,c,n=!0,t=!1){const a=wc||Ge;if(a){const s=a.type;if(e===Bl){const l=u2(s,!1);if(l&&(l===c||l===$c(c)||l===pn($c(c))))return s}const u=Lr(a[e]||s[e],c)||Lr(a.appContext[e],c);return!u&&t?s:u}}function Lr(e,c){return e&&(e[c]||e[$c(c)]||e[pn($c(c))])}function Mn(e,c,n,t){let a;const s=n&&n[t];if(ge(e)||Ye(e)){a=new Array(e.length);for(let u=0,l=e.length;u<l;u++)a[u]=c(e[u],u,void 0,s&&s[u])}else if(typeof e=="number"){a=new Array(e);for(let u=0;u<e;u++)a[u]=c(u+1,u,void 0,s&&s[u])}else if(Ne(e))if(e[Symbol.iterator])a=Array.from(e,(u,l)=>c(u,l,void 0,s&&s[l]));else{const u=Object.keys(e);a=new Array(u.length);for(let l=0,r=u.length;l<r;l++){const o=u[l];a[l]=c(e[o],o,l,s&&s[l])}}else a=[];return n&&(n[t]=a),a}function Qs(e,c){const n={};for(const t in e)n[c&&/[A-Z]/.test(t)?`on:${t}`:ns(t)]=e[t];return n}const Su=e=>e?k1(e)?Ts(e)||e.proxy:Su(e.parent):null,da=ac(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Su(e.parent),$root:e=>Su(e.root),$emit:e=>e.emit,$options:e=>Ol(e),$forceUpdate:e=>e.f||(e.f=()=>El(e.update)),$nextTick:e=>e.n||(e.n=Oe.bind(e.proxy)),$watch:e=>k0.bind(e)}),Js=(e,c)=>e!==Fe&&!e.__isScriptSetup&&Ee(e,c),A0={get({_:e},c){const{ctx:n,setupState:t,data:a,props:s,accessCache:u,type:l,appContext:r}=e;let o;if(c[0]!=="$"){const v=u[c];if(v!==void 0)switch(v){case 1:return t[c];case 2:return a[c];case 4:return n[c];case 3:return s[c]}else{if(Js(t,c))return u[c]=1,t[c];if(a!==Fe&&Ee(a,c))return u[c]=2,a[c];if((o=e.propsOptions[0])&&Ee(o,c))return u[c]=3,s[c];if(n!==Fe&&Ee(n,c))return u[c]=4,n[c];Cu&&(u[c]=0)}}const i=da[c];let d,f;if(i)return c==="$attrs"&&kc(e,"get",c),i(e);if((d=l.__cssModules)&&(d=d[c]))return d;if(n!==Fe&&Ee(n,c))return u[c]=4,n[c];if(f=r.config.globalProperties,Ee(f,c))return f[c]},set({_:e},c,n){const{data:t,setupState:a,ctx:s}=e;return Js(a,c)?(a[c]=n,!0):t!==Fe&&Ee(t,c)?(t[c]=n,!0):Ee(e.props,c)||c[0]==="$"&&c.slice(1)in e?!1:(s[c]=n,!0)},has({_:{data:e,setupState:c,accessCache:n,ctx:t,appContext:a,propsOptions:s}},u){let l;return!!n[u]||e!==Fe&&Ee(e,u)||Js(c,u)||(l=s[0])&&Ee(l,u)||Ee(t,u)||Ee(da,u)||Ee(a.config.globalProperties,u)},defineProperty(e,c,n){return n.get!=null?e._.accessCache[c]=0:Ee(n,"value")&&this.set(e,c,n.value,null),Reflect.defineProperty(e,c,n)}};let Cu=!0;function E0(e){const c=Ol(e),n=e.proxy,t=e.ctx;Cu=!1,c.beforeCreate&&Fr(c.beforeCreate,e,"bc");const{data:a,computed:s,methods:u,watch:l,provide:r,inject:o,created:i,beforeMount:d,mounted:f,beforeUpdate:v,updated:y,activated:b,deactivated:k,beforeDestroy:g,beforeUnmount:p,destroyed:j,unmounted:P,render:x,renderTracked:I,renderTriggered:A,errorCaptured:q,serverPrefetch:C,expose:w,inheritAttrs:V,components:_,directives:M,filters:N}=c;if(o&&P0(o,t,null,e.appContext.config.unwrapInjectedRef),u)for(const H in u){const D=u[H];_e(D)&&(t[H]=D.bind(n))}if(a){const H=a.call(n,n);Ne(H)&&(e.data=sc(H))}if(Cu=!0,s)for(const H in s){const D=s[H],J=_e(D)?D.bind(n,n):_e(D.get)?D.get.bind(n,n):Uc,R=!_e(D)&&_e(D.set)?D.set.bind(n):Uc,K=h({get:J,set:R});Object.defineProperty(t,H,{enumerable:!0,configurable:!0,get:()=>K.value,set:z=>K.value=z})}if(l)for(const H in l)d1(l[H],t,n,H);if(r){const H=_e(r)?r.call(n):r;Reflect.ownKeys(H).forEach(D=>{Ke(D,H[D])})}i&&Fr(i,e,"c");function F(H,D){ge(D)?D.forEach(J=>H(J.bind(n))):D&&H(D.bind(n))}if(F(As,d),F(vc,f),F(r1,v),F(Ml,y),F(s1,b),F(u1,k),F(w0,q),F(x0,I),F(_0,A),F(jc,p),F(i1,P),F(C0,C),ge(w))if(w.length){const H=e.exposed||(e.exposed={});w.forEach(D=>{Object.defineProperty(H,D,{get:()=>n[D],set:J=>n[D]=J})})}else e.exposed||(e.exposed={});x&&e.render===Uc&&(e.render=x),V!=null&&(e.inheritAttrs=V),_&&(e.components=_),M&&(e.directives=M)}function P0(e,c,n=Uc,t=!1){ge(e)&&(e=_u(e));for(const a in e){const s=e[a];let u;Ne(s)?"default"in s?u=Ve(s.from||a,s.default,!0):u=Ve(s.from||a):u=Ve(s),We(u)&&t?Object.defineProperty(c,a,{enumerable:!0,configurable:!0,get:()=>u.value,set:l=>u.value=l}):c[a]=u}}function Fr(e,c,n){Pc(ge(e)?e.map(t=>t.bind(c.proxy)):e.bind(c.proxy),c,n)}function d1(e,c,n,t){const a=t.includes(".")?c1(n,t):()=>n[t];if(Ye(e)){const s=c[e];_e(s)&&ae(a,s)}else if(_e(e))ae(a,e.bind(n));else if(Ne(e))if(ge(e))e.forEach(s=>d1(s,c,n,t));else{const s=_e(e.handler)?e.handler.bind(n):c[e.handler];_e(s)&&ae(a,s,e)}}function Ol(e){const c=e.type,{mixins:n,extends:t}=c,{mixins:a,optionsCache:s,config:{optionMergeStrategies:u}}=e.appContext,l=s.get(c);let r;return l?r=l:!a.length&&!n&&!t?r=c:(r={},a.length&&a.forEach(o=>ms(r,o,u,!0)),ms(r,c,u)),Ne(c)&&s.set(c,r),r}function ms(e,c,n,t=!1){const{mixins:a,extends:s}=c;s&&ms(e,s,n,!0),a&&a.forEach(u=>ms(e,u,n,!0));for(const u in c)if(!(t&&u==="expose")){const l=T0[u]||n&&n[u];e[u]=l?l(e[u],c[u]):c[u]}return e}const T0={data:Nr,props:et,emits:et,methods:et,computed:et,beforeCreate:hc,created:hc,beforeMount:hc,mounted:hc,beforeUpdate:hc,updated:hc,beforeDestroy:hc,beforeUnmount:hc,destroyed:hc,unmounted:hc,activated:hc,deactivated:hc,errorCaptured:hc,serverPrefetch:hc,components:et,directives:et,watch:M0,provide:Nr,inject:$0};function Nr(e,c){return c?e?function(){return ac(_e(e)?e.call(this,this):e,_e(c)?c.call(this,this):c)}:c:e}function $0(e,c){return et(_u(e),_u(c))}function _u(e){if(ge(e)){const c={};for(let n=0;n<e.length;n++)c[e[n]]=e[n];return c}return e}function hc(e,c){return e?[...new Set([].concat(e,c))]:c}function et(e,c){return e?ac(ac(Object.create(null),e),c):c}function M0(e,c){if(!e)return c;if(!c)return e;const n=ac(Object.create(null),e);for(const t in c)n[t]=hc(e[t],c[t]);return n}function B0(e,c,n,t=!1){const a={},s={};is(s,Es,1),e.propsDefaults=Object.create(null),f1(e,c,a,s);for(const u in e.propsOptions[0])u in a||(a[u]=void 0);n?e.props=t?a:t0(a):e.type.props?e.props=a:e.props=s,e.attrs=s}function R0(e,c,n,t){const{props:a,attrs:s,vnode:{patchFlag:u}}=e,l=Ce(a),[r]=e.propsOptions;let o=!1;if((t||u>0)&&!(u&16)){if(u&8){const i=e.vnode.dynamicProps;for(let d=0;d<i.length;d++){let f=i[d];if(ws(e.emitsOptions,f))continue;const v=c[f];if(r)if(Ee(s,f))v!==s[f]&&(s[f]=v,o=!0);else{const y=$c(f);a[y]=xu(r,l,y,v,e,!1)}else v!==s[f]&&(s[f]=v,o=!0)}}}else{f1(e,c,a,s)&&(o=!0);let i;for(const d in l)(!c||!Ee(c,d)&&((i=Dt(d))===d||!Ee(c,i)))&&(r?n&&(n[d]!==void 0||n[i]!==void 0)&&(a[d]=xu(r,l,d,void 0,e,!0)):delete a[d]);if(s!==l)for(const d in s)(!c||!Ee(c,d))&&(delete s[d],o=!0)}o&&bn(e,"set","$attrs")}function f1(e,c,n,t){const[a,s]=e.propsOptions;let u=!1,l;if(c)for(let r in c){if(cs(r))continue;const o=c[r];let i;a&&Ee(a,i=$c(r))?!s||!s.includes(i)?n[i]=o:(l||(l={}))[i]=o:ws(e.emitsOptions,r)||(!(r in t)||o!==t[r])&&(t[r]=o,u=!0)}if(s){const r=Ce(n),o=l||Fe;for(let i=0;i<s.length;i++){const d=s[i];n[d]=xu(a,r,d,o[d],e,!Ee(o,d))}}return u}function xu(e,c,n,t,a,s){const u=e[n];if(u!=null){const l=Ee(u,"default");if(l&&t===void 0){const r=u.default;if(u.type!==Function&&_e(r)){const{propsDefaults:o}=a;n in o?t=o[n]:(Bt(a),t=o[n]=r.call(null,c),dt())}else t=r}u[0]&&(s&&!l?t=!1:u[1]&&(t===""||t===Dt(n))&&(t=!0))}return t}function m1(e,c,n=!1){const t=c.propsCache,a=t.get(e);if(a)return a;const s=e.props,u={},l=[];let r=!1;if(!_e(e)){const i=d=>{r=!0;const[f,v]=m1(d,c,!0);ac(u,f),v&&l.push(...v)};!n&&c.mixins.length&&c.mixins.forEach(i),e.extends&&i(e.extends),e.mixins&&e.mixins.forEach(i)}if(!s&&!r)return Ne(e)&&t.set(e,It),It;if(ge(s))for(let i=0;i<s.length;i++){const d=$c(s[i]);Dr(d)&&(u[d]=Fe)}else if(s)for(const i in s){const d=$c(i);if(Dr(d)){const f=s[i],v=u[d]=ge(f)||_e(f)?{type:f}:Object.assign({},f);if(v){const y=Ur(Boolean,v.type),b=Ur(String,v.type);v[0]=y>-1,v[1]=b<0||y<b,(y>-1||Ee(v,"default"))&&l.push(d)}}}const o=[u,l];return Ne(e)&&t.set(e,o),o}function Dr(e){return e[0]!=="$"}function zr(e){const c=e&&e.toString().match(/^\s*(function|class) (\w+)/);return c?c[2]:e===null?"null":""}function Hr(e,c){return zr(e)===zr(c)}function Ur(e,c){return ge(c)?c.findIndex(n=>Hr(n,e)):_e(c)&&Hr(c,e)?0:-1}const v1=e=>e[0]==="_"||e==="$stable",Ll=e=>ge(e)?e.map(Qc):[Qc(e)],O0=(e,c,n)=>{if(c._n)return c;const t=Ae((...a)=>Ll(c(...a)),n);return t._c=!1,t},y1=(e,c,n)=>{const t=e._ctx;for(const a in e){if(v1(a))continue;const s=e[a];if(_e(s))c[a]=O0(a,s,t);else if(s!=null){const u=Ll(s);c[a]=()=>u}}},b1=(e,c)=>{const n=Ll(c);e.slots.default=()=>n},L0=(e,c)=>{if(e.vnode.shapeFlag&32){const n=c._;n?(e.slots=Ce(c),is(c,"_",n)):y1(c,e.slots={})}else e.slots={},c&&b1(e,c);is(e.slots,Es,1)},F0=(e,c,n)=>{const{vnode:t,slots:a}=e;let s=!0,u=Fe;if(t.shapeFlag&32){const l=c._;l?n&&l===1?s=!1:(ac(a,c),!n&&l===1&&delete a._):(s=!c.$stable,y1(c,a)),u=c}else c&&(b1(e,c),u={default:1});if(s)for(const l in a)!v1(l)&&!(l in u)&&delete a[l]};function h1(){return{app:null,config:{isNativeTag:qm,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let N0=0;function D0(e,c){return function(t,a=null){_e(t)||(t=Object.assign({},t)),a!=null&&!Ne(a)&&(a=null);const s=h1(),u=new Set;let l=!1;const r=s.app={_uid:N0++,_component:t,_props:a,_container:null,_context:s,_instance:null,version:o2,get config(){return s.config},set config(o){},use(o,...i){return u.has(o)||(o&&_e(o.install)?(u.add(o),o.install(r,...i)):_e(o)&&(u.add(o),o(r,...i))),r},mixin(o){return s.mixins.includes(o)||s.mixins.push(o),r},component(o,i){return i?(s.components[o]=i,r):s.components[o]},directive(o,i){return i?(s.directives[o]=i,r):s.directives[o]},mount(o,i,d){if(!l){const f=m(t,a);return f.appContext=s,i&&c?c(f,o):e(f,o,d),l=!0,r._container=o,o.__vue_app__=r,Ts(f.component)||f.component.proxy}},unmount(){l&&(e(null,r._container),delete r._container.__vue_app__)},provide(o,i){return s.provides[o]=i,r}};return r}}function wu(e,c,n,t,a=!1){if(ge(e)){e.forEach((f,v)=>wu(f,c&&(ge(c)?c[v]:c),n,t,a));return}if(as(t)&&!a)return;const s=t.shapeFlag&4?Ts(t.component)||t.component.proxy:t.el,u=a?null:s,{i:l,r}=e,o=c&&c.r,i=l.refs===Fe?l.refs={}:l.refs,d=l.setupState;if(o!=null&&o!==r&&(Ye(o)?(i[o]=null,Ee(d,o)&&(d[o]=null)):We(o)&&(o.value=null)),_e(r))Rn(r,l,12,[u,i]);else{const f=Ye(r),v=We(r);if(f||v){const y=()=>{if(e.f){const b=f?Ee(d,r)?d[r]:i[r]:r.value;a?ge(b)&&hl(b,s):ge(b)?b.includes(s)||b.push(s):f?(i[r]=[s],Ee(d,r)&&(d[r]=i[r])):(r.value=[s],e.k&&(i[e.k]=r.value))}else f?(i[r]=u,Ee(d,r)&&(d[r]=u)):v&&(r.value=u,e.k&&(i[e.k]=u))};u?(y.id=-1,qc(y,n)):y()}}}const qc=q0;function z0(e){return H0(e)}function H0(e,c){const n=wm();n.__VUE__=!0;const{insert:t,remove:a,patchProp:s,createElement:u,createText:l,createComment:r,setText:o,setElementText:i,parentNode:d,nextSibling:f,setScopeId:v=Uc,insertStaticContent:y}=e,b=(S,E,L,U=null,G=null,ce=null,ue=!1,ee=null,te=!!E.dynamicChildren)=>{if(S===E)return;S&&!nt(S,E)&&(U=O(S),z(S,G,ce,!0),S=null),E.patchFlag===-2&&(te=!1,E.dynamicChildren=null);const{type:Q,ref:ye,shapeFlag:de}=E;switch(Q){case Ma:k(S,E,L,U);break;case yn:g(S,E,L,U);break;case eu:S==null&&p(E,L,U,ue);break;case ve:_(S,E,L,U,G,ce,ue,ee,te);break;default:de&1?x(S,E,L,U,G,ce,ue,ee,te):de&6?M(S,E,L,U,G,ce,ue,ee,te):(de&64||de&128)&&Q.process(S,E,L,U,G,ce,ue,ee,te,ie)}ye!=null&&G&&wu(ye,S&&S.ref,ce,E||S,!E)},k=(S,E,L,U)=>{if(S==null)t(E.el=l(E.children),L,U);else{const G=E.el=S.el;E.children!==S.children&&o(G,E.children)}},g=(S,E,L,U)=>{S==null?t(E.el=r(E.children||""),L,U):E.el=S.el},p=(S,E,L,U)=>{[S.el,S.anchor]=y(S.children,E,L,U,S.el,S.anchor)},j=({el:S,anchor:E},L,U)=>{let G;for(;S&&S!==E;)G=f(S),t(S,L,U),S=G;t(E,L,U)},P=({el:S,anchor:E})=>{let L;for(;S&&S!==E;)L=f(S),a(S),S=L;a(E)},x=(S,E,L,U,G,ce,ue,ee,te)=>{ue=ue||E.type==="svg",S==null?I(E,L,U,G,ce,ue,ee,te):C(S,E,G,ce,ue,ee,te)},I=(S,E,L,U,G,ce,ue,ee)=>{let te,Q;const{type:ye,props:de,shapeFlag:be,transition:ke,dirs:we}=S;if(te=S.el=u(S.type,ce,de&&de.is,de),be&8?i(te,S.children):be&16&&q(S.children,te,null,U,G,ce&&ye!=="foreignObject",ue,ee),we&&Gn(S,null,U,"created"),A(te,S,S.scopeId,ue,U),de){for(const Me in de)Me!=="value"&&!cs(Me)&&s(te,Me,null,de[Me],ce,S.children,U,G,T);"value"in de&&s(te,"value",null,de.value),(Q=de.onVnodeBeforeMount)&&Zc(Q,U,S)}we&&Gn(S,null,U,"beforeMount");const Re=(!G||G&&!G.pendingBranch)&&ke&&!ke.persisted;Re&&ke.beforeEnter(te),t(te,E,L),((Q=de&&de.onVnodeMounted)||Re||we)&&qc(()=>{Q&&Zc(Q,U,S),Re&&ke.enter(te),we&&Gn(S,null,U,"mounted")},G)},A=(S,E,L,U,G)=>{if(L&&v(S,L),U)for(let ce=0;ce<U.length;ce++)v(S,U[ce]);if(G){let ce=G.subTree;if(E===ce){const ue=G.vnode;A(S,ue,ue.scopeId,ue.slotScopeIds,G.parent)}}},q=(S,E,L,U,G,ce,ue,ee,te=0)=>{for(let Q=te;Q<S.length;Q++){const ye=S[Q]=ee?Tn(S[Q]):Qc(S[Q]);b(null,ye,E,L,U,G,ce,ue,ee)}},C=(S,E,L,U,G,ce,ue)=>{const ee=E.el=S.el;let{patchFlag:te,dynamicChildren:Q,dirs:ye}=E;te|=S.patchFlag&16;const de=S.props||Fe,be=E.props||Fe;let ke;L&&Xn(L,!1),(ke=be.onVnodeBeforeUpdate)&&Zc(ke,L,E,S),ye&&Gn(E,S,L,"beforeUpdate"),L&&Xn(L,!0);const we=G&&E.type!=="foreignObject";if(Q?w(S.dynamicChildren,Q,ee,L,U,we,ce):ue||D(S,E,ee,null,L,U,we,ce,!1),te>0){if(te&16)V(ee,E,de,be,L,U,G);else if(te&2&&de.class!==be.class&&s(ee,"class",null,be.class,G),te&4&&s(ee,"style",de.style,be.style,G),te&8){const Re=E.dynamicProps;for(let Me=0;Me<Re.length;Me++){const Qe=Re[Me],Nc=de[Qe],qt=be[Qe];(qt!==Nc||Qe==="value")&&s(ee,Qe,Nc,qt,G,S.children,L,U,T)}}te&1&&S.children!==E.children&&i(ee,E.children)}else!ue&&Q==null&&V(ee,E,de,be,L,U,G);((ke=be.onVnodeUpdated)||ye)&&qc(()=>{ke&&Zc(ke,L,E,S),ye&&Gn(E,S,L,"updated")},U)},w=(S,E,L,U,G,ce,ue)=>{for(let ee=0;ee<E.length;ee++){const te=S[ee],Q=E[ee],ye=te.el&&(te.type===ve||!nt(te,Q)||te.shapeFlag&70)?d(te.el):L;b(te,Q,ye,null,U,G,ce,ue,!0)}},V=(S,E,L,U,G,ce,ue)=>{if(L!==U){if(L!==Fe)for(const ee in L)!cs(ee)&&!(ee in U)&&s(S,ee,L[ee],null,ue,E.children,G,ce,T);for(const ee in U){if(cs(ee))continue;const te=U[ee],Q=L[ee];te!==Q&&ee!=="value"&&s(S,ee,Q,te,ue,E.children,G,ce,T)}"value"in U&&s(S,"value",L.value,U.value)}},_=(S,E,L,U,G,ce,ue,ee,te)=>{const Q=E.el=S?S.el:l(""),ye=E.anchor=S?S.anchor:l("");let{patchFlag:de,dynamicChildren:be,slotScopeIds:ke}=E;ke&&(ee=ee?ee.concat(ke):ke),S==null?(t(Q,L,U),t(ye,L,U),q(E.children,L,ye,G,ce,ue,ee,te)):de>0&&de&64&&be&&S.dynamicChildren?(w(S.dynamicChildren,be,L,G,ce,ue,ee),(E.key!=null||G&&E===G.subTree)&&Fl(S,E,!0)):D(S,E,L,ye,G,ce,ue,ee,te)},M=(S,E,L,U,G,ce,ue,ee,te)=>{E.slotScopeIds=ee,S==null?E.shapeFlag&512?G.ctx.activate(E,L,U,ue,te):N(E,L,U,G,ce,ue,te):Z(S,E,te)},N=(S,E,L,U,G,ce,ue)=>{const ee=S.component=c2(S,U,G);if(Vs(S)&&(ee.ctx.renderer=ie),n2(ee),ee.asyncDep){if(G&&G.registerDep(ee,F),!S.el){const te=ee.subTree=m(yn);g(null,te,E,L)}return}F(ee,S,E,L,G,ce,ue)},Z=(S,E,L)=>{const U=E.component=S.component;if(h0(S,E,L))if(U.asyncDep&&!U.asyncResolved){H(U,E,L);return}else U.next=E,d0(U.update),U.update();else E.el=S.el,U.vnode=E},F=(S,E,L,U,G,ce,ue)=>{const ee=()=>{if(S.isMounted){let{next:ye,bu:de,u:be,parent:ke,vnode:we}=S,Re=ye,Me;Xn(S,!1),ye?(ye.el=we.el,H(S,ye,ue)):ye=we,de&&ts(de),(Me=ye.props&&ye.props.onVnodeBeforeUpdate)&&Zc(Me,ke,ye,we),Xn(S,!0);const Qe=Xs(S),Nc=S.subTree;S.subTree=Qe,b(Nc,Qe,d(Nc.el),O(Nc),S,G,ce),ye.el=Qe.el,Re===null&&g0(S,Qe.el),be&&qc(be,G),(Me=ye.props&&ye.props.onVnodeUpdated)&&qc(()=>Zc(Me,ke,ye,we),G)}else{let ye;const{el:de,props:be}=E,{bm:ke,m:we,parent:Re}=S,Me=as(E);if(Xn(S,!1),ke&&ts(ke),!Me&&(ye=be&&be.onVnodeBeforeMount)&&Zc(ye,Re,E),Xn(S,!0),de&&me){const Qe=()=>{S.subTree=Xs(S),me(de,S.subTree,S,G,null)};Me?E.type.__asyncLoader().then(()=>!S.isUnmounted&&Qe()):Qe()}else{const Qe=S.subTree=Xs(S);b(null,Qe,L,U,S,G,ce),E.el=Qe.el}if(we&&qc(we,G),!Me&&(ye=be&&be.onVnodeMounted)){const Qe=E;qc(()=>Zc(ye,Re,Qe),G)}(E.shapeFlag&256||Re&&as(Re.vnode)&&Re.vnode.shapeFlag&256)&&S.a&&qc(S.a,G),S.isMounted=!0,E=L=U=null}},te=S.effect=new pl(ee,()=>El(Q),S.scope),Q=S.update=()=>te.run();Q.id=S.uid,Xn(S,!0),Q()},H=(S,E,L)=>{E.component=S;const U=S.vnode.props;S.vnode=E,S.next=null,R0(S,E.props,U,L),F0(S,E.children,L),zt(),Br(),Ht()},D=(S,E,L,U,G,ce,ue,ee,te=!1)=>{const Q=S&&S.children,ye=S?S.shapeFlag:0,de=E.children,{patchFlag:be,shapeFlag:ke}=E;if(be>0){if(be&128){R(Q,de,L,U,G,ce,ue,ee,te);return}else if(be&256){J(Q,de,L,U,G,ce,ue,ee,te);return}}ke&8?(ye&16&&T(Q,G,ce),de!==Q&&i(L,de)):ye&16?ke&16?R(Q,de,L,U,G,ce,ue,ee,te):T(Q,G,ce,!0):(ye&8&&i(L,""),ke&16&&q(de,L,U,G,ce,ue,ee,te))},J=(S,E,L,U,G,ce,ue,ee,te)=>{S=S||It,E=E||It;const Q=S.length,ye=E.length,de=Math.min(Q,ye);let be;for(be=0;be<de;be++){const ke=E[be]=te?Tn(E[be]):Qc(E[be]);b(S[be],ke,L,null,G,ce,ue,ee,te)}Q>ye?T(S,G,ce,!0,!1,de):q(E,L,U,G,ce,ue,ee,te,de)},R=(S,E,L,U,G,ce,ue,ee,te)=>{let Q=0;const ye=E.length;let de=S.length-1,be=ye-1;for(;Q<=de&&Q<=be;){const ke=S[Q],we=E[Q]=te?Tn(E[Q]):Qc(E[Q]);if(nt(ke,we))b(ke,we,L,null,G,ce,ue,ee,te);else break;Q++}for(;Q<=de&&Q<=be;){const ke=S[de],we=E[be]=te?Tn(E[be]):Qc(E[be]);if(nt(ke,we))b(ke,we,L,null,G,ce,ue,ee,te);else break;de--,be--}if(Q>de){if(Q<=be){const ke=be+1,we=ke<ye?E[ke].el:U;for(;Q<=be;)b(null,E[Q]=te?Tn(E[Q]):Qc(E[Q]),L,we,G,ce,ue,ee,te),Q++}}else if(Q>be)for(;Q<=de;)z(S[Q],G,ce,!0),Q++;else{const ke=Q,we=Q,Re=new Map;for(Q=we;Q<=be;Q++){const Sc=E[Q]=te?Tn(E[Q]):Qc(E[Q]);Sc.key!=null&&Re.set(Sc.key,Q)}let Me,Qe=0;const Nc=be-we+1;let qt=!1,_r=0;const ta=new Array(Nc);for(Q=0;Q<Nc;Q++)ta[Q]=0;for(Q=ke;Q<=de;Q++){const Sc=S[Q];if(Qe>=Nc){z(Sc,G,ce,!0);continue}let Xc;if(Sc.key!=null)Xc=Re.get(Sc.key);else for(Me=we;Me<=be;Me++)if(ta[Me-we]===0&&nt(Sc,E[Me])){Xc=Me;break}Xc===void 0?z(Sc,G,ce,!0):(ta[Xc-we]=Q+1,Xc>=_r?_r=Xc:qt=!0,b(Sc,E[Xc],L,null,G,ce,ue,ee,te),Qe++)}const xr=qt?U0(ta):It;for(Me=xr.length-1,Q=Nc-1;Q>=0;Q--){const Sc=we+Q,Xc=E[Sc],wr=Sc+1<ye?E[Sc+1].el:U;ta[Q]===0?b(null,Xc,L,wr,G,ce,ue,ee,te):qt&&(Me<0||Q!==xr[Me]?K(Xc,L,wr,2):Me--)}}},K=(S,E,L,U,G=null)=>{const{el:ce,type:ue,transition:ee,children:te,shapeFlag:Q}=S;if(Q&6){K(S.component.subTree,E,L,U);return}if(Q&128){S.suspense.move(E,L,U);return}if(Q&64){ue.move(S,E,L,ie);return}if(ue===ve){t(ce,E,L);for(let de=0;de<te.length;de++)K(te[de],E,L,U);t(S.anchor,E,L);return}if(ue===eu){j(S,E,L);return}if(U!==2&&Q&1&&ee)if(U===0)ee.beforeEnter(ce),t(ce,E,L),qc(()=>ee.enter(ce),G);else{const{leave:de,delayLeave:be,afterLeave:ke}=ee,we=()=>t(ce,E,L),Re=()=>{de(ce,()=>{we(),ke&&ke()})};be?be(ce,we,Re):Re()}else t(ce,E,L)},z=(S,E,L,U=!1,G=!1)=>{const{type:ce,props:ue,ref:ee,children:te,dynamicChildren:Q,shapeFlag:ye,patchFlag:de,dirs:be}=S;if(ee!=null&&wu(ee,null,L,S,!0),ye&256){E.ctx.deactivate(S);return}const ke=ye&1&&be,we=!as(S);let Re;if(we&&(Re=ue&&ue.onVnodeBeforeUnmount)&&Zc(Re,E,S),ye&6)B(S.component,L,U);else{if(ye&128){S.suspense.unmount(L,U);return}ke&&Gn(S,null,E,"beforeUnmount"),ye&64?S.type.remove(S,E,L,G,ie,U):Q&&(ce!==ve||de>0&&de&64)?T(Q,E,L,!1,!0):(ce===ve&&de&384||!G&&ye&16)&&T(te,E,L),U&&fe(S)}(we&&(Re=ue&&ue.onVnodeUnmounted)||ke)&&qc(()=>{Re&&Zc(Re,E,S),ke&&Gn(S,null,E,"unmounted")},L)},fe=S=>{const{type:E,el:L,anchor:U,transition:G}=S;if(E===ve){oe(L,U);return}if(E===eu){P(S);return}const ce=()=>{a(L),G&&!G.persisted&&G.afterLeave&&G.afterLeave()};if(S.shapeFlag&1&&G&&!G.persisted){const{leave:ue,delayLeave:ee}=G,te=()=>ue(L,ce);ee?ee(S.el,ce,te):te()}else ce()},oe=(S,E)=>{let L;for(;S!==E;)L=f(S),a(S),S=L;a(E)},B=(S,E,L)=>{const{bum:U,scope:G,update:ce,subTree:ue,um:ee}=S;U&&ts(U),G.stop(),ce&&(ce.active=!1,z(ue,S,E,L)),ee&&qc(ee,E),qc(()=>{S.isUnmounted=!0},E),E&&E.pendingBranch&&!E.isUnmounted&&S.asyncDep&&!S.asyncResolved&&S.suspenseId===E.pendingId&&(E.deps--,E.deps===0&&E.resolve())},T=(S,E,L,U=!1,G=!1,ce=0)=>{for(let ue=ce;ue<S.length;ue++)z(S[ue],E,L,U,G)},O=S=>S.shapeFlag&6?O(S.component.subTree):S.shapeFlag&128?S.suspense.next():f(S.anchor||S.el),re=(S,E,L)=>{S==null?E._vnode&&z(E._vnode,null,null,!0):b(E._vnode||null,S,E,null,null,null,L),Br(),Zo(),E._vnode=S},ie={p:b,um:z,m:K,r:fe,mt:N,mc:q,pc:D,pbc:w,n:O,o:e};let xe,me;return c&&([xe,me]=c(ie)),{render:re,hydrate:xe,createApp:D0(re,xe)}}function Xn({effect:e,update:c},n){e.allowRecurse=c.allowRecurse=n}function Fl(e,c,n=!1){const t=e.children,a=c.children;if(ge(t)&&ge(a))for(let s=0;s<t.length;s++){const u=t[s];let l=a[s];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=a[s]=Tn(a[s]),l.el=u.el),n||Fl(u,l)),l.type===Ma&&(l.el=u.el)}}function U0(e){const c=e.slice(),n=[0];let t,a,s,u,l;const r=e.length;for(t=0;t<r;t++){const o=e[t];if(o!==0){if(a=n[n.length-1],e[a]<o){c[t]=a,n.push(t);continue}for(s=0,u=n.length-1;s<u;)l=s+u>>1,e[n[l]]<o?s=l+1:u=l;o<e[n[s]]&&(s>0&&(c[t]=n[s-1]),n[s]=t)}}for(s=n.length,u=n[s-1];s-- >0;)n[s]=u,u=c[u];return n}const W0=e=>e.__isTeleport,fa=e=>e&&(e.disabled||e.disabled===""),Wr=e=>typeof SVGElement<"u"&&e instanceof SVGElement,Vu=(e,c)=>{const n=e&&e.to;return Ye(n)?c?c(n):null:n},K0={__isTeleport:!0,process(e,c,n,t,a,s,u,l,r,o){const{mc:i,pc:d,pbc:f,o:{insert:v,querySelector:y,createText:b,createComment:k}}=o,g=fa(c.props);let{shapeFlag:p,children:j,dynamicChildren:P}=c;if(e==null){const x=c.el=b(""),I=c.anchor=b("");v(x,n,t),v(I,n,t);const A=c.target=Vu(c.props,y),q=c.targetAnchor=b("");A&&(v(q,A),u=u||Wr(A));const C=(w,V)=>{p&16&&i(j,w,V,a,s,u,l,r)};g?C(n,I):A&&C(A,q)}else{c.el=e.el;const x=c.anchor=e.anchor,I=c.target=e.target,A=c.targetAnchor=e.targetAnchor,q=fa(e.props),C=q?n:I,w=q?x:A;if(u=u||Wr(I),P?(f(e.dynamicChildren,P,C,a,s,u,l),Fl(e,c,!0)):r||d(e,c,C,w,a,s,u,l,!1),g)q||Ga(c,n,x,o,1);else if((c.props&&c.props.to)!==(e.props&&e.props.to)){const V=c.target=Vu(c.props,y);V&&Ga(c,V,null,o,0)}else q&&Ga(c,I,A,o,1)}g1(c)},remove(e,c,n,t,{um:a,o:{remove:s}},u){const{shapeFlag:l,children:r,anchor:o,targetAnchor:i,target:d,props:f}=e;if(d&&s(i),(u||!fa(f))&&(s(o),l&16))for(let v=0;v<r.length;v++){const y=r[v];a(y,c,n,!0,!!y.dynamicChildren)}},move:Ga,hydrate:Y0};function Ga(e,c,n,{o:{insert:t},m:a},s=2){s===0&&t(e.targetAnchor,c,n);const{el:u,anchor:l,shapeFlag:r,children:o,props:i}=e,d=s===2;if(d&&t(u,c,n),(!d||fa(i))&&r&16)for(let f=0;f<o.length;f++)a(o[f],c,n,2);d&&t(l,c,n)}function Y0(e,c,n,t,a,s,{o:{nextSibling:u,parentNode:l,querySelector:r}},o){const i=c.target=Vu(c.props,r);if(i){const d=i._lpa||i.firstChild;if(c.shapeFlag&16)if(fa(c.props))c.anchor=o(u(e),c,l(e),n,t,a,s),c.targetAnchor=d;else{c.anchor=u(e);let f=d;for(;f;)if(f=u(f),f&&f.nodeType===8&&f.data==="teleport anchor"){c.targetAnchor=f,i._lpa=c.targetAnchor&&u(c.targetAnchor);break}o(d,c,i,n,t,a,s)}g1(c)}return c.anchor&&u(c.anchor)}const G0=K0;function g1(e){const c=e.ctx;if(c&&c.ut){let n=e.children[0].el;for(;n!==e.targetAnchor;)n.nodeType===1&&n.setAttribute("data-v-owner",c.uid),n=n.nextSibling;c.ut()}}const ve=Symbol(void 0),Ma=Symbol(void 0),yn=Symbol(void 0),eu=Symbol(void 0),ma=[];let zc=null;function Be(e=!1){ma.push(zc=e?null:[])}function X0(){ma.pop(),zc=ma[ma.length-1]||null}let Ca=1;function Kr(e){Ca+=e}function j1(e){return e.dynamicChildren=Ca>0?zc||It:null,X0(),Ca>0&&zc&&zc.push(e),e}function tc(e,c,n,t,a,s){return j1(ec(e,c,n,t,a,s,!0))}function cn(e,c,n,t,a){return j1(m(e,c,n,t,a,!0))}function Iu(e){return e?e.__v_isVNode===!0:!1}function nt(e,c){return e.type===c.type&&e.key===c.key}const Es="__vInternal",q1=({key:e})=>e??null,ss=({ref:e,ref_key:c,ref_for:n})=>e!=null?Ye(e)||We(e)||_e(e)?{i:wc,r:e,k:c,f:!!n}:e:null;function ec(e,c=null,n=null,t=0,a=null,s=e===ve?0:1,u=!1,l=!1){const r={__v_isVNode:!0,__v_skip:!0,type:e,props:c,key:c&&q1(c),ref:c&&ss(c),scopeId:e1,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:t,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:wc};return l?(Nl(r,n),s&128&&e.normalize(r)):n&&(r.shapeFlag|=Ye(n)?8:16),Ca>0&&!u&&zc&&(r.patchFlag>0||s&6)&&r.patchFlag!==32&&zc.push(r),r}const m=Z0;function Z0(e,c=null,n=null,t=0,a=null,s=!1){if((!e||e===o1)&&(e=yn),Iu(e)){const l=hn(e,c,!0);return n&&Nl(l,n),Ca>0&&!s&&zc&&(l.shapeFlag&6?zc[zc.indexOf(e)]=l:zc.push(l)),l.patchFlag|=-2,l}if(l2(e)&&(e=e.__vccOpts),c){c=Q0(c);let{class:l,style:r}=c;l&&!Ye(l)&&(c.class=$t(l)),Ne(r)&&(Do(r)&&!ge(r)&&(r=ac({},r)),c.style=yl(r))}const u=Ye(e)?1:j0(e)?128:W0(e)?64:Ne(e)?4:_e(e)?2:0;return ec(e,c,n,t,a,u,s,!0)}function Q0(e){return e?Do(e)||Es in e?ac({},e):e:null}function hn(e,c,n=!1){const{props:t,ref:a,patchFlag:s,children:u}=e,l=c?se(t||{},c):t;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&q1(l),ref:c&&c.ref?n&&a?ge(a)?a.concat(ss(c)):[a,ss(c)]:ss(c):a,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:u,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:c&&e.type!==ve?s===-1?16:s|16:s,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&hn(e.ssContent),ssFallback:e.ssFallback&&hn(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function ic(e=" ",c=0){return m(Ma,null,e,c)}function Qc(e){return e==null||typeof e=="boolean"?m(yn):ge(e)?m(ve,null,e.slice()):typeof e=="object"?Tn(e):m(Ma,null,String(e))}function Tn(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:hn(e)}function Nl(e,c){let n=0;const{shapeFlag:t}=e;if(c==null)c=null;else if(ge(c))n=16;else if(typeof c=="object")if(t&65){const a=c.default;a&&(a._c&&(a._d=!1),Nl(e,a()),a._c&&(a._d=!0));return}else{n=32;const a=c._;!a&&!(Es in c)?c._ctx=wc:a===3&&wc&&(wc.slots._===1?c._=1:(c._=2,e.patchFlag|=1024))}else _e(c)?(c={default:c,_ctx:wc},n=32):(c=String(c),t&64?(n=16,c=[ic(c)]):n=8);e.children=c,e.shapeFlag|=n}function se(...e){const c={};for(let n=0;n<e.length;n++){const t=e[n];for(const a in t)if(a==="class")c.class!==t.class&&(c.class=$t([c.class,t.class]));else if(a==="style")c.style=yl([c.style,t.style]);else if(ps(a)){const s=c[a],u=t[a];u&&s!==u&&!(ge(s)&&s.includes(u))&&(c[a]=s?[].concat(s,u):u)}else a!==""&&(c[a]=t[a])}return c}function Zc(e,c,n,t=null){Pc(e,c,7,[n,t])}const J0=h1();let e2=0;function c2(e,c,n){const t=e.type,a=(c?c.appContext:e.appContext)||J0,s={uid:e2++,vnode:e,type:t,parent:c,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,scope:new Eo(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:c?c.provides:Object.create(a.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:m1(t,a),emitsOptions:Jo(t,a),emit:null,emitted:null,propsDefaults:Fe,inheritAttrs:t.inheritAttrs,ctx:Fe,data:Fe,props:Fe,attrs:Fe,slots:Fe,refs:Fe,setupState:Fe,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=c?c.root:s,s.emit=v0.bind(null,s),e.ce&&e.ce(s),s}let Ge=null;const Ps=()=>Ge||wc,Bt=e=>{Ge=e,e.scope.on()},dt=()=>{Ge&&Ge.scope.off(),Ge=null};function k1(e){return e.vnode.shapeFlag&4}let _a=!1;function n2(e,c=!1){_a=c;const{props:n,children:t}=e.vnode,a=k1(e);B0(e,n,a,c),L0(e,t);const s=a?t2(e,c):void 0;return _a=!1,s}function t2(e,c){const n=e.type;e.accessCache=Object.create(null),e.proxy=zo(new Proxy(e.ctx,A0));const{setup:t}=n;if(t){const a=e.setupContext=t.length>1?s2(e):null;Bt(e),zt();const s=Rn(t,e,0,[e.props,a]);if(Ht(),dt(),Vo(s)){if(s.then(dt,dt),c)return s.then(u=>{Yr(e,u,c)}).catch(u=>{xs(u,e,0)});e.asyncDep=s}else Yr(e,s,c)}else p1(e,c)}function Yr(e,c,n){_e(c)?e.type.__ssrInlineRender?e.ssrRender=c:e.render=c:Ne(c)&&(e.setupState=Ko(c)),p1(e,n)}let Gr;function p1(e,c,n){const t=e.type;if(!e.render){if(!c&&Gr&&!t.render){const a=t.template||Ol(e).template;if(a){const{isCustomElement:s,compilerOptions:u}=e.appContext.config,{delimiters:l,compilerOptions:r}=t,o=ac(ac({isCustomElement:s,delimiters:l},u),r);t.render=Gr(a,o)}}e.render=t.render||Uc}Bt(e),zt(),E0(e),Ht(),dt()}function a2(e){return new Proxy(e.attrs,{get(c,n){return kc(e,"get","$attrs"),c[n]}})}function s2(e){const c=t=>{e.exposed=t||{}};let n;return{get attrs(){return n||(n=a2(e))},slots:e.slots,emit:e.emit,expose:c}}function Ts(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Ko(zo(e.exposed)),{get(c,n){if(n in c)return c[n];if(n in da)return da[n](e)},has(c,n){return n in c||n in da}}))}function u2(e,c=!0){return _e(e)?e.displayName||e.name:e.name||c&&e.__name}function l2(e){return _e(e)&&"__vccOpts"in e}const h=(e,c)=>r0(e,c,_a);function ln(e,c,n){const t=arguments.length;return t===2?Ne(c)&&!ge(c)?Iu(c)?m(e,null,[c]):m(e,c):m(e,null,c):(t>3?n=Array.prototype.slice.call(arguments,2):t===3&&Iu(n)&&(n=[n]),m(e,c,n))}const r2=Symbol(""),i2=()=>Ve(r2),o2="3.2.47",d2="http://www.w3.org/2000/svg",tt=typeof document<"u"?document:null,Xr=tt&&tt.createElement("template"),f2={insert:(e,c,n)=>{c.insertBefore(e,n||null)},remove:e=>{const c=e.parentNode;c&&c.removeChild(e)},createElement:(e,c,n,t)=>{const a=c?tt.createElementNS(d2,e):tt.createElement(e,n?{is:n}:void 0);return e==="select"&&t&&t.multiple!=null&&a.setAttribute("multiple",t.multiple),a},createText:e=>tt.createTextNode(e),createComment:e=>tt.createComment(e),setText:(e,c)=>{e.nodeValue=c},setElementText:(e,c)=>{e.textContent=c},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>tt.querySelector(e),setScopeId(e,c){e.setAttribute(c,"")},insertStaticContent(e,c,n,t,a,s){const u=n?n.previousSibling:c.lastChild;if(a&&(a===s||a.nextSibling))for(;c.insertBefore(a.cloneNode(!0),n),!(a===s||!(a=a.nextSibling)););else{Xr.innerHTML=t?`<svg>${e}</svg>`:e;const l=Xr.content;if(t){const r=l.firstChild;for(;r.firstChild;)l.appendChild(r.firstChild);l.removeChild(r)}c.insertBefore(l,n)}return[u?u.nextSibling:c.firstChild,n?n.previousSibling:c.lastChild]}};function m2(e,c,n){const t=e._vtc;t&&(c=(c?[c,...t]:[...t]).join(" ")),c==null?e.removeAttribute("class"):n?e.setAttribute("class",c):e.className=c}function v2(e,c,n){const t=e.style,a=Ye(n);if(n&&!a){if(c&&!Ye(c))for(const s in c)n[s]==null&&Au(t,s,"");for(const s in n)Au(t,s,n[s])}else{const s=t.display;a?c!==n&&(t.cssText=n):c&&e.removeAttribute("style"),"_vod"in e&&(t.display=s)}}const Zr=/\s*!important$/;function Au(e,c,n){if(ge(n))n.forEach(t=>Au(e,c,t));else if(n==null&&(n=""),c.startsWith("--"))e.setProperty(c,n);else{const t=y2(e,c);Zr.test(n)?e.setProperty(Dt(t),n.replace(Zr,""),"important"):e[t]=n}}const Qr=["Webkit","Moz","ms"],cu={};function y2(e,c){const n=cu[c];if(n)return n;let t=$c(c);if(t!=="filter"&&t in e)return cu[c]=t;t=pn(t);for(let a=0;a<Qr.length;a++){const s=Qr[a]+t;if(s in e)return cu[c]=s}return c}const Jr="http://www.w3.org/1999/xlink";function b2(e,c,n,t,a){if(t&&c.startsWith("xlink:"))n==null?e.removeAttributeNS(Jr,c.slice(6,c.length)):e.setAttributeNS(Jr,c,n);else{const s=jm(c);n==null||s&&!_o(n)?e.removeAttribute(c):e.setAttribute(c,s?"":n)}}function h2(e,c,n,t,a,s,u){if(c==="innerHTML"||c==="textContent"){t&&u(t,a,s),e[c]=n??"";return}if(c==="value"&&e.tagName!=="PROGRESS"&&!e.tagName.includes("-")){e._value=n;const r=n??"";(e.value!==r||e.tagName==="OPTION")&&(e.value=r),n==null&&e.removeAttribute(c);return}let l=!1;if(n===""||n==null){const r=typeof e[c];r==="boolean"?n=_o(n):n==null&&r==="string"?(n="",l=!0):r==="number"&&(n=0,l=!0)}try{e[c]=n}catch{}l&&e.removeAttribute(c)}function xt(e,c,n,t){e.addEventListener(c,n,t)}function g2(e,c,n,t){e.removeEventListener(c,n,t)}function j2(e,c,n,t,a=null){const s=e._vei||(e._vei={}),u=s[c];if(t&&u)u.value=t;else{const[l,r]=q2(c);if(t){const o=s[c]=S2(t,a);xt(e,l,o,r)}else u&&(g2(e,l,u,r),s[c]=void 0)}}const ei=/(?:Once|Passive|Capture)$/;function q2(e){let c;if(ei.test(e)){c={};let t;for(;t=e.match(ei);)e=e.slice(0,e.length-t[0].length),c[t[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Dt(e.slice(2)),c]}let nu=0;const k2=Promise.resolve(),p2=()=>nu||(k2.then(()=>nu=0),nu=Date.now());function S2(e,c){const n=t=>{if(!t._vts)t._vts=Date.now();else if(t._vts<=n.attached)return;Pc(C2(t,n.value),c,5,[t])};return n.value=e,n.attached=p2(),n}function C2(e,c){if(ge(c)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},c.map(t=>a=>!a._stopped&&t&&t(a))}else return c}const ci=/^on[a-z]/,_2=(e,c,n,t,a=!1,s,u,l,r)=>{c==="class"?m2(e,t,a):c==="style"?v2(e,n,t):ps(c)?bl(c)||j2(e,c,n,t,u):(c[0]==="."?(c=c.slice(1),!0):c[0]==="^"?(c=c.slice(1),!1):x2(e,c,t,a))?h2(e,c,t,s,u,l,r):(c==="true-value"?e._trueValue=t:c==="false-value"&&(e._falseValue=t),b2(e,c,t,a))};function x2(e,c,n,t){return t?!!(c==="innerHTML"||c==="textContent"||c in e&&ci.test(c)&&_e(n)):c==="spellcheck"||c==="draggable"||c==="translate"||c==="form"||c==="list"&&e.tagName==="INPUT"||c==="type"&&e.tagName==="TEXTAREA"||ci.test(c)&&Ye(n)?!1:c in e}const An="transition",aa="animation",sn=(e,{slots:c})=>ln(t1,C1(e),c);sn.displayName="Transition";const S1={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},w2=sn.props=ac({},t1.props,S1),Zn=(e,c=[])=>{ge(e)?e.forEach(n=>n(...c)):e&&e(...c)},ni=e=>e?ge(e)?e.some(c=>c.length>1):e.length>1:!1;function C1(e){const c={};for(const _ in e)_ in S1||(c[_]=e[_]);if(e.css===!1)return c;const{name:n="v",type:t,duration:a,enterFromClass:s=`${n}-enter-from`,enterActiveClass:u=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:r=s,appearActiveClass:o=u,appearToClass:i=l,leaveFromClass:d=`${n}-leave-from`,leaveActiveClass:f=`${n}-leave-active`,leaveToClass:v=`${n}-leave-to`}=e,y=V2(a),b=y&&y[0],k=y&&y[1],{onBeforeEnter:g,onEnter:p,onEnterCancelled:j,onLeave:P,onLeaveCancelled:x,onBeforeAppear:I=g,onAppear:A=p,onAppearCancelled:q=j}=c,C=(_,M,N)=>{Pn(_,M?i:l),Pn(_,M?o:u),N&&N()},w=(_,M)=>{_._isLeaving=!1,Pn(_,d),Pn(_,v),Pn(_,f),M&&M()},V=_=>(M,N)=>{const Z=_?A:p,F=()=>C(M,_,N);Zn(Z,[M,F]),ti(()=>{Pn(M,_?r:s),fn(M,_?i:l),ni(Z)||ai(M,t,b,F)})};return ac(c,{onBeforeEnter(_){Zn(g,[_]),fn(_,s),fn(_,u)},onBeforeAppear(_){Zn(I,[_]),fn(_,r),fn(_,o)},onEnter:V(!1),onAppear:V(!0),onLeave(_,M){_._isLeaving=!0;const N=()=>w(_,M);fn(_,d),x1(),fn(_,f),ti(()=>{_._isLeaving&&(Pn(_,d),fn(_,v),ni(P)||ai(_,t,k,N))}),Zn(P,[_,N])},onEnterCancelled(_){C(_,!1),Zn(j,[_])},onAppearCancelled(_){C(_,!0),Zn(q,[_])},onLeaveCancelled(_){w(_),Zn(x,[_])}})}function V2(e){if(e==null)return null;if(Ne(e))return[tu(e.enter),tu(e.leave)];{const c=tu(e);return[c,c]}}function tu(e){return xm(e)}function fn(e,c){c.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e._vtc||(e._vtc=new Set)).add(c)}function Pn(e,c){c.split(/\s+/).forEach(t=>t&&e.classList.remove(t));const{_vtc:n}=e;n&&(n.delete(c),n.size||(e._vtc=void 0))}function ti(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let I2=0;function ai(e,c,n,t){const a=e._endId=++I2,s=()=>{a===e._endId&&t()};if(n)return setTimeout(s,n);const{type:u,timeout:l,propCount:r}=_1(e,c);if(!u)return t();const o=u+"end";let i=0;const d=()=>{e.removeEventListener(o,f),s()},f=v=>{v.target===e&&++i>=r&&d()};setTimeout(()=>{i<r&&d()},l+1),e.addEventListener(o,f)}function _1(e,c){const n=window.getComputedStyle(e),t=y=>(n[y]||"").split(", "),a=t(`${An}Delay`),s=t(`${An}Duration`),u=si(a,s),l=t(`${aa}Delay`),r=t(`${aa}Duration`),o=si(l,r);let i=null,d=0,f=0;c===An?u>0&&(i=An,d=u,f=s.length):c===aa?o>0&&(i=aa,d=o,f=r.length):(d=Math.max(u,o),i=d>0?u>o?An:aa:null,f=i?i===An?s.length:r.length:0);const v=i===An&&/\b(transform|all)(,|$)/.test(t(`${An}Property`).toString());return{type:i,timeout:d,propCount:f,hasTransform:v}}function si(e,c){for(;e.length<c.length;)e=e.concat(e);return Math.max(...c.map((n,t)=>ui(n)+ui(e[t])))}function ui(e){return Number(e.slice(0,-1).replace(",","."))*1e3}function x1(){return document.body.offsetHeight}const w1=new WeakMap,V1=new WeakMap,I1={name:"TransitionGroup",props:ac({},w2,{tag:String,moveClass:String}),setup(e,{slots:c}){const n=Ps(),t=n1();let a,s;return Ml(()=>{if(!a.length)return;const u=e.moveClass||`${e.name||"v"}-move`;if(!M2(a[0].el,n.vnode.el,u))return;a.forEach(P2),a.forEach(T2);const l=a.filter($2);x1(),l.forEach(r=>{const o=r.el,i=o.style;fn(o,u),i.transform=i.webkitTransform=i.transitionDuration="";const d=o._moveCb=f=>{f&&f.target!==o||(!f||/transform$/.test(f.propertyName))&&(o.removeEventListener("transitionend",d),o._moveCb=null,Pn(o,u))};o.addEventListener("transitionend",d)})}),()=>{const u=Ce(e),l=C1(u);let r=u.tag||ve;a=s,s=c.default?Tl(c.default()):[];for(let o=0;o<s.length;o++){const i=s[o];i.key!=null&&Sa(i,pa(i,l,t,n))}if(a)for(let o=0;o<a.length;o++){const i=a[o];Sa(i,pa(i,l,t,n)),w1.set(i,i.el.getBoundingClientRect())}return m(r,null,s)}}},A2=e=>delete e.mode;I1.props;const E2=I1;function P2(e){const c=e.el;c._moveCb&&c._moveCb(),c._enterCb&&c._enterCb()}function T2(e){V1.set(e,e.el.getBoundingClientRect())}function $2(e){const c=w1.get(e),n=V1.get(e),t=c.left-n.left,a=c.top-n.top;if(t||a){const s=e.el.style;return s.transform=s.webkitTransform=`translate(${t}px,${a}px)`,s.transitionDuration="0s",e}}function M2(e,c,n){const t=e.cloneNode();e._vtc&&e._vtc.forEach(u=>{u.split(/\s+/).forEach(l=>l&&t.classList.remove(l))}),n.split(/\s+/).forEach(u=>u&&t.classList.add(u)),t.style.display="none";const a=c.nodeType===1?c:c.parentNode;a.appendChild(t);const{hasTransform:s}=_1(t);return a.removeChild(t),s}const li=e=>{const c=e.props["onUpdate:modelValue"]||!1;return ge(c)?n=>ts(c,n):c};function B2(e){e.target.composing=!0}function ri(e){const c=e.target;c.composing&&(c.composing=!1,c.dispatchEvent(new Event("input")))}const R2={created(e,{modifiers:{lazy:c,trim:n,number:t}},a){e._assign=li(a);const s=t||a.props&&a.props.type==="number";xt(e,c?"change":"input",u=>{if(u.target.composing)return;let l=e.value;n&&(l=l.trim()),s&&(l=gu(l)),e._assign(l)}),n&&xt(e,"change",()=>{e.value=e.value.trim()}),c||(xt(e,"compositionstart",B2),xt(e,"compositionend",ri),xt(e,"change",ri))},mounted(e,{value:c}){e.value=c??""},beforeUpdate(e,{value:c,modifiers:{lazy:n,trim:t,number:a}},s){if(e._assign=li(s),e.composing||document.activeElement===e&&e.type!=="range"&&(n||t&&e.value.trim()===c||(a||e.type==="number")&&gu(e.value)===c))return;const u=c??"";e.value!==u&&(e.value=u)}},rn={beforeMount(e,{value:c},{transition:n}){e._vod=e.style.display==="none"?"":e.style.display,n&&c?n.beforeEnter(e):sa(e,c)},mounted(e,{value:c},{transition:n}){n&&c&&n.enter(e)},updated(e,{value:c,oldValue:n},{transition:t}){!c!=!n&&(t?c?(t.beforeEnter(e),sa(e,!0),t.enter(e)):t.leave(e,()=>{sa(e,!1)}):sa(e,c))},beforeUnmount(e,{value:c}){sa(e,c)}};function sa(e,c){e.style.display=c?e._vod:"none"}const O2=ac({patchProp:_2},f2);let ii;function L2(){return ii||(ii=z0(O2))}const F2=(...e)=>{const c=L2().createApp(...e),{mount:n}=c;return c.mount=t=>{const a=N2(t);if(!a)return;const s=c._component;!_e(s)&&!s.render&&!s.template&&(s.template=a.innerHTML),a.innerHTML="";const u=n(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),u},c};function N2(e){return Ye(e)?document.querySelector(e):e}/*!
  * vue-router v4.1.6
  * (c) 2022 Eduardo San Martin Morote
  * @license MIT
  */const wt=typeof window<"u";function D2(e){return e.__esModule||e[Symbol.toStringTag]==="Module"}const Te=Object.assign;function au(e,c){const n={};for(const t in c){const a=c[t];n[t]=Wc(a)?a.map(e):e(a)}return n}const va=()=>{},Wc=Array.isArray,z2=/\/$/,H2=e=>e.replace(z2,"");function su(e,c,n="/"){let t,a={},s="",u="";const l=c.indexOf("#");let r=c.indexOf("?");return l<r&&l>=0&&(r=-1),r>-1&&(t=c.slice(0,r),s=c.slice(r+1,l>-1?l:c.length),a=e(s)),l>-1&&(t=t||c.slice(0,l),u=c.slice(l,c.length)),t=Y2(t??c,n),{fullPath:t+(s&&"?")+s+u,path:t,query:a,hash:u}}function U2(e,c){const n=c.query?e(c.query):"";return c.path+(n&&"?")+n+(c.hash||"")}function oi(e,c){return!c||!e.toLowerCase().startsWith(c.toLowerCase())?e:e.slice(c.length)||"/"}function W2(e,c,n){const t=c.matched.length-1,a=n.matched.length-1;return t>-1&&t===a&&Rt(c.matched[t],n.matched[a])&&A1(c.params,n.params)&&e(c.query)===e(n.query)&&c.hash===n.hash}function Rt(e,c){return(e.aliasOf||e)===(c.aliasOf||c)}function A1(e,c){if(Object.keys(e).length!==Object.keys(c).length)return!1;for(const n in e)if(!K2(e[n],c[n]))return!1;return!0}function K2(e,c){return Wc(e)?di(e,c):Wc(c)?di(c,e):e===c}function di(e,c){return Wc(c)?e.length===c.length&&e.every((n,t)=>n===c[t]):e.length===1&&e[0]===c}function Y2(e,c){if(e.startsWith("/"))return e;if(!e)return c;const n=c.split("/"),t=e.split("/");let a=n.length-1,s,u;for(s=0;s<t.length;s++)if(u=t[s],u!==".")if(u==="..")a>1&&a--;else break;return n.slice(0,a).join("/")+"/"+t.slice(s-(s===t.length?1:0)).join("/")}var xa;(function(e){e.pop="pop",e.push="push"})(xa||(xa={}));var ya;(function(e){e.back="back",e.forward="forward",e.unknown=""})(ya||(ya={}));function G2(e){if(!e)if(wt){const c=document.querySelector("base");e=c&&c.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),H2(e)}const X2=/^[^#]+#/;function Z2(e,c){return e.replace(X2,"#")+c}function Q2(e,c){const n=document.documentElement.getBoundingClientRect(),t=e.getBoundingClientRect();return{behavior:c.behavior,left:t.left-n.left-(c.left||0),top:t.top-n.top-(c.top||0)}}const $s=()=>({left:window.pageXOffset,top:window.pageYOffset});function J2(e){let c;if("el"in e){const n=e.el,t=typeof n=="string"&&n.startsWith("#"),a=typeof n=="string"?t?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!a)return;c=Q2(a,e)}else c=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(c):window.scrollTo(c.left!=null?c.left:window.pageXOffset,c.top!=null?c.top:window.pageYOffset)}function fi(e,c){return(history.state?history.state.position-c:-1)+e}const Eu=new Map;function ev(e,c){Eu.set(e,c)}function cv(e){const c=Eu.get(e);return Eu.delete(e),c}let nv=()=>location.protocol+"//"+location.host;function E1(e,c){const{pathname:n,search:t,hash:a}=c,s=e.indexOf("#");if(s>-1){let l=a.includes(e.slice(s))?e.slice(s).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),oi(r,"")}return oi(n,e)+t+a}function tv(e,c,n,t){let a=[],s=[],u=null;const l=({state:f})=>{const v=E1(e,location),y=n.value,b=c.value;let k=0;if(f){if(n.value=v,c.value=f,u&&u===y){u=null;return}k=b?f.position-b.position:0}else t(v);a.forEach(g=>{g(n.value,y,{delta:k,type:xa.pop,direction:k?k>0?ya.forward:ya.back:ya.unknown})})};function r(){u=n.value}function o(f){a.push(f);const v=()=>{const y=a.indexOf(f);y>-1&&a.splice(y,1)};return s.push(v),v}function i(){const{history:f}=window;f.state&&f.replaceState(Te({},f.state,{scroll:$s()}),"")}function d(){for(const f of s)f();s=[],window.removeEventListener("popstate",l),window.removeEventListener("beforeunload",i)}return window.addEventListener("popstate",l),window.addEventListener("beforeunload",i),{pauseListeners:r,listen:o,destroy:d}}function mi(e,c,n,t=!1,a=!1){return{back:e,current:c,forward:n,replaced:t,position:window.history.length,scroll:a?$s():null}}function av(e){const{history:c,location:n}=window,t={value:E1(e,n)},a={value:c.state};a.value||s(t.value,{back:null,current:t.value,forward:null,position:c.length-1,replaced:!0,scroll:null},!0);function s(r,o,i){const d=e.indexOf("#"),f=d>-1?(n.host&&document.querySelector("base")?e:e.slice(d))+r:nv()+e+r;try{c[i?"replaceState":"pushState"](o,"",f),a.value=o}catch(v){console.error(v),n[i?"replace":"assign"](f)}}function u(r,o){const i=Te({},c.state,mi(a.value.back,r,a.value.forward,!0),o,{position:a.value.position});s(r,i,!0),t.value=r}function l(r,o){const i=Te({},a.value,c.state,{forward:r,scroll:$s()});s(i.current,i,!0);const d=Te({},mi(t.value,r,null),{position:i.position+1},o);s(r,d,!1),t.value=r}return{location:t,state:a,push:l,replace:u}}function sv(e){e=G2(e);const c=av(e),n=tv(e,c.state,c.location,c.replace);function t(s,u=!0){u||n.pauseListeners(),history.go(s)}const a=Te({location:"",base:e,go:t,createHref:Z2.bind(null,e)},c,n);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>c.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>c.state.value}),a}function uv(e){return typeof e=="string"||e&&typeof e=="object"}function P1(e){return typeof e=="string"||typeof e=="symbol"}const En={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},T1=Symbol("");var vi;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(vi||(vi={}));function Ot(e,c){return Te(new Error,{type:e,[T1]:!0},c)}function dn(e,c){return e instanceof Error&&T1 in e&&(c==null||!!(e.type&c))}const yi="[^/]+?",lv={sensitive:!1,strict:!1,start:!0,end:!0},rv=/[.+*?^${}()[\]/\\]/g;function iv(e,c){const n=Te({},lv,c),t=[];let a=n.start?"^":"";const s=[];for(const o of e){const i=o.length?[]:[90];n.strict&&!o.length&&(a+="/");for(let d=0;d<o.length;d++){const f=o[d];let v=40+(n.sensitive?.25:0);if(f.type===0)d||(a+="/"),a+=f.value.replace(rv,"\\$&"),v+=40;else if(f.type===1){const{value:y,repeatable:b,optional:k,regexp:g}=f;s.push({name:y,repeatable:b,optional:k});const p=g||yi;if(p!==yi){v+=10;try{new RegExp(`(${p})`)}catch(P){throw new Error(`Invalid custom RegExp for param "${y}" (${p}): `+P.message)}}let j=b?`((?:${p})(?:/(?:${p}))*)`:`(${p})`;d||(j=k&&o.length<2?`(?:/${j})`:"/"+j),k&&(j+="?"),a+=j,v+=20,k&&(v+=-8),b&&(v+=-20),p===".*"&&(v+=-50)}i.push(v)}t.push(i)}if(n.strict&&n.end){const o=t.length-1;t[o][t[o].length-1]+=.7000000000000001}n.strict||(a+="/?"),n.end?a+="$":n.strict&&(a+="(?:/|$)");const u=new RegExp(a,n.sensitive?"":"i");function l(o){const i=o.match(u),d={};if(!i)return null;for(let f=1;f<i.length;f++){const v=i[f]||"",y=s[f-1];d[y.name]=v&&y.repeatable?v.split("/"):v}return d}function r(o){let i="",d=!1;for(const f of e){(!d||!i.endsWith("/"))&&(i+="/"),d=!1;for(const v of f)if(v.type===0)i+=v.value;else if(v.type===1){const{value:y,repeatable:b,optional:k}=v,g=y in o?o[y]:"";if(Wc(g)&&!b)throw new Error(`Provided param "${y}" is an array but it is not repeatable (* or + modifiers)`);const p=Wc(g)?g.join("/"):g;if(!p)if(k)f.length<2&&(i.endsWith("/")?i=i.slice(0,-1):d=!0);else throw new Error(`Missing required param "${y}"`);i+=p}}return i||"/"}return{re:u,score:t,keys:s,parse:l,stringify:r}}function ov(e,c){let n=0;for(;n<e.length&&n<c.length;){const t=c[n]-e[n];if(t)return t;n++}return e.length<c.length?e.length===1&&e[0]===40+40?-1:1:e.length>c.length?c.length===1&&c[0]===40+40?1:-1:0}function dv(e,c){let n=0;const t=e.score,a=c.score;for(;n<t.length&&n<a.length;){const s=ov(t[n],a[n]);if(s)return s;n++}if(Math.abs(a.length-t.length)===1){if(bi(t))return 1;if(bi(a))return-1}return a.length-t.length}function bi(e){const c=e[e.length-1];return e.length>0&&c[c.length-1]<0}const fv={type:0,value:""},mv=/[a-zA-Z0-9_]/;function vv(e){if(!e)return[[]];if(e==="/")return[[fv]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function c(v){throw new Error(`ERR (${n})/"${o}": ${v}`)}let n=0,t=n;const a=[];let s;function u(){s&&a.push(s),s=[]}let l=0,r,o="",i="";function d(){o&&(n===0?s.push({type:0,value:o}):n===1||n===2||n===3?(s.length>1&&(r==="*"||r==="+")&&c(`A repeatable param (${o}) must be alone in its segment. eg: '/:ids+.`),s.push({type:1,value:o,regexp:i,repeatable:r==="*"||r==="+",optional:r==="*"||r==="?"})):c("Invalid state to consume buffer"),o="")}function f(){o+=r}for(;l<e.length;){if(r=e[l++],r==="\\"&&n!==2){t=n,n=4;continue}switch(n){case 0:r==="/"?(o&&d(),u()):r===":"?(d(),n=1):f();break;case 4:f(),n=t;break;case 1:r==="("?n=2:mv.test(r)?f():(d(),n=0,r!=="*"&&r!=="?"&&r!=="+"&&l--);break;case 2:r===")"?i[i.length-1]=="\\"?i=i.slice(0,-1)+r:n=3:i+=r;break;case 3:d(),n=0,r!=="*"&&r!=="?"&&r!=="+"&&l--,i="";break;default:c("Unknown state");break}}return n===2&&c(`Unfinished custom RegExp for param "${o}"`),d(),u(),a}function yv(e,c,n){const t=iv(vv(e.path),n),a=Te(t,{record:e,parent:c,children:[],alias:[]});return c&&!a.record.aliasOf==!c.record.aliasOf&&c.children.push(a),a}function bv(e,c){const n=[],t=new Map;c=ji({strict:!1,end:!0,sensitive:!1},c);function a(i){return t.get(i)}function s(i,d,f){const v=!f,y=hv(i);y.aliasOf=f&&f.record;const b=ji(c,i),k=[y];if("alias"in i){const j=typeof i.alias=="string"?[i.alias]:i.alias;for(const P of j)k.push(Te({},y,{components:f?f.record.components:y.components,path:P,aliasOf:f?f.record:y}))}let g,p;for(const j of k){const{path:P}=j;if(d&&P[0]!=="/"){const x=d.record.path,I=x[x.length-1]==="/"?"":"/";j.path=d.record.path+(P&&I+P)}if(g=yv(j,d,b),f?f.alias.push(g):(p=p||g,p!==g&&p.alias.push(g),v&&i.name&&!gi(g)&&u(i.name)),y.children){const x=y.children;for(let I=0;I<x.length;I++)s(x[I],g,f&&f.children[I])}f=f||g,(g.record.components&&Object.keys(g.record.components).length||g.record.name||g.record.redirect)&&r(g)}return p?()=>{u(p)}:va}function u(i){if(P1(i)){const d=t.get(i);d&&(t.delete(i),n.splice(n.indexOf(d),1),d.children.forEach(u),d.alias.forEach(u))}else{const d=n.indexOf(i);d>-1&&(n.splice(d,1),i.record.name&&t.delete(i.record.name),i.children.forEach(u),i.alias.forEach(u))}}function l(){return n}function r(i){let d=0;for(;d<n.length&&dv(i,n[d])>=0&&(i.record.path!==n[d].record.path||!$1(i,n[d]));)d++;n.splice(d,0,i),i.record.name&&!gi(i)&&t.set(i.record.name,i)}function o(i,d){let f,v={},y,b;if("name"in i&&i.name){if(f=t.get(i.name),!f)throw Ot(1,{location:i});b=f.record.name,v=Te(hi(d.params,f.keys.filter(p=>!p.optional).map(p=>p.name)),i.params&&hi(i.params,f.keys.map(p=>p.name))),y=f.stringify(v)}else if("path"in i)y=i.path,f=n.find(p=>p.re.test(y)),f&&(v=f.parse(y),b=f.record.name);else{if(f=d.name?t.get(d.name):n.find(p=>p.re.test(d.path)),!f)throw Ot(1,{location:i,currentLocation:d});b=f.record.name,v=Te({},d.params,i.params),y=f.stringify(v)}const k=[];let g=f;for(;g;)k.unshift(g.record),g=g.parent;return{name:b,path:y,params:v,matched:k,meta:jv(k)}}return e.forEach(i=>s(i)),{addRoute:s,resolve:o,removeRoute:u,getRoutes:l,getRecordMatcher:a}}function hi(e,c){const n={};for(const t of c)t in e&&(n[t]=e[t]);return n}function hv(e){return{path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:void 0,beforeEnter:e.beforeEnter,props:gv(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}}}function gv(e){const c={},n=e.props||!1;if("component"in e)c.default=n;else for(const t in e.components)c[t]=typeof n=="boolean"?n:n[t];return c}function gi(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function jv(e){return e.reduce((c,n)=>Te(c,n.meta),{})}function ji(e,c){const n={};for(const t in e)n[t]=t in c?c[t]:e[t];return n}function $1(e,c){return c.children.some(n=>n===e||$1(e,n))}const M1=/#/g,qv=/&/g,kv=/\//g,pv=/=/g,Sv=/\?/g,B1=/\+/g,Cv=/%5B/g,_v=/%5D/g,R1=/%5E/g,xv=/%60/g,O1=/%7B/g,wv=/%7C/g,L1=/%7D/g,Vv=/%20/g;function Dl(e){return encodeURI(""+e).replace(wv,"|").replace(Cv,"[").replace(_v,"]")}function Iv(e){return Dl(e).replace(O1,"{").replace(L1,"}").replace(R1,"^")}function Pu(e){return Dl(e).replace(B1,"%2B").replace(Vv,"+").replace(M1,"%23").replace(qv,"%26").replace(xv,"`").replace(O1,"{").replace(L1,"}").replace(R1,"^")}function Av(e){return Pu(e).replace(pv,"%3D")}function Ev(e){return Dl(e).replace(M1,"%23").replace(Sv,"%3F")}function Pv(e){return e==null?"":Ev(e).replace(kv,"%2F")}function vs(e){try{return decodeURIComponent(""+e)}catch{}return""+e}function Tv(e){const c={};if(e===""||e==="?")return c;const t=(e[0]==="?"?e.slice(1):e).split("&");for(let a=0;a<t.length;++a){const s=t[a].replace(B1," "),u=s.indexOf("="),l=vs(u<0?s:s.slice(0,u)),r=u<0?null:vs(s.slice(u+1));if(l in c){let o=c[l];Wc(o)||(o=c[l]=[o]),o.push(r)}else c[l]=r}return c}function qi(e){let c="";for(let n in e){const t=e[n];if(n=Av(n),t==null){t!==void 0&&(c+=(c.length?"&":"")+n);continue}(Wc(t)?t.map(s=>s&&Pu(s)):[t&&Pu(t)]).forEach(s=>{s!==void 0&&(c+=(c.length?"&":"")+n,s!=null&&(c+="="+s))})}return c}function $v(e){const c={};for(const n in e){const t=e[n];t!==void 0&&(c[n]=Wc(t)?t.map(a=>a==null?null:""+a):t==null?t:""+t)}return c}const Mv=Symbol(""),ki=Symbol(""),zl=Symbol(""),F1=Symbol(""),Tu=Symbol("");function ua(){let e=[];function c(t){return e.push(t),()=>{const a=e.indexOf(t);a>-1&&e.splice(a,1)}}function n(){e=[]}return{add:c,list:()=>e,reset:n}}function $n(e,c,n,t,a){const s=t&&(t.enterCallbacks[a]=t.enterCallbacks[a]||[]);return()=>new Promise((u,l)=>{const r=d=>{d===!1?l(Ot(4,{from:n,to:c})):d instanceof Error?l(d):uv(d)?l(Ot(2,{from:c,to:d})):(s&&t.enterCallbacks[a]===s&&typeof d=="function"&&s.push(d),u())},o=e.call(t&&t.instances[a],c,n,r);let i=Promise.resolve(o);e.length<3&&(i=i.then(r)),i.catch(d=>l(d))})}function uu(e,c,n,t){const a=[];for(const s of e)for(const u in s.components){let l=s.components[u];if(!(c!=="beforeRouteEnter"&&!s.instances[u]))if(Bv(l)){const o=(l.__vccOpts||l)[c];o&&a.push($n(o,n,t,s,u))}else{let r=l();a.push(()=>r.then(o=>{if(!o)return Promise.reject(new Error(`Couldn't resolve component "${u}" at "${s.path}"`));const i=D2(o)?o.default:o;s.components[u]=i;const f=(i.__vccOpts||i)[c];return f&&$n(f,n,t,s,u)()}))}}return a}function Bv(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function pi(e){const c=Ve(zl),n=Ve(F1),t=h(()=>c.resolve(dc(e.to))),a=h(()=>{const{matched:r}=t.value,{length:o}=r,i=r[o-1],d=n.matched;if(!i||!d.length)return-1;const f=d.findIndex(Rt.bind(null,i));if(f>-1)return f;const v=Si(r[o-2]);return o>1&&Si(i)===v&&d[d.length-1].path!==v?d.findIndex(Rt.bind(null,r[o-2])):f}),s=h(()=>a.value>-1&&Fv(n.params,t.value.params)),u=h(()=>a.value>-1&&a.value===n.matched.length-1&&A1(n.params,t.value.params));function l(r={}){return Lv(r)?c[dc(e.replace)?"replace":"push"](dc(e.to)).catch(va):Promise.resolve()}return{route:t,href:h(()=>t.value.href),isActive:s,isExactActive:u,navigate:l}}const Rv=$l({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:pi,setup(e,{slots:c}){const n=sc(pi(e)),{options:t}=Ve(zl),a=h(()=>({[Ci(e.activeClass,t.linkActiveClass,"router-link-active")]:n.isActive,[Ci(e.exactActiveClass,t.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const s=c.default&&c.default(n);return e.custom?s:ln("a",{"aria-current":n.isExactActive?e.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:a.value},s)}}}),Ov=Rv;function Lv(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const c=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(c))return}return e.preventDefault&&e.preventDefault(),!0}}function Fv(e,c){for(const n in c){const t=c[n],a=e[n];if(typeof t=="string"){if(t!==a)return!1}else if(!Wc(a)||a.length!==t.length||t.some((s,u)=>s!==a[u]))return!1}return!0}function Si(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Ci=(e,c,n)=>e??c??n,Nv=$l({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:c,slots:n}){const t=Ve(Tu),a=h(()=>e.route||t.value),s=Ve(ki,0),u=h(()=>{let o=dc(s);const{matched:i}=a.value;let d;for(;(d=i[o])&&!d.components;)o++;return o}),l=h(()=>a.value.matched[u.value]);Ke(ki,h(()=>u.value+1)),Ke(Mv,l),Ke(Tu,a);const r=$();return ae(()=>[r.value,l.value,e.name],([o,i,d],[f,v,y])=>{i&&(i.instances[d]=o,v&&v!==i&&o&&o===f&&(i.leaveGuards.size||(i.leaveGuards=v.leaveGuards),i.updateGuards.size||(i.updateGuards=v.updateGuards))),o&&i&&(!v||!Rt(i,v)||!f)&&(i.enterCallbacks[d]||[]).forEach(b=>b(o))},{flush:"post"}),()=>{const o=a.value,i=e.name,d=l.value,f=d&&d.components[i];if(!f)return _i(n.default,{Component:f,route:o});const v=d.props[i],y=v?v===!0?o.params:typeof v=="function"?v(o):v:null,k=ln(f,Te({},y,c,{onVnodeUnmounted:g=>{g.component.isUnmounted&&(d.instances[i]=null)},ref:r}));return _i(n.default,{Component:k,route:o})||k}}});function _i(e,c){if(!e)return null;const n=e(c);return n.length===1?n[0]:n}const Dv=Nv;function zv(e){const c=bv(e.routes,e),n=e.parseQuery||Tv,t=e.stringifyQuery||qi,a=e.history,s=ua(),u=ua(),l=ua(),r=Vl(En);let o=En;wt&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const i=au.bind(null,B=>""+B),d=au.bind(null,Pv),f=au.bind(null,vs);function v(B,T){let O,re;return P1(B)?(O=c.getRecordMatcher(B),re=T):re=B,c.addRoute(re,O)}function y(B){const T=c.getRecordMatcher(B);T&&c.removeRoute(T)}function b(){return c.getRoutes().map(B=>B.record)}function k(B){return!!c.getRecordMatcher(B)}function g(B,T){if(T=Te({},T||r.value),typeof B=="string"){const S=su(n,B,T.path),E=c.resolve({path:S.path},T),L=a.createHref(S.fullPath);return Te(S,E,{params:f(E.params),hash:vs(S.hash),redirectedFrom:void 0,href:L})}let O;if("path"in B)O=Te({},B,{path:su(n,B.path,T.path).path});else{const S=Te({},B.params);for(const E in S)S[E]==null&&delete S[E];O=Te({},B,{params:d(B.params)}),T.params=d(T.params)}const re=c.resolve(O,T),ie=B.hash||"";re.params=i(f(re.params));const xe=U2(t,Te({},B,{hash:Iv(ie),path:re.path})),me=a.createHref(xe);return Te({fullPath:xe,hash:ie,query:t===qi?$v(B.query):B.query||{}},re,{redirectedFrom:void 0,href:me})}function p(B){return typeof B=="string"?su(n,B,r.value.path):Te({},B)}function j(B,T){if(o!==B)return Ot(8,{from:T,to:B})}function P(B){return A(B)}function x(B){return P(Te(p(B),{replace:!0}))}function I(B){const T=B.matched[B.matched.length-1];if(T&&T.redirect){const{redirect:O}=T;let re=typeof O=="function"?O(B):O;return typeof re=="string"&&(re=re.includes("?")||re.includes("#")?re=p(re):{path:re},re.params={}),Te({query:B.query,hash:B.hash,params:"path"in re?{}:B.params},re)}}function A(B,T){const O=o=g(B),re=r.value,ie=B.state,xe=B.force,me=B.replace===!0,S=I(O);if(S)return A(Te(p(S),{state:typeof S=="object"?Te({},ie,S.state):ie,force:xe,replace:me}),T||O);const E=O;E.redirectedFrom=T;let L;return!xe&&W2(t,re,O)&&(L=Ot(16,{to:E,from:re}),R(re,re,!0,!1)),(L?Promise.resolve(L):C(E,re)).catch(U=>dn(U)?dn(U,2)?U:J(U):H(U,E,re)).then(U=>{if(U){if(dn(U,2))return A(Te({replace:me},p(U.to),{state:typeof U.to=="object"?Te({},ie,U.to.state):ie,force:xe}),T||E)}else U=V(E,re,!0,me,ie);return w(E,re,U),U})}function q(B,T){const O=j(B,T);return O?Promise.reject(O):Promise.resolve()}function C(B,T){let O;const[re,ie,xe]=Hv(B,T);O=uu(re.reverse(),"beforeRouteLeave",B,T);for(const S of re)S.leaveGuards.forEach(E=>{O.push($n(E,B,T))});const me=q.bind(null,B,T);return O.push(me),kt(O).then(()=>{O=[];for(const S of s.list())O.push($n(S,B,T));return O.push(me),kt(O)}).then(()=>{O=uu(ie,"beforeRouteUpdate",B,T);for(const S of ie)S.updateGuards.forEach(E=>{O.push($n(E,B,T))});return O.push(me),kt(O)}).then(()=>{O=[];for(const S of B.matched)if(S.beforeEnter&&!T.matched.includes(S))if(Wc(S.beforeEnter))for(const E of S.beforeEnter)O.push($n(E,B,T));else O.push($n(S.beforeEnter,B,T));return O.push(me),kt(O)}).then(()=>(B.matched.forEach(S=>S.enterCallbacks={}),O=uu(xe,"beforeRouteEnter",B,T),O.push(me),kt(O))).then(()=>{O=[];for(const S of u.list())O.push($n(S,B,T));return O.push(me),kt(O)}).catch(S=>dn(S,8)?S:Promise.reject(S))}function w(B,T,O){for(const re of l.list())re(B,T,O)}function V(B,T,O,re,ie){const xe=j(B,T);if(xe)return xe;const me=T===En,S=wt?history.state:{};O&&(re||me?a.replace(B.fullPath,Te({scroll:me&&S&&S.scroll},ie)):a.push(B.fullPath,ie)),r.value=B,R(B,T,O,me),J()}let _;function M(){_||(_=a.listen((B,T,O)=>{if(!oe.listening)return;const re=g(B),ie=I(re);if(ie){A(Te(ie,{replace:!0}),re).catch(va);return}o=re;const xe=r.value;wt&&ev(fi(xe.fullPath,O.delta),$s()),C(re,xe).catch(me=>dn(me,12)?me:dn(me,2)?(A(me.to,re).then(S=>{dn(S,20)&&!O.delta&&O.type===xa.pop&&a.go(-1,!1)}).catch(va),Promise.reject()):(O.delta&&a.go(-O.delta,!1),H(me,re,xe))).then(me=>{me=me||V(re,xe,!1),me&&(O.delta&&!dn(me,8)?a.go(-O.delta,!1):O.type===xa.pop&&dn(me,20)&&a.go(-1,!1)),w(re,xe,me)}).catch(va)}))}let N=ua(),Z=ua(),F;function H(B,T,O){J(B);const re=Z.list();return re.length?re.forEach(ie=>ie(B,T,O)):console.error(B),Promise.reject(B)}function D(){return F&&r.value!==En?Promise.resolve():new Promise((B,T)=>{N.add([B,T])})}function J(B){return F||(F=!B,M(),N.list().forEach(([T,O])=>B?O(B):T()),N.reset()),B}function R(B,T,O,re){const{scrollBehavior:ie}=e;if(!wt||!ie)return Promise.resolve();const xe=!O&&cv(fi(B.fullPath,0))||(re||!O)&&history.state&&history.state.scroll||null;return Oe().then(()=>ie(B,T,xe)).then(me=>me&&J2(me)).catch(me=>H(me,B,T))}const K=B=>a.go(B);let z;const fe=new Set,oe={currentRoute:r,listening:!0,addRoute:v,removeRoute:y,hasRoute:k,getRoutes:b,resolve:g,options:e,push:P,replace:x,go:K,back:()=>K(-1),forward:()=>K(1),beforeEach:s.add,beforeResolve:u.add,afterEach:l.add,onError:Z.add,isReady:D,install(B){const T=this;B.component("RouterLink",Ov),B.component("RouterView",Dv),B.config.globalProperties.$router=T,Object.defineProperty(B.config.globalProperties,"$route",{enumerable:!0,get:()=>dc(r)}),wt&&!z&&r.value===En&&(z=!0,P(a.location).catch(ie=>{}));const O={};for(const ie in En)O[ie]=h(()=>r.value[ie]);B.provide(zl,T),B.provide(F1,sc(O)),B.provide(Tu,r);const re=B.unmount;fe.add(B),B.unmount=function(){fe.delete(B),fe.size<1&&(o=En,_&&_(),_=null,r.value=En,z=!1,F=!1),re()}}};return oe}function kt(e){return e.reduce((c,n)=>c.then(()=>n()),Promise.resolve())}function Hv(e,c){const n=[],t=[],a=[],s=Math.max(c.matched.length,e.matched.length);for(let u=0;u<s;u++){const l=c.matched[u];l&&(e.matched.find(o=>Rt(o,l))?t.push(l):n.push(l));const r=e.matched[u];r&&(c.matched.find(o=>Rt(o,r))||a.push(r))}return[n,t,a]}const zn=(e,c)=>{const n=e.__vccOpts||e;for(const[t,a]of c)n[t]=a;return n},Uv={};function Wv(e,c,n,t,a,s){const u=Le("RouterView");return Be(),cn(u)}const Kv=zn(Uv,[["render",Wv]]),Yv={},Gv=ec("h1",null,"司法試験過去問題集",-1);function Xv(e,c){const n=Le("RouterLink");return Be(),tc("main",null,[Gv,m(n,{to:"/tantou"},{default:Ae(()=>[ic("短答")]),_:1})])}const Zv=zn(Yv,[["render",Xv]]),us=[{year:"2023",num:"1",subject:"ken",q:`憲法第１３条に関する次のアからウまでの各記述について、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．最高裁判所は、市営地下鉄内における商業宣伝放送の違法性が争われた事件において、聞きたくない音を聞かない自由は、人格的利益に含まれると解することもできないものではないが、精神的自由の一つに含まれるため、憲法第１３条によって保障されるとの主張は適当でないとした。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"4"},{year:"2023",num:"2",subject:"ken",q:`憲法第１９条の保障する思想・良心の自由に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、それぞれ正しい場合には１を、誤っている場合には２を選びなさい。
...
ウ．企業内においても労働者の思想、信条等の精神的自由は十分尊重されるべきであることから、企業が労働者に対し、その者が特定の政党に所属するかどうかに関する書面の提出を求めることは、それがたとえ企業の組織秩序の維持を目的とする調査の一環であり、強要にわたるような態様のものでなかったとしても、社会的に許容し得る限界を超えて労働者の精神的自由を侵害した違法行為である。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"112"},{year:"2023",num:"3",subject:"ken",q:`表現の自由に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、それぞれ正しい場合には１を、誤っている場合には２を選びなさい。
...
ウ．少年法第６１条が禁止する推知報道に当たるか否かは、少年と面識のある特定多数の者あるいは少年が生活基盤としてきた地域社会の不特定多数の者ではなく、不特定多数の一般人が、当該事件報道記事等により、少年を当該事件の本人であると推知することができるかを基準にして判断すべきである。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"221"},{year:"2023",num:"4",subject:"ken",q:`集会の自由に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．皇居外苑などの国民公園は、国が直接公共の用に供した財産であるとしても、集会のために設置されたものではないため、公園を集会に使用するための許可の申請について、公園の管理権者はその許否を自由に決することができ、不許可処分を行っても憲法第２１条に反しない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"2"},{year:"2023",num:"5",subject:"ken",q:`学問の自由に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．憲法第２３条の学問の自由は、学問研究の自由とその研究結果の発表の自由とを含むものであるが、教育ないし教授の自由は、学問の自由と密接な関係を有するけれども、学問の自由に含まれるものではない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"6"},{year:"2023",num:"6",subject:"ken",q:`財産権の保障に関する次のアからウまでの各記述について、ｂの見解がａの見解の批判となっている場合には１を、そうでない場合には２を選びなさい。
...
ｂ．基幹産業の国有化は、同条第３項の正当な補償を条件として、同条第２項の「公共の福祉」を実現する立法府の裁量に委ねられている。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"122"},{year:"2023",num:"7",subject:"ken",q:`生存権に関する次のアからウまでの各記述について、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．憲法第２８条の労働基本権の保障は公務員に対しても及ぶが、国家公務員の従事する職務には公共性がある一方、法律によりその主要な勤務条件が定められ、身分が保障されているほか、適切な代償措置が講じられていることなどからすれば、法律により国家公務員の争議行為を禁止することは、勤労者をも含めた国民全体の共同利益の見地からするとやむを得ない制約というべきであって、憲法第２８条に違反しない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"121"},{year:"2023",num:"9",subject:"ken",q:`人身の自由に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、それぞれ正しい場合には１を、誤っている場合には２を選びなさい。
...
ウ．交通事故を起こした運転者は、警察官に対し、交通事故発生の日時、場所、死傷者の数などを報告する義務を負うが、道路における危険とこれによる被害の増大を防止し、交通の安全を図るという目的のためには、刑事責任を負うことにつながるような自己に不利益な供述をさせることもやむを得ないから、この報告義務を定めた法律は、憲法第３８条第１項に違反しない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"122"},{year:"2023",num:"10",subject:"ken",q:`次の対話は、憲法第２４条に関する教授と学生の対話である。教授の各質問に対する次のアからウまでの学生の各回答について、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ｂ．憲法は、主権が国民に存すると規定するとともに、最高裁判所に国家行為の憲法適合性を判断する権限を有する終審裁判所という重要な地位・権限を付与している。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"221"},{year:"2023",num:"12",subject:"ken",q:`選挙制度に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、それぞれ正しい場合には１を、誤っている場合には２を選びなさい。
...
ウ．判例は、憲法前文に規定されている「平和のうちに生存する権利」はあらゆる基本的人権を支える基礎的な権利であるため、具体的訴訟においても、それ自体で独立して私法上の行為の効力を判断する基準になるとしている。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"4"},{year:"2023",num:"14",subject:"ken",q:`国会の立法手続に関する次のアからウまでの各記述について、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．法律には、国務大臣全員が署名し、内閣総理大臣が連署することが必要であるが、これは、法律に対する執行責任を明示するために求められるにすぎず、それ自体は法律の成立要件ではない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"6"},{year:"2023",num:"15",subject:"ken",q:`内閣に関する次のアからウまでの各記述について、それぞれ正しい場合には１を、誤っている場合には２を選びなさい。
...
ウ．衆議院議員総選挙又は参議院議員通常選挙の後に初めて国会が召集されたときは、憲法の規定により、内閣は、総辞職をしなければならない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"112"},{year:"2023",num:"16",subject:"ken",q:`司法権の範囲ないし限界に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、正しいものには〇、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．判例によれば、公職選挙法の規定において、一定の者につき選挙権を制限していることの憲法適合性については、当該者が自己の選挙権の侵害を理由にその救済を求めて提起する訴訟においてこれを争うことの可否はおくとしても、同法第２０４条の選挙無効訴訟において選挙人らが他者の選挙権の制限に係る当該規定の違憲を主張してこれを争うことは法律上予定されていない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"3"},{year:"2023",num:"18",subject:"ken",q:`財政に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、それぞれ正しい場合には１を、誤っている場合には２を選びなさい。
...
ウ．長く課税されることがなかったパチンコ球遊器について、行政の内部命令である通達によって課税の物件たる遊戯具に該当するとして課税の対象とされたことは、通達の内容が法の正しい解釈に合致するものであっても、憲法第８４条に違反する。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"112"},{year:"2023",num:"19",subject:"ken",q:`地方自治に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、それぞれ正しい場合には１を、誤っている場合には２を選びなさい。
...
ウ．地方公共団体が、地方自治の本旨に従って、財産を管理し、事務を処理し、及び行政を執行するためには、その財源を自ら調達する権能が必要であるから、地方自治の不可欠の要素として、国とは別途に課税権の主体となることが憲法上予定されており、租税の税目、課税客体、課税標準、税率等の事項について、法律で定められた具体的な準則に従う必要はない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"212"},{year:"2023",num:"20",subject:"ken",q:`条約に関する次のアからウまでの各記述について、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．条約の締結には国会の承認が必要であるが、衆議院が承認の議決をし、参議院でこれと異なった議決をした場合には、衆議院で出席議員の３分の２以上の多数で再び承認の議決をしたときは、衆議院の議決が国会の議決となる。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"2"},{year:"2023",num:"1",subject:"min",q:`胎児に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．胎児の母は、認知の訴えを提起することができない。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2023",num:"2",subject:"min",q:`意思能力に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．婚姻の当事者が婚姻届を作成した時に意思能力を有しないことは、婚姻の取消しの原因となる。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"3",subject:"min",q:`不在者の財産管理に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．家庭裁判所が選任した不在者の財産の管理人は、相続人である不在者を代理してそれ以外の相続人との間で協議による遺産分割をするときは、家庭裁判所の許可を得なければならない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"4",subject:"min",q:`代理に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．権限の定めのない代理人は、代理の目的である物又は権利の性質を変えない範囲内において、その利用又は改良を目的とする行為をする権限を有する。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"5",subject:"min",q:`無効又は取消しに関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ａがその真意ではないことを知りながらＡの所有する甲土地をＢに売る旨の意思表示をした場合において、ＢがＡの意思表示が真意ではないことを知ることができたためにＡの意思表示が無効であったとしても、善意のＣがＢから甲土地を買い受けたときは、Ａは、Ｃに対し、その無効を対抗することができない。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"6",subject:"min",q:`条件に関する次のアからオまでの各記述のうち、正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．ＡがＢとの間で、Ａの気が向いたらＢに１０万円を与える旨の贈与契約を締結した場合において、ＢがＡに１０万円の支払を請求したときは、Ａは、これを拒むことができない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2023",num:"7",subject:"min",q:`取得時効に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．地役権は、継続的に行使され、かつ、外形上認識することができるものに限り、時効によって取得することができる。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"8",subject:"min",q:`登記請求権に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ａの所有する甲土地がＡからＢ、ＢからＣに順次売却されて、それぞれその旨の所有権移転登記がされた場合において、いずれの売買契約も無効であるときは、Ｂは、Ｃに対し、ＢからＣへの所有権移転登記の抹消登記手続を請求することができる。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"9",subject:"min",q:`不動産を目的とする権利変動の対抗に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．永小作権を目的として抵当権を設定した永小作人は、その永小作権を放棄したとしても、その放棄をもって抵当権者に対抗することができない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"10",subject:"min",q:`占有回収の訴えに関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ａが自己所有の動産甲をＢに賃貸し引き渡していた場合において、ＣがＢのもとから甲を窃取したときは、Ａは、Ｃに対して、占有回収の訴えによって甲の返還を求めることができる。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"11",subject:"min",q:`付合、混和及び加工に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．ＡがＢの所有する鋼板甲に工作を加えて作品乙を製作した場合において、工作によって生じた価格が甲の価格を著しく超えるときは、乙の所有権は、Ａに帰属する。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2023",num:"12",subject:"min",q:`用益物権に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．入会権の行使を妨害する者に対する妨害排除請求権の行使は、別段の慣習がない限り、入会団体の構成員の全員でしなければならない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"13",subject:"min",q:`先取特権の順位及び効力に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ａ所有の建物について、Ｂが登記をした不動産保存の先取特権を有し、Ｃが登記をした抵当権を有するときは、Ｂの登記がＣの登記に後れたとしても、Ｂは、Ｃの抵当権に先立って、その先取特権を行使することができる。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．ウ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"14",subject:"min",q:`Ａが、Ｂに対して有するα債権の担保として、甲土地及び乙土地について第一順位の抵当権を共同抵当として有する場合に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．甲土地及び乙土地がＣの所有であって、甲土地には第二順位の抵当権者Ｄがいる場合において、Ａが甲土地のみについて抵当権を実行し、その代価からα債権の全部の弁済を受けたときは、Ⅾは、乙土地についてＡに代位してその抵当権を行使することができない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"15",subject:"min",q:`根抵当権に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．元本が確定した後は、根抵当権によって担保される利息や損害金は、通算して最後の２年分に限定される。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2023",num:"16",subject:"min",q:`不動産の譲渡担保に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．譲渡担保権者は、被担保債権について不履行があったときは、設定者との間で帰属清算の合意がされていたとしても、目的物を処分する権限を取得する。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"17",subject:"min",q:`履行遅滞に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ｂがその所有する動産甲をＨに贈与し、更にＨが甲をＩに贈与し、それぞれ引渡しがされた。この場合において、Ａは、Ｉに対する詐害行為取消請求において財産返還を請求することができるときは、Ｈに対する詐害行為取消請求において価額償還を請求することができない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"19",subject:"min",q:`根保証契約に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．主たる債務の元本が確定したときは、保証人は、確定した元本に関し確定後に発生した利息について、その履行をする責任を負わない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"20",subject:"min",q:`弁済に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．債権者Ａから弁済を受領する権限を付与されていないＢが、Ａの代理人と称して債権を行使し、債務者Ｃから弁済を受領したときは、Ｃが善意無過失であったとしても、その弁済は効力を有しない。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"21",subject:"min",q:`ＡのＢに対する金銭債権（以下「甲債権」という。）とＢのＡに対する金銭債権（以下「乙債権」という。）との相殺に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．甲債権について弁済期が到来していなくても、乙債権について弁済期が到来していれば、Ａは、相殺をもってＢに対抗することができる。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"22",subject:"min",q:`更改及び混同に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ａがその所有する甲建物をＢに賃貸し、ＢがこれをＣに転貸した場合において、ＣがＡから甲建物を購入して賃貸人たる地位がＣに帰属したときは、転貸借関係は、混同により消滅する。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2023",num:"23",subject:"min",q:`同時履行の抗弁に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．債権に関する証書がある場合において、その債権に係る債務と証書の返還義務とは、同時履行の関係にある。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2023",num:"24",subject:"min",q:`契約の解除に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．賃借人が死亡し、複数の相続人が賃借権を共同相続した場合、賃貸人が賃貸借契約を解除するには、その相続人全員に対して解除の意思表示をしなければならない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"25",subject:"min",q:`売買契約に基づき買主Ａが売主Ｂから引渡しを受けた動産甲の品質が契約の内容に適合しないものである場合に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ｂが引渡し時に不適合を過失なく知らなかった場合において、Ａが不適合を知った時から法定の期間内にその旨をＢに通知しなかったときは、Ａは、Ｂに対し、損害賠償を請求することができない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"26",subject:"min",q:`報酬に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．民法上の組合における業務執行組合員は、特約がない限り、報酬を請求することができない。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2023",num:"27",subject:"min",q:`Ａがその所有する動産甲をＢに賃貸した場合に関する次のアからオまでの各記述のうち、正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ｂが、Ａの承諾を得て甲をＣに転貸していた場合において、ＡＢ間の賃貸借の期間が満了し、その賃貸借が更新されなかったときは、Ａは、Ｃに対して、所有権に基づいて甲の引渡しを請求することができる。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"28",subject:"min",q:`委任契約に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．委任者の利益だけでなく、受任者の利益をも目的とする委任契約においては、委任者は、やむを得ない事由がなければ、契約を解除することができない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"29",subject:"min",q:`不当利得に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．Ａがその所有する動産をＢに贈与し、その引渡しをしたことが不法原因給付に該当し、不当利得に基づく動産の返還請求をすることができないときは、Ａは、Ｂに対し、所有権に基づく動産の返還請求をすることもできない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"30",subject:"min",q:`不法行為に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．損害賠償の額を定めるに当たり、被害を受けた未成年者の過失を考慮するためには、その未成年者に事理を弁識するに足りる知能が備わっていれば足りる。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2023",num:"31",subject:"min",q:`親族関係に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
ア．配偶者は、１親等の姻族である。
イ．配偶者の姉の夫は、親族ではない。
ウ．Ａを養親とし、Ｂを養子とする普通養子縁組が成立した場合において、その縁組前からＢに子Ｃがいたときは、ＡとＣとの間には親族関係が生じない。
エ．妻の親と夫の親とは、互いに親族である。
オ．夫が死亡した場合、妻が姻族関係を終了させる意思表示をしない限り、夫の兄弟姉妹と妻との姻族関係は終了しない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"32",subject:"min",q:`父Ａと母Ｂとの間に生まれた子であるＣを養子とし、婚姻しているＤとＥとを養親とする特別養子縁組に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．特別養子縁組が成立した場合、Ａ及びＢとＣとの親族関係は終了する。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2023",num:"33",subject:"min",q:`相続の承認及び放棄に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．限定承認者は、受遺者に弁済した後でなければ、相続債権者に弁済することができない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"34",subject:"min",q:`遺言に関する次のアからオまでの各記述のうち、誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．公正証書による遺言をした者は、その遺言を自筆証書による遺言によって撤回することができる。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"35",subject:"min",q:`相続人の不存在に関する次のアからオまでの各記述のうち、判例の趣旨に照らし誤っているものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．相続財産の清算人が相続財産に属する財産を売却するときは、家庭裁判所の許可を得なければならない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"36",subject:"min",q:`重大な過失に関する次のアからオまでの各記述のうち、判例の趣旨に照らし正しいものを組み合わせたものは、後記１から５までのうちどれか。
...
オ．賃借人が失火によって賃借物を滅失させたときは、賃貸人は、賃借人に重大な過失がない限り、債務不履行による損害賠償の請求をすることができない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"1",subject:"kei",q:`次のアからオまでの各記述を判例の立場に従って検討し、正しい場合には１を、誤っている場合には２を選びなさい。
...
オ．甲は、乙が窃取したバッグを、これが盗品かもしれないがそれでも構わないと思って購入した。この場合、甲に盗品等有償譲受け罪が成立する。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"22221"},{year:"2023",num:"2",subject:"kei",q:`暴行罪及び傷害罪に関する次のアからオまでの各記述を判例の立場に従って検討した場合、誤っているものの個数を後記１から５までの中から選びなさい。
...
オ．相手方に暴行を加えて負傷させた者が、傷害結果が発生することについて認識を欠いている場合には、傷害罪が成立することはない。`,c1:"１．１個",c2:"２．２個",c3:"３．３個",c4:"４．４個",c5:"５．５個",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"3",subject:"kei",q:`次の【判旨】に関する後記１から５までの各【記述】のうち、誤っているものを２個選びなさい。
【判旨】
...
【記述】`,c1:"１．【判旨】を前提にすると、殺意を有する者と傷害の故意にとどまる者との間で共謀共同正犯が成立する余地はない。",c2:"２．【判旨】は、共同正犯の成立には、実行行為の一部を分担することは必要ないとの立場に立っている。",c3:"３．【判旨】は、共謀共同正犯の成立には、単に関与者の内心における意思の合致があるだけでは十分でなく、客観的な謀議行為が必要であるとする考えと矛盾しない。",c4:"４．【判旨】に対しては、共同正犯を教唆及び幇助と区別することが困難になるとの批判がある。",c5:"５．【判旨】を前提にすると、共謀共同正犯の成立には、実行行為を行わない者が実行行為者に対して指揮命令をすることが必要である。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"15"},{year:"2023",num:"4",subject:"kei",q:"次の１から５までの各事例における甲の罪責について判例の立場に従って検討した場合、甲に窃盗罪が成立しないものはどれか。",c1:"１．甲は、Ｖ宅内において、Ｖが所在を見失っていたＶ所有の指輪を発見し、これを自己のものにしようと考えて無断で持ち去った。",c2:"２．甲は、Ｖが海中に取り落としたＶ所有の金塊について、Ｖからおおよその落下場所を教えてもらった上で回収を依頼され、Ｖの眼前で同所に潜り、同金塊を同所付近で発見したものの、これを自己のものにしようと考えて無断で持ち去った。",c3:"３．甲は、看守者のいない仏堂に所有者Ｖが据え置いてまつっていた仏像を、自己のものにしようと考えて無断で持ち去った。",c4:"４．甲は、Ⅴが乙から窃取した乙所有の腕時計を、これが盗品であることを知りながら自己のものにしようと考えて、Ⅴ宅に忍び込んで無断で持ち去った。",c5:"５．甲は、満員電車内において、乗客Ｖが網棚にかばんを置き忘れたままＡ駅で下車したのを目撃し、Ｂ駅で下車する際、同かばんを自己のものにしようと考えて無断で持ち去った。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2023",num:"5",subject:"kei",q:`次のアからオまでの各記述を判例の立場に従って検討した場合、正しいものの組合せは、後記１から５までのうちどれか。
...
オ．甲は、恐喝目的でＡを監禁し、監禁のための暴行等により畏怖しているＡを更に脅迫して現金を喝取した。この場合、監禁罪と恐喝罪が成立し、これらは牽連犯となる。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"6",subject:"kei",q:`性的自由に対する罪に関する次のアからオまでの各記述を判例の立場に従って検討し、正しい場合には１を、誤っている場合には２を選びなさい。
...
学生Ｂ．甲の虚偽報告の有無にかかわらずＸ県は代金を支払わざるを得ませんので、そもそも、⑤（ｉ．欺罔行為がない・ｊ．財物の交付行為がない）と考えます。したがって、詐欺未遂罪も成立しません。`,c1:"１．①ａ ③ｅ ⑤ｉ",c2:"２．①ｂ ②ｃ ④ｇ",c3:"３．①ｂ ④ｈ ⑤ｉ",c4:"４．②ｃ ③ｆ ④ｇ",c5:"５．②ｄ ③ｅ ⑤ｊ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2023",num:"11",subject:"kei",q:`賄賂罪に関する次のアからオまでの各記述を判例の立場に従って検討した場合、正しいものの組合せは、後記１から５までのうちどれか。
...
オ．裁判所は、収賄の共同正犯者が共同して収受した賄賂について、共犯者各自に対し、公務員の身分の有無にかかわらず、それぞれその価額全部の追徴を命じることができ、相当と認められる場合には、裁量により、各自にそれぞれ一部の額の追徴を命じ、あるいは一部の者にのみ追徴を科することも許される。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2023",num:"12",subject:"kei",q:`緊急避難に関する次のアからオまでの各記述を判例の立場に従って検討した場合、正しいものの組合せは、後記１から５までのうちどれか。
...
ク．共同正犯
（参照条文）刑法
第２０２条 人を教唆し若しくは幇助して自殺させ、又は人をその嘱託を受け若しくはその承諾を得て殺した者は、６月以上７年以下の懲役又は禁錮に処する。`,c1:"１．①ア ②オ ③カ ④イ ⑤キ ⑥ウ",c2:"２．①ア ②カ ③オ ④ウ ⑤ク ⑥イ",c3:"３．①ア ②カ ③オ ④エ ⑤ク ⑥ウ",c4:"４．①イ ②オ ③カ ④ア ⑤キ ⑥エ",c5:"５．①イ ②オ ③カ ④エ ⑤キ ⑥ウ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2023",num:"14",subject:"kei",q:`身分犯の共犯に関して、学生Ａ及びＢが次の【会話】のとおり議論している。【会話】中の①から⑤までの（ ）内に後記【語句群】から適切な語句を入れた場合、正しいものの組合せは、後記１から５までのうちどれか。なお、①から⑤までの（ ）内にはそれぞれ異なる語句が入る。
【会話】
...
ｉ．間接正犯
ｊ．幇助犯`,c1:"１．①ａ ③ｇ ⑤ｃ",c2:"２．①ｂ ③ｈ ⑤ｃ",c3:"３．①ｃ ④ｉ ⑤ａ",c4:"４．②ｄ ④ｊ ⑥ｆ",c5:"５．②ｆ ④ｉ ⑥ｅ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2023",num:"17",subject:"kei",q:`刑法第２３０条の２に関する次の各【見解】についての後記１から５までの各【記述】のうち、正しいものはどれか。
...
オ．丙のいずれの行為についても、証拠上、犯罪の嫌疑が不十分として不起訴となった場合、丁が丙をかくまった行為について犯人蔵匿罪は成立しない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"22212"},{year:"2022",num:"1",subject:"ken",q:`憲法が保障する基本的人権の制約理由に関する次のアからウまでの各記述について、最高裁判所の判例の趣旨に照らして、正しいものには○、誤っているものには×を付した場合の組合せを、後記１から８までの中から選びなさい。
...
ウ．憲法第３章の人権規定は，未成年者にも当然適用される。もっとも，人権の性質によっては，社会の構成員として成熟した人間を主として対象としており，それに至らない未成年者に対しては，その保障の範囲や程度が異なることがある。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"7"},{year:"2009",num:"2",subject:"ken",q:`私人間における人権保障に関する次のアからウまでの各記述について，最高裁判所の判例の趣旨に照らして，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ウ．多数意見は，相続制度が総合的な立法政策によるものであることと法定相続分規定の補充性を理由に，相続制度の法定に関する広い立法裁量を帰結する。それに対し，反対意見は，立法裁量にも憲法上の限界があるとした上で，そのような限界として個人の尊厳を挙げる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"211"},{year:"2009",num:"4",subject:"ken",q:`選挙権及び被選挙権に関する次のアからウまでの各記述について，正しいものには○，誤っているものには×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ．立候補の自由について，最高裁判所は，選挙権の自由な行使と表裏の関係にあり，自由かつ公正な選挙を維持する上で極めて重要であることを認めつつ，憲法が立候補の自由について明文では規定していないので，立候補の自由は憲法の保障する基本的人権とまではいえないと判示した。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"2"},{year:"2009",num:"5",subject:"ken",q:`市立小学校の校長が音楽専科の教諭に対し，入学式における国歌斉唱の際に「君が代」のピアノ伴奏を行うよう命じた職務命令が，憲法第１９条に違反しないとした最高裁判所の判決（最高裁判所平成１９年２月２７日第三小法廷判決，民集６１巻１号２９１頁）に関する次のアからウまでの各記述について，正しいものには○，誤っているものには×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ．患者が，輸血を受けることは宗教上の信念に反するとして，輸血を伴う医療行為を拒否するとの明確な意思を有している場合には，その意思決定をする権利は尊重されなければならない。医師としては，手術の際に輸血以外には救命手段がないと判断したときは輸血するとの方針を採っていることを患者に説明し，手術を受けるか否かをその意思決定にゆだねるべきである。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"211"},{year:"2009",num:"7",subject:"ken",q:`政教分離原則に関する次のアからウまでの各記述について，最高裁判所の判例の趣旨に照らして，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ｂ．しかし，この見解は，「思想の自由市場」が必ずしも自由とは言い難い現実からして問題が残る。また，仮に「市場」が完全に機能しているとしても，最後に残った意見が真理であることを立証することは，不可能である。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"211"},{year:"2009",num:"9",subject:"ken",q:`酒類販売の免許制が憲法第２２条第１項に適合するか否かについて判示した最高裁判所の判決（最高裁判所平成４年１２月１５日第三小法廷判決，民集４６巻９号２８２９頁）に関する次のアからウまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ウ．この判決は，酒類販売の免許制は，経済的弱者保護という意味での積極目的による規制とは異なるとした上で，免許の許否が実際に既存の酒類販売業者の権益を擁護するような運用になっているか否かに着目すべきであるが，そのような運用がなされていない限り酒税法の立法目的を明らかに逸脱するものであるとはいえず，合憲であるとした。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"122"},{year:"2009",num:"10",subject:"ken",q:`大学の自治に関する次のアからウまでの各記述について，正しいものには○，誤っているものには×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ．大学における研究と教育は，大学が国家権力等による干渉を排し，組織体としての自律性を保障されることなしには全うすることが不可能であるから，学問の自由と不可分のものとして大学の自治も保障される。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"5"},{year:"2009",num:"11",subject:"ken",q:`労働基本権に関する次のアからウまでの各記述について，正しいものには○，誤っているものには×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
エ．憲法は，国の行政組織について法律で定めるべきことを明示していない。一般には，国の行政組織の基本は法律で定めるべきであるが，各省庁の組織の細部については政令で定めることができると解されている。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"15",subject:"ken",q:`衆議院解散権に関する次のアからエまでの各記述について，正しいもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ．現在の実務は，内閣の自由な衆議院解散権を憲法第７条で根拠付けているが，最高裁判所は，これが妥当な憲法解釈であるか否かについて判断を示していない。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"6"},{year:"2009",num:"16",subject:"ken",q:`次の文章は，最高裁判所平成１０年１２月１日大法廷決定（民集５２巻９号１７６１頁）の中で，裁判官に対する懲戒と憲法第８２条第１項との関係について論じた部分を要約したものである。次のアからウまでの各記述につき，この見解に対する批判となり得る場合には○を，批判となり得ない場合には×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ．裁判官に対する懲戒の裁判が，固有の意味における司法権の作用ではないとしても，これを公開することで裁判の公正・中立に対する国民の信頼が確保されることを見過ごしている。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"1"},{year:"2009",num:"17",subject:"ken",q:`次のアからウは，憲法第８９条後段にいう「公の支配」に関する文章である。ａはある見解を要約したものであり，ｂはそれぞれの見解に対する批判である。ｂがａに対する批判となり得る場合には１を，批判となり得ない場合には２を選びなさい。
...
ｂ．この見解は，現行法の私学助成を合憲とするものであるが，体系的解釈によっては学校法人への助成を正当化することにはならない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"211"},{year:"2009",num:"18",subject:"ken",q:`条例と法律の関係に関する次のアからウまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ウ．憲法第３１条により刑罰及びこれを科す手続は「法律」で定める必要があるが，この「法律」には，法律に限らず，その授権を受けた下位法令も含まれる。そして，条例は住民の代表である議会が制定する自主立法として法律に類するから，法律が相当程度具体的に限定して授権している場合には，条例により刑罰及びこれを科す手続を定めることができる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"122"},{year:"2009",num:"19",subject:"ken",q:`次のアからウは，憲法改正手続に関する文章である。ａはある見解を要約したものであり，ｂはそれぞれの見解に対する批判である。ｂがａに対する批判となり得る場合には１を，批判となり得ない場合には２を選びなさい。
...
ｂ．書き損ない等の理由で無効とされてしまう投票をすべて反対投票と数えるのは，不合理である。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"112"},{year:"2009",num:"20",subject:"ken",q:`条約に対する違憲審査に関する次のアからエまでの各記述について，明らかに誤っているもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ．条約が違憲審査の対象となるとする見解によれば，条約を違憲とする判決によって当該条約の国内法的効力及び国際法的効力のいずれもが失われることになる。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2009",num:"21",subject:"gyo",q:`次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ．行政機関が定立する定めであっても，国民の権利義務に直接関係しない行政規則は，行政機関が法律の根拠なくして定立することができる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2221"},{year:"2009",num:"22",subject:"gyo",q:`行政手続法に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ．聴聞の主宰者は，不利益処分の原因となる事実に対する当事者等の主張に理由があるかどうかについての意見を記載した報告書を作成し，行政庁に提出するが，処分権限を有するのは行政庁であるから，行政庁は，不利益処分の決定をする際に，当該報告書に記載された主宰者の意見を参酌することを要しない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2212"},{year:"2009",num:"23",subject:"gyo",q:`Ａ市では，職員の非違行為の類型とそれに対して課されるべき懲戒処分の種別及び程度を規定した内部基準（地方公務員法第２９条第１項第１号にいう条例，規則又は規程のいずれにも該当しないもの。以下「本件基準」という。）を定めているが，Ａ市市長は，職員Ｘに対し，本件基準よりも厳しい懲戒処分（以下「本件処分」という。）を行った。そこで，Ｘは，本件処分の取消訴訟を提起した。この事例に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
（参照条文）地方公務員法
...
エ．裁判所は行政規則には拘束されないとの見解を採ると，本件処分が本件基準よりも厳しいものであるという事情は，本件処分の違法性に関する受訴裁判所の判断に影響することはない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1122"},{year:"2009",num:"24",subject:"gyo",q:`行政指導に関する次のアからウまでの各記述について，法令に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ．収税官吏は，調査のため必要がある場合には，国税犯則取締法第１条の規定に基づき，調査に際し，実力を行使し，調査の相手方の抵抗を排して必要な措置を行うことができる。（参照条文）国税犯則取締法第１条 収税官吏ハ国税（関税及噸税ヲ除ク以下同シ）ニ関スル犯則事件（以下犯則事件ト称ス）ヲ調査スル為必要アルトキハ犯則嫌疑者若ハ参考人ニ対シ質問シ，犯則嫌疑者ノ所持スル物件，帳簿，書類等ヲ検査シ又ハ此等ノ者ニ於テ任意ニ提出シタル物ヲ領置スルコトヲ得２ 収税官吏ハ犯則事件ヲ調査スル為必要アルトキハ参考人ノ所持スル物件，帳簿，書類等ヲ検査スルコトヲ得`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"4"},{year:"2009",num:"26",subject:"gyo",q:`道路交通法（以下「法」という。）に基づく交通反則通告制度に関する後記条文について述べた次のアからエまでの各記述について，最高裁判所の判例に照らし，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ．中止命令に従わない場合には，Ａ市市長が除却を命ずることができるものとして，行政代執行法に基づく行政代執行を可能にすること`,c1:"１．１個",c2:"２．２個",c3:"３．３個",c4:"４．４個",c5:"５．０個",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"28",subject:"gyo",q:`行政機関の保有する情報の公開に関する法律（以下「公開法」という。）及び行政機関の保有する個人情報の保護に関する法律（以下「保護法」という。）に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ．この判決は，Ｘらが，本件開設許可により，自己の権利若しくは法律上保護された利益を侵害され，又は必然的に侵害されるおそれのある者には該当しないとの判断を示したものである。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2009",num:"30",subject:"gyo",q:`最高裁判所平成２０年９月１０日大法廷判決（以下「本判決」という。）は，土地区画整理法に基づく土地区画整理事業計画の決定が抗告訴訟の対象となる行政処分に当たると判断したが，本判決に関する次のアからエまでの各記述について，誤っているものの個数を，後記１から５までの中から選びなさい。
...
ウ．地方公共団体の水道事業に関して，水道料金の値上げを内容とする「水道事業給水条例」が制定された場合，水道需要者は，同条例の施行によって，その後にされる個別的行政処分を経ることなく，同条例に従って値上げされた水道料金の支払義務を負わされることになるから，同条例の制定行為には，処分性が認められるものといえる。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"8"},{year:"2009",num:"32",subject:"gyo",q:`行政事件訴訟の判決に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
乙 「４号請求だね。実務上も一番多いらしいね。」`,c1:"１．１個",c2:"２．２個",c3:"３．３個",c4:"４．４個",c5:"５．０個",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"35",subject:"gyo",q:`Ｘは，マンション建設を計画し，Ｙ県知事に対し，都市計画法第２９条の開発行為の許可を求める申請をした。ところが，その建設予定地は，急傾斜地であり，同開発行為によってがけ崩れがあれば直接的な被害を受けることが予想される近接地に居住しているＺは，同開発行為が同法第３３条第１項第７号の開発許可基準を満たしていないと考えている。次のアからエまでの各記述について，法令又は最高裁判所の判例に照らし，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
（参照条文）都市計画法
第３３条 都道府県知事は，開発許可の申請があつた場合において，当該申請に係る開発行為が，次に掲げる基準（中略）に適合しており，かつ，その申請の手続がこの法律又はこの法律に基づく命令の規定に違反していないと認めるときは，開発許可をしなければならない。
一～六 （略）
...
エ．ＸがＹ県を被告として不作為の違法確認の訴えと開発許可処分の義務付けの訴えを提起した場合，裁判所は，Ｘ，Ｙ県若しくはＺの申立てにより又は職権で，決定をもって，Ｚを訴訟に参加させることができる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2121"},{year:"2009",num:"36",subject:"gyo",q:`次のアからエまでの各事例におけるＸが行政事件訴訟法上の仮の救済を求めるとした場合，各事例について最も適切と考えられる仮の救済の申立てを，それぞれ後記１から４までの中から一つ選びなさい。
...
２．処分の効力の停止の申立て
３．仮の義務付けの申立て
４．仮の差止めの申立て`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1342"},{year:"2009",num:"37",subject:"gyo",q:`国家賠償法第２条に関する次のアからウまでの各記述について，最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
一～五 （略）
２，３ （略）`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"6"},{year:"2009",num:"39",subject:"gyo",q:`Ｘの夫Ａは，勤務中にくも膜下出血を起こし死亡した。Ｘは，Ａの発症は，過重な労働が原因と考え，所轄の労働基準監督署長に対して遺族補償給付の支給を請求したが，同署長は，業務起因性が認められないとして不支給の決定をした。次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
（参照条文）労働者災害補償保険法
...
エ．労働者災害補償保険審査官は，Ｘの審査請求を棄却し，労働保険審査会は，Ｘの再審査請求を棄却した。Ｘは，Ａの死亡に業務起因性がないとした労働基準監督署長の不支給決定の違法を理由として，労働保険審査会の裁決の取消しを求めることができない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2211"},{year:"2009",num:"40",subject:"gyo",q:`行政組織に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ．国土交通大臣の指定を受けた指定確認検査機関が建築確認を行った場合には，当該建築確認に関し，指定確認検査機関は行政庁に当たる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2211"},{year:"2009",num:"1",subject:"min",q:"行為能力に関する次の１から５までの各記述のうち，正しいものを２個選びなさい。",c1:"１．負担のない贈与をする旨の申込みを受けた未成年者が法定代理人の同意を得ないでした承諾は，取り消すことができない。",c2:"２．未成年者が，法定代理人から営業の許可を得た後，法定代理人の同意を得ないで当該営業に関しない行為をした場合には，その行為は取り消すことができない。",c3:"３．成年被後見人がした行為であっても，日用品の購入は，取り消すことができない。",c4:"４．被保佐人が保佐人の同意を得ることを要する行為をその同意を得ないでした場合には，保佐人は，その行為を追認することはできるが，その行為を取り消すことはできない。",c5:"５．後見開始の審判は本人が請求することはできないが，保佐開始の審判は本人も請求することができる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"13"},{year:"2009",num:"2",subject:"min",q:"法人の剰余金又は残余財産に関する次の１から５までの各記述のうち，誤っているものはどれか。",c1:"１．株主に剰余金の配当を受ける権利及び残余財産の分配を受ける権利の全部を与えない旨の株式会社の定款の定めは，その効力を有しない。",c2:"２．社員に残余財産の分配を受ける権利を与える旨の一般社団法人の定款の定めは，その効力を有しない。",c3:"３．一般社団法人の社員総会は，社員に剰余金を分配する旨の決議をすることができない。",c4:"４．解散をして清算をすることになった一般社団法人の残余財産の帰属が定款で定まらない場合において，その一般社団法人の社員総会は，その残余財産を社員に分配する旨の決議をすることができない。",c5:"５．設立者に残余財産の分配を受ける権利を与える旨の一般財団法人の定款の定めは，その効力を有しない。 ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2009",num:"3",subject:"min",q:"果実に関する次の１から５までの各記述のうち，誤っているものはどれか。",c1:"１．善意の占有者は，占有物から生ずる果実を取得するが，強迫によって占有をしている者は，果実を返還する義務を負い，果実を既に消費している場合には果実の代価を償還する義務を負う。",c2:"２．売主は，目的物の引渡しを遅滞している場合でも，引渡しまで果実を収取することができる。",c3:"３．受遺者は，遺言者がその遺言に別段の意思を表示しない限り，遺贈の履行を請求することができる時から果実を取得する。",c4:"４．不動産質権者は，質権の目的物である不動産の用法に従いこれを使用することができるが，不動産から生じた果実を取得することはできない。",c5:"５．Ａが，Ｃに賃料毎月月末支払の約定で賃貸している家屋を，月の途中でＢに贈与した場合，ＡＢ間に特段の合意がなければ，当該月の賃料は日割りによってＡ及びＢに分配される。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2009",num:"4",subject:"min",q:`虚偽表示に当たる法律行為がされた場合における次のアからオまでの者のうち，判例の趣旨に照らし「相手方と通じてした虚偽の意思表示の無効を対抗することができない第三者」に該当するものを組み合わせたものは，後記１から５までのうちどれか。
ア．虚偽の意思表示により目的物を譲り受けた者からその目的物について抵当権の設定を受けた者
イ．土地の賃借人が所有する地上建物を他に仮装譲渡した場合の土地賃貸人
ウ．財産の仮装譲渡を受けた者の相続人
エ．虚偽の意思表示により譲り受けた目的物を差し押さえた仮装譲受人の一般債権者
オ．土地の仮装譲受人から当該土地上の建物を賃借した者`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"5",subject:"min",q:"錯誤に関する次の１から５までの各記述のうち，正しいものを２個選びなさい。",c1:"１．婚姻の相手が人違いである場合は，そのことに重大な過失があっても，婚姻の無効を主張することができる。",c2:"２．判例によれば，錯誤による意思表示の表意者に重大な過失があった場合には，表意者は無効を主張することができないが，相手方は無効を主張することができる。",c3:"３．債務者でない者が錯誤によって債務の弁済をした場合において，債権者が善意で担保を放棄したときは，弁済をした者は，重大な過失がなくても返還の請求をすることができない。",c4:"４．錯誤により無効な契約であっても，表意者がその行為の無効であることを知って追認をしたときは，行為の時にさかのぼってその効力を生ずる。",c5:"５．判例によれば，家庭裁判所が相続放棄の申述を受理した後は，相続放棄について錯誤による無効を主張することはできない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"13"},{year:"2009",num:"6",subject:"min",q:`代理に関する次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 占有回収の訴えは，占有を奪われた時から１年以内に提起しなければならない。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2009",num:"9",subject:"min",q:"動産の占有権の譲渡に関する次の１から５までの各記述のうち，誤っているものはどれか。",c1:"１．動産の所有者であって寄託者であるＡが，その受寄者であるＢに対して，以後第三者Ｃのために動産を占有することを命じ，Ｃがそれを承諾したときは，Ｃは動産の占有権を取得する。",c2:"２．動産の所有者であって賃貸人であるＡが，その賃借人として引渡しを受けているＢとの間で売買契約を締結した場合，占有権を譲渡する旨のＡとＢの意思表示によって，Ａは動産の占有権を失う。",c3:"３．動産の所有者であって寄託者であるＡの承諾を得て，受寄者であるＢが，その動産について第三者Ｃとの間で寄託契約を締結して引渡しをした場合，Ｂは動産の占有権を失う。",c4:"４．動産の所有者であって自ら動産を占有するＡが，Ｂとの間で売買契約を締結し，同時にＢを使用貸主，Ａを使用借主とする使用貸借契約を締結した場合，以後Ｂのために占有する旨のＡの意思表示によって，Ｂは動産の占有権を取得する。",c5:"５．動産の所有者であって賃貸人であるＡの承諾を得て，賃借人であるＢが，その賃借権を第三者Ｃに譲渡し，動産を引き渡した場合，Ｂは動産の占有権を失う。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2009",num:"10",subject:"min",q:"相隣関係に関する次の１から５までの各記述のうち，誤っているものはどれか。",c1:"１．隣接する土地の一方の所有者は，他方の土地の所有者に対し，共同の費用で境界標を設置することに協力するよう請求することができ，その協力の結果設置された境界標は共有に属するものと推定される。",c2:"２．建物を建築する際に境界線から５０センチメートル以上の距離を保つ必要がある場合であっても，建築に着手してから１年を経過し，又は建物が完成した後は，隣地の所有者は建物の変更を請求することができず，損害賠償のみを請求することができる。",c3:"３．隣接する土地の一方の所有者がその所有地上の建物を改修する場合，必要な範囲内で隣地の使用を隣人に請求することができるが，隣人の承諾がなければ，その住家に立ち入ることはできない。",c4:"４．判例によれば，袋地（他人の土地に囲まれて公道に通じない土地）を買い受けた者は，所有権移転登記をしなければ，囲繞地（袋地を囲んでいる土地）の所有者に対し，公道に至るため囲繞地を通行する権利を有することを主張することができない。",c5:"５．甲土地を所有するＡが，同土地を袋地である乙土地と袋地でない丙土地に分筆した上，乙土地をＢに売った場合には，Ｂは，丙土地についてのみ，公道に至るための通行権を有する。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2009",num:"11",subject:"min",q:`不動産の物権変動に関する次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．保証人は，書面によらない保証契約を撤回することができる。ただし，履行の終わった部分については，この限りでない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"25",subject:"min",q:"利益を受ける者の意思の尊重に関する次の１から５までの各記述のうち，正しいものを２個選びなさい。",c1:"１．契約により，当事者の一方（債務者）が第三者に対してある給付をすることを約束したときは，その第三者は，債務者に対し，直接にその給付を請求する権利を有する。第三者が債務者に対し，その契約の利益を享受する意思を表示したときは，第三者の権利は，前記契約が成立した時にさかのぼって発生する。",c2:"２．遺贈義務者が受遺者に対し，相当の期間を定めて，その期間内に遺贈の承認又は放棄をすべき旨の催告をした場合，受遺者がその期間内に遺贈義務者に対してその意思を表示しないときは，遺贈を承認したものとみなされる。",c3:"３．義務なく他人のために事務の管理を始めた者は，その事務管理が本人の意思に反するものであるときは，本人のために有益な費用を支出したとしても，本人に対し，その償還を請求することができない。",c4:"４．利害関係を有しない第三者は，債務者の意思に反して，その債務の弁済をすることができない。",c5:"５．利害関係を有しない第三者は，債務者の意思に反して，その債務の保証をすることができない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"24"},{year:"2009",num:"26",subject:"min",q:`契約の解除に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．動産の売買契約が締結され，売買代金の一部が支払われた後で，当該売買契約が売主の債務不履行を理由に解除された場合，売主は，買主の損害を賠償する義務を負うが，受領した売買代金の一部を返還するに当たっては，その受領の時からの利息を付す必要はない。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"27",subject:"min",q:`Ａが所有する甲不動産について，Ｂを売主とし，Ｃを買主とする売買契約が成立した場合に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．建物建築工事の請負契約において，請負人が建物の所有権を取得するとしても，請負人には敷地利用権がない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2009",num:"30",subject:"min",q:`Ａが所有し運転するタクシーに，Ｂが所有し運転する自家用車が衝突する交通事故が発生し，ＡＢ所有の各車両が損傷するとともに歩行者Ｃが負傷した。当該交通事故により，Ａには５０万円の損害が，Ｂには８０万円の損害が，Ｃには１００万円の損害が，それぞれ生じ，当該交通事故及びＣの負傷についての過失割合はＡが２割で，Ｂが８割であり，また，Ｃの負傷にはＣの過失がないものとして，次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
エ．検察官は，当事者双方が存命中は，婚姻適齢違反の婚姻の取消しを請求することができる。`,c1:"１．ア",c2:"２．イ",c3:"３．ウ",c4:"４．エ",c5:"５．誤っているものはない",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2009",num:"33",subject:"min",q:`利益相反行為に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．後見監督人がある場合でも，後見人と被後見人との利益相反行為については特別代理人を選任しなければならない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2009",num:"34",subject:"min",q:"民法上の後見に関する次の１から５までの各記述のうち，正しいものはどれか。",c1:"１．成年後見人になる者は必ず家庭裁判所の選任によるが，未成年後見人になる者は必ずしも家庭裁判所が選任するとは限らない。",c2:"２．成年後見人は，正当な事由があるときは，家庭裁判所の許可を得てその任務を辞することができるが，未成年後見人は，正当な事由があっても，家庭裁判所の許可を得てその任務を辞することはできない。",c3:"３．家庭裁判所は，成年後見人を解任することができるが，未成年後見人を解任することはできない。",c4:"４．家庭裁判所は，成年後見人には被後見人の財産から相当な報酬を与えることができるが，未成年後見人には報酬を与えることはできない。",c5:"５．成年後見人の配偶者は後見監督人になることができるが，未成年後見人の配偶者は後見監督人になることはできない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2009",num:"35",subject:"min",q:"相続による権利義務の承継に関する次の１から５までの各記述のうち，正しいものはどれか。",c1:"１．使用貸借の借主が死亡すると，その相続人は使用借主となる。",c2:"２．定期の給付を目的とする贈与は，たとえ書面でなされたとしても，贈与者の死亡によって効力を失う。",c3:"３．被相続人が有していた占有権は，相続人が相続財産について事実的支配をしないと，相続されない。",c4:"４．系譜，祭具及び墳墓の所有権は，氏を同じくする者のうち慣習に従い祖先の祭祀を主宰すべき者が相続する。",c5:"５．被相続人が買主の詐欺により不動産を売り渡したが，その売買契約を取り消さずに死亡したときは，相続人は，これを取り消すことができない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"36",subject:"min",q:"共有者の一人が死亡し，相続人の不存在が確定し，清算手続が終了した場合，その共有持分は他の共有者に帰属するとする見解（甲説）と，特別縁故者に対する財産分与の対象となり，この分与がされない場合に初めて他の共有者に帰属するとする見解（乙説）がある。次の１から５までの記述を，甲説の説明又は根拠に親しむものと，乙説の説明又は根拠に親しむものとに分けた場合，前者に属するものはどれか。",c1:"１．相続財産が共有持分である場合とそうでない場合とで，区別して扱う合理的な理由はない。",c2:"２．相続財産が共有持分である場合であっても，それを相続債権者の弁済のために換価して弁済した場合と，そのような事情がなく換価しなかった場合とで，区別して扱う合理的な理由はない。",c3:"３．個別の事案に応じて，他の共有者と特別縁故者とのいずれを保護すべきかについての家庭裁判所の判断を通じて，具体的妥当性を図ることができるようにすべきである。",c4:"４．特別縁故者に対する財産分与の制度は，遺贈又は死因贈与の制度の補完である。",c5:"５．共有関係は，完全な財産権が他の共有持分によって制約されているにすぎず，共有者間には，当該共有財産に関し相互連帯的な特別関係があるといえる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2009",num:"37",subject:"syo",q:"株式会社の設立に関する次の１から５までの各記述のうち，正しいものを２個選びなさい。",c1:"１．発起設立において，発起人は，公証人の認証を受けた定款で定められて選任されたものとみなされた設立時取締役を会社の成立の時よりも前に解任することができない。",c2:"２．募集設立において，会社の成立の時における検査役の調査を経ていない財産引受けの目的財産の価額が定款に記載され，又は記録された価額に著しく不足するときは，発起人は，その職務を行うについて注意を怠らなかったことを証明した場合でも，当該不足額を支払う義務を免れることができない。",c3:"３．募集設立において，会社法上の公開会社の設立時取締役の選任は，創立総会の決議によって行わなければならない。",c4:"４．設立時募集株式の引受人は，出資の履行期日又は期間内に出資に係る金銭の払込み又は金銭以外の財産の給付をしなければ，株主となることができない。",c5:"５．委員会設置会社でない会社の設立手続に重大な瑕疵があるときは，株主，取締役，会社債権者，監査役又は清算人は，会社の成立の日から１年以内に，設立の無効の訴えを提起することができる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"23"},{year:"2009",num:"38",subject:"syo",q:`株式に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．会社がその発行する株式を引き受ける者の募集において株主に株式の割当てを受ける権利を与える場合には，当該会社は，自己株式について募集株式の割当てを受ける権利を有しない。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2009",num:"39",subject:"syo",q:"異なる種類の株式に関する次の１から５までの各記述のうち，誤っているものはどれか。",c1:"１．種類株式発行会社において単元株制度を採用する場合には，その単元株式数は，株式の種類ごとに定めなければならない。",c2:"２．種類株式発行会社とは，内容の異なる２以上の種類の株式を発行する会社をいい，その旨を定款で定めていれば足り，現に２以上の種類の株式を発行していることを要しない。",c3:"３．委員会設置会社においては，当該種類の株式の種類株主を構成員とする種類株主総会において取締役を選任することを内容とする種類の株式を発行することができない。",c4:"４．株式会社は，定款に定めることにより，株主総会のあらゆる決議事項について議決権を行使することができない種類の株式を発行することができる。",c5:"５．取得請求権付株式の株主は，会社に対し，当該会社に分配可能額がなくとも，当該取得請求権付株式を取得することを請求することができる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2009",num:"40",subject:"syo",q:`新株予約権に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．募集新株予約権の行使に際して出資される財産の価額が当該募集新株予約権の発行時の株価より著しく低い場合には，その募集事項の決定は，株主総会の特別決議によらなければならない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2009",num:"41",subject:"syo",q:`取締役会設置会社における株主総会に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．株主総会に先立って議決権行使書面をあらかじめ会社に提出した株主は，当該株主総会に出席して議決権を行使することができない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2009",num:"42",subject:"syo",q:`取締役の競業取引又は利益相反取引に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．取締役会設置会社の取締役が会社の事業と同じ種類の事業を行っている他の株式会社の業務執行者に就任するためには，当該取締役会設置会社の取締役会の承認を受けなければならない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2009",num:"43",subject:"syo",q:`特別取締役に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．委員会設置会社においては，特別取締役の制度は認められておらず，取締役会は，その決議によって，重要な財産の処分の決定を執行役に委任することができる。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2009",num:"44",subject:"syo",q:`取締役会設置会社における監査役に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ．裁判所の管轄は，訴えの提起の時を標準として定められるから，５０万円の損害賠償を求める訴えを簡易裁判所に提起した後に，請求額を１５０万円に拡張した場合でも，簡易裁判所は訴訟を地方裁判所に移送する必要はない。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2009",num:"58",subject:"mso",q:`株式会社の代表者に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ ．特定の財産が特別受益財産に当たることの確認を求める訴えは，相続分又は遺留分をめぐる紛争を直接かつ抜本的に解決することになるから，確認の利益を有する。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2009",num:"61",subject:"mso",q:`申立事項と判決事項に関する次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
ウ. すべての人権に論理必然的に内在する「公共の福祉」は，人権相互間に生じる矛盾・衝突の調節を図るための実質的公平の原理であり，例えば，社会権を実質的に保障するために自由権を制約する場合には必要な限度の規制が認められるという見解がある。しかし，この見解では，憲法第２２条，第２９条の「公共の福祉」が，結局，国の経済的・社会的政策という意味でとらえられることになり，広汎な裁量論の下で経済的自由権と社会権の保障が不十分になるおそれがある。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"112"},{year:"2008",num:"4",subject:"ken",q:`次のアからウまでの各記述について，団体の自律性と構成員の思想の自由に関する最高裁判所の判例の趣旨に照らして，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい 
...
ウ. 大震災で被災した他県の司法書士会へ復興支援拠出金寄附のための負担金の徴収は，司法書士会の目的の範囲を逸脱するものではない。司法書士会が強制加入団体であることを考慮しても，本件会員の政治的又は宗教的立場や思想信条の自由を害するものではなく，会員の協力義務を否定すべき特段の事情があるとは認められない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"5"},{year:"2008",num:"5",subject:"ken",q:`次の文章は，街路樹への広告物掲出を禁止する県条例の違憲審査の基準について論じたものである。次のアからウまでの各記述につき，この見解に対する批判となり得る場合には１を，批判となり得ない場合には２を選びなさい。
...
ウ. 表現者にとって，特定の時，場所，方法で表現することと表現の内容とが同程度に重要である場合が少なくないことを見過ごしている。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"121"},{year:"2008",num:"6",subject:"ken",q:`宗教法人法に基づくオウム真理教に対する裁判所の解散命令は，憲法第２０条第１項に違反しないとした最高裁判所の決定（最高裁判所平成８年１月３０日第一小法廷決定，民集５０巻１号１９９頁）に関する次のアからエまでの各記述について，正しいもの二つの組合せを，後記１から６までの中から選びなさい。 
...
エ. この決定は，宗教上の行為の自由は，内心における信仰の自由が最大限尊重されるべきものであるのとは異なって，公共の福祉の観点からする合理的な制約に服するべきものであるとした。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"7",subject:"ken",q:`生存権の法的性格に関する次のアからウまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。 
...
ウ. 具体的権利説を言葉どおりにとらえれば，憲法第２５条第１項は，それを直接の根拠にして「健康で文化的な最低限度の生活」を確保するための具体的請求権を保障する規定ということになりそうである。しかし，具体的権利説といわれている見解は，必ずしも憲法のみを根拠に裁判所に具体的な給付請求ができるということまで主張するものではない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"211"},{year:"2008",num:"8",subject:"ken",q:`学校教育に関する次のアからウまでの各記述について，最高裁判所の判例の趣旨に照らして，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ウ. 憲法第２６条第２項後段の義務教育の無償の規定は，直接には，普通教育の対価を徴収しないこと，すなわち，授業料の不徴収を定める趣旨である。ただし，教科書，学用品等の授業料以外の費用については，国の財政等の事情を考慮して立法により無償と定められた場合に，その限度で，同項の義務教育の無償の内容となる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"122"},{year:"2008",num:"9",subject:"ken",q:`人身の自由に関する次のアからウまでの各記述について，最高裁判所の判例の趣旨に照らして，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ウ. 憲法第３９条前段は，何人も，実行の時に適法であった行為については刑事上の責任を問われない旨を規定しているが，行為の時に最高裁判所の判例が示していた法解釈に従えば無罪となるべき行為を処罰することは，同規定に違反するものではない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"211"},{year:"2008",num:"10",subject:"ken",q:`憲法第４０条に関する次のアからウまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ウ. 最高裁判所の判例によれば，刑事訴訟法上の手続における無罪の確定裁判に限らず，少年審判手続における不処分決定事件でも，非行事実が認められないことを理由とする不処分決定である場合には，憲法第４０条の「無罪の裁判」に含まれる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"112"},{year:"2008",num:"11",subject:"ken",q:`国民の義務に関する次のアからウまでの各記述について，それぞれ正しい場合には１を，誤って。いる場合には２を選びなさい。
...
ウ. 憲法第３０条は国民の納税義務を定めているが，国際法や条約に基づいて免除される場合を除き，法律の定めるところにより，我が国に居住する外国籍の者から徴税することは違憲ではない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"121"},{year:"2008",num:"12",subject:"ken",q:`国民主権の観念における権力性の契機と正当性の契機に関する次のアからウまでの各記述について，それぞれ理論的に成立するものには１を，成立し難いものには２を選びなさい。
...
ウ. 主権の正当性の契機において，主権の主体である国民は全国民（国籍保持者の総体）を指す。国民を全国民ととらえると，国民主権の原理は，命令的委任に拘束された国民代表制を要請することになる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"112"},{year:"2008",num:"13",subject:"ken",q:`次のアからウまでの各記述について，政党に関する最高裁判所の判例の趣旨に照らして，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 法律上の権利義務関係をめぐる争訟であっても，政党の除名処分の有効性が紛争の前提問題となっている場合には，宗教上の教義や信仰の対象に関する価値判断が前提問題となっている場合と同様，裁判所の審査権は及ばない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"2"},{year:"2008",num:"14",subject:"ken",q:`天皇の国事行為に関する次のアからエまでの各記述について，明らかに誤っているもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 天皇は国会の開会式に参列するが，その際の「おことば」は天皇の象徴としての行為であるとする立場からすると，「おことば」について内閣の補佐は不要である。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"15",subject:"ken",q:`国政調査権に関する次のアからエまでの各記述について，明らかに誤っているもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 団体の規制に関する法改正の要否に関連して，議院における証人の宣誓及び証言等に関する法律に基づき証人として出頭したある団体の代表者は，その個人的な信条を明らかにするように尋問された場合でも，証言を拒むことは許されない。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"16",subject:"ken",q:`内閣及び内閣総理大臣に関する次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 内閣総理大臣は国務大臣の任免権，国務大臣の訴追に対する同意権及び予算の作成・提出権を有するが，これらはすべて内閣総理大臣の専権事項であるので，閣議にかけて決定する必要はない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"8"},{year:"2008",num:"17",subject:"ken",q:`司法権に関する次のアからエまでの各記述について，正しいもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 憲法第８１条は「最高裁判所は，一切の法律，命令，規則又は処分が憲法に適合するかしないかを決定する権限を有する終審裁判所である」と規定しているが，最高裁判所の判例によれば，仮にこの規定がないとすると，最高裁判所に違憲立法審査権を認める余地はない。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"18",subject:"ken",q:`予算及び決算に関する次のアからエまでの各記述について，正しいもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 内閣は，国会及び国民に対し，定期に，少くとも毎年一回，国の財政状況について報告しなければならないが，国会に対しては，毎会計年度予算及び決算を提出しているから，この報告に関しては，成立した予算及び決算を国民に対して報告すれば足りる。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"19",subject:"ken",q:`地方自治に関する次のアからウまでの各記述について，それぞれ正しい場合には１を，誤ってい。る場合には２を選びなさい。
...
ウ. 憲法第９４条は地方公共団体の条例制定権を定めており，地方公共団体は，広義の自治事務に該当する事務であれば，条例により住民の基本的人権に制約を課することも許されるのであって，このこと自体を直ちに違憲ということはできない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"211"},{year:"2008",num:"20",subject:"ken",q:`憲法改正の限界については，理論上限界があるという立場（限界説）と限界がないという立場（無限界説）があるが，次のアからエまでの各記述のうち，限界説からの記述二つの組合せを，後記１から６までの中から選びなさい。 
ア. 憲法制定時の規範・価値によって将来の世代を拘束するのは不当である。
イ. 憲法の妥当性の根拠は，基本的人権の保障を含む根本規範である。
ウ. 憲法規範には実定化された自然法規範が含まれており，それは実定化されても自然法規範としての性質を失わない。
エ. 憲法規範中に価値序列や階層性を認めることはできない。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"21",subject:"gyo",q:`国家賠償法第１条第１項の違法性に関する次のアからウまでの各記述について，最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 税務署長のする所得税の更正は，所得金額を過大に認定していたとしても，そのことから直ちに国家賠償法第１条第１項にいう違法があったとの評価を受けるものではない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"3"},{year:"2008",num:"22",subject:"gyo",q:`損失補償に関する次のアからエまでの各記述について，法令又は最高裁判所の判例に照らし，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
（参照条文）土地収用法
第７１条 収用する土地又はその土地に関する所有権以外の権利に対する補償金の額は，近傍類地の取引価格等を考慮して算定した事業の認定の告示の時における相当な価格に，権利取得裁決の時までの物価の変動に応ずる修正率を乗じて得た額とする。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2122"},{year:"2008",num:"23",subject:"gyo",q:`次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 最高裁判所の判例によれば，職員が通達を違法と考えた場合，その通達に沿った上司の命令に服従すべき義務はなく，服従拒否を理由とする懲戒処分は違法になると解されている。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1212"},{year:"2008",num:"24",subject:"gyo",q:`行政裁量に関する次のアからエまでの各記述について，法令又は最高裁判所の判例に照らし，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
三 前二号に規定する場合の外，その職に必要な適格性を欠く場合
四 職制若しくは定数の改廃又は予算の減少により廃職又は過員を生じた場合
２～４ （略）`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1122"},{year:"2008",num:"25",subject:"gyo",q:`行政指導に関する次のアからエまでの各記述について，明らかに誤っているものの個数を，後記１から５までの中から選びなさい。
...
エ. 行政指導は，相手方の任意の協力を求めるものであるから，法律に根拠がなく，かつ，その行政機関の任務又は所掌事務の範囲を超えるものであっても，その行政機関が行政サービスの目的で行うものである限り，行うことが許される。`,c1:"１．１個",c2:"２．２個",c3:"３．３個",c4:"４．４個",c5:"５．０個",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"26",subject:"gyo",q:`通達に関する次のアからウまでの各記述について，法令又は最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
二 （略）`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"4"},{year:"2008",num:"27",subject:"gyo",q:`法人税法（平成１３年法律第１２９号による改正前のもの。以下同じ。）上の質問検査権に関する最高裁判所平成１６年１月２０日第二小法廷決定（刑集５８巻１号２６頁）の次の判示を読み，後記アからエまでの各記述について，明らかに同決定の考え方と整合しないもの二つの組合せを，後記１から６までの中から選びなさい。
...
ウ. この判決は，原子炉設置許可処分の取消訴訟においては，原子炉施設の安全審査に関する資料をすべて行政庁の側が保持していることなどの点を考慮すると，行政庁の側がその判断に不合理な点がないことの主張，立証責任を負うべきものとしている。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"8"},{year:"2008",num:"29",subject:"gyo",q:`次のアからエは，Ａ欄に掲げる各行政処分についてＢ欄に掲げる各手続等に係る行政手続法の定めが適用されることを示したものである。それぞれ正しい場合には１を，誤っている場合には２を選びなさい。ただし，いずれの行政処分についても，同法の規定が原則どおり適用されるものとする。
Ａ欄　Ｂ欄
ア　営業許可申請に対する不許可処分　弁明の機会の付与、審査基準の設定
イ　営業許可の職権による取消処分　聴聞、理由の提示
ウ　職権による営業停止処分　理由の提示、標準処理期間の設定
エ　職権による法人の役員の解任命令　聴聞、命令等制定手続`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2122"},{year:"2008",num:"30",subject:"gyo",q:`Ａは，国有地である河川区域内の土地について行政庁Ｂから河川法第２４条の占用許可を受けていたが，同法第２６条第１項の許可を受けることなく当該土地上に工作物を設置した。次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
二，三 （略）
２～１０ （略）`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2211"},{year:"2008",num:"31",subject:"gyo",q:`行政機関の保有する情報の公開に関する法律（以下「情報公開法」という。）に関する次のアからウまでの各記述について，法令又は最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
Ｄ. 私法上の行為にすぎないこと
Ｅ. 相手方に対してする法律所定の事由に当たることについての観念の通知にすぎないこと`,c1:"１．Ａ－Ｂ",c2:"２．Ａ－Ｃ",c3:"３．Ａ－Ｄ",c4:"４．Ａ－Ｅ",c5:"５．Ｂ－Ｃ",c6:"６．Ｂ－Ｄ",c7:"７．Ｂ－Ｅ",c8:"８．Ｃ－Ｄ",c9:"９．Ｃ－Ｅ",c10:"10．Ｄ－Ｅ",a:"7"},{year:"2008",num:"34",subject:"gyo",q:`訴えの利益に関する次のアからウまでの各記述について，法令又は最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
学生：建築確認が違法であるとして判決でそれが取り消されれば，その判決の拘束力によって，行政庁は，建築物に関する完了検査についての検査済証の交付を拒否することや違反是正命令を発することを義務付けられますから，建築工事が完了しても，建築確認の取消しを求める訴えの利益は失われないと思います。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1212"},{year:"2008",num:"36",subject:"gyo",q:`次のアからエまでの各訴訟について，それぞれ行政事件訴訟法第４条の「公法上の法律関係に関する確認の訴えその他の公法上の法律関係に関する訴訟」に分類される場合には１を，そうでない場合には２を選びなさい。
...
２～６ （略）
第１７９条 前条第１項の訴えにおいては，特許庁長官を被告としなければならない。ただし，特許無効審判（中略）の審決に対するものにあつては，その審判（中略）の請求人又は被請求人を被告としなければならない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1212"},{year:"2008",num:"37",subject:"gyo",q:`無効等確認訴訟に関する次のアからウまでの各記述について，最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 執行停止について内閣総理大臣の異議の制度があるのと同様に，仮の差止めにおいても内閣総理大臣の異議の制度が設けられている。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"7"},{year:"2008",num:"39",subject:"gyo",q:`住民訴訟に関する次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 住民訴訟を提起した住民が，訴訟の係属中に死亡したときは，その住民の相続人が訴訟を承継することができる。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"4"},{year:"2008",num:"40",subject:"gyo",q:`行政不服審査法に関する次のアからエまでの各記述について，法令又は最高裁判所の判例に照らし，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 原処分を適法と認めて審査請求を棄却する裁決があった場合，当該裁決は処分庁を拘束するから，処分庁は原処分を取り消したり，変更したりすることができない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2212"},{year:"2008",num:"1",subject:"min",q:`信義誠実の原則又は権利濫用禁止の原則に関する次のアからオまでの各記述のうち，権利濫用禁止の原則について述べているものを組み合わせたものは 後記１から５までのうちどれか。
...
オ. 他に連帯保証人があるとの債務者の説明を誤信して連帯保証契約を結んだ者は，特にその旨を表示し保証契約の内容としたのでなければ，錯誤無効を主張することができない。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．ウ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"6",subject:"min",q:"民法上の代理に関する次の１から５までの各記述のうち 誤っているものはどれか。",c1:"１．代理人が本人のためにすることを示さないでした意思表示であっても，代理人が本人のためにすることを相手方において知ることができた場合には，意思表示は本人に帰属する。",c2:"２．自己契約及び双方代理は，債務の履行行為及び本人があらかじめ許諾した行為を除き原則として効力を生じないが，本人の保護のための制度であるから，無権代理行為として，本人が追認すれば有効になる。",c3:"３．代理人が自己又は第三者のために代理権を濫用しても，それが客観的に代理権の範囲にあり，相手方が代理人の意図を知らず，知らないことに過失がないときは，代理人がした意思表示は本人に帰属する。",c4:"４．何らの代理権がない者が代理人と称してした契約であっても，相手方が代理人と称した者に当該契約を締結する権限があると信じ，そのように信じたことにつき正当な理由がある場合には，本人に対してその効力を生じる。",c5:"５．復代理人は，本人の代理人であって代理人の代理人ではないから，復代理人が代理行為をするに当たっては，本人のためにすることを示せば十分である。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"7",subject:"min",q:`時効に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. Ａは，甲建物に対する抵当権設定後，長期にわたりＢに対する賃料の支払を怠った。土地賃借権は，従たる権利として抵当権の目的となっているから，Ｂは土地賃貸借契約を解除することができない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"15",subject:"min",q:`注意義務に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか 
...
オ. 親権者は，善良な管理者の注意をもって子の財産を管理しなければならない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"16",subject:"min",q:`債権者代位権と詐害行為取消権に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか 
...
オ. 法律行為の時に債権者を害する状態であれば，その後の事情によって債権者を害さないこととなっているとしても，詐害行為取消権を行使することができる。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"17",subject:"min",q:`次の【見解】を有する裁判所が，次の【事案】について，詐害行為取消しを認容すべきとの判断に至った場合，Ｙに命ずべき給付等の内容として正しいものは 後記１から５までのうちどれか。
【見 解】
...
オ. 金銭消費貸借上の債務を主たる債務とする法人間の根保証契約において，極度額の定めがないときは，その根保証契約は効力を生じない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"19",subject:"min",q:`弁済の目的物の供託（以下「弁済供託」という。）に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 債務者以外の者は，弁済供託をすることができない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"20",subject:"min",q:`相殺に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 相殺契約においては，両債権が同種の目的を有することは必要ではない。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"21",subject:"min",q:`売主Ｘと買主Ｙとの間の売買契約において手付が交付された場合に関する次のアからエまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から６までのうちどれか。
...
エ. Ｘが手付による解除の抗弁を訴訟において主張する場合，Ｙは，ＸとＹが解除権の留保をしない旨の合意をしたこと，又は，Ｘ若しくはＹがＸの解除の意思表示に先立ち履行に着手したことを再抗弁とすることができる。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．ア エ",c4:"４．イ ウ",c5:"５．イ エ",c6:"６．ウ エ",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"22",subject:"min",q:"売買契約に基づき売買代金の支払を請求する場合に関する次の１から５までの各記述のうち，誤っているものを２個選びなさい。",c1:"１．原告は，請求原因において被告との間で売買契約を締結したことを主張する必要があるが，売買契約締結当時，その目的物が原告の所有であったことを主張する必要はない。",c2:"２．法律行為の附款である条件をそれが付された法律行為の成立要件とは区別される可分なものと考える見解に立った場合，売買契約に停止条件が付されているときは，停止条件が成就したことが再抗弁となる。",c3:"３．法律行為の附款である期限をそれが付された法律行為の成立要件とは区別されない不可分なものと考える見解に立った場合，売買契約に弁済期が定められているときは，弁済期が到来していないことが抗弁となる。",c4:"４．被告が抗弁として同時履行の抗弁を主張した場合，原告は，代金支払を目的物引渡しの先履行とする旨の合意があったことを再抗弁として主張することができる。",c5:"５．被告が抗弁として同時履行の抗弁を主張した場合，原告は，目的物引渡しにつき，その履行の提供をしたことを再抗弁として主張することができる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"35"},{year:"2008",num:"23",subject:"min",q:"準消費貸借契約に関する次の１から５までの各記述のうち，判例の趣旨に照らし誤っているものはどれか。",c1:"１．旧債務に付着していた同時履行の抗弁権が消滅するか否かは，準消費貸借契約を締結した当事者において，新旧債務の同一性を維持する意思があるか否かによって決定される。",c2:"２．旧債務の消滅時効期間が２年間である場合，準消費貸借契約の成立によって発生する新債務の消滅時効期間は，準消費貸借契約の締結が商行為に該当するとしても２年間である。",c3:"３．将来において発生する金銭債務を目的としても，準消費貸借契約は成立する。",c4:"４．既存の消費貸借契約上の債務を旧債務としても，準消費貸借契約は成立する。",c5:"５．準消費貸借契約は，目的とされた旧債務が存在しないときにはその効力を生じない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"24",subject:"min",q:"賃貸借契約に関する次の１から５までの各記述のうち 誤っているものを２個選びなさい。",c1:"１．賃貸借契約は有償契約であり，賃料を伴う点で使用貸借と区別することができるから，借主が金銭を支払うことを約束して契約を締結すれば，その額の多寡にかかわらず賃貸借契約が成立する。",c2:"２．判例の趣旨に照らすならば，不動産の賃借人が賃貸借について対抗要件を具備した場合には，賃借物を権原なく占有する第三者に対し，賃借権に基づき妨害排除請求権を行使することができる。",c3:"３．建物所有を目的とする土地の賃借人が，当該土地上に建物を建築した後，賃貸人の承諾を得ずに建物を第三者に賃貸し，第三者が実際に建物の使用を開始した場合には，土地の賃貸人は，土地の賃借人に対し，土地の無断転貸を理由として土地の賃貸借契約を解除することができる。",c4:"４．賃貸借契約の目的物である建物の全部が，契約成立後に不可抗力によって滅失したときは，賃貸借契約は履行不能により終了する。",c5:"５．建物の賃借人が 賃貸人が修繕すべき屋根からの雨漏りを自ら費用を出して修繕したときは，，賃貸人に対して，直ちに修繕費用全額の償還を請求することができる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"13"},{year:"2008",num:"25",subject:"min",q:"敷金の取扱いに関する次の１から５までの各記述のうち，判例の趣旨に照らし誤っているものはどれか。",c1:"１．建物賃貸借契約において，当該建物の所有権移転に伴い賃貸人たる地位に承継があった場合には，旧賃貸人に差し入れられた敷金は，未払賃料債務があればこれに当然充当され，残額についてその権利義務関係が新賃貸人に承継される。",c2:"２．建物賃貸借における敷金は，賃貸借終了後建物明渡義務履行までに生ずる賃料相当額の損害金債権その他賃貸借契約により賃貸人が賃借人に対して取得する一切の債権を担保するものであり，敷金返還請求権は，賃貸借終了後建物明渡完了の時においてそれまでに生じた上記の一切の被担保債権を控除しなお残額がある場合に，その残額につき具体的に発生する。",c3:"３．土地賃借権が賃貸人の承諾を得て旧賃借人から新賃借人に移転された場合であっても，敷金に関する敷金交付者の権利義務関係は，敷金交付者において賃貸人との間で敷金をもって新賃借人の債務の担保とすることを約し又は新賃借人に対して敷金返還請求権を譲渡するなど特段の事情のない限り，新賃借人に承継されない。",c4:"４．敷金が授受された賃貸借契約に係る賃料債権につき抵当権者が物上代位権を行使してこれを差し押さえた場合において，当該賃貸借契約が終了し，目的物が明け渡されたとしても，それまでに生じた賃料債権が，敷金の充当によって消滅することはない。",c5:"５．建物賃貸借終了に伴う賃借人の建物明渡債務と賃貸人の敷金返還債務とは，特別の約定のない限り，同時履行の関係に立たず，賃貸人は，賃借人から建物明渡しを受けた後に敷金残額を返還すれば足りる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"26",subject:"min",q:"民法上の契約における報酬に関する次の１から５までの各記述のうち，誤っているものはどれか。",c1:"１．雇用契約は有償契約であり，報酬の支払時期は，後払いが原則であるが，前払の特約を結ぶこともできる。",c2:"２．請負契約は有償契約であり，報酬は，目的物の引渡しを要するときはその引渡しと引換えに，物の引渡しを要しないときは仕事の完成と引換えに，支払わなければならない。",c3:"３．委任契約は無償契約を原則とするが，特約があれば，受任者は委任者に対して報酬を請求することができる。",c4:"４．寄託契約において報酬の合意をした場合，寄託が不可抗力によって履行の中途で終了したときは，受寄者は，既にした履行の割合に応じて報酬を請求することができる。",c5:"５．労働者は，その有する報酬債権の担保として，使用者の総財産について先取特権を有する。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"27",subject:"min",q:`民法上の組合に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 組合員は清算前に組合財産の分割を求めることができず，また，組合員が組合財産についての持分を処分しても，その処分を組合に対抗することができない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"28",subject:"min",q:`不法行為に基づく損害賠償を請求した場合の被告の抗弁に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 原告が土地の所有者を被告として，民法第７１７条第１項ただし書の土地の工作物等の所有者の責任に基づいて損害賠償を請求した場合，被告は，結果の発生を防止するために必要な注意義務を尽くしたことを抗弁として主張することはできないが，自己の責任無能力を抗弁として主張することはできる。`,c1:"１．ア ウ",c2:"２．イ エ",c3:"３．イ オ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"29",subject:"min",q:`不法行為における過失相殺に関する次のアからエまでの各記述のうち，判例の趣旨に照らし誤っているものはどれか 
...
オ. 株主総会で株主から特定の事項について説明を求められた場合において，当該事項について説明をするために調査をすることが必要であるときは，当該株主が株主総会の日より相当の期間前に当該事項を当該会社に通知していたとしても，取締役は，当該株主総会において，説明をする必要はない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"41",subject:"syo",q:`取締役に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 甲株式会社の取締役会は，取締役の職務の執行が法令及び定款に適合することを確保するための体制の整備の決定をＡに委任することができる。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2008",num:"43",subject:"syo",q:`監査役又は監査役会に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 監査役会において会社の業務及び財産の状況の調査の方法の決定をした場合，監査役は，その権限の行使に当たり，当該決定に従わなければならない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"44",subject:"syo",q:`会計参与に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 委員会設置会社でない株式会社において，会計参与は，計算書類及びその附属明細書の作成に際し，代表取締役と意見が一致しないときは，その旨を当該計算書類又は附属明細書に記載することができる。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"45",subject:"syo",q:`委員会設置会社に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 判例によれば，営業所としての実質がない場所を営業所と称し，そこに置いた使用人に支配人類似の名称を付している場合には，この使用人は表見支配人に該当する。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"51",subject:"syo",q:`商行為によって生じた債務に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 当該債務が商人間における金銭の消費貸借によって生じたものであるときは，貸主は，約定をしなくとも，当該債務につき，法定利率による利息を請求することができる。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"52",subject:"syo",q:`匿名組合に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 匿名組合契約は，匿名組合員又は営業者が死亡し，又は破産手続開始の決定を受けたことにより，終了する。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"53",subject:"syo",q:`為替手形，約束手形及び小切手に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 請求の原因に関する中間判決がなされた場合，中間判決に接着する口頭弁論終結前に存在していた事実であっても，これを主張しなかったことにつき相当の理由があることの証明があったときは，当該審級においてその事実を主張して中間判決で示された判断を争うことが許される。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"64",subject:"mso",q:`証明と疎明に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 補助参加の申出は，参加的効力が及ぶ被参加人の同意がなければ，取り下げることができない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2008",num:"72",subject:"mso",q:`再審に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 甲は，乙を逃走させるため，丙の背部をいきなり足で蹴って転倒させたが，乙は観念していたので逃走しなかった。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"5",subject:"kei",q:`次の【事例】に関する後記アからオまでの各【記述】を判例の立場に従って検討した場合，正しいものの組合せは，後記１から５までのうちどれか。
【事 例】
...
オ. 甲と乙が，共同して丙に傷害を負わせる意思をもってけん銃を発射した場合，甲及び乙には傷害致死罪の共同正犯が成立する。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2008",num:"6",subject:"kei",q:`次の【事例】における甲の罪責について，「甲には犯人隠避教唆罪及び証拠偽造教唆罪が成立し，両罪は観念的競合となる。」との結論に達した場合，後記アからオまでの【論点と見解】のうち，この結論を導くための論拠となり得ないものの組合せは，後記１から５までのうちどれか。
【事 例】
...
オ. 犯人隠避罪と証拠偽造罪の罪数関係について，両者の保護法益は，広義においては国家の刑事司法作用を保護するものであるが，前者は犯人の確保の観点から，後者は適正な証拠の収集の観点から，それぞれこれを妨害する行為を処罰するものであって，保護法益が異なることを重視する見解`,c1:"１．ア イ ウ",c2:"２．ア ウ エ",c3:"３．ア エ オ",c4:"４．イ ウ オ",c5:"５．イ エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"7",subject:"kei",q:`次のアからオまでの各記述を判例の立場に従って検討した場合，正しいものの組合せは，後記１から５までのうちどれか。
...
オ. 甲は，客観的にはわいせつな文書を，その意味内容は理解したものの，その程度の性的描写であれば刑法上の「わいせつな文書」には該当しないと判断し，同文書を販売した。この場合，甲にはわいせつ文書販売罪は成立しない。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．ウ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"8",subject:"kei",q:`甲の罪責についての次の１から５までの各記述を判例の立場に従って検討し，正しい場合には１を，誤っている場合には２を選びなさい。
...
５. 甲は，乙に１００万円を貸したが，乙が甲に借用証を渡さなかったので，乙が返済しなかった場合に証拠として使おうと考え，乙に無断で乙の氏名を記載し，乙名義の１００万円の借用証を作成した。文書の内容が真実であるから，甲には有印私文書偽造罪は成立しない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"21122"},{year:"2008",num:"9",subject:"kei",q:`次の【事例】について，学生Ａ及びＢが後記【会話】のとおり議論している。【会話】中の①から③までの（ ）内に入る学生Ａの発言として正しいものを後記【発言】から選んだ場合，正しいものの組合せは，後記１から５までのうちどれか。
【事 例】
...
ウ. 私の立場からは，あたかも身分のない故意ある道具の利用の場合と規範的意味において同じように考え，心神耗弱状態を利用した場合にも原因において自由な行為の理論を認めることができると思う。`,c1:"１．①ア ②イ ③ウ ",c2:"２．①ウ ②ア ③イ",c3:"３．①ア ②ウ ③イ",c4:"４．①ウ ②イ ③ア",c5:"５．①イ ②ア ③ウ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"10",subject:"kei",q:`次のアからオまでの各記述を判例の立場に従って検討した場合，正しいものの組合せは，後記１から５までのうちどれか。
...
オ. 甲は，乙を自宅に招いて毒入りの菓子を食べさせて毒殺しようと考え，菓子に致死量の毒薬を混入し，乙に自宅に招待する旨の電話をしたが，乙が多忙を理由にこれを断ったため，乙を殺害することができなかった。（殺人罪）`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"11123"},{year:"2008",num:"12",subject:"kei",q:`次のアからオまでの各事例における甲の罪責を検討した場合，危険運転致死罪が成立するものの組合せとして正しいものは，後記１から５までのうちどれか。
...
オ. 甲は，自動車を運転中，長距離運転の過労から眠気を覚えたにもかかわらず，その状態のままあえて運転を続けたため，運転中に眠り込んでしまい，自車を進路左前方の歩道に進入させ，歩道上の歩行者に衝突させて同人を死亡させた。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2008",num:"13",subject:"kei",q:`学生Ａ，Ｂは，不能犯の成否の判断基準に関する次のⅠ，Ⅱの【見解】のいずれかを採って後記【事例】について後記【会話】のとおり議論している。【会話】中の①から⑦までの（ ）内から適切な語句を選んだ場合，後記１から５までのうち誤りを含むものはどれか。
【見 解】
...
オ. 保釈保証金の没取決定の可否
カ. 公判前整理手続に付する決定の可否
キ. 第一審の公判期日における被告人の出頭義務の有無`,c1:"１．ア エ キ",c2:"２．ア オ カ",c3:"３．イ ウ キ",c4:"４．イ オ カ",c5:"５．ウ エ カ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2008",num:"22",subject:"kso",q:`任意捜査と強制捜査の区別に関する次の【記述】の①から⑬までの（ ）内には，「任意」又は「強制」のいずれかの語句が入る。②，④，⑦及び⑪の（ ）内に入る語句の組合せとして正しいものは，後記１から６までのうちどれか。
【記 述】
...
エ. Ｖは，自宅から自己の所有する宝石が盗まれたとして，親族でない甲を窃盗の罪で告訴した。捜査の結果，甲がＶの別居中の弟乙とともに窃盗に及んだことが判明した場合，Ｖの告訴の効力は，乙に対しても及ぶ。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2008",num:"24",subject:"kso",q:`緊急逮捕に関する次のアからオまでの各記述のうち，正しいものの組合せは，後記１から５までのうちどれか。なお，死体遺棄罪（刑法第１９０条）の法定刑は，３年以下の懲役である。
...
オ. 身柄を拘束されていない被疑者を採尿場所へ任意に同行することが事実上不可能であると認められる場合には，強制採尿のための捜索差押令状の効力として，採尿に適する最寄りの場所まで被疑者を連行することができる。`,c1:"１．ア イ ウ",c2:"２．ア イ エ",c3:"３．ア ウ エ",c4:"４．イ ウ エ",c5:"５．イ ウ オ",c6:"６．ウ エ オ",c7:"",c8:"",c9:"",c10:"",a:"6"},{year:"2008",num:"28",subject:"kso",q:`公訴の提起前における押収及び捜索に関する次のアからオまでの各記述のうち，正しいものの組合せは，後記１から５までのうちどれか。
...
オ. 公判前整理手続に付された事件については，被告人又は弁護人は，証拠により証明すべき事実その他の事実上及び法律上の主張があるときは，証拠調べのはじめに行われる検察官の冒頭陳述に引き続き，これを明らかにしなければならない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"11221"},{year:"2008",num:"33",subject:"kso",q:`検察官は，ハンマーを凶器とする傷害被告事件の証拠として，犯行を目撃したＷの検察官に対する供述調書及び犯行に使用されたとされるハンマーの証拠調べを請求した。この場合に関する次のアからオまでの各記述のうち，正しいものの組合せは，後記１から５までのうちどれか。
...
カ. Ⅱの考え方に立ったとき，甲が常習としてａ事件を犯したものであるか否かを判断するために，ｂ事件の存在を考慮することは許されない。`,c1:"１．ア ウ カ",c2:"２．ア エ オ",c3:"３．ア オ カ",c4:"４．イ エ オ",c5:"５．ウ エ カ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2008",num:"38",subject:"kso",q:`刑事訴訟法第３２６条第１項の「同意」に関する次のアからエまでの各記述につき，正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 証拠の明白性は，もし申立てに係る証拠が確定判決を下した裁判所の審理中に提出されていたとするならば，果たしてその確定判決においてなされたような事実認定に到達したであろうかどうかという観点から，当の証拠と他の全証拠と総合的に評価して判断すべきである。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．イ エ",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"1",subject:"ken",q:`次の文章は，「法の支配」に関するものである。ＡからＤまでの各空欄に，後記１から８までの中から適切なものを補充して，文章を完成させなさい。
...
７. 基本的人権
８. 憲法第１２条に規定されているように「常に公共の福祉のためにこれを利用する責任を負ふ」`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5736"},{year:"2007",num:"2",subject:"ken",q:`障害福祉年金の受給資格について国籍要件を課すことは，憲法第１４条第１項，第２５条に違反しないとした最高裁判所の判決（最高裁判所平成元年３月２日第一小法廷判決，判例時報１３６３号６８頁）に関する次のアからエまでの各記述について，正しいもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. この判決は，社会保障上の施策において在留外国人をどのように処遇するかは，立法府の広い裁量に委ねられており，国は特別の条約の存しない限り，その政治的判断によりこれを決定できるという考え方を前提としている。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"3",subject:"ken",q:`私人間における人権保障に関する次のアからエまでの各記述について，明らかに誤っているもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 学説における人格的利益説の場合，どのような権利・自由が「人格的生存にとって不可欠な利益」であるかは 必ずしも明らかでない。例えば，自己決定権としての髪型の自由について，人格的利益説を採る論者の間でも「人格的生存にとって不可欠な利益」であるか否か，見解が分かれる。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"6"},{year:"2007",num:"5",subject:"ken",q:`法の下の平等に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 女性のみに再婚禁止期間を定める民法第７３３条の立法趣旨は，父性推定の重複の回避と父子関係をめぐる紛争の防止にあるという判例（最高裁判所平成７年１２月５日第三小法廷判決）の理解からすると，立法当時に比べて父子関係の立証がはるかに容易になっている現状の下でも，立法目的の合理性を肯定することは可能である。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1211"},{year:"2007",num:"6",subject:"ken",q:`政教分離原則に関する次のアからエまでの各記述について，最高裁判所の判例に照らして，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 神社自体がその境内において挙行する恒例の祭祀に際して地方公共団体が玉串料等を奉納することは，建築主が主催して建築現場において土地の平安堅固，工事の無事安全等を祈願するために行う儀式である起工式の場合とは異なり，既に慣習化した社会的儀礼にすぎないものになっているとはいえない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2121"},{year:"2007",num:"7",subject:"ken",q:`次の文章は，いわゆる泉佐野市市民会館事件判決（最高裁判所平成７年３月７日第三小法廷，民集４９巻３号６８７頁）の判示を要約したものである。後記の小問１及び２に答えなさい。
...
３. 「風俗を害すべき書籍，図画，彫刻物その他の物品」を輸入禁制品として掲げる関税定率法の規定が憲法第２１条に違反しないとした判決。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"33"},{year:"2007",num:"8",subject:"ken",q:`居住・移転の自由に関する次の文章の空欄アからオまでに，後記ａからｊまでの各文から適切なものを選択して文章を完成させる場合の正しい組合せを，後記１から６までの中から選びなさい。
...
（ア，イ，ウ，エ，オの順とする）`,c1:"１．ｆ – ｄ – ｈ – ｉ – ｂ ",c2:"２．ｆ – ｄ – ｈ – ｃ – ｂ ",c3:"３．ａ – ｄ – ｈ – ｃ – ｂ",c4:"４．ａ – ｊ – ｅ – ｃ – ｇ ",c5:"５．ａ – ｊ – ｅ – ｉ – ｇ ",c6:"６．ｆ – ｊ – ｅ – ｉ – ｇ",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"9",subject:"ken",q:`学問の自由に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤って。いる場合には２を選びなさい。 
...
エ. 最高裁判所の判例によれば，学問の自由は教授の自由を含み，普通教育における教師に対しても一定の範囲における教授の自由が保障されるが，大学教育と異なり普通教育においては教師に完全な教授の自由は認められない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2211"},{year:"2007",num:"10",subject:"ken",q:`生存権に関する次のアからウまでの各記述について，最高裁判所の判例に照らして，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
エ. 国家公務員法の規制をめぐる全農林警職法事件（最高裁判所昭和４８年４月２５日大法廷判決）において，最高裁判所は，全逓東京中郵事件判決を変更する旨述べ，「公務員の地位の特殊性と職務の公共性」論，公務員の勤務条件に関する「財政民主主義」論を根拠にして，公務員の争議行為の一律禁止を合憲とした。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1212"},{year:"2007",num:"12",subject:"ken",q:`政党に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 法律上は，政党法を始めとして，政治資金規正法，政党助成法，政党交付金の交付を受ける政党等に対する法人格の付与に関する法律，公職選挙法などの法律で，それぞれの法律の目的に応じて政党に関する規定が置かれている。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2112"},{year:"2007",num:"13",subject:"ken",q:`憲法第９条に関する次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
オ. 憲法は，会期制を前提として「一事不再議の原則」を規定しているが，その例外として，法律案について衆議院が再議決することを認めている。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．アとオ",c5:"５．イとウ",c6:"６．イとエ",c7:"７．イとオ",c8:"８．ウとエ",c9:"９．ウとオ",c10:"10．エとオ",a:"5"},{year:"2007",num:"15",subject:"ken",q:`内閣に関する次のアからエまでの各記述について，正しいもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 裁判官の定年は，憲法第７９条第５項，第８０条第１項により，法律で定められることになっているが，法律で定められた年齢を引き下げ，その年齢に達しているすべての裁判官を退官させることは，憲法第７８条の趣旨に照らして許されない。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"17",subject:"ken",q:`次の文章は，選挙権行使の保障に関する最高裁判所の二つの判決に関するものである。ＡからＤまでの各空欄に，後記１から６までの中から適切なものを補充して 文章を完成させなさい。なお ，同じ記号には，同じ文章が入るものとする。
...
６. 平成１０年の公職選挙法改正で在外選挙制度が創設されたが，その対象が衆議院と参議院の比例代表選挙に限られている点で，遅くとも本判決言渡し後に初めて行われる衆議院議員の総選挙又は参議院議員の通常選挙の時点において，憲法に違反する`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2364"},{year:"2007",num:"18",subject:"ken",q:`市町村の国民健康保険条例に保険料率などの具体的規定がないことと租税法律主義を定めた憲法第８４条との関係について判示した最高裁判所の判決 最高裁判所平成１８年３月１日大法廷判決（，民集６０巻２号５８７頁）に関する次のアからエまでの各記述について，正しいもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. この判決は，保険料率算定の基礎となる賦課総額の算定基準及び賦課総額に基づく保険料率の算定方法が賦課期日までに明らかにされているとしても，具体的な各年度の保険料率をそれぞれ各年度の賦課期日後に告示するとすれば，憲法第８４条に反し，許されないこととなるとした。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2007",num:"19",subject:"ken",q:`地方自治に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤ってい。る場合には２を選びなさい。
...
エ. 憲法第９２条は，地方自治の基本原則について定めているが，地方公共団体の長に対する住民による条例の制定又は改廃についての直接請求制度を設けることは，地方自治の本旨の一内容である団体自治を実現するものとして認められる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1212"},{year:"2007",num:"20",subject:"ken",q:`条約に関する次のアからオまでの各記述について，明らかに誤っているもの三つの組合せを，後記１から10までの中から選びなさい。
...
ウ. 国家賠償法第２条第１項の営造物の設置又は管理の瑕疵とは，利用者にとって営造物が通常有すべき安全性を欠いている状態をいうのであって，同項の規定は当該営造物の利用者以外の者に対しては適用されない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"8"},{year:"2007",num:"22",subject:"gyo",q:`損失補償について判示した最高裁判所の判決に関する次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 上級行政庁の下級行政庁に対する指揮監督権には，一般に，下級行政庁の行った違法・不当な行為の取消し又は停止を当該下級行政庁に命ずる権限も含まれる。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"7"},{year:"2007",num:"24",subject:"gyo",q:`行政法上の諸原則に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
③ 都道府県知事は，第１項の許可に５年を下らない有効期間その他の必要な条件を付けることができる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1222"},{year:"2007",num:"26",subject:"gyo",q:`行政事件訴訟法第３条第２項にいう「行政庁の処分その他公権力の行使に当たる行為」に関する次のアからエまでの各記述について，最高裁判所の判例に照らし，明らかに誤りであるものの個数を，後記１から４までの中から選びなさい。
ア. 国又は地方公共団体に属する機関がする行為でなければならない。
イ. 相手方の権利を制限し，又は義務を課する行為でなければならない。
ウ. 行政手続法にいう「不利益処分」又は「申請に対する処分」に該当する行為でなければならない。
エ. 国又は地方公共団体以外の者を名宛人とする行為でなければならない。`,c1:"１．１個",c2:"２．２個",c3:"３．３個",c4:"４．４個",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"27",subject:"gyo",q:`行政指導に関する次のアからエまでの各記述について，最高裁判所の判例に照らし，明らかに誤りであるものの個数を，後記１から５までの中から選びなさい。
...
エ. 行政指導は，法的拘束力がなく，国民の権利利益に直接の影響を及ぼすものではないが，国家賠償法第１条の「公権力の行使」として違法とされる場合がある。`,c1:"１．１個",c2:"２．２個",c3:"３．３個",c4:"４．４個",c5:"５．０個",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"28",subject:"gyo",q:`Ａは，公衆浴場法の許可を行政庁Ｂから得て公衆浴場を経営している。あるとき，Ｂの職員ＣがＡの公衆浴場に現れ，公衆浴場法第６条第１項に基づく立入検査を実施するとＡに告げた。次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
第９条 第６条第１項の規定による報告をせず，若しくは虚偽の報告をし，又は当該吏員の立入検査を拒み，妨げ，若しくは忌避した者は，これを２千円以下の罰金に処する。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2222"},{year:"2007",num:"29",subject:"gyo",q:`次のアからエまでの記述の中から，現在の法令及び最高裁判所の判例に照らして正しいものを選びなさい。
...
エ. 行政機関の保有する個人情報の保護に関する法律によれば，国の行政機関は，自らが特定した利用目的の達成に必要な範囲を超えて個人情報を保有してはならないとされている。`,c1:"１．ア",c2:"２．イ",c3:"３．ウ",c4:"４．エ",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"30",subject:"gyo",q:`行政手続法第６章（意見公募手続等）に関する次のアからエまでの各記述について，明らかに誤りであるものの個数を，後記１から５までの中から選びなさい。
...
エ. 意見公募手続の規定は，行政上の規制に係る命令等を対象としており，行政上の給付に係る命令等を定める場合には適用がない。`,c1:"１．１個",c2:"２．２個",c3:"３．３個",c4:"４．４個",c5:"５．０個",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"31",subject:"gyo",q:`行政代執行法による代執行に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 代執行による履行確保の対象となる義務は，法律に基づくものに限られ，法律の委任に基づく条例による処分によって課される義務については，代執行を行うことはできない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1212"},{year:"2007",num:"32",subject:"gyo",q:`Ａは，自己所有建物の増築について建築基準法による確認を受けたが，その内容と異なり建築基準法令の規定に違反する工事を行ったとして，Ｂ県知事から工事停止命令を受け，その後，更に違反建築部分についての除却命令を受けた。しかし，Ａは，これらの命令に従わないで建築を続行している。隣地の自宅に居住するＣは，上記工事により，自宅とその敷地への日照がほとんど遮断され，通風も悪くなり，生活条件が著しく悪化する被害を受けるに至ったと主張している。この場合において，次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
オ. 情報公開条例においては，当該地方公共団体の長等が法律に基づいて行う行政処分に関する文書であっても，当該地方公共団体が保有するものであれば，開示請求権制度の対象とすることができる。`,c1:"１．ア",c2:"２．イ",c3:"３．ウ",c4:"４．エ",c5:"５．オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"34",subject:"gyo",q:`自動車運転免許に係る処分についての訴えの利益に関して述べた次のアからウまでの各記述の中から，最高裁判所の判例に照らして正しいものを選びなさい。
...
ウ. 運転免許効力停止処分の前歴があることにより，名誉，感情，信用等を損なう可能性が継続して存在するとしても，それは処分がもたらす事実上の効果にすぎないものであるから，処分の取消しを求める訴えの利益があることの根拠とするのは相当でない。`,c1:"１．ア",c2:"２．イ",c3:"３．ウ",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"35",subject:"gyo",q:`最高裁判所平成１７年１２月７日大法廷判決（小田急線連続立体交差事業認可処分取消請求事件）の次の判示を読み，同判決に関する後記アからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 課税処分をした税務署長が，その税の滞納処分として納税義務者の財産を差し押さえていたときに，その課税処分が取消訴訟の判決により取り消され，それが確定したときは，税務署長は，滞納処分を続行してはならない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"5"},{year:"2007",num:"37",subject:"gyo",q:`行政事件訴訟法上の取消訴訟に関する次のアからエまでの各記述について，法令及び最高裁判所の判例に照らし，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 取消訴訟における行政処分の違法判断の基準時は，行政処分がされた時点であると解すべきであるから，処分の適法性の判断に用いられる科学的，専門技術的知見も，処分当時のものに限定される。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2212"},{year:"2007",num:"38",subject:"gyo",q:`行政事件訴訟の類型に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 機関訴訟とは，国又は公共団体の機関相互間における権限の存否又はその行使に関する紛争についての訴訟であり，法律に定める場合において，法律に定める者に限り，提起することができる。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2111"},{year:"2007",num:"39",subject:"gyo",q:`仮の救済に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。 
...
エ. 内閣総理大臣の異議は，裁判所が執行停止の決定を行う前にこれを述べなければならず，いったん執行停止の決定がなされた後はもはやこれを述べることは許されない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1112"},{year:"2007",num:"40",subject:"gyo",q:`行政不服審査及び行政事件訴訟に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. Ａが成年被後見人であった場合，ＢがＡの成年後見人Ｃに対して１か月の期間内にＡの行為を追認するか否かを確答すべきことを催告し，Ｃがこの期間内に確答を発しなかったときは，Ａの行為を取り消したものとみなされる。`,c1:"１．ア",c2:"２．イ",c3:"３．ウ",c4:"４．エ",c5:"５．誤っているものはない",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"4",subject:"min",q:`条件及び期限に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 留置権者が留置物の占有を継続している間であっても，その被担保債権についての消滅時効は進行する。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．ウ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"7",subject:"min",q:"次の１から５までの各記述のうち，正しいものを２個選びなさい。",c1:"１．判例によれば，建物は，屋根瓦を葺き荒壁を塗り床及び天井を張る等して初めて独立した不動産となる。",c2:"２．建物の増築部分は，既存建物の従物である。",c3:"３．家具の所有者ＡがＢに賃貸中の当該家具をＣに売却した場合，特約がなければ，Ｃは，直ちにその所有権を取得するから，Ｂに対する賃料債権も，Ｃが売買契約時に取得することになる。",c4:"４．一筆の土地を贈与する契約において，物権行為の独自性を認める立場では，２つの法律行為が存在することになる。",c5:"５．判例によれば，物の売買契約を結ぶ以前の段階において，将来の売買代金債権を売却し，対抗要件を備えることは可能である。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"45"},{year:"2007",num:"8",subject:"min",q:`相続と登記に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 元本の確定した根抵当権は，確定した元本のほか，利息その他の定期金のうち満期となった最後の２年分について，極度額を限度として担保する。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"14",subject:"min",q:"物上代位に関する次の１から５までの各記述のうち，判例の趣旨に照らし誤っているものはどれか。",c1:"１．動産売買の先取特権を有する者は，債務者が第三者に先取特権の目的物を売却した場合，その転売代金債権について，物上代位権を行使することができる。",c2:"２．動産売買の先取特権を有する者は，物上代位権行使の目的である債権について，一般債権者が差押えをした後であっても，物上代位権を行使することができる。",c3:"３．抵当権に基づく物上代位の目的債権が譲渡され，第三者に対する対抗要件が備えられた場合であっても，それより前に抵当権が設定され，第三者に対する対抗要件が備えられていたならば，抵当権者は，自ら目的債権を差し押さえて物上代位権を行使することができる。",c4:"４．抵当権者は，抵当不動産の賃借人を所有者と同視することを相当とする場合を除き，その賃借人が取得する転貸賃料債権について物上代位権を行使することができない。",c5:"５．抵当権者が，物上代位権を行使して，抵当不動産の賃貸借契約に基づく未払の賃料債権の全額を差し押えた場合，当該不動産の賃借人と賃貸人の間で敷金が授受されていて，かつ，賃貸借契約が終了し，賃借人が不動産を明け渡したとしても，敷金は未払の賃料に充当されない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"15",subject:"min",q:`根抵当権でない抵当権に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. Ｘが所有する甲不動産について，Ｙに対して抵当権を設定して金銭を借り入れるとともに，Ａが，ＸのＹに対する借入れ債務を担保するため，Ｙとの間で連帯保証契約を結んだ場合，Ａが借入れ債務を全額弁済したとしても，Ｘは，Ｙに対して，抵当権設定登記の抹消を求めることはできない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"16",subject:"min",q:"抵当権の法律関係に関する次の１から５までの各記述のうち 誤っているものはどれか。",c1:"１．抵当権が設定された建物を，抵当権者に対抗することができない賃貸借に基づいて使用する者は，競売手続開始前から使用していれば，建物の買受人が買い受けた時から６か月を経過するまでは，その建物の買受人への引渡しを猶予される。",c2:"２．登記をした賃貸借は，その登記前に登記をした抵当権を有するすべての者が同意をすれば，その同意をした抵当権者に対抗することができる。",c3:"３．土地に抵当権が設定された当時，その土地に建物が築造されていた場合，その建物の所有者が，その土地を占有するについて抵当権者に対抗することができる権利を有しないとしても，抵当権者は，土地とともに建物を競売することはできない。",c4:"４．抵当権が設定された不動産について，地上権の設定を受けた者は，抵当権消滅請求をすることができない。",c5:"５．被担保債権の債務不履行後に，抵当不動産の所有者が，その後に生じた果実を収受しても，不当利得にはならない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"17",subject:"min",q:"契約上の債務の不履行の場合における当該債務の履行の強制に関する次の１から５までの各記述のうち，誤っているものを２個選びなさい。",c1:"１．履行の強制を求めるとともに，損害賠償を請求できる場合がある。",c2:"２．履行の強制を求めることができず，損害賠償の請求のみできる場合がある。",c3:"３．代替執行が可能なときには，間接強制を求めることはできない。",c4:"４．履行の強制を求めることも，損害賠償の請求もできない場合がある。",c5:"５．意思表示を命ずる確定判決の執行は間接強制による。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"35"},{year:"2007",num:"18",subject:"min",q:`次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 建物賃借人は，その賃借権を保全するために，建物の賃貸人である借地権者が土地賃貸人に対して有する建物買取請求権を代位行使することができる。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"19",subject:"min",q:`詐害行為取消権に関する次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 不動産が債務者から受益者へ，受益者から転得者へと順次譲渡された場合において，債権者が，債務者の一般財産を回復させるため，受益者を被告として，債務者と受益者との間の譲渡行為を詐害行為として取り消すときは，価格賠償を請求しなければならない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ オ",c4:"４．ウ エ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"20",subject:"min",q:`弁済による代位に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 一つの債権の一部につき代位弁済がされた場合，その債権を被担保債権とする抵当権の実行による競売代金の配当については，代位弁済者は債権者に劣後する。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"21",subject:"min",q:`次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. ＡのＢに対する債権につき譲渡禁止特約が存在することを知って，ＣがＡからその債権を譲り受けた後，Ｂが承諾をすれば，ＡＣ間の債権譲渡は，Ｂの承諾の時から有効になる。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"22",subject:"min",q:`Ａは，Ｂに対し甲動産を売却したが，Ｂが代金を支払わないので，Ａは，その支払を求めて訴えを提起した。この事例に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. Ｂによる同時履行の抗弁の主張が認められる場合，Ｂは，Ａに対し，Ａから甲動産の引渡しを受けるのと引換えに代金を支払うべき旨が，判決主文に記載されなければならない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2007",num:"23",subject:"min",q:`履行遅滞による契約解除のための催告に関する次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 履行すべき相当の期間を定めない催告も有効であり，催告の後，客観的に見て相当な期間を，経過すれば解除権が発生する。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"24",subject:"min",q:"Ａは その所有する甲土地をＢに売却する契約（以下「本契約」という。）を結び ＢはＡに手付を交付した。Ａ又はＢが手付により解除することができるかどうかに関する次の１から４までの各記述のうち，判例の趣旨に照らし正しいものはどれか 。",c1:"１．Ａが解除する場合，Ａが手付の倍額をＢに提供しなくても，本契約を手付により解除する旨の通知がＢに到達した時，解除の効果が発生する。",c2:"２．甲土地は乙土地の一部であったが Ａが乙土地から甲土地を分筆する登記手続をしたときは，，Ｂは，本契約を手付により解除することはできない。",c3:"３．Ｂが手付のほか内金をＡに支払った後に，Ｂが本契約を手付により解除する場合，Ｂは，Ａに対し内金の返還を請求することはできない。",c4:"４．Ａが本契約を結んだ翌日，甲土地の売却代金を購入代金に充てる資金計画の下で，Ｃの所有する土地をＣから購入する契約を結んだ場合，Ｂは，本契約を手付により解除することはできない。",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"25",subject:"min",q:"借地借家法の適用を受ける不動産賃貸借に関する次の１から５までの各記述のうち，正しいものはどれか。",c1:"１．期間の定めがない土地の賃貸借契約において，賃貸人は，１年前の解約申入れにより，契約を終了させることができる。",c2:"２．当事者が土地の賃貸借契約を締結した後に，この契約を最初に更新する場合にあっては，その期間は更新の日から１０年とされるが，当事者がこれより長い期間を定めることは妨げられない。",c3:"３．期間の定めがある建物の賃貸借契約が法定更新された場合には，従前の契約と同一の条件及び期間で契約を更新したものとみなされる。",c4:"４．期間の定めがない建物の賃貸借契約において，賃貸人は，正当の事由があるか否かにかかわらず，６か月前の解約申入れにより，契約を終了させることができる。",c5:"５．期間の定めがある建物の賃貸借契約をする場合においては，公正証書による等書面によって契約をするときに限り，契約の更新がないこととする旨を定めることができる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"26",subject:"min",q:`委任の終了に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 委任の終了事由は，相手方に通知しなければ，相手方がその事由を知っているか否かを問わず，これをもってその相手方に対抗することができない。`,c1:"１．ア エ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"27",subject:"min",q:`不当利得に関する次のアからオまでの各記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 不法行為による損害賠償債権の２０年の期間制限については，加害行為が終了してから相当の期間が経過した後に損害が発生する場合であっても，加害行為の時から起算される。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"30",subject:"min",q:"事務管理に関する次の１から５までの各記述のうち 誤っているものを２個選びなさい。",c1:"１．本人の意思に反していても事務管理が成立することがあり，その場合には，管理者は，本人が現に利益を受けている限度においてのみ，本人のために支出した費用の償還を請求することができる。",c2:"２．管理者は その事務が終了した時に 本人に対して相当の額の報酬を請求することができる。",c3:"３．管理者は，本人の身体，名誉又は財産に対する急迫の危害を免れさせるために事務管理をしたときを除き，善良な管理者の注意をもって事務を処理する義務を負う。",c4:"４．管理者が本人の名でした法律行為の効果は，本人に帰属する。",c5:"５．管理者は，その事務が終了した後は，本人に対して，遅滞なくその経過及び結果を報告しなければならない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"24"},{year:"2007",num:"31",subject:"min",q:`離婚に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 共同親権に服する子のいる父母が裁判上の離婚をする場合には，裁判所が父母の一方を親権者と定める。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"32",subject:"min",q:"後見に関する次の１から５までの各記述のうち 誤っているものを２個選びなさい。",c1:"１．未成年者に対して親権を行う者がないときは，家庭裁判所が職権で未成年後見人を選任する。",c2:"２．家庭裁判所は，精神上の障害により事理を弁識する能力を欠く常況にある者について，後見開始の審判をするときは，併せて成年後見人を選任する。",c3:"３．後見人は，善良な管理者の注意をもって，被後見人の財産を管理する義務を負う。",c4:"４．未成年後見人が選任されている場合においても，家庭裁判所は，必要があると認めるときは，更に未成年後見人を追加して選任することができる。",c5:"５．後見監督人がいない場合，後見人は，自己と被後見人との利益が相反する行為について，被後見人のために特別代理人の選任を家庭裁判所に請求しなければならない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"14"},{year:"2007",num:"33",subject:"min",q:"相続の承認と放棄に関する次の１から５までの各記述のうち 誤っているものはどれか。",c1:"１．共同相続人に強迫されて相続放棄をした場合は，放棄を取り消すことができるが，追認することができる時から６か月以内に家庭裁判所に申述して取り消さなくてはならない。",c2:"２．熟慮期間中の相続人は，固有財産におけるのと同一の注意をもって，相続財産を管理しなければならない。",c3:"３．相続人Ａが相続放棄をしたことにより相続人となったＢが相続の承認をした場合であっても，Ｂの承認後にＡが相続財産を費消した場合には，Ａは単純承認をしたものとみなされる。",c4:"４．限定承認者は，相続債権者に弁済した後でなければ，受遺者に弁済することができない。",c5:"５．相続人が数人あるときは，限定承認は，相続人全員が共同してしなくてはならない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"34",subject:"min",q:"相続人が複数存在する場合における遺産分割前の遺産に関する次の１から５までの各記述のうち，判例の趣旨に照らし正しいものを２個選びなさい。",c1:"１．遺産である貸金債権は相続人全員が共同してのみ行使することができる。",c2:"２．不動産の引渡義務を相続した場合，いずれの相続人も当該不動産の引渡義務を負う。",c3:"３．遺産である不動産を単独で占有する相続人に対して，他の相続人は，自己の持分の価額が過半数であることを理由に，その明渡しを請求することができる。",c4:"４．遺産である不動産につき，各相続人は自己の持分を処分することはできない。",c5:"５．ＡとＢが連帯して債務を負っており，Ａが死亡した場合，Ａの連帯債務はＡの相続人間で当然に分割され，各相続人はその相続分に応じて承継し，その承継した範囲においてＢとともに連帯債務者となる。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"25"},{year:"2007",num:"35",subject:"min",q:"遺留分に関する次の１から５までの各記述のうち 正しいものを２個選びなさい。",c1:"１．遺留分権利者が数人あるときは，全員で共同して遺留分減殺請求権を行使する必要がある。",c2:"２．遺留分減殺請求権は，相続の開始を知った時から１年以内に行使しなければ時効消滅する。",c3:"３．判例によれば，共同相続人の１人に対する婚姻のための財産の贈与については，それが相続開始の１年前の日より前に行われた贈与であっても，特段の事情のない限り，他の共同相続人は遺留分減殺請求権を行使できる。",c4:"４．遺留分権利者は，相続開始前には遺留分を放棄することができないが，相続開始後は遺留分を放棄できる。",c5:"５．被相続人が全財産を第三者に遺贈し，相続人が被相続人の両親のみであった場合，両親の遺留分はそれぞれ６分の１である。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"35"},{year:"2007",num:"36",subject:"syo",q:"株式会社，合同会社及び民法上の組合（ 以下「会社等」という。）の比較に関する次の１から４までの各記述のうち，正しいものを２個選びなさい。なお，「構成員」とは，株式会社にあっては株主を，合同会社にあっては社員を，民法上の組合にあっては組合員をそれぞれ指すものとし，また，各記述について，定款又は組合契約には特別の定めがないものとする。",c1:"１．「構成員は，出資の限度でのみ責任を負う。」 という説明は，株式会社及び合同会社には当てはまるが，民法上の組合には当てはまらない。",c2:"２．「会社等の常務は，その完了前に他の構成員が異議を述べない限り，各構成員が単独で行うことができる。」という説明は，株式会社，合同会社及び民法上の組合のいずれにも当てはまらない。",c3:"３．「定款又は組合契約を変更するには，構成員の全員の同意が必要である。」という説明は，合同会社及び民法上の組合には当てはまるが，株式会社には当てはまらない。",c4:"４．「構成員が１人になった場合であっても，会社等は存続することができる。」という説明は株式会社には当てはまるが，合同会社及び民法上の組合には当てはまらない。",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"13"},{year:"2007",num:"37",subject:"syo",q:`次のアからオまでの各記述のうち，株式会社は定款所定の目的の範囲内でのみ権利能力を有するという考え方に対する批判として，ふさわしくないものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 取引相手方がある行為が目的の範囲内のものであるかどうかを的確に判断することは困難である。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"38",subject:"syo",q:`株式会社の設立に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 会社の設立の登記があっても，定款の絶対的記載又は記録事項が欠けている場合や定款の認証がない場合には，瑕疵が重大であるため，会社は不存在となり，誰でもいつでも会社が存在しないことを主張することができる。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"39",subject:"syo",q:`募集株式の発行に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 新株発行不存在確認の訴えについては，出訴期間の制限はない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"40",subject:"syo",q:`単元株に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 種類株式発行会社において単元株制度を採用するときは，各種類株式に係る単元株式数は，同じ数でなければならない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"41",subject:"syo",q:"株式会社（清算株式会社を除く。）における機関設計に関する次の１から５までの各記述のうち，誤っているものはどれか。",c1:"１．株式会社には，取締役を必ず置かなければならない。",c2:"２．会社法上の公開会社には，取締役会を必ず置かなければならない。",c3:"３．取締役会を置いた場合には，監査役又は委員会（指名委員会，監査委員会及び報酬委員会をいう。以下同じ。）のいずれかを必ず置かなければならない。",c4:"４．取締役会を置かない場合には，監査役会及び委員会のいずれも置くことができない。",c5:"５．大会社には，会計監査人を必ず置かなければならない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"42",subject:"syo",q:`取締役会設置会社の取締役に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 会社が取締役に対して訴えを提起する場合には，監査役設置会社であるか否かを問わず，被告となる取締役以外の取締役が会社を代表する。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2007",num:"43",subject:"syo",q:`一定の法定期間内本店に備え置かれなければならない次のアからオまでのもののうち，それらが書面をもって作成されている場合において，法定の備置期間内における営業時間内に，裁判所の許可を得ることなく，株主及び会社債権者が当該書面又はその写しの閲覧請求権を行使することができるものを組み合わせたものは，後記１から５までのうちどれか。
ア. 書面による議決権行使として会社に提出された議決権行使書面
イ. 株主総会議事録
ウ. 取締役会議事録
エ. 委員会設置会社における各委員会の議事録
オ. 計算書類及び事業報告並びにこれらの附属明細書`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"44",subject:"syo",q:`株式会社の監査役に関する次のアからオまでの各記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 会社は，定款の定めにより，当該会社の監査役の任期を，選任後２年以内に終了する事業年度のうち最終のものに関する定時株主総会の終結の時までとすることができる。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"45",subject:"syo",q:`株式会社の計算に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. Ｂ信用金庫とＡ株式会社との間に当座勘定取引が行われているときは，当該取引は商法にいう交互計算契約に該当し，いわゆる交互計算不可分の原則の適用がある。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2007",num:"51",subject:"syo",q:`Ａの販売する商品をＢが買い付けるに当たりＣが関与する法的形態についての次のアからオまで，の各記述のうち 正しいものを組み合わせたものは 後記１から５までのうちどれか。
...
オ. ＣがＡから委託を受けた締約代理商であり，その旨をＢに明示して契約する場合には，売買契約はＡ・Ｂ間に成立する。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"52",subject:"syo",q:`約束手形に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 人事訴訟において，対審の公開停止のための要件がないにもかかわらず，公開を停止した場合，その違反は，当事者の責問権の喪失によって治癒されるものではない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"57",subject:"mso",q:`上告審に関する次のアからオまでの各記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 判例によれば，上告裁判所によって破棄差戻しがされた後の原審が，差戻し前の原判決と同一の認定事実の下で，破棄理由で誤りとされた法律的見解とは別個の法律的見解に立って，差戻し前の原判決と同一の結論の判決をすることは，破棄判決の拘束力に違反しない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"58",subject:"mso",q:`相殺に関する次のアからオまでの各記述のうち，判例の趣旨に照らし正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
学生Ｂ. 私は，判例に⑤（ｉ. 賛成・ｊ. 反対）する立場です。`,c1:"１．①ａ②ｄ③ｆ④ｈ⑤ｉ",c2:"２．①ａ②ｄ③ｅ④ｇ⑤ｊ",c3:"３．①ｂ②ｃ③ｅ④ｈ⑤ｊ",c4:"４．①ｂ②ｄ③ｅ④ｇ⑤ｉ",c5:"５．①ｂ②ｃ③ｆ④ｇ⑤ｊ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2007",num:"4",subject:"kei",q:"刑法上の過失に関する次の１から５までの各記述のうち，正しいものはどれか。",c1:"１．行為者が構成要件的結果発生の認容を欠く場合を認識のない過失といい，その認容がある場合を認識のある過失という。",c2:"２．業務上過失傷害罪について通常の過失傷害罪より重い法定刑が定められているのは，業務上の過失が通常の過失より重大な結果を引き起こすことが多いためであるから，生じた結果が軽微な場合は業務上過失傷害罪は成立せず，過失傷害罪が成立し得るにとどまる。",c3:"３．重過失とは，注意義務違反の程度が著しい場合をいい，行為者としてわずかな注意を用いることによって結果を予見でき，かつ，結果の発生を回避することができる場合の過失をいう。",c4:"４．被害者が不適切な行動に出ないことを信頼するに足る事情があり，その被害者の不適切な行動によって結果が発生した場合は，過失相殺が適用されるから，行為者の注意義務違反の程度が著しい場合であっても重過失が認められることはない。",c5:"５．構成要件的結果を惹起させた直接行為者について，これを監督すべき立場にある監督者の過失を，監督過失という。監督過失を認めるには，直接行為者に構成要件的結果発生の予見可能性があれば足り，監督者にはその予見可能性は必要とされていない。",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"5",subject:"kei",q:`盗品等に関する罪についての次のアからオまでの各記述を判例の立場に従って検討した場合，誤っているものの組合せは，後記１から５までのうちどれか。
...
Ｄ. 正犯が一定の行為を行ったことを要するが，その内容としては，正犯の行為が構成要件，違法性及び責任を備えていなければならない。`,c1:"１．①Ａ，Ｂ，Ｃ ②Ｄ ③Ａ ④Ａ，Ｂ ⑤Ｃ，Ｄ",c2:"２．①Ｂ，Ｃ，Ｄ ②Ａ ③Ｄ ④B, C, D ⑤A",c3:"３．①Ａ，Ｂ ②C, D ③A ④B, C, D ⑤A",c4:"４．①Ａ，Ｂ，Ｃ ②Ｄ ③A ④C, D ⑤A, B",c5:"５．①Ａ，Ｂ ②Ｃ，Ｄ ③Ｄ ④A, B ⑤C, D",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2007",num:"7",subject:"kei",q:`次のアからオまでの各記述について 判例の立場に従って，その組合せとして正しいものは，後記１から５までのうちどれか。
...
（参照条文）民法
第７０８条 不法な原因のために給付をした者は，その給付したものの返還を請求することができない。ただし，不法な原因が受益者についてのみ存したときは，この限りでない。`,c1:"１．Ａ，Ｄ",c2:"２．Ｂ，Ｃ，Ｅ",c3:"３．Ａ，Ｂ，Ｃ",c4:"４．Ａ，Ｂ，Ｄ",c5:"５．Ｃ，Ｄ，Ｅ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"14",subject:"kei",q:`次のアからエまでの各事例の甲の罪責について，判例の立場に従って検討し，それぞれａないし。ｃから正しいものを選んだ場合 その組合せとして正しいものは 後記１から５までのうちどれか。
...
オ. 甲は，約束手形を偽造してこれを割引に出して利益を得ようと考え，自ら不正に作成したＥ社の振出しに係る約束手形１通を割引依頼のためにＦに呈示したが，Ｆは，既に上記約束手形が偽造であることを甲の友人Ｇから聞いて知っていたため 割引依頼を断った(偽造有価証券行使罪）。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"21112"},{year:"2007",num:"20",subject:"kei",q:`次の【見解】ⅠないしⅢに従って，後記の【記述】アないしウについて正誤を検討した場合，後記１から５までのうち，正しいものはどれか。
【見解】
...
カ. 検察官が，冒頭陳述を行う。`,c1:"１．イエオア",c2:"２．エイオカ",c3:"３．オイアカ",c4:"４．エイオア",c5:"５．オイカウ",c6:"６．エオイア",c7:"７．オエイア",c8:"８．オエイカ",c9:"",c10:"",a:"4"},{year:"2007",num:"30",subject:"kso",q:`次の【事例】における【Ｗの証人尋問】中の（ア）から（エ）までの下線部分にそれぞれ対応する後記アからエまでの【記述】のうち，誤っているものの組合せは，後記１から５までのうちどれか 。
【事例】
...
エ. この尋問は，Ｗに示した写真７枚が，いまだ証拠調べを終えていないものであるので許されない。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2007",num:"31",subject:"kso",q:`起訴状記載の公訴事実の特定に関し，裁判所が検察官に対して求釈明する義務を負うのは，訴因の明示に必要な範囲に限られるとの見解がある。次のアからオまでの各記述のうち，この見解と矛盾するものの組合せとして正しいものは，後記１から６までのうちどれか 。
...
ク. 弁護人が取調べに立ち会ったか否か
ケ. 取調方法が違法であったか否か
コ. 虚偽の自白を誘発するおそれがあったか否か`,c1:"１．アキクウケイ",c2:"２．コカオエクウ",c3:"３．コカオウケイ",c4:"４．コイオキケエ",c5:"５．クカコウオイ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2007",num:"36",subject:"kso",q:`次の【見解】は 自白の補強証拠が必要とされる範囲について述べたものである 見解 中の①と②の（ ）内に入る適切な記述を後記【Ａ群】の１から５までのうちから，また ③と④の内に入る適切な語句を後記【Ｂ群】の１から５までのうちから，それぞれ一つずつ選びなさい。なお，同じ数字の（ ）内には，同じ語句又は記述が入るものとする。
【見解】
...
５．自白全体が架空のものでないとの裏付けがあり，補強証拠に欠けるところはないから，有罪とすることが許される`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1545"},{year:"2007",num:"37",subject:"kso",q:`次のアからカまでの各記述のうち，免訴の言渡しをしなければならない場合の組合せとして正しいものは，後記１から６までのうちどれか。
...
カ. 公訴の取消し後，犯罪事実につき，新たに重要な証拠が発見されていないにもかかわらず，公訴の取消しによる公訴棄却の決定が確定した同一事実について起訴がなされたとき`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ カ",c6:" ６．オ カ",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2007",num:"38",subject:"kso",q:`控訴審に関する次のアからエまでの各記述につき，正しい場合には１を，誤っている場合には２を選びなさい 。
...
エ. 法廷等の秩序維持に関する法律による制裁は従来の刑事的行政的処罰のいずれの範ちゅうにも属しないところの，同法によって設定された特殊の処罰であるが，その制裁は，通常の刑事裁判に関して憲法が要求する諸手続の範囲内において，これに準拠して科されるべきものである。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1212"},{year:"2006",num:"2",subject:"ken",q:`日本国憲法における「主権」の概念に関する次のアからエまでの各記述について，誤っているもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 日本国憲法の国民主権原理が明治憲法の天皇主権の否定として表明されたものだという趣旨からすると，日本国憲法下において，少なくとも天皇は国民ではないことは明らかである。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2006",num:"3",subject:"ken",q:`私人間における人権保障に関する次のアからエまでの各記述について，最高裁判所の判決の要約として，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
カ. 条約は国会の議決を必要とする一種の法律であるから，後法優先の原則により，新たな条項の付された条約は国内法として効力を持つことになる。`,c1:"１．アとウ",c2:"２．イとエ",c3:"３．ウとオ",c4:"４．エとカ",c5:"５．アとエ",c6:"６．イとオ",c7:"７．ウとカ",c8:"８．アとオ",c9:"９．イとカ",c10:"",a:"9"},{year:"2006",num:"7",subject:"ken",q:`次の文章は，職業選択の自由を規制する法令の合憲性判断基準に関するものである。ＡからＤまでの空欄に，後記１から６までの中から適切なものを補充して，文章を完成させなさい。
...
６．司法書士及び公共嘱託登記司法書士協会以外の者が他人の嘱託を受けて登記に関する手続の代理業務等を行うことを禁じた司法書士法の規定の合憲性が争われた事案`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5132"},{year:"2006",num:"8",subject:"ken",q:`財政制度に関する次のアからエまでの各記述について，明らかに誤っているもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 憲法第９条の宣明する国際平和主義，戦争の放棄，戦力の不保持などの国家の統治活動に対する規範は，私法的な価値秩序とは本来関係のない公法的な性格を有する規範であるから，それに反する私法上の行為の効力を一律に否定する作用を営むことはない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1121"},{year:"2006",num:"11",subject:"ken",q:`思想・良心の自由に関する次のアからエまでの各記述について，誤っているもの二つの組合せを，後記１から６までの中から選びなさい。
...
エ. 憲法第１９条は，内心の告白を強制されないという意味では「沈黙の自由」を保障したものと解することができるから，「自己に不利益な供述を強要されない」と規定する憲法第３８条第１項は 憲法第１９条との関係では一般法に対する特別法の関係にあると一般に解されている。`,c1:"１．アとイ",c2:"２．アとウ",c3:"３．アとエ",c4:"４．イとウ",c5:"５．イとエ",c6:"６．ウとエ",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"12",subject:"ken",q:`内閣及び内閣総理大臣に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 内閣総理大臣は，内閣を代表して議案を国会に提出し，国務を総理するほか，外交関係について国会に報告することを職務とするが，外交関係の処理と条約の締結は内閣が行うべき事務である。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1122"},{year:"2006",num:"13",subject:"ken",q:`次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
エ. 刑事事件の公判廷における写真撮影は，審判の秩序を乱し被告人その他訴訟関係人の正当な利益を不当に害する結果を生ずる恐れがあるため，最高裁判所規則により，裁判長の許可を得なければすることができないものと規定することは，憲法第２１条に違反しない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1221"},{year:"2006",num:"19",subject:"ken",q:`憲法第１７条及び国家賠償法に関する次のアからオまでの各記述について，明らかに誤っているもの二つの組合せを，後記１から10までの中から選びなさい。
...
２ (略)`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1211"},{year:"2006",num:"24",subject:"gyo",q:`行政機関の種別に関する次の記述について，アからエまでの下線部の各記述につき，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 複数の行政機関が同一の行政目的を実現するため一定の条件に該当する複数の者に対し行政指導を行う場合に，これらの行政指導に共通してその内容となるべき事項を上級機関の通達により定めることは許される。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2111"},{year:"2006",num:"27",subject:"gyo",q:`水道事業者による給水拒否に関する次のアからウまでの各記述について，最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
（参照条文）水道法
第１５条第１項 水道事業者は，事業計画に定める給水区域内の需要者から給水契約の申込みを受けたときは，正当な理由がなければ，これを拒んではならない。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"8"},{year:"2006",num:"28",subject:"gyo",q:`行政手続法における利害関係人の取扱いに関する次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
エ. 法律の条文上，行政庁において，数種類の不利益処分（一定の者に対して直接に義務を課し又はその権利を制限する処分）をすることができると規定されている場合，特定の者に対しどの処分を行うかについて，行政庁に裁量が認められることがある。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1211"},{year:"2006",num:"30",subject:"gyo",q:`行政指導に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤ってい。る場合には２を選びなさい。
...
エ. 行政手続法の行政指導に関する規定は，法令上に根拠規定のある行政指導にのみ適用される。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2212"},{year:"2006",num:"31",subject:"gyo",q:`次のアからウまでの各記述について，法令及び最高裁判所の判例に照らし，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
一から三まで （略）`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"4"},{year:"2006",num:"32",subject:"gyo",q:`次の文章について，後記語句群アからカまでの中から適切な言葉を選択して空欄Ａ，Ｂ，Ｃに入れて文章を完成させる場合の正しい組合せを，後記１から８までの中から選びなさい。
...
空欄Ｃについて
オ. 即時強制
カ. 直接強制`,c1:"１．Ａア Ｂウ Ｃオ",c2:"２．Ａア Ｂウ Ｃカ",c3:"３．Ａア Ｂエ Ｃオ",c4:"４．Ａア Ｂエ Ｃカ",c5:"５．Ａイ Ｂウ Ｃオ",c6:"６．Ａイ Ｂウ Ｃカ",c7:"７．Ａイ Ｂエ Ｃオ",c8:"８．Ａイ Ｂエ Ｃカ",c9:"",c10:"",a:"7"},{year:"2006",num:"33",subject:"gyo",q:`行政機関の保有する情報の公開に関する法律に関する次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
エ. この判示からは，行政庁の許可に基づく事業者の行為によって第三者が不利益を受け，それが処分の法的効果としての権利利益の侵害に当たると解される場合に，その第三者は当該事業者に対してその行為の差止めを訴求することができることから許可処分の取消しを求める法律上の利益を有しないとの結論は導かれない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2221"},{year:"2006",num:"35",subject:"gyo",q:`抗告訴訟の審理に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
ｇ. 過去の
ｈ. 具体的な
ｉ. 特定の種類の`,c1:"１．ａ ｆ ｇ",c2:"２．ｂ ｄ ｇ",c3:"３．ｂ ｄ ｉ",c4:"４．ｃ ｅ ｈ",c5:"５．ｃ ｆ ｈ",c6:"６．ｃ ｆ ｇ",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"39",subject:"gyo",q:`行政不服審査法に関する次のアからウまでの各記述について，正しいものに○，誤っているものに×を付した場合の組合せを，後記１から８までの中から選びなさい。
...
ウ. 再審査請求は，審査請求についての審査庁の裁決に不服のある者が同じ審査庁に対して更に不服を申し立てるものであり，法律又は条例に再審査請求ができる旨の定めがあるときにすることができる。`,c1:"１．ア○ イ○ ウ○",c2:"２．ア○ イ○ ウ×",c3:"３．ア○ イ× ウ○",c4:"４．ア○ イ× ウ×",c5:"５．ア× イ○ ウ○",c6:"６．ア× イ○ ウ×",c7:"７．ア× イ× ウ○",c8:"８．ア× イ× ウ×",c9:"",c10:"",a:"6"},{year:"2006",num:"40",subject:"gyo",q:`行政不服審査法及び行政事件訴訟法の規定に関する次のアからエまでの各記述について，それぞれ正しい場合には１を，誤っている場合には２を選びなさい。
...
オ. 土地をもってする代物弁済による債務消滅の効果を主張する場合，当事者の合意を主張立証すれば足り，対抗要件の具備まで主張立証する必要はない。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"5",subject:"min",q:`詐害行為取消権に関する次のアからオまでの記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 弁済を受けたことにつき詐害行為取消権を行使された者は，自己の債権に係る按分額の支払を拒むことができる。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2006",num:"6",subject:"min",q:`親族関係に関する次のアからエまでの記述のうち，正しいものは，後記１から５までのうちどれか。
ア. 養子は，その養親の実子と婚姻をすることができない。
イ. 夫婦の一方が死亡すれば，生存配偶者の姻族関係は終了する。
ウ. 夫婦の一方は，他方が前婚でもうけた子に対して扶養義務を負うことはない。
エ. 夫婦の一方は，他方の兄弟姉妹の配偶者に対して扶養義務を負うことはない。`,c1:"１．ア",c2:"２．イ",c3:"３．ウ",c4:"４．エ",c5:"５．正しいものはない",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2006",num:"7",subject:"min",q:`代襲相続に関する次のアからオまでの記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 被相続人Ａの父Ｂの父Ｃは，Ａの代襲相続人となる場合がある。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．イ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2006",num:"8",subject:"min",q:`親子関係をめぐる訴訟に関する次のアからオまでの記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. Ａが自動車をＢから買い，その自動車をＢからＣに引き渡すとの契約を締結した場合，Ｃが引渡しを受けた当該自動車に隠れた瑕疵があったときは，Ｃは，ＡＢ間の売買契約を解除することができる。`,c1:"１．ア イ",c2:"２．ア ウ",c3:"３．イ エ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2006",num:"24",subject:"min",q:`不動産賃貸借に関する次のアからオまでの記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 正当の事由の有無にかかわらず契約の更新がないこととする建物賃貸借契約の類型も認められている。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2"},{year:"2006",num:"25",subject:"min",q:`表見代理についての民法の規定に関する次のアからオまでの記述のうち，判例の趣旨に照らし誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
エ. 養子縁組に際して，養子となる者が１５歳未満である場合において監護権者があるときは，親権者の承諾のほかに監護権者の同意が必要である。`,c1:"１．ア イ",c2:"２．ア イ ウ",c3:"３．ア ウ エ",c4:"４．イ エ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2006",num:"36",subject:"syo",q:`商号に関する次のアからオまでの記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 営業を譲り受けた商人が譲渡人の商号を引き続き使用する場合には，その譲受人も，譲渡人の営業によって生じた債務について，譲り受けた財産を限度として，弁済責任を負う。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2006",num:"37",subject:"syo",q:`支配人とその登記に関する次のアからオまでの記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 取締役会設置会社においては，株式の分割は，取締役会の決議によって行うことができる。`,c1:"１．ア イ",c2:"２．ア オ",c3:"３．イ ウ",c4:"４．ウ エ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2006",num:"41",subject:"syo",q:`株式又は持分の譲渡に関する次のアからオまでの記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 株式の譲渡による取得について，取締役会設置会社では，取締役会ではなく株主総会の承認を要する旨を定款に定めることはできない。`,c1:"１．ア ウ",c2:"２．ア エ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"42",subject:"syo",q:`自己株式に関する次のアからオまでの記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 進行協議期日において，証拠調べと争点との関係の確認の協議を行った後に，新たな攻撃防御方法を提出した当事者は，相手方の求めがあるときは，相手方に対して，その協議前に提出することができなかった理由を説明しなければならない。`,c1:"１．ア イ",c2:"２．ア エ",c3:"３．イ ウ",c4:"４．ウ オ",c5:"５．エ オ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2006",num:"60",subject:"mso",q:`文書に関する次のアからオまでの記述のうち，誤っているものを組み合わせたものは，後記１から５までのうちどれか。
...
オ. 証拠保全も証拠調べであることに変わりはなく，裁判所は，文書の検証に応じない文書の所持者に対し，検証物提示命令を出すことができる。`,c1:"１．ア ウ",c2:"２．ア オ",c3:"３．イ エ",c4:"４．イ オ",c5:"５．ウ エ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2006",num:"61",subject:"mso",q:`判決に関する次のアからオまでの記述のうち，正しいものを組み合わせたものは，後記１から５までのうちどれか。
...
Ｅ. 死を強制されている
Ｆ. 自ら死を望んでいる`,c1:"１．①Ｄ ②Ａ，Ｂ，Ｃ ③Ｃ ④Ｅ",c2:"２．①Ｄ ②Ａ，Ｂ，Ｃ ③Ａ ④Ｆ",c3:"３．①Ｂ，Ｄ ②Ａ，Ｃ ③Ａ ④Ｅ",c4:"４．①Ｂ，Ｄ ②Ａ，Ｃ ③Ｃ ④Ｅ",c5:"５．①Ｂ，Ｄ ②Ａ，Ｃ ③Ａ ④Ｆ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"4",subject:"kei",q:`次の【記述】中のアないしウの《 》内に後記の【見解】ⅠないしⅢから適切なものを，また，同【記述】中の①から⑤までの（ ）内に後記の【語句群】から適切な語句を，それぞれ入れた場合及び，《 》 （ ）内に入るものの組合せとして正しいものは，後記１から５までのうちどれか。
【記 述】
...
Ⅰ. 横領罪が成立する。
Ⅱ. 背任罪が成立し，横領罪は成立しない。
Ⅲ. 横領罪も背任罪も成立しない。`,c1:"１．アⅠ−イⅠ",c2:"２．アⅡ−ウⅢ",c3:"３．イⅢ−エⅡ",c4:"４．ウⅡ−オⅠ",c5:"５．エⅢ−オⅡ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"6",subject:"kei",q:`次の【記述】中の①から⑧までの（ ）内に後記の【語句群】から適切な語句を入れた場合，（ ）内に入るものの組合せとして正しいものは，後記１から５までのうちどれか。
【記 述】
...
ｌ. 刃物で被害者の手の指を切断し被害者の物をつかむ機能を永続的に侵害した事例`,c1:"１．①ｂ③ｃ⑤ｅ",c2:"２．①ａ④ｄ⑥ｇ",c3:"３．②ａ④ｃ⑦ｉ",c4:"４．③ｃ⑦ｊ⑧ｋ",c5:"５．⑤ｆ⑥ｈ⑧ｌ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"4"},{year:"2006",num:"7",subject:"kei",q:`文書偽造罪に関する次の【記述】中の①から④までの（ ）内に，後記の【語句群】から適切な語句を入れた場合，（ ）内に入るものの組合せとして正しいものは，後記１から５までのうちどれか。なお，一つの（ ）内に二つ以上の語句が入る場合もある。
【記 述】
...
オ. 再度の執行猶予の場合，被告人を，（ｉ. 必ず保護観察に付さなければならない・ｊ. 保護観察に付するかどうかは裁判所の裁量である）。`,c1:"１．ａｃｅｇｉ",c2:"２．ａｄｆｈｊ",c3:"３．ｂｃｅｇｊ",c4:"４．ｂｄｅｈｊ",c5:"５．ｂｄｆｇｉ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"11",subject:"kei",q:`次の【事例】の甲について，強姦罪（刑法第１７７条）だけではなく強盗罪（刑法第２３６条第１項）の成立を認める見解と明らかに矛盾する記述は，後記１から５までのうちどれか。
【事例】
...
エ. Ⅱの事例で，乙の行為に過失があった場合，Ａの見解からは，乙の行為とＶの死亡との間の因果関係が肯定されるが，Ｂ及びＣの見解からは，因果関係が否定される。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2212"},{year:"2006",num:"19",subject:"kei",q:`判例の立場に従って次のアからエまでの各事例の甲の罪責について検討し，正しい場合には１を，誤っている場合には２を選びなさい。
...
ｇ. 口頭
ｈ. 義務
ｉ. 職権`,c1:"１．①ｉ③ｄ",c2:"２．①ｃ⑧ｈ",c3:"３．③ａ④ｅ",c4:"４．⑤ｇ⑥ｆ",c5:"５．④ｂ⑧ｈ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2006",num:"22",subject:"kso",q:`告訴に関する次のアからオまでの各記述のうち，誤っているものの組合せは，後記１から５までのうちどれか。
...
エ. 保釈の制度は，被疑者の勾留には存しないが，被告人の勾留には存する。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1221"},{year:"2006",num:"25",subject:"kso",q:`次の【事例】中のアからオまでの下線部分に関して述べた後記【記述】のうち，誤っているものの組合せは，後記１から５までのうちどれか。
【事例】
...
ク. 国家の干渉を受けることなく独自に意思決定をする自由を実質的に侵害する行為である`,c1:"１．ア ク",c2:"２．イ エ",c3:"３．ウ オ",c4:"４．カ ウ",c5:"５．キ イ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"28",subject:"kso",q:`後記１から５までの【記述】のうち，次の【判例】（最高裁判所平成１３年４月１１日第三小法廷決定・刑集５５巻３号１２７頁）と明らかに矛盾するものはどれか。
【判例】
...
オ. 公判前整理手続に付された事件において証拠開示をめぐる当事者間の争いが生じた場合には，これを裁判所が決定で裁定し，不服のある当事者は，この決定に対して即時抗告をすることができる。`,c1:"１．ア ウ",c2:"２．イ ウ",c3:"３．イ エ",c4:"４．ウ エ",c5:"５．ウ オ",c6:"６．エ オ",c7:"",c8:"",c9:"",c10:"",a:"3"},{year:"2006",num:"31",subject:"kso",q:`被告人甲及び乙に対して別個に公訴提起がなされた後の弁論の併合・分離に関する次のアからエまでの各記述のうち，正しい場合には１を，誤っている場合には２を選びなさい。
...
エ. 弁論併合後に，弁論を分離した上で甲を乙に対する被告事件の証人として尋問することは，証人となった甲に黙秘権が認められないにもかかわらず，尋問の結果作成された甲の証人尋問調書は刑事訴訟法第３２２条の要件を満たす限り，甲の被告事件においても証拠能力を取得することとなり，結局甲の黙秘権保障に反する結果となるから，許されない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"2122"},{year:"2006",num:"32",subject:"kso",q:`次の【見解】は，刑事訴訟における当事者の主張・立証活動について述べたものである。後記アからオまでの【記述】のうち，この【見解】の主題を最も適切に述べたものの組合せとして正しいものは，後記１から５までのうちどれか。
【見解】
...
ｈ. 「かつ」
ｉ. 違法の重大性
ｊ. 司法の廉潔性`,c1:"１．①ｃ③ｉ④ｅ⑥ｉ",c2:"２．①ｃ③ａ④ｅ⑥ｉ",c3:"３．①ｃ③ｄ④ｂ⑥ａ",c4:"４．①ｈ③ｊ④ｇ⑥ｊ",c5:"５．①ｈ③ｉ④ｇ⑥ｉ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"1"},{year:"2006",num:"34",subject:"kso",q:`次の【文章】のアからオまでの（ ）内には後記【語句群】のａからｇまでの語句のいずれか，甲及び乙の《 》内には文章中に記載した①から④までの事情のいずれかが入る。エ及びオに入る適切な語句，甲及び乙に入る適切な事情の組合せとして正しいものは，後記１から８までのうちどれか。なお，アからオまでの（ ）内には，それぞれ異なる語句が入る。
【文章】
...
ｅ. 裁判所の検証の結果を記載した調書
ｆ. 信用性の情況的保障
ｇ. 必要性`,c1:"１．エ−ｆ オ−ａ 甲−① 乙−②",c2:"２．エ−ｆ オ−ａ 甲−③ 乙−④",c3:"３．エ−ｆ オ−ｄ 甲−② 乙−③",c4:"４．エ−ｆ オ−ｄ 甲−③ 乙−④",c5:"５．エ−ｆ オ−ｃ 甲−① 乙−④",c6:"６．エ−ｆ オ−ｅ 甲−② 乙−③",c7:"７．エ−ｇ オ−ｃ 甲−② 乙−④",c8:"８．エ−ｇ オ−ｅ 甲−① 乙−③",c9:"",c10:"",a:"4"},{year:"2006",num:"35",subject:"kso",q:`刑事訴訟法第３２８条にいう「公判準備又は公判期日における被告人，証人その他の者の供述の証明力を争うため」に用いることのできる同法「第３２１条乃至第３２４条の規定により証拠とすることができない書面又は供述」の範囲については，
...
ｅ. オは，③の説を採った場合でなければ，証拠として許容されることはない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"21122"},{year:"2006",num:"36",subject:"kso",q:`犯罪被害者に関する次のアからエまでの各記述のうち，正しいものの組合せは，後記１から６までのうちどれか。
...
ｊ. 差戻
ｋ. 相対的控訴理由
ｌ. 絶対的控訴理由`,c1:"１．ｂｄｆｇｉｋ",c2:"２．ｂｅｆｇｊｋ",c3:"３．ａｄｆｇｈｋ",c4:"４．ａｅｆｇｈｌ",c5:"５．ａｅｆｇｉｌ",c6:"",c7:"",c8:"",c9:"",c10:"",a:"5"},{year:"2006",num:"39",subject:"kso",q:`次のアからオまでの場合における不服申立ての可否・方法について，それぞれ正しいものを後記１から３までのうちから選びなさい。
...
１．準抗告が可能である。
２．抗告が可能である。
３．現行法上不服申立ては許されない。`,c1:"",c2:"",c3:"",c4:"",c5:"",c6:"",c7:"",c8:"",c9:"",c10:"",a:"31123"},{year:"2006",num:"40",subject:"kso",q:`略式手続に関する次のアからオまでの各記述のうち，正しいものの組合せは，後記１から６までのうちどれか。
...
オ. 略式命令を受けた者又は検察官は，その内容に不服のある場合は，その告知を受けた日から１４日以内に，略式命令をした簡易裁判所の上級審である地方裁判所に対して正式裁判の請求をすることができる。`,c1:"１．ア イ",c2:"２．イ ウ",c3:"３．イ エ",c4:"４．ウ エ",c5:"５．ウ オ",c6:"６．エ オ",c7:"",c8:"",c9:"",c10:"",a:"2"}];function gn(e){return Array.isArray?Array.isArray(e):z1(e)==="[object Array]"}const Qv=1/0;function Jv(e){if(typeof e=="string")return e;let c=e+"";return c=="0"&&1/e==-Qv?"-0":c}function ey(e){return e==null?"":Jv(e)}function nn(e){return typeof e=="string"}function N1(e){return typeof e=="number"}function cy(e){return e===!0||e===!1||ny(e)&&z1(e)=="[object Boolean]"}function D1(e){return typeof e=="object"}function ny(e){return D1(e)&&e!==null}function _c(e){return e!=null}function lu(e){return!e.trim().length}function z1(e){return e==null?e===void 0?"[object Undefined]":"[object Null]":Object.prototype.toString.call(e)}const ty="Incorrect 'index' type",ay=e=>`Invalid value for key ${e}`,sy=e=>`Pattern length exceeds max of ${e}.`,uy=e=>`Missing ${e} property in key`,ly=e=>`Property 'weight' in key '${e}' must be a positive integer`,xi=Object.prototype.hasOwnProperty;class ry{constructor(c){this._keys=[],this._keyMap={};let n=0;c.forEach(t=>{let a=H1(t);n+=a.weight,this._keys.push(a),this._keyMap[a.id]=a,n+=a.weight}),this._keys.forEach(t=>{t.weight/=n})}get(c){return this._keyMap[c]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}function H1(e){let c=null,n=null,t=null,a=1,s=null;if(nn(e)||gn(e))t=e,c=wi(e),n=$u(e);else{if(!xi.call(e,"name"))throw new Error(uy("name"));const u=e.name;if(t=u,xi.call(e,"weight")&&(a=e.weight,a<=0))throw new Error(ly(u));c=wi(u),n=$u(u),s=e.getFn}return{path:c,id:n,weight:a,src:t,getFn:s}}function wi(e){return gn(e)?e:e.split(".")}function $u(e){return gn(e)?e.join("."):e}function iy(e,c){let n=[],t=!1;const a=(s,u,l)=>{if(_c(s))if(!u[l])n.push(s);else{let r=u[l];const o=s[r];if(!_c(o))return;if(l===u.length-1&&(nn(o)||N1(o)||cy(o)))n.push(ey(o));else if(gn(o)){t=!0;for(let i=0,d=o.length;i<d;i+=1)a(o[i],u,l+1)}else u.length&&a(o,u,l+1)}};return a(e,nn(c)?c.split("."):c,0),t?n:n[0]}const oy={includeMatches:!1,findAllMatches:!1,minMatchCharLength:1},dy={isCaseSensitive:!1,includeScore:!1,keys:[],shouldSort:!0,sortFn:(e,c)=>e.score===c.score?e.idx<c.idx?-1:1:e.score<c.score?-1:1},fy={location:0,threshold:.6,distance:100},my={useExtendedSearch:!1,getFn:iy,ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1};var qe={...dy,...oy,...fy,...my};const vy=/[^ ]+/g;function yy(e=1,c=3){const n=new Map,t=Math.pow(10,c);return{get(a){const s=a.match(vy).length;if(n.has(s))return n.get(s);const u=1/Math.pow(s,.5*e),l=parseFloat(Math.round(u*t)/t);return n.set(s,l),l},clear(){n.clear()}}}class Hl{constructor({getFn:c=qe.getFn,fieldNormWeight:n=qe.fieldNormWeight}={}){this.norm=yy(n,3),this.getFn=c,this.isCreated=!1,this.setIndexRecords()}setSources(c=[]){this.docs=c}setIndexRecords(c=[]){this.records=c}setKeys(c=[]){this.keys=c,this._keysMap={},c.forEach((n,t)=>{this._keysMap[n.id]=t})}create(){this.isCreated||!this.docs.length||(this.isCreated=!0,nn(this.docs[0])?this.docs.forEach((c,n)=>{this._addString(c,n)}):this.docs.forEach((c,n)=>{this._addObject(c,n)}),this.norm.clear())}add(c){const n=this.size();nn(c)?this._addString(c,n):this._addObject(c,n)}removeAt(c){this.records.splice(c,1);for(let n=c,t=this.size();n<t;n+=1)this.records[n].i-=1}getValueForItemAtKeyId(c,n){return c[this._keysMap[n]]}size(){return this.records.length}_addString(c,n){if(!_c(c)||lu(c))return;let t={v:c,i:n,n:this.norm.get(c)};this.records.push(t)}_addObject(c,n){let t={i:n,$:{}};this.keys.forEach((a,s)=>{let u=a.getFn?a.getFn(c):this.getFn(c,a.path);if(_c(u)){if(gn(u)){let l=[];const r=[{nestedArrIndex:-1,value:u}];for(;r.length;){const{nestedArrIndex:o,value:i}=r.pop();if(_c(i))if(nn(i)&&!lu(i)){let d={v:i,i:o,n:this.norm.get(i)};l.push(d)}else gn(i)&&i.forEach((d,f)=>{r.push({nestedArrIndex:f,value:d})})}t.$[s]=l}else if(nn(u)&&!lu(u)){let l={v:u,n:this.norm.get(u)};t.$[s]=l}}}),this.records.push(t)}toJSON(){return{keys:this.keys,records:this.records}}}function U1(e,c,{getFn:n=qe.getFn,fieldNormWeight:t=qe.fieldNormWeight}={}){const a=new Hl({getFn:n,fieldNormWeight:t});return a.setKeys(e.map(H1)),a.setSources(c),a.create(),a}function by(e,{getFn:c=qe.getFn,fieldNormWeight:n=qe.fieldNormWeight}={}){const{keys:t,records:a}=e,s=new Hl({getFn:c,fieldNormWeight:n});return s.setKeys(t),s.setIndexRecords(a),s}function Xa(e,{errors:c=0,currentLocation:n=0,expectedLocation:t=0,distance:a=qe.distance,ignoreLocation:s=qe.ignoreLocation}={}){const u=c/e.length;if(s)return u;const l=Math.abs(t-n);return a?u+l/a:l?1:u}function hy(e=[],c=qe.minMatchCharLength){let n=[],t=-1,a=-1,s=0;for(let u=e.length;s<u;s+=1){let l=e[s];l&&t===-1?t=s:!l&&t!==-1&&(a=s-1,a-t+1>=c&&n.push([t,a]),t=-1)}return e[s-1]&&s-t>=c&&n.push([t,s-1]),n}const at=32;function gy(e,c,n,{location:t=qe.location,distance:a=qe.distance,threshold:s=qe.threshold,findAllMatches:u=qe.findAllMatches,minMatchCharLength:l=qe.minMatchCharLength,includeMatches:r=qe.includeMatches,ignoreLocation:o=qe.ignoreLocation}={}){if(c.length>at)throw new Error(sy(at));const i=c.length,d=e.length,f=Math.max(0,Math.min(t,d));let v=s,y=f;const b=l>1||r,k=b?Array(d):[];let g;for(;(g=e.indexOf(c,y))>-1;){let A=Xa(c,{currentLocation:g,expectedLocation:f,distance:a,ignoreLocation:o});if(v=Math.min(A,v),y=g+i,b){let q=0;for(;q<i;)k[g+q]=1,q+=1}}y=-1;let p=[],j=1,P=i+d;const x=1<<i-1;for(let A=0;A<i;A+=1){let q=0,C=P;for(;q<C;)Xa(c,{errors:A,currentLocation:f+C,expectedLocation:f,distance:a,ignoreLocation:o})<=v?q=C:P=C,C=Math.floor((P-q)/2+q);P=C;let w=Math.max(1,f-C+1),V=u?d:Math.min(f+C,d)+i,_=Array(V+2);_[V+1]=(1<<A)-1;for(let N=V;N>=w;N-=1){let Z=N-1,F=n[e.charAt(Z)];if(b&&(k[Z]=+!!F),_[N]=(_[N+1]<<1|1)&F,A&&(_[N]|=(p[N+1]|p[N])<<1|1|p[N+1]),_[N]&x&&(j=Xa(c,{errors:A,currentLocation:Z,expectedLocation:f,distance:a,ignoreLocation:o}),j<=v)){if(v=j,y=Z,y<=f)break;w=Math.max(1,2*f-y)}}if(Xa(c,{errors:A+1,currentLocation:f,expectedLocation:f,distance:a,ignoreLocation:o})>v)break;p=_}const I={isMatch:y>=0,score:Math.max(.001,j)};if(b){const A=hy(k,l);A.length?r&&(I.indices=A):I.isMatch=!1}return I}function jy(e){let c={};for(let n=0,t=e.length;n<t;n+=1){const a=e.charAt(n);c[a]=(c[a]||0)|1<<t-n-1}return c}class W1{constructor(c,{location:n=qe.location,threshold:t=qe.threshold,distance:a=qe.distance,includeMatches:s=qe.includeMatches,findAllMatches:u=qe.findAllMatches,minMatchCharLength:l=qe.minMatchCharLength,isCaseSensitive:r=qe.isCaseSensitive,ignoreLocation:o=qe.ignoreLocation}={}){if(this.options={location:n,threshold:t,distance:a,includeMatches:s,findAllMatches:u,minMatchCharLength:l,isCaseSensitive:r,ignoreLocation:o},this.pattern=r?c:c.toLowerCase(),this.chunks=[],!this.pattern.length)return;const i=(f,v)=>{this.chunks.push({pattern:f,alphabet:jy(f),startIndex:v})},d=this.pattern.length;if(d>at){let f=0;const v=d%at,y=d-v;for(;f<y;)i(this.pattern.substr(f,at),f),f+=at;if(v){const b=d-at;i(this.pattern.substr(b),b)}}else i(this.pattern,0)}searchIn(c){const{isCaseSensitive:n,includeMatches:t}=this.options;if(n||(c=c.toLowerCase()),this.pattern===c){let y={isMatch:!0,score:0};return t&&(y.indices=[[0,c.length-1]]),y}const{location:a,distance:s,threshold:u,findAllMatches:l,minMatchCharLength:r,ignoreLocation:o}=this.options;let i=[],d=0,f=!1;this.chunks.forEach(({pattern:y,alphabet:b,startIndex:k})=>{const{isMatch:g,score:p,indices:j}=gy(c,y,b,{location:a+k,distance:s,threshold:u,findAllMatches:l,minMatchCharLength:r,includeMatches:t,ignoreLocation:o});g&&(f=!0),d+=p,g&&j&&(i=[...i,...j])});let v={isMatch:f,score:f?d/this.chunks.length:1};return f&&t&&(v.indices=i),v}}class Hn{constructor(c){this.pattern=c}static isMultiMatch(c){return Vi(c,this.multiRegex)}static isSingleMatch(c){return Vi(c,this.singleRegex)}search(){}}function Vi(e,c){const n=e.match(c);return n?n[1]:null}class qy extends Hn{constructor(c){super(c)}static get type(){return"exact"}static get multiRegex(){return/^="(.*)"$/}static get singleRegex(){return/^=(.*)$/}search(c){const n=c===this.pattern;return{isMatch:n,score:n?0:1,indices:[0,this.pattern.length-1]}}}class ky extends Hn{constructor(c){super(c)}static get type(){return"inverse-exact"}static get multiRegex(){return/^!"(.*)"$/}static get singleRegex(){return/^!(.*)$/}search(c){const t=c.indexOf(this.pattern)===-1;return{isMatch:t,score:t?0:1,indices:[0,c.length-1]}}}class py extends Hn{constructor(c){super(c)}static get type(){return"prefix-exact"}static get multiRegex(){return/^\^"(.*)"$/}static get singleRegex(){return/^\^(.*)$/}search(c){const n=c.startsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,this.pattern.length-1]}}}class Sy extends Hn{constructor(c){super(c)}static get type(){return"inverse-prefix-exact"}static get multiRegex(){return/^!\^"(.*)"$/}static get singleRegex(){return/^!\^(.*)$/}search(c){const n=!c.startsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,c.length-1]}}}class Cy extends Hn{constructor(c){super(c)}static get type(){return"suffix-exact"}static get multiRegex(){return/^"(.*)"\$$/}static get singleRegex(){return/^(.*)\$$/}search(c){const n=c.endsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[c.length-this.pattern.length,c.length-1]}}}class _y extends Hn{constructor(c){super(c)}static get type(){return"inverse-suffix-exact"}static get multiRegex(){return/^!"(.*)"\$$/}static get singleRegex(){return/^!(.*)\$$/}search(c){const n=!c.endsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,c.length-1]}}}class K1 extends Hn{constructor(c,{location:n=qe.location,threshold:t=qe.threshold,distance:a=qe.distance,includeMatches:s=qe.includeMatches,findAllMatches:u=qe.findAllMatches,minMatchCharLength:l=qe.minMatchCharLength,isCaseSensitive:r=qe.isCaseSensitive,ignoreLocation:o=qe.ignoreLocation}={}){super(c),this._bitapSearch=new W1(c,{location:n,threshold:t,distance:a,includeMatches:s,findAllMatches:u,minMatchCharLength:l,isCaseSensitive:r,ignoreLocation:o})}static get type(){return"fuzzy"}static get multiRegex(){return/^"(.*)"$/}static get singleRegex(){return/^(.*)$/}search(c){return this._bitapSearch.searchIn(c)}}class Y1 extends Hn{constructor(c){super(c)}static get type(){return"include"}static get multiRegex(){return/^'"(.*)"$/}static get singleRegex(){return/^'(.*)$/}search(c){let n=0,t;const a=[],s=this.pattern.length;for(;(t=c.indexOf(this.pattern,n))>-1;)n=t+s,a.push([t,n-1]);const u=!!a.length;return{isMatch:u,score:u?0:1,indices:a}}}const Mu=[qy,Y1,py,Sy,_y,Cy,ky,K1],Ii=Mu.length,xy=/ +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,wy="|";function Vy(e,c={}){return e.split(wy).map(n=>{let t=n.trim().split(xy).filter(s=>s&&!!s.trim()),a=[];for(let s=0,u=t.length;s<u;s+=1){const l=t[s];let r=!1,o=-1;for(;!r&&++o<Ii;){const i=Mu[o];let d=i.isMultiMatch(l);d&&(a.push(new i(d,c)),r=!0)}if(!r)for(o=-1;++o<Ii;){const i=Mu[o];let d=i.isSingleMatch(l);if(d){a.push(new i(d,c));break}}}return a})}const Iy=new Set([K1.type,Y1.type]);class Ay{constructor(c,{isCaseSensitive:n=qe.isCaseSensitive,includeMatches:t=qe.includeMatches,minMatchCharLength:a=qe.minMatchCharLength,ignoreLocation:s=qe.ignoreLocation,findAllMatches:u=qe.findAllMatches,location:l=qe.location,threshold:r=qe.threshold,distance:o=qe.distance}={}){this.query=null,this.options={isCaseSensitive:n,includeMatches:t,minMatchCharLength:a,findAllMatches:u,ignoreLocation:s,location:l,threshold:r,distance:o},this.pattern=n?c:c.toLowerCase(),this.query=Vy(this.pattern,this.options)}static condition(c,n){return n.useExtendedSearch}searchIn(c){const n=this.query;if(!n)return{isMatch:!1,score:1};const{includeMatches:t,isCaseSensitive:a}=this.options;c=a?c:c.toLowerCase();let s=0,u=[],l=0;for(let r=0,o=n.length;r<o;r+=1){const i=n[r];u.length=0,s=0;for(let d=0,f=i.length;d<f;d+=1){const v=i[d],{isMatch:y,indices:b,score:k}=v.search(c);if(y){if(s+=1,l+=k,t){const g=v.constructor.type;Iy.has(g)?u=[...u,...b]:u.push(b)}}else{l=0,s=0,u.length=0;break}}if(s){let d={isMatch:!0,score:l/s};return t&&(d.indices=u),d}}return{isMatch:!1,score:1}}}const Bu=[];function Ey(...e){Bu.push(...e)}function Ru(e,c){for(let n=0,t=Bu.length;n<t;n+=1){let a=Bu[n];if(a.condition(e,c))return new a(e,c)}return new W1(e,c)}const ys={AND:"$and",OR:"$or"},Ou={PATH:"$path",PATTERN:"$val"},Lu=e=>!!(e[ys.AND]||e[ys.OR]),Py=e=>!!e[Ou.PATH],Ty=e=>!gn(e)&&D1(e)&&!Lu(e),Ai=e=>({[ys.AND]:Object.keys(e).map(c=>({[c]:e[c]}))});function G1(e,c,{auto:n=!0}={}){const t=a=>{let s=Object.keys(a);const u=Py(a);if(!u&&s.length>1&&!Lu(a))return t(Ai(a));if(Ty(a)){const r=u?a[Ou.PATH]:s[0],o=u?a[Ou.PATTERN]:a[r];if(!nn(o))throw new Error(ay(r));const i={keyId:$u(r),pattern:o};return n&&(i.searcher=Ru(o,c)),i}let l={children:[],operator:s[0]};return s.forEach(r=>{const o=a[r];gn(o)&&o.forEach(i=>{l.children.push(t(i))})}),l};return Lu(e)||(e=Ai(e)),t(e)}function $y(e,{ignoreFieldNorm:c=qe.ignoreFieldNorm}){e.forEach(n=>{let t=1;n.matches.forEach(({key:a,norm:s,score:u})=>{const l=a?a.weight:null;t*=Math.pow(u===0&&l?Number.EPSILON:u,(l||1)*(c?1:s))}),n.score=t})}function My(e,c){const n=e.matches;c.matches=[],_c(n)&&n.forEach(t=>{if(!_c(t.indices)||!t.indices.length)return;const{indices:a,value:s}=t;let u={indices:a,value:s};t.key&&(u.key=t.key.src),t.idx>-1&&(u.refIndex=t.idx),c.matches.push(u)})}function By(e,c){c.score=e.score}function Ry(e,c,{includeMatches:n=qe.includeMatches,includeScore:t=qe.includeScore}={}){const a=[];return n&&a.push(My),t&&a.push(By),e.map(s=>{const{idx:u}=s,l={item:c[u],refIndex:u};return a.length&&a.forEach(r=>{r(s,l)}),l})}class Ut{constructor(c,n={},t){this.options={...qe,...n},this.options.useExtendedSearch,this._keyStore=new ry(this.options.keys),this.setCollection(c,t)}setCollection(c,n){if(this._docs=c,n&&!(n instanceof Hl))throw new Error(ty);this._myIndex=n||U1(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight})}add(c){_c(c)&&(this._docs.push(c),this._myIndex.add(c))}remove(c=()=>!1){const n=[];for(let t=0,a=this._docs.length;t<a;t+=1){const s=this._docs[t];c(s,t)&&(this.removeAt(t),t-=1,a-=1,n.push(s))}return n}removeAt(c){this._docs.splice(c,1),this._myIndex.removeAt(c)}getIndex(){return this._myIndex}search(c,{limit:n=-1}={}){const{includeMatches:t,includeScore:a,shouldSort:s,sortFn:u,ignoreFieldNorm:l}=this.options;let r=nn(c)?nn(this._docs[0])?this._searchStringList(c):this._searchObjectList(c):this._searchLogical(c);return $y(r,{ignoreFieldNorm:l}),s&&r.sort(u),N1(n)&&n>-1&&(r=r.slice(0,n)),Ry(r,this._docs,{includeMatches:t,includeScore:a})}_searchStringList(c){const n=Ru(c,this.options),{records:t}=this._myIndex,a=[];return t.forEach(({v:s,i:u,n:l})=>{if(!_c(s))return;const{isMatch:r,score:o,indices:i}=n.searchIn(s);r&&a.push({item:s,idx:u,matches:[{score:o,value:s,norm:l,indices:i}]})}),a}_searchLogical(c){const n=G1(c,this.options),t=(l,r,o)=>{if(!l.children){const{keyId:d,searcher:f}=l,v=this._findMatches({key:this._keyStore.get(d),value:this._myIndex.getValueForItemAtKeyId(r,d),searcher:f});return v&&v.length?[{idx:o,item:r,matches:v}]:[]}const i=[];for(let d=0,f=l.children.length;d<f;d+=1){const v=l.children[d],y=t(v,r,o);if(y.length)i.push(...y);else if(l.operator===ys.AND)return[]}return i},a=this._myIndex.records,s={},u=[];return a.forEach(({$:l,i:r})=>{if(_c(l)){let o=t(n,l,r);o.length&&(s[r]||(s[r]={idx:r,item:l,matches:[]},u.push(s[r])),o.forEach(({matches:i})=>{s[r].matches.push(...i)}))}}),u}_searchObjectList(c){const n=Ru(c,this.options),{keys:t,records:a}=this._myIndex,s=[];return a.forEach(({$:u,i:l})=>{if(!_c(u))return;let r=[];t.forEach((o,i)=>{r.push(...this._findMatches({key:o,value:u[i],searcher:n}))}),r.length&&s.push({idx:l,item:u,matches:r})}),s}_findMatches({key:c,value:n,searcher:t}){if(!_c(n))return[];let a=[];if(gn(n))n.forEach(({v:s,i:u,n:l})=>{if(!_c(s))return;const{isMatch:r,score:o,indices:i}=t.searchIn(s);r&&a.push({score:o,key:c,value:s,idx:u,norm:l,indices:i})});else{const{v:s,n:u}=n,{isMatch:l,score:r,indices:o}=t.searchIn(s);l&&a.push({score:r,key:c,value:s,norm:u,indices:o})}return a}}Ut.version="6.6.2";Ut.createIndex=U1;Ut.parseIndex=by;Ut.config=qe;Ut.parseQuery=G1;Ey(Ay);function Ul(e){switch(e){case"ken":return"憲法";case"gyo":return"行政法";case"min":return"民法";case"syo":return"商法";case"mso":return"民事訴訟法";case"kei":return"刑法";case"kso":return"刑事訴訟法"}}const Oy={data(){return{word:"",results:[]}},methods:{search(){var e={threshold:.3,includeMatches:!0,keys:["q","c1","c2","c3","c4","c5"]},c=new Ut(us,e);this.results=c.search(this.word)},highlight(e,c){console.log(c);const n=[];let t=0;for(let a=0;a<c.length;a++){let s=e.slice(t,c[a][0])+'<span style="font-weight:bold; background-color:yellow;">',u=e.slice(c[a][0],c[a][1]+1)+"</span>";if(n.push(s,u),t=c[a][1]+1,a==c.length-1){let l=e.slice(c[a][1]+1);n.push(l)}}return n.join("")},onClick(e){let c=this.$router.resolve({name:"tantou",params:{subject:e.subject,year:e.year,qNum:e.num}});window.open(c.href,"_blank")},subjectFull(e){return Ul(e)}}},Ly=ec("h1",null,"司法試験過去問題集・検索",-1),Fy=ec("thead",null,[ec("tr",null,[ec("th",null," 科目 "),ec("th",null," 年度 "),ec("th",null," 問題番号 "),ec("th",null," 問題 ")])],-1),Ny=["onClick"],Dy=["innerHTML"];function zy(e,c,n,t,a,s){const u=Le("v-text-field"),l=Le("v-table");return Be(),tc("main",null,[Ly,m(u,{modelValue:a.word,"onUpdate:modelValue":[c[0]||(c[0]=r=>a.word=r),s.search],density:"compact",variant:"solo",label:"検索","append-inner-icon":"mdi-magnify","single-line":""},null,8,["modelValue","onUpdate:modelValue"]),m(l,null,{default:Ae(()=>[Fy,ec("tbody",null,[(Be(!0),tc(ve,null,Mn(a.results,r=>(Be(),tc("tr",{key:r.refIndex,class:"tr-link",onClick:o=>s.onClick(r.item)},[ec("td",null,vn(s.subjectFull(r.item.subject)),1),ec("td",null,vn(r.item.year),1),ec("td",null,vn(r.item.num),1),ec("td",{innerHTML:s.highlight(r.item.q,r.matches[0].indices)},null,8,Dy)],8,Ny))),128))])]),_:1})])}const Hy=zn(Oy,[["render",zy]]),Uy={data(){return{open:[],subjects:["ken","gyo","min","syo","mso","kei","kso"]}},methods:{subjectFull(e){return Ul(e)},years(e){return["gyo","syo","mso","kso"].includes(e)?["2014","2013","2012","2011","2010","2009","2008","2007","2006"]:["2023","2022","2021","2020","2019","2018","2017","2016","2015","2014","2013","2012","2011","2010","2009","2008","2007","2006"]},qNum(e,c){return e=="gyo"&&["2014","2013","2012","2011","2010","2009","2008","2007","2006"].includes(c)?21:e=="syo"&&c==2014?38:e=="syo"&&["2013","2012","2011","2010","2009"].includes(c)?37:e=="syo"&&["2008","2007","2006"].includes(c)?36:e=="mso"&&c==2014?57:e=="mso"&&["2013","2012","2011","2010","2009"].includes(c)?56:e=="mso"&&["2008","2006"].includes(c)?55:e=="mso"&&c==2007?53:e=="kso"&&["2014","2013","2012","2011","2010","2009","2008","2007","2006"].includes(c)?21:1}}},Wy=ec("h1",null,"司法試験過去問題集・短答",-1);function Ky(e,c,n,t,a,s){const u=Le("v-list-item"),l=Le("v-list-group"),r=Le("v-list");return Be(),tc("main",null,[Wy,m(r,{opened:a.open,"onUpdate:opened":c[0]||(c[0]=o=>a.open=o)},{default:Ae(()=>[(Be(!0),tc(ve,null,Mn(a.subjects,o=>(Be(),cn(l,{value:o},{activator:Ae(({props:i})=>[m(u,se(i,{title:s.subjectFull(o)}),null,16,["title"])]),default:Ae(()=>[(Be(!0),tc(ve,null,Mn(s.years(o),i=>(Be(),cn(u,{title:i,to:"/tantou/"+o+"/"+i+"/"+s.qNum(o,i)},null,8,["title","to"]))),256))]),_:2},1032,["value"]))),256))]),_:1},8,["opened"])])}const Yy=zn(Uy,[["render",Ky]]);const Gy={props:{datum:{},subjectFull:"",num:"",year:""},computed:{title(){return this.subjectFull+this.year+"年第"+this.num+"問"},filteredQ(){return this.datum.q.replace(/\n/g,`

`)}}};function Xy(e,c,n,t,a,s){const u=Le("v-card-text"),l=Le("v-card");return Be(),cn(l,{title:s.title,variant:"outlined"},{default:Ae(()=>[m(u,{class:"q",innerHTML:s.filteredQ},null,8,["innerHTML"])]),_:1},8,["title"])}const Zy=zn(Gy,[["render",Xy],["__scopeId","data-v-f11345ad"]]);const Qy={emits:["showAnswer"],props:{datum:{}},data(){return{toggle_multiple:[],toggle1:"",toggle2:"",toggle3:"",toggle4:"",toggle5:""}},computed:{filteredChoices(){return Object.keys(this.datum).filter(e=>e.startsWith("c")).filter(e=>this.datum[e]!="").map(e=>this.datum[e])}},methods:{hankaku2Zenkaku(e){return e.replace(/[０-９]/g,function(c){return String.fromCharCode(c.charCodeAt(0)-65248)})},getResult(e){let c="";typeof e=="object"?(c=Object.values(e).map(a=>a+1).reduce((a,s)=>a+String(s)).slice(0,this.datum.a.length),this.toggle_multiple=[],this.toggle1="",this.toggle2="",this.toggle3="",this.toggle4="",this.toggle5=""):c=e.substr(0,1);const n=this.hankaku2Zenkaku(c)==this.datum.a;this.$emit("showAnswer",n)},setToggle(e){return"toggle"+String(e)},getTheNumberOfChoices(e,c,n){return e=="gyo"&&c=="2012"&&n=="21"||e=="kso"&&c=="2007"&&n=="23"||e=="kso"&&c=="2007"&&n=="36"?5:e=="gyo"&&c=="2009"&&n=="36"||e=="min"&&c=="2006"&&n=="31"?4:e=="ken"&&c=="2007"&&n=="1"?8:e=="ken"&&c=="2007"&&n=="7"||e=="ken"&&c=="2006"&&n=="5"||e=="kso"&&c=="2006"&&n=="39"?3:e=="ken"&&c=="2007"&&n=="17"||e=="kso"&&c=="2007"&&n=="21"||e=="ken"&&c=="2006"&&n=="7"?6:2}}};function Jy(e,c,n,t,a,s){const u=Le("v-btn"),l=Le("v-item"),r=Le("v-col"),o=Le("v-row"),i=Le("v-container"),d=Le("v-item-group");return n.datum.a.length>2||n.datum.subject=="ken"&&n.datum.year==2007&&n.datum.num==7||n.datum.subject=="kso"&&n.datum.year==2007&&n.datum.num==21?(Be(),tc(ve,{key:0},[(Be(!0),tc(ve,null,Mn(n.datum.a.length,f=>(Be(),tc("div",null,[m(d,{modelValue:e.$data["toggle"+f],"onUpdate:modelValue":v=>e.$data["toggle"+f]=v,mandatory:"","selected-class":"bg-grey"},{default:Ae(()=>[m(i,null,{default:Ae(()=>[m(o,null,{default:Ae(()=>[(Be(!0),tc(ve,null,Mn(s.getTheNumberOfChoices(n.datum.subject,n.datum.year,n.datum.num),v=>(Be(),cn(r,{cols:"1"},{default:Ae(()=>[m(l,null,{default:Ae(({selectedClass:y,toggle:b})=>[m(u,{class:$t(y),onClick:b},{default:Ae(()=>[ic(vn(v),1)]),_:2},1032,["class","onClick"])]),_:2},1024)]),_:2},1024))),256))]),_:1})]),_:1})]),_:2},1032,["modelValue","onUpdate:modelValue"])]))),256)),m(u,{onClick:c[0]||(c[0]=f=>s.getResult([a.toggle1,a.toggle2,a.toggle3,a.toggle4,a.toggle5]))},{default:Ae(()=>[ic("解答確認")]),_:1})],64)):n.datum.a.length==2?(Be(),tc(ve,{key:1},[m(i,null,{default:Ae(()=>[m(d,{modelValue:a.toggle_multiple,"onUpdate:modelValue":c[1]||(c[1]=f=>a.toggle_multiple=f),multiple:"","selected-class":"bg-grey"},{default:Ae(()=>[(Be(!0),tc(ve,null,Mn(s.filteredChoices,f=>(Be(),cn(l,null,{default:Ae(({selectedClass:v,toggle:y})=>[m(o,{align:"center"},{default:Ae(()=>[m(r,{cols:"1"},{default:Ae(()=>[m(u,{class:$t(v),onClick:y},{default:Ae(()=>[ic(vn(f.substr(0,2)),1)]),_:2},1032,["class","onClick"])]),_:2},1024),m(r,{cols:"11",class:"choice"},{default:Ae(()=>[ic(vn(f.substr(2)),1)]),_:2},1024)]),_:2},1024)]),_:2},1024))),256))]),_:1},8,["modelValue"])]),_:1}),m(u,{onClick:c[2]||(c[2]=f=>s.getResult(a.toggle_multiple))},{default:Ae(()=>[ic("解答確認")]),_:1})],64)):(Be(),cn(i,{key:2},{default:Ae(()=>[(Be(!0),tc(ve,null,Mn(s.filteredChoices,f=>(Be(),cn(o,{align:"center"},{default:Ae(()=>[m(r,{cols:"1"},{default:Ae(()=>[m(u,{onClick:v=>s.getResult(f)},{default:Ae(()=>[ic(vn(f.split("．")[0]+"．"),1)]),_:2},1032,["onClick"])]),_:2},1024),m(r,{cols:"11",class:"choice"},{default:Ae(()=>[ic(vn(f.split("．")[1]),1)]),_:2},1024)]),_:2},1024))),256))]),_:1}))}const eb=zn(Qy,[["render",Jy],["__scopeId","data-v-a60a3253"]]);const cb={props:{datum:{},show:Boolean,correct:Boolean}},nb={class:"result"},tb={key:0,style:{color:"red"}},ab={key:1,style:{color:"blue"}},sb={class:"answer"};function ub(e,c,n,t,a,s){return Be(),tc("div",{class:$t({hide:!n.show})},[ec("div",nb,[n.correct?(Be(),tc("p",tb,"○　正解")):(Be(),tc("p",ab,"×　不正解"))]),ec("p",sb,"正解："+vn(n.datum.a),1)],2)}const lb=zn(cb,[["render",ub],["__scopeId","data-v-73dba6f6"]]),rb={components:{QuestionComponent:Zy,ChoicesComponent:eb,ResultComponent:lb},data(){return{num:this.$route.params.qNum,subject:this.$route.params.subject,year:this.$route.params.year,subjectFull:"",datum:{},correct:!1,show:!1,questions:[]}},created(){const e=us.filter(n=>n.subject==this.subject&&n.year==this.year),c=Number(e[0].num);this.questions=this.range(c,c+e.length),this.datum=us.filter(n=>n.subject==this.subject&&n.year==this.year&&n.num==this.num)[0],this.subjectFull=Ul(this.subject)},computed:{breadcrumbs(){return[{text:"司法試験過去問題集",disabled:!1,to:{name:"home"}},{text:"短答",disabled:!1,to:{name:"tantouTop"}},{text:this.subjectFull,disabled:!1,to:{name:"tantouTop"}},{text:this.year+"年",disabled:!1,to:{name:"tantou",params:{subject:this.subject,qNum:1}}},{text:"第"+this.num+"問",disabled:!1,to:{name:"tantou",params:{subject:this.subject,qNum:this.num}}}]}},beforeRouteUpdate(e,c,n){this.num=e.params.qNum,this.subject=e.params.subject,this.year=e.params.year,this.datum=us.filter(t=>t.subject==e.params.subject&&t.year==e.params.year&&t.num==e.params.qNum)[0],this.correct=!1,this.show=!1,window.scrollTo(0,0),n()},methods:{prevQ(){this.$router.push({name:"tantou",params:{qNum:Number(this.num)-1}})},nextQ(){this.$router.push({name:"tantou",params:{qNum:Number(this.num)+1}})},showAnswer(e){this.correct=e,this.show=!0,window.scrollBy(0,1e3)},range(e,c){let n=[];for(let t=e;t<c;t++)n.push(t);return n}}},ib=ec("h1",null,"司法試験過去問題集・短答",-1);function ob(e,c,n,t,a,s){const u=Le("v-list-item"),l=Le("v-list"),r=Le("v-navigation-drawer"),o=Le("v-breadcrumbs"),i=Le("QuestionComponent"),d=Le("ChoicesComponent"),f=Le("ResultComponent"),v=Le("v-btn"),y=Le("v-main"),b=Le("v-layout");return Be(),cn(b,null,{default:Ae(()=>[m(r,{permanent:"",width:"150"},{default:Ae(()=>[m(l,{nav:""},{default:Ae(()=>[(Be(!0),tc(ve,null,Mn(a.questions,k=>(Be(),cn(u,{title:"第"+k+"問",to:"/tantou/"+a.subject+"/"+a.year+"/"+k,ref_for:!0,ref:"question"},null,8,["title","to"]))),256))]),_:1})]),_:1}),m(y,null,{default:Ae(()=>[ib,m(o,{items:s.breadcrumbs,divider:">"},null,8,["items"]),m(i,{datum:a.datum,subjectFull:a.subjectFull,num:a.num,year:a.year},null,8,["datum","subjectFull","num","year"]),m(d,{datum:a.datum,onShowAnswer:s.showAnswer},null,8,["datum","onShowAnswer"]),m(f,{datum:a.datum,show:a.show,correct:a.correct},null,8,["datum","show","correct"]),m(v,{onClick:s.prevQ},{default:Ae(()=>[ic("前の問題")]),_:1},8,["onClick"]),ic("　"),m(v,{onClick:s.nextQ},{default:Ae(()=>[ic("次の問題")]),_:1},8,["onClick"])]),_:1})]),_:1})}const db=zn(rb,[["render",ob]]),fb=zv({history:sv("/shihoushiken/"),routes:[{path:"/",name:"home",component:Zv},{path:"/search",name:"search",component:Hy},{path:"/tantou",name:"tantouTop",component:Yy},{path:"/tantou/:subject/:year/:qNum",name:"tantou",component:db}]});function Ei(e,c,n){mb(e,c),c.set(e,n)}function mb(e,c){if(c.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")}function vb(e,c,n){var t=X1(e,c,"set");return yb(e,t,n),n}function yb(e,c,n){if(c.set)c.set.call(e,n);else{if(!c.writable)throw new TypeError("attempted to set read only private field");c.value=n}}function Qn(e,c){var n=X1(e,c,"get");return bb(e,n)}function X1(e,c,n){if(!c.has(e))throw new TypeError("attempted to "+n+" private field on non-instance");return c.get(e)}function bb(e,c){return c.get?c.get.call(e):c.value}function Z1(e,c,n){const t=c.length-1;if(t<0)return e===void 0?n:e;for(let a=0;a<t;a++){if(e==null)return n;e=e[c[a]]}return e==null||e[c[t]]===void 0?n:e[c[t]]}function mt(e,c){if(e===c)return!0;if(e instanceof Date&&c instanceof Date&&e.getTime()!==c.getTime()||e!==Object(e)||c!==Object(c))return!1;const n=Object.keys(e);return n.length!==Object.keys(c).length?!1:n.every(t=>mt(e[t],c[t]))}function Fu(e,c,n){return e==null||!c||typeof c!="string"?n:e[c]!==void 0?e[c]:(c=c.replace(/\[(\w+)\]/g,".$1"),c=c.replace(/^\./,""),Z1(e,c.split("."),n))}function en(e,c,n){if(c==null)return e===void 0?n:e;if(e!==Object(e)){if(typeof c!="function")return n;const a=c(e,n);return typeof a>"u"?n:a}if(typeof c=="string")return Fu(e,c,n);if(Array.isArray(c))return Z1(e,c,n);if(typeof c!="function")return n;const t=c(e,n);return typeof t>"u"?n:t}function tn(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0;return Array.from({length:e},(n,t)=>c+t)}function le(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"px";if(!(e==null||e===""))return isNaN(+e)?String(e):isFinite(+e)?`${Number(e)}${c}`:void 0}function Nu(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}function hb(e){return e==null?void 0:e.$el}const Pi=Object.freeze({enter:13,tab:9,delete:46,esc:27,space:32,up:38,down:40,left:37,right:39,end:35,home:36,del:46,backspace:8,insert:45,pageup:33,pagedown:34,shift:16}),Du=Object.freeze({enter:"Enter",tab:"Tab",delete:"Delete",esc:"Escape",space:"Space",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight",end:"End",home:"Home",del:"Delete",backspace:"Backspace",insert:"Insert",pageup:"PageUp",pagedown:"PageDown",shift:"Shift"});function Q1(e){return Object.keys(e)}function Wt(e,c,n){const t=Object.create(null),a=Object.create(null);for(const s in e)c.some(u=>u instanceof RegExp?u.test(s):u===s)&&!(n!=null&&n.some(u=>u===s))?t[s]=e[s]:a[s]=e[s];return[t,a]}function on(e,c){const n={...e};return c.forEach(t=>delete n[t]),n}function vt(e){return Wt(e,["class","style","id",/^data-/])}function Tc(e){return e==null?[]:Array.isArray(e)?e:[e]}function fc(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:1;return Math.max(c,Math.min(n,e))}function Ti(e){const c=e.toString().trim();return c.includes(".")?c.length-c.indexOf(".")-1:0}function $i(e,c){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"0";return e+n.repeat(Math.max(0,c-e.length))}function gb(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:1;const n=[];let t=0;for(;t<e.length;)n.push(e.substr(t,c)),t+=c;return n}function Mi(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:1e3;if(e<c)return`${e} B`;const n=c===1024?["Ki","Mi","Gi"]:["k","M","G"];let t=-1;for(;Math.abs(e)>=c&&t<n.length-1;)e/=c,++t;return`${e.toFixed(1)} ${n[t]}B`}function jn(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=arguments.length>2?arguments[2]:void 0;const t={};for(const a in e)t[a]=e[a];for(const a in c){const s=e[a],u=c[a];if(Nu(s)&&Nu(u)){t[a]=jn(s,u,n);continue}if(Array.isArray(s)&&Array.isArray(u)&&n){t[a]=n(s,u);continue}t[a]=u}return t}function On(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"";if(On.cache.has(e))return On.cache.get(e);const c=e.replace(/[^a-z]/gi,"-").replace(/\B([A-Z])/g,"-$1").toLowerCase();return On.cache.set(e,c),c}On.cache=new Map;function ba(e,c){if(!c||typeof c!="object")return[];if(Array.isArray(c))return c.map(n=>ba(e,n)).flat(1);if(Array.isArray(c.children))return c.children.map(n=>ba(e,n)).flat(1);if(c.component){if(Object.getOwnPropertySymbols(c.component.provides).includes(e))return[c.component];if(c.component.subTree)return ba(e,c.component.subTree).flat(1)}return[]}var Za=new WeakMap,pt=new WeakMap;class jb{constructor(c){Ei(this,Za,{writable:!0,value:[]}),Ei(this,pt,{writable:!0,value:0}),this.size=c}push(c){Qn(this,Za)[Qn(this,pt)]=c,vb(this,pt,(Qn(this,pt)+1)%this.size)}values(){return Qn(this,Za).slice(Qn(this,pt)).concat(Qn(this,Za).slice(0,Qn(this,pt)))}}function qb(e){return"touches"in e?{clientX:e.touches[0].clientX,clientY:e.touches[0].clientY}:{clientX:e.clientX,clientY:e.clientY}}function Wl(e){const c=sc({}),n=h(e);return Kc(()=>{for(const t in n.value)c[t]=n.value[t]},{flush:"sync"}),Il(c)}function bs(e,c){return e.includes(c)}const kb=/^on[^a-z]/,pb=e=>kb.test(e),an=()=>[Function,Array];function Bi(e,c){return c="on"+pn(c),!!(e[c]||e[`${c}Once`]||e[`${c}Capture`]||e[`${c}OnceCapture`]||e[`${c}CaptureOnce`])}function Kl(e){for(var c=arguments.length,n=new Array(c>1?c-1:0),t=1;t<c;t++)n[t-1]=arguments[t];if(Array.isArray(e))for(const a of e)a(...n);else typeof e=="function"&&e(...n)}function Yl(e){const c=["button","[href]",'input:not([type="hidden"])',"select","textarea","[tabindex]"].map(n=>`${n}:not([tabindex="-1"]):not([disabled])`).join(", ");return[...e.querySelectorAll(c)]}function J1(e,c){var a,s,u;const n=Yl(e),t=n.indexOf(document.activeElement);if(!c)e.contains(document.activeElement)||(a=n[0])==null||a.focus();else if(c==="first")(s=n[0])==null||s.focus();else if(c==="last")(u=n.at(-1))==null||u.focus();else{let l,r=t;const o=c==="next"?1:-1;do r+=o,l=n[r];while((!l||l.offsetParent==null)&&r<n.length&&r>=0);l?l.focus():J1(e,c==="next"?"first":"last")}}const ed=["top","bottom"],Sb=["start","end","left","right"];function zu(e,c){let[n,t]=e.split(" ");return t||(t=bs(ed,n)?"start":bs(Sb,n)?"top":"center"),{side:Hu(n,c),align:Hu(t,c)}}function Hu(e,c){return e==="start"?c?"right":"left":e==="end"?c?"left":"right":e}function ru(e){return{side:{center:"center",top:"bottom",bottom:"top",left:"right",right:"left"}[e.side],align:e.align}}function iu(e){return{side:e.side,align:{center:"center",top:"bottom",bottom:"top",left:"right",right:"left"}[e.align]}}function Ri(e){return{side:e.align,align:e.side}}function Oi(e){return bs(ed,e.side)?"y":"x"}class Tt{constructor(c){let{x:n,y:t,width:a,height:s}=c;this.x=n,this.y=t,this.width=a,this.height=s}get top(){return this.y}get bottom(){return this.y+this.height}get left(){return this.x}get right(){return this.x+this.width}}function Li(e,c){return{x:{before:Math.max(0,c.left-e.left),after:Math.max(0,e.right-c.right)},y:{before:Math.max(0,c.top-e.top),after:Math.max(0,e.bottom-c.bottom)}}}function Gl(e){const c=e.getBoundingClientRect(),n=getComputedStyle(e),t=n.transform;if(t){let a,s,u,l,r;if(t.startsWith("matrix3d("))a=t.slice(9,-1).split(/, /),s=+a[0],u=+a[5],l=+a[12],r=+a[13];else if(t.startsWith("matrix("))a=t.slice(7,-1).split(/, /),s=+a[0],u=+a[3],l=+a[4],r=+a[5];else return new Tt(c);const o=n.transformOrigin,i=c.x-l-(1-s)*parseFloat(o),d=c.y-r-(1-u)*parseFloat(o.slice(o.indexOf(" ")+1)),f=s?c.width/s:e.offsetWidth+1,v=u?c.height/u:e.offsetHeight+1;return new Tt({x:i,y:d,width:f,height:v})}else return new Tt(c)}function ut(e,c,n){if(typeof e.animate>"u")return{finished:Promise.resolve()};let t;try{t=e.animate(c,n)}catch{return{finished:Promise.resolve()}}return typeof t.finished>"u"&&(t.finished=new Promise(a=>{t.onfinish=()=>{a(t)}})),t}function cd(e,c,n){if(n&&(c={__isVue:!0,$parent:n,$options:c}),c){if(c.$_alreadyWarned=c.$_alreadyWarned||[],c.$_alreadyWarned.includes(e))return;c.$_alreadyWarned.push(e)}return`[Vuetify] ${e}`+(c?xb(c):"")}function Ln(e,c,n){const t=cd(e,c,n);t!=null&&console.warn(t)}function Uu(e,c,n){const t=cd(e,c,n);t!=null&&console.error(t)}const Cb=/(?:^|[-_])(\w)/g,_b=e=>e.replace(Cb,c=>c.toUpperCase()).replace(/[-_]/g,"");function ou(e,c){if(e.$root===e)return"<Root>";const n=typeof e=="function"&&e.cid!=null?e.options:e.__isVue?e.$options||e.constructor.options:e||{};let t=n.name||n._componentTag;const a=n.__file;if(!t&&a){const s=a.match(/([^/\\]+)\.vue$/);t=s==null?void 0:s[1]}return(t?`<${_b(t)}>`:"<Anonymous>")+(a&&c!==!1?` at ${a}`:"")}function xb(e){if(e.__isVue&&e.$parent){const c=[];let n=0;for(;e;){if(c.length>0){const t=c[c.length-1];if(t.constructor===e.constructor){n++,e=e.$parent;continue}else n>0&&(c[c.length-1]=[t,n],n=0)}c.push(e),e=e.$parent}return`

found in

`+c.map((t,a)=>`${a===0?"---> ":" ".repeat(5+a*2)}${Array.isArray(t)?`${ou(t[0])}... (${t[1]} recursive calls)`:ou(t)}`).join(`
`)}else return`

(found in ${ou(e)})`}const wb=[[3.2406,-1.5372,-.4986],[-.9689,1.8758,.0415],[.0557,-.204,1.057]],Vb=e=>e<=.0031308?e*12.92:1.055*e**(1/2.4)-.055,Ib=[[.4124,.3576,.1805],[.2126,.7152,.0722],[.0193,.1192,.9505]],Ab=e=>e<=.04045?e/12.92:((e+.055)/1.055)**2.4;function nd(e){const c=Array(3),n=Vb,t=wb;for(let a=0;a<3;++a)c[a]=Math.round(fc(n(t[a][0]*e[0]+t[a][1]*e[1]+t[a][2]*e[2]))*255);return{r:c[0],g:c[1],b:c[2]}}function Xl(e){let{r:c,g:n,b:t}=e;const a=[0,0,0],s=Ab,u=Ib;c=s(c/255),n=s(n/255),t=s(t/255);for(let l=0;l<3;++l)a[l]=u[l][0]*c+u[l][1]*n+u[l][2]*t;return a}const hs=.20689655172413793,Eb=e=>e>hs**3?Math.cbrt(e):e/(3*hs**2)+4/29,Pb=e=>e>hs?e**3:3*hs**2*(e-4/29);function td(e){const c=Eb,n=c(e[1]);return[116*n-16,500*(c(e[0]/.95047)-n),200*(n-c(e[2]/1.08883))]}function ad(e){const c=Pb,n=(e[0]+16)/116;return[c(n+e[1]/500)*.95047,c(n),c(n-e[2]/200)*1.08883]}function Fi(e){return!!e&&/^(#|var\(--|(rgb|hsl)a?\()/.test(e)}function lt(e){if(typeof e=="number")return(isNaN(e)||e<0||e>16777215)&&Ln(`'${e}' is not a valid hex color`),{r:(e&16711680)>>16,g:(e&65280)>>8,b:e&255};if(typeof e=="string"){let c=e.startsWith("#")?e.slice(1):e;[3,4].includes(c.length)?c=c.split("").map(t=>t+t).join(""):[6,8].includes(c.length)||Ln(`'${e}' is not a valid hex(a) color`);const n=parseInt(c,16);return(isNaN(n)||n<0||n>4294967295)&&Ln(`'${e}' is not a valid hex(a) color`),id(c)}else throw new TypeError(`Colors can only be numbers or strings, recieved ${e==null?e:e.constructor.name} instead`)}function Ms(e){const{h:c,s:n,v:t,a}=e,s=l=>{const r=(l+c/60)%6;return t-t*n*Math.max(Math.min(r,4-r,1),0)},u=[s(5),s(3),s(1)].map(l=>Math.round(l*255));return{r:u[0],g:u[1],b:u[2],a}}function Zl(e){if(!e)return{h:0,s:1,v:1,a:1};const c=e.r/255,n=e.g/255,t=e.b/255,a=Math.max(c,n,t),s=Math.min(c,n,t);let u=0;a!==s&&(a===c?u=60*(0+(n-t)/(a-s)):a===n?u=60*(2+(t-c)/(a-s)):a===t&&(u=60*(4+(c-n)/(a-s)))),u<0&&(u=u+360);const l=a===0?0:(a-s)/a,r=[u,l,a];return{h:r[0],s:r[1],v:r[2],a:e.a}}function sd(e){const{h:c,s:n,v:t,a}=e,s=t-t*n/2,u=s===1||s===0?0:(t-s)/Math.min(s,1-s);return{h:c,s:u,l:s,a}}function ud(e){const{h:c,s:n,l:t,a}=e,s=t+n*Math.min(t,1-t),u=s===0?0:2-2*t/s;return{h:c,s:u,v:s,a}}function Tb(e){let{r:c,g:n,b:t,a}=e;return a===void 0?`rgb(${c}, ${n}, ${t})`:`rgba(${c}, ${n}, ${t}, ${a})`}function ld(e){return Tb(Ms(e))}function Qa(e){const c=Math.round(e).toString(16);return("00".substr(0,2-c.length)+c).toUpperCase()}function rd(e){let{r:c,g:n,b:t,a}=e;return`#${[Qa(c),Qa(n),Qa(t),a!==void 0?Qa(Math.round(a*255)):""].join("")}`}function id(e){e=fd(e);let[c,n,t,a]=gb(e,2).map(s=>parseInt(s,16));return a=a===void 0?a:a/255,{r:c,g:n,b:t,a}}function od(e){const c=id(e);return Zl(c)}function dd(e){return rd(Ms(e))}function fd(e){return e.startsWith("#")&&(e=e.slice(1)),e=e.replace(/([^0-9a-f])/gi,"F"),(e.length===3||e.length===4)&&(e=e.split("").map(c=>c+c).join("")),e.length!==6&&(e=$i($i(e,6),8,"F")),e}function $b(e,c){const n=td(Xl(e));return n[0]=n[0]+c*10,nd(ad(n))}function Mb(e,c){const n=td(Xl(e));return n[0]=n[0]-c*10,nd(ad(n))}function Wu(e){const c=lt(e);return Xl(c)[1]}function Bb(e,c){const n=Wu(e),t=Wu(c),a=Math.max(n,t),s=Math.min(n,t);return(a+.05)/(s+.05)}function he(e,c){return n=>Object.keys(e).reduce((t,a)=>{const u=typeof e[a]=="object"&&e[a]!=null&&!Array.isArray(e[a])?e[a]:{type:e[a]};return n&&a in n?t[a]={...u,default:n[a]}:t[a]=u,c&&!t[a].source&&(t[a].source=c),t},{})}const ne=he({class:[String,Array],style:{type:[String,Array,Object],default:null}},"component");function Nn(e,c){let n;function t(){n=ql(),n.run(()=>c.length?c(()=>{n==null||n.stop(),t()}):c())}ae(e,a=>{a&&!n?t():a||(n==null||n.stop(),n=void 0)},{immediate:!0}),Vc(()=>{n==null||n.stop()})}const wa=Symbol.for("vuetify:defaults");function Rb(e){return $(e)}function Ql(){const e=Ve(wa);if(!e)throw new Error("[Vuetify] Could not find defaults instance");return e}function Je(e,c){const n=Ql(),t=$(e),a=h(()=>{if(dc(c==null?void 0:c.disabled))return n.value;const u=dc(c==null?void 0:c.scoped),l=dc(c==null?void 0:c.reset),r=dc(c==null?void 0:c.root);let o=jn(t.value,{prev:n.value});if(u)return o;if(l||r){const i=Number(l||1/0);for(let d=0;d<=i&&!(!o||!("prev"in o));d++)o=o.prev;return o}return o.prev?jn(o.prev,o):o});return Ke(wa,a),a}function Ob(e,c){var n,t;return typeof((n=e.props)==null?void 0:n[c])<"u"||typeof((t=e.props)==null?void 0:t[On(c)])<"u"}function Lb(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},c=arguments.length>1?arguments[1]:void 0,n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Ql();const t=lc("useDefaults");if(c=c??t.type.name??t.type.__name,!c)throw new Error("[Vuetify] Could not determine component name");const a=h(()=>{var r;return(r=n.value)==null?void 0:r[e._as??c]}),s=new Proxy(e,{get(r,o){var d,f,v,y;const i=Reflect.get(r,o);return o==="class"||o==="style"?[(d=a.value)==null?void 0:d[o],i].filter(b=>b!=null):typeof o=="string"&&!Ob(t.vnode,o)?((f=a.value)==null?void 0:f[o])??((y=(v=n.value)==null?void 0:v.global)==null?void 0:y[o])??i:i}}),u=Vl();Kc(()=>{if(a.value){const r=Object.entries(a.value).filter(o=>{let[i]=o;return i.startsWith(i[0].toUpperCase())});r.length&&(u.value=Object.fromEntries(r))}});function l(){Nn(u,()=>{var r;Je(jn(((r=zb(wa))==null?void 0:r.value)??{},u.value))})}return{props:s,provideSubDefaults:l}}function Mc(e){if(e._setup=e._setup??e.setup,!e.name)return Ln("The component is missing an explicit name, unable to generate default prop value"),e;if(e._setup){e.props=he(e.props??{},On(e.name))();const c=Object.keys(e.props);e.filterProps=function(t){return Wt(t,c,["class","style"])},e.props._as=String,e.setup=function(t,a){const s=Ql();if(!s.value)return e._setup(t,a);const{props:u,provideSubDefaults:l}=Lb(t,t._as??e.name,s),r=e._setup(u,a);return l(),r}}return e}function W(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:!0;return c=>(e?Mc:$l)(c)}function Yc(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"div",n=arguments.length>2?arguments[2]:void 0;return W()({name:n??pn($c(e.replace(/__/g,"-"))),props:{tag:{type:String,default:c},...ne()},setup(t,a){let{slots:s}=a;return()=>{var u;return ln(t.tag,{class:[e,t.class],style:t.style},(u=s.default)==null?void 0:u.call(s))}}})}function md(e){if(typeof e.getRootNode!="function"){for(;e.parentNode;)e=e.parentNode;return e!==document?null:document}const c=e.getRootNode();return c!==document&&c.getRootNode({composed:!0})!==document?null:c}const Va="cubic-bezier(0.4, 0, 0.2, 1)",Fb="cubic-bezier(0.0, 0, 0.2, 1)",Nb="cubic-bezier(0.4, 0, 1, 1)";function lc(e,c){const n=Ps();if(!n)throw new Error(`[Vuetify] ${e} ${c||"must be called from inside a setup function"}`);return n}function Cn(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"composables";const c=lc(e).type;return On((c==null?void 0:c.aliasName)||(c==null?void 0:c.name))}let vd=0,ls=new WeakMap;function yc(){const e=lc("getUid");if(ls.has(e))return ls.get(e);{const c=vd++;return ls.set(e,c),c}}yc.reset=()=>{vd=0,ls=new WeakMap};function yd(e){for(;e;){if(Jl(e))return e;e=e.parentElement}return document.scrollingElement}function gs(e,c){const n=[];if(c&&e&&!c.contains(e))return n;for(;e&&(Jl(e)&&n.push(e),e!==c);)e=e.parentElement;return n}function Jl(e){if(!e||e.nodeType!==Node.ELEMENT_NODE)return!1;const c=window.getComputedStyle(e);return c.overflowY==="scroll"||c.overflowY==="auto"&&e.scrollHeight>e.clientHeight}const Xe=typeof window<"u",er=Xe&&"IntersectionObserver"in window,Db=Xe&&("ontouchstart"in window||window.navigator.maxTouchPoints>0),Ku=Xe&&typeof CSS<"u"&&typeof CSS.supports<"u"&&CSS.supports("selector(:focus-visible)");function zb(e){const{provides:c}=lc("injectSelf");if(c&&e in c)return c[e]}function Hb(e){for(;e;){if(window.getComputedStyle(e).position==="fixed")return!0;e=e.offsetParent}return!1}function X(e){const c=lc("useRender");c.render=e}function pe(e,c,n){let t=arguments.length>3&&arguments[3]!==void 0?arguments[3]:d=>d,a=arguments.length>4&&arguments[4]!==void 0?arguments[4]:d=>d;const s=lc("useProxiedModel"),u=$(e[c]!==void 0?e[c]:n),l=On(c),o=h(l!==c?()=>{var d,f,v,y;return e[c],!!(((d=s.vnode.props)!=null&&d.hasOwnProperty(c)||(f=s.vnode.props)!=null&&f.hasOwnProperty(l))&&((v=s.vnode.props)!=null&&v.hasOwnProperty(`onUpdate:${c}`)||(y=s.vnode.props)!=null&&y.hasOwnProperty(`onUpdate:${l}`)))}:()=>{var d,f;return e[c],!!((d=s.vnode.props)!=null&&d.hasOwnProperty(c)&&((f=s.vnode.props)!=null&&f.hasOwnProperty(`onUpdate:${c}`)))});Nn(()=>!o.value,()=>{ae(()=>e[c],d=>{u.value=d})});const i=h({get(){const d=e[c];return t(o.value?d:u.value)},set(d){const f=a(d),v=Ce(o.value?e[c]:u.value);v===f||t(v)===d||(u.value=f,s==null||s.emit(`update:${c}`,f))}});return Object.defineProperty(i,"externalValue",{get:()=>o.value?e[c]:u.value}),i}const Ub={badge:"Badge",close:"Close",dataIterator:{noResultsText:"No matching records found",loadingText:"Loading items..."},dataTable:{itemsPerPageText:"Rows per page:",ariaLabel:{sortDescending:"Sorted descending.",sortAscending:"Sorted ascending.",sortNone:"Not sorted.",activateNone:"Activate to remove sorting.",activateDescending:"Activate to sort descending.",activateAscending:"Activate to sort ascending."},sortBy:"Sort by"},dataFooter:{itemsPerPageText:"Items per page:",itemsPerPageAll:"All",nextPage:"Next page",prevPage:"Previous page",firstPage:"First page",lastPage:"Last page",pageText:"{0}-{1} of {2}"},datePicker:{itemsSelected:"{0} selected",nextMonthAriaLabel:"Next month",nextYearAriaLabel:"Next year",prevMonthAriaLabel:"Previous month",prevYearAriaLabel:"Previous year"},noDataText:"No data available",carousel:{prev:"Previous visual",next:"Next visual",ariaLabel:{delimiter:"Carousel slide {0} of {1}"}},calendar:{moreEvents:"{0} more"},input:{clear:"Clear {0}",prependAction:"{0} prepended action",appendAction:"{0} appended action"},fileInput:{counter:"{0} files",counterSize:"{0} files ({1} in total)"},timePicker:{am:"AM",pm:"PM"},pagination:{ariaLabel:{root:"Pagination Navigation",next:"Next page",previous:"Previous page",page:"Go to page {0}",currentPage:"Page {0}, Current page",first:"First page",last:"Last page"}},rating:{ariaLabel:{item:"Rating {0} of {1}"}},loading:"Loading...",infiniteScroll:{loadMore:"Load more",empty:"No more"}},Ni="$vuetify.",Di=(e,c)=>e.replace(/\{(\d+)\}/g,(n,t)=>String(c[+t])),bd=(e,c,n)=>function(t){for(var a=arguments.length,s=new Array(a>1?a-1:0),u=1;u<a;u++)s[u-1]=arguments[u];if(!t.startsWith(Ni))return Di(t,s);const l=t.replace(Ni,""),r=e.value&&n.value[e.value],o=c.value&&n.value[c.value];let i=Fu(r,l,null);return i||(Ln(`Translation key "${t}" not found in "${e.value}", trying fallback locale`),i=Fu(o,l,null)),i||(Uu(`Translation key "${t}" not found in fallback`),i=t),typeof i!="string"&&(Uu(`Translation key "${t}" has a non-string value`),i=t),Di(i,s)};function hd(e,c){return(n,t)=>new Intl.NumberFormat([e.value,c.value],t).format(n)}function du(e,c,n){const t=pe(e,c,e[c]??n.value);return t.value=e[c]??n.value,ae(n,a=>{e[c]==null&&(t.value=n.value)}),t}function gd(e){return c=>{const n=du(c,"locale",e.current),t=du(c,"fallback",e.fallback),a=du(c,"messages",e.messages);return{name:"vuetify",current:n,fallback:t,messages:a,t:bd(n,t,a),n:hd(n,t),provide:gd({current:n,fallback:t,messages:a})}}}function Wb(e){const c=$((e==null?void 0:e.locale)??"en"),n=$((e==null?void 0:e.fallback)??"en"),t=$({en:Ub,...e==null?void 0:e.messages});return{name:"vuetify",current:c,fallback:n,messages:t,t:bd(c,n,t),n:hd(c,n),provide:gd({current:c,fallback:n,messages:t})}}const Kb={af:!1,ar:!0,bg:!1,ca:!1,ckb:!1,cs:!1,de:!1,el:!1,en:!1,es:!1,et:!1,fa:!0,fi:!1,fr:!1,hr:!1,hu:!1,he:!0,id:!1,it:!1,ja:!1,ko:!1,lv:!1,lt:!1,nl:!1,no:!1,pl:!1,pt:!1,ro:!1,ru:!1,sk:!1,sl:!1,srCyrl:!1,srLatn:!1,sv:!1,th:!1,tr:!1,az:!1,uk:!1,vi:!1,zhHans:!1,zhHant:!1},Lt=Symbol.for("vuetify:locale");function Yb(e){return e.name!=null}function Gb(e){const c=e!=null&&e.adapter&&Yb(e==null?void 0:e.adapter)?e==null?void 0:e.adapter:Wb(e),n=Zb(c,e);return{...c,...n}}function Bc(){const e=Ve(Lt);if(!e)throw new Error("[Vuetify] Could not find injected locale instance");return e}function Xb(e){const c=Ve(Lt);if(!c)throw new Error("[Vuetify] Could not find injected locale instance");const n=c.provide(e),t=Qb(n,c.rtl,e),a={...n,...t};return Ke(Lt,a),a}function Zb(e,c){const n=$((c==null?void 0:c.rtl)??Kb),t=h(()=>n.value[e.current.value]??!1);return{isRtl:t,rtl:n,rtlClasses:h(()=>`v-locale--is-${t.value?"rtl":"ltr"}`)}}function Qb(e,c,n){const t=h(()=>n.rtl??c.value[e.current.value]??!1);return{isRtl:t,rtl:c,rtlClasses:h(()=>`v-locale--is-${t.value?"rtl":"ltr"}`)}}function _n(){const e=Ve(Lt);if(!e)throw new Error("[Vuetify] Could not find injected rtl instance");return{isRtl:e.isRtl,rtlClasses:e.rtlClasses}}function Jb(e){let c=[];const n=[],t=jd(e),a=qd(e);for(let s=0;s<t.getDay();s++)c.push(null);for(let s=1;s<=a.getDate();s++){const u=new Date(e.getFullYear(),e.getMonth(),s);c.push(u),c.length===7&&(n.push(c),c=[])}for(let s=c.length;s<7;s++)c.push(null);return n.push(c),n}function jd(e){return new Date(e.getFullYear(),e.getMonth(),1)}function qd(e){return new Date(e.getFullYear(),e.getMonth()+1,0)}function eh(e){if(e==null)return null;if(e instanceof Date)return e;if(typeof e=="string"){const c=Date.parse(e);if(!isNaN(c))return new Date(c)}return null}const ch={"001":1,AD:1,AE:6,AF:6,AG:0,AI:1,AL:1,AM:1,AN:1,AR:1,AS:0,AT:1,AU:0,AX:1,AZ:1,BA:1,BD:0,BE:1,BG:1,BH:6,BM:1,BN:1,BR:0,BS:0,BT:0,BW:0,BY:1,BZ:0,CA:0,CH:1,CL:1,CM:1,CN:0,CO:0,CR:1,CY:1,CZ:1,DE:1,DJ:6,DK:1,DM:0,DO:0,DZ:6,EC:1,EE:1,EG:6,ES:1,ET:0,FI:1,FJ:1,FO:1,FR:1,GB:1,"GB-alt-variant":0,GE:1,GF:1,GP:1,GR:1,GT:0,GU:0,HK:0,HN:0,HR:1,HU:1,ID:0,IE:1,IL:0,IN:0,IQ:6,IR:6,IS:1,IT:1,JM:0,JO:6,JP:0,KE:0,KG:1,KH:0,KR:0,KW:6,KZ:1,LA:0,LB:1,LI:1,LK:1,LT:1,LU:1,LV:1,LY:6,MC:1,MD:1,ME:1,MH:0,MK:1,MM:0,MN:1,MO:0,MQ:1,MT:0,MV:5,MX:0,MY:1,MZ:0,NI:0,NL:1,NO:1,NP:0,NZ:1,OM:6,PA:0,PE:0,PH:0,PK:0,PL:1,PR:0,PT:0,PY:0,QA:6,RE:1,RO:1,RS:1,RU:1,SA:0,SD:6,SE:1,SG:0,SI:1,SK:1,SM:1,SV:0,SY:6,TH:0,TJ:1,TM:1,TR:1,TT:0,TW:0,UA:1,UM:0,US:0,UY:1,UZ:1,VA:1,VE:0,VI:0,VN:1,WS:0,XK:1,YE:0,ZA:0,ZW:0},zi=new Date(2e3,0,2);function nh(e){const c=ch[e.slice(-2).toUpperCase()];return tn(7).map(n=>{const t=new Date(zi);return t.setDate(zi.getDate()+c+n),new Intl.DateTimeFormat(e,{weekday:"long"}).format(t)})}function th(e,c,n){const t=new Date(e);let a={};switch(c){case"fullDateWithWeekday":a={weekday:"long",day:"numeric",month:"long",year:"numeric"};break;case"normalDateWithWeekday":a={weekday:"short",day:"numeric",month:"short",year:"numeric"};break;case"keyboardDate":a={};break;case"monthAndDate":a={month:"long",day:"numeric"};break;case"monthAndYear":a={month:"long",year:"numeric"};break;default:a={timeZone:"UTC",timeZoneName:"short"}}return new Intl.DateTimeFormat(n,a).format(t)}function ah(e,c){const n=new Date(e);return n.setDate(n.getDate()+c),n}function sh(e,c){const n=new Date(e);return n.setMonth(n.getMonth()+c),n}function uh(e){return e.getFullYear()}function lh(e){return e.getMonth()}function rh(e){return new Date(e.getFullYear(),0,1)}function ih(e){return new Date(e.getFullYear(),11,31)}function fu(e){return new Date(e,0,1)}function oh(e){let c=e.getFullYear(),n=fu(c);if(e<n)c=c-1,n=fu(c);else{const s=fu(c+1);e>=s&&(c=c+1,n=s)}const t=Math.abs(e.getTime()-n.getTime()),a=Math.ceil(t/(1e3*60*60*24));return Math.floor(a/7)+1}function dh(e,c){return kd(e,c[0])&&mh(e,c[1])}function fh(e){const c=new Date(e);return c instanceof Date&&!isNaN(c.getTime())}function kd(e,c){return e.getTime()>c.getTime()}function mh(e,c){return e.getTime()<c.getTime()}function vh(e,c){return e.getTime()===c.getTime()}function yh(e,c){return e.getDate()===c.getDate()&&e.getMonth()===c.getMonth()&&e.getFullYear()===c.getFullYear()}function bh(e,c){return e.getMonth()===c.getMonth()&&e.getFullYear()===c.getFullYear()}function hh(e,c,n){const t=new Date(e),a=new Date(c);return n==="month"?t.getMonth()-a.getMonth()+(t.getFullYear()-a.getFullYear())*12:Math.floor((t.getTime()-a.getTime())/(1e3*60*60*24))}function gh(e,c){const n=new Date(e);return n.setFullYear(c),n}class jh{constructor(){let c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"en";this.locale=c}date(c){return eh(c)}addDays(c,n){return ah(c,n)}addMonths(c,n){return sh(c,n)}getWeekArray(c){return Jb(c)}startOfMonth(c){return jd(c)}endOfMonth(c){return qd(c)}format(c,n){return th(c,n,this.locale)}isEqual(c,n){return vh(c,n)}isValid(c){return fh(c)}isWithinRange(c,n){return dh(c,n)}isAfter(c,n){return kd(c,n)}isSameDay(c,n){return yh(c,n)}isSameMonth(c,n){return bh(c,n)}setYear(c,n){return gh(c,n)}getDiff(c,n,t){return hh(c,n,t)}getWeek(c){return oh(c)}getWeekdays(){return nh(this.locale)}getYear(c){return uh(c)}getMonth(c){return lh(c)}startOfYear(c){return rh(c)}endOfYear(c){return ih(c)}}const Hi=Symbol.for("vuetify:date-adapter");function qh(e){return e??{adapter:jh}}const Bs=["sm","md","lg","xl","xxl"],Yu=Symbol.for("vuetify:display"),Ui={mobileBreakpoint:"lg",thresholds:{xs:0,sm:600,md:960,lg:1280,xl:1920,xxl:2560}},kh=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Ui;return jn(Ui,e)};function Wi(e){return Xe&&!e?window.innerWidth:0}function Ki(e){return Xe&&!e?window.innerHeight:0}function Yi(e){const c=Xe&&!e?window.navigator.userAgent:"ssr";function n(y){return!!c.match(y)}const t=n(/android/i),a=n(/iphone|ipad|ipod/i),s=n(/cordova/i),u=n(/electron/i),l=n(/chrome/i),r=n(/edge/i),o=n(/firefox/i),i=n(/opera/i),d=n(/win/i),f=n(/mac/i),v=n(/linux/i);return{android:t,ios:a,cordova:s,electron:u,chrome:l,edge:r,firefox:o,opera:i,win:d,mac:f,linux:v,touch:Db,ssr:c==="ssr"}}function ph(e,c){const{thresholds:n,mobileBreakpoint:t}=kh(e),a=$(Ki(c)),s=Vl(Yi(c)),u=sc({}),l=$(Wi(c));function r(){a.value=Ki(),l.value=Wi()}function o(){r(),s.value=Yi()}return Kc(()=>{const i=l.value<n.sm,d=l.value<n.md&&!i,f=l.value<n.lg&&!(d||i),v=l.value<n.xl&&!(f||d||i),y=l.value<n.xxl&&!(v||f||d||i),b=l.value>=n.xxl,k=i?"xs":d?"sm":f?"md":v?"lg":y?"xl":"xxl",g=typeof t=="number"?t:n[t],p=l.value<g;u.xs=i,u.sm=d,u.md=f,u.lg=v,u.xl=y,u.xxl=b,u.smAndUp=!i,u.mdAndUp=!(i||d),u.lgAndUp=!(i||d||f),u.xlAndUp=!(i||d||f||v),u.smAndDown=!(f||v||y||b),u.mdAndDown=!(v||y||b),u.lgAndDown=!(y||b),u.xlAndDown=!b,u.name=k,u.height=a.value,u.width=l.value,u.mobile=p,u.mobileBreakpoint=t,u.platform=s.value,u.thresholds=n}),Xe&&window.addEventListener("resize",r,{passive:!0}),{...Il(u),update:o,ssr:!!c}}function yt(){const e=Ve(Yu);if(!e)throw new Error("Could not find Vuetify display injection");return e}const Sh={collapse:"mdi-chevron-up",complete:"mdi-check",cancel:"mdi-close-circle",close:"mdi-close",delete:"mdi-close-circle",clear:"mdi-close-circle",success:"mdi-check-circle",info:"mdi-information",warning:"mdi-alert-circle",error:"mdi-close-circle",prev:"mdi-chevron-left",next:"mdi-chevron-right",checkboxOn:"mdi-checkbox-marked",checkboxOff:"mdi-checkbox-blank-outline",checkboxIndeterminate:"mdi-minus-box",delimiter:"mdi-circle",sortAsc:"mdi-arrow-up",sortDesc:"mdi-arrow-down",expand:"mdi-chevron-down",menu:"mdi-menu",subgroup:"mdi-menu-down",dropdown:"mdi-menu-down",radioOn:"mdi-radiobox-marked",radioOff:"mdi-radiobox-blank",edit:"mdi-pencil",ratingEmpty:"mdi-star-outline",ratingFull:"mdi-star",ratingHalf:"mdi-star-half-full",loading:"mdi-cached",first:"mdi-page-first",last:"mdi-page-last",unfold:"mdi-unfold-more-horizontal",file:"mdi-paperclip",plus:"mdi-plus",minus:"mdi-minus"},Ch={component:e=>ln(nr,{...e,class:"mdi"})},je=[String,Function,Object,Array],Gu=Symbol.for("vuetify:icons"),Rs=he({icon:{type:je},tag:{type:String,required:!0}},"icon"),Xu=W()({name:"VComponentIcon",props:Rs(),setup(e,c){let{slots:n}=c;return()=>{const t=e.icon;return m(e.tag,null,{default:()=>{var a;return[e.icon?m(t,null,null):(a=n.default)==null?void 0:a.call(n)]}})}}}),cr=Mc({name:"VSvgIcon",inheritAttrs:!1,props:Rs(),setup(e,c){let{attrs:n}=c;return()=>m(e.tag,se(n,{style:null}),{default:()=>[m("svg",{class:"v-icon__svg",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",role:"img","aria-hidden":"true"},[Array.isArray(e.icon)?e.icon.map(t=>Array.isArray(t)?m("path",{d:t[0],"fill-opacity":t[1]},null):m("path",{d:t},null)):m("path",{d:e.icon},null)])]})}}),_h=Mc({name:"VLigatureIcon",props:Rs(),setup(e){return()=>m(e.tag,null,{default:()=>[e.icon]})}}),nr=Mc({name:"VClassIcon",props:Rs(),setup(e){return()=>m(e.tag,{class:e.icon},null)}}),xh={svg:{component:cr},class:{component:nr}};function wh(e){return jn({defaultSet:"mdi",sets:{...xh,mdi:Ch},aliases:Sh},e)}const Vh=e=>{const c=Ve(Gu);if(!c)throw new Error("Missing Vuetify Icons provide!");return{iconData:h(()=>{var r;const t=dc(e);if(!t)return{component:Xu};let a=t;if(typeof a=="string"&&(a=a.trim(),a.startsWith("$")&&(a=(r=c.aliases)==null?void 0:r[a.slice(1)])),!a)throw new Error(`Could not find aliased icon "${t}"`);if(Array.isArray(a))return{component:cr,icon:a};if(typeof a!="string")return{component:Xu,icon:a};const s=Object.keys(c.sets).find(o=>typeof a=="string"&&a.startsWith(`${o}:`)),u=s?a.slice(s.length+1):a;return{component:c.sets[s??c.defaultSet].component,icon:u}})}},St=2.4,Gi=.2126729,Xi=.7151522,Zi=.072175,Ih=.55,Ah=.58,Eh=.57,Ph=.62,Ja=.03,Qi=1.45,Th=5e-4,$h=1.25,Mh=1.25,Ji=.078,eo=12.82051282051282,es=.06,co=.001;function no(e,c){const n=(e.r/255)**St,t=(e.g/255)**St,a=(e.b/255)**St,s=(c.r/255)**St,u=(c.g/255)**St,l=(c.b/255)**St;let r=n*Gi+t*Xi+a*Zi,o=s*Gi+u*Xi+l*Zi;if(r<=Ja&&(r+=(Ja-r)**Qi),o<=Ja&&(o+=(Ja-o)**Qi),Math.abs(o-r)<Th)return 0;let i;if(o>r){const d=(o**Ih-r**Ah)*$h;i=d<co?0:d<Ji?d-d*eo*es:d-es}else{const d=(o**Ph-r**Eh)*Mh;i=d>-co?0:d>-Ji?d-d*eo*es:d+es}return i*100}const Ia=Symbol.for("vuetify:theme"),Ie=he({theme:String},"theme"),la={defaultTheme:"light",variations:{colors:[],lighten:0,darken:0},themes:{light:{dark:!1,colors:{background:"#FFFFFF",surface:"#FFFFFF","surface-variant":"#424242","on-surface-variant":"#EEEEEE",primary:"#6200EE","primary-darken-1":"#3700B3",secondary:"#03DAC6","secondary-darken-1":"#018786",error:"#B00020",info:"#2196F3",success:"#4CAF50",warning:"#FB8C00"},variables:{"border-color":"#000000","border-opacity":.12,"high-emphasis-opacity":.87,"medium-emphasis-opacity":.6,"disabled-opacity":.38,"idle-opacity":.04,"hover-opacity":.04,"focus-opacity":.12,"selected-opacity":.08,"activated-opacity":.12,"pressed-opacity":.12,"dragged-opacity":.08,"theme-kbd":"#212529","theme-on-kbd":"#FFFFFF","theme-code":"#F5F5F5","theme-on-code":"#000000"}},dark:{dark:!0,colors:{background:"#121212",surface:"#212121","surface-variant":"#BDBDBD","on-surface-variant":"#424242",primary:"#BB86FC","primary-darken-1":"#3700B3",secondary:"#03DAC5","secondary-darken-1":"#03DAC5",error:"#CF6679",info:"#2196F3",success:"#4CAF50",warning:"#FB8C00"},variables:{"border-color":"#FFFFFF","border-opacity":.12,"high-emphasis-opacity":.87,"medium-emphasis-opacity":.6,"disabled-opacity":.38,"idle-opacity":.1,"hover-opacity":.04,"focus-opacity":.12,"selected-opacity":.08,"activated-opacity":.12,"pressed-opacity":.16,"dragged-opacity":.08,"theme-kbd":"#212529","theme-on-kbd":"#FFFFFF","theme-code":"#343434","theme-on-code":"#CCCCCC"}}}};function Bh(){var n,t;let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:la;if(!e)return{...la,isDisabled:!0};const c={};for(const[a,s]of Object.entries(e.themes??{})){const u=s.dark||a==="dark"?(n=la.themes)==null?void 0:n.dark:(t=la.themes)==null?void 0:t.light;c[a]=jn(u,s)}return jn(la,{...e,themes:c})}function Rh(e){const c=sc(Bh(e)),n=$(c.defaultTheme),t=$(c.themes),a=h(()=>{const i={};for(const[d,f]of Object.entries(t.value)){const v=i[d]={...f,colors:{...f.colors}};if(c.variations)for(const y of c.variations.colors){const b=v.colors[y];if(b)for(const k of["lighten","darken"]){const g=k==="lighten"?$b:Mb;for(const p of tn(c.variations[k],1))v.colors[`${y}-${k}-${p}`]=rd(g(lt(b),p))}}for(const y of Object.keys(v.colors)){if(/^on-[a-z]/.test(y)||v.colors[`on-${y}`])continue;const b=`on-${y}`,k=lt(v.colors[y]),g=Math.abs(no(lt(0),k)),p=Math.abs(no(lt(16777215),k));v.colors[b]=p>Math.min(g,50)?"#fff":"#000"}}return i}),s=h(()=>a.value[n.value]),u=h(()=>{const i=[];s.value.dark&&Jn(i,":root",["color-scheme: dark"]),Jn(i,":root",to(s.value));for(const[y,b]of Object.entries(a.value))Jn(i,`.v-theme--${y}`,[`color-scheme: ${b.dark?"dark":"normal"}`,...to(b)]);const d=[],f=[],v=new Set(Object.values(a.value).flatMap(y=>Object.keys(y.colors)));for(const y of v)/^on-[a-z]/.test(y)?Jn(f,`.${y}`,[`color: rgb(var(--v-theme-${y})) !important`]):(Jn(d,`.bg-${y}`,[`--v-theme-overlay-multiplier: var(--v-theme-${y}-overlay-multiplier)`,`background-color: rgb(var(--v-theme-${y})) !important`,`color: rgb(var(--v-theme-on-${y})) !important`]),Jn(f,`.text-${y}`,[`color: rgb(var(--v-theme-${y})) !important`]),Jn(f,`.border-${y}`,[`--v-border-color: var(--v-theme-${y})`]));return i.push(...d,...f),i.map((y,b)=>b===0?y:`    ${y}`).join("")});function l(){return{style:[{children:u.value,id:"vuetify-theme-stylesheet",nonce:c.cspNonce||!1}]}}function r(i){const d=i._context.provides.usehead;if(d)if(d.push){const v=d.push(l);ae(u,()=>{v.patch(l)})}else Xe?(d.addHeadObjs(h(l)),Kc(()=>d.updateDOM())):d.addHeadObjs(l());else{let y=function(){if(!c.isDisabled){if(typeof document<"u"&&!v){const b=document.createElement("style");b.type="text/css",b.id="vuetify-theme-stylesheet",c.cspNonce&&b.setAttribute("nonce",c.cspNonce),v=b,document.head.appendChild(v)}v&&(v.innerHTML=u.value)}};var f=y;let v=Xe?document.getElementById("vuetify-theme-stylesheet"):null;ae(u,y,{immediate:!0})}}const o=h(()=>c.isDisabled?void 0:`v-theme--${n.value}`);return{install:r,isDisabled:c.isDisabled,name:n,themes:t,current:s,computedThemes:a,themeClasses:o,styles:u,global:{name:n,current:s}}}function Pe(e){lc("provideTheme");const c=Ve(Ia,null);if(!c)throw new Error("Could not find Vuetify theme injection");const n=h(()=>e.theme??(c==null?void 0:c.name.value)),t=h(()=>c.isDisabled?void 0:`v-theme--${n.value}`),a={...c,name:n,themeClasses:t};return Ke(Ia,a),a}function pd(){lc("useTheme");const e=Ve(Ia,null);if(!e)throw new Error("Could not find Vuetify theme injection");return e}function Jn(e,c,n){e.push(`${c} {
`,...n.map(t=>`  ${t};
`),`}
`)}function to(e){const c=e.dark?2:1,n=e.dark?1:2,t=[];for(const[a,s]of Object.entries(e.colors)){const u=lt(s);t.push(`--v-theme-${a}: ${u.r},${u.g},${u.b}`),a.startsWith("on-")||t.push(`--v-theme-${a}-overlay-multiplier: ${Wu(s)>.18?c:n}`)}for(const[a,s]of Object.entries(e.variables)){const u=typeof s=="string"&&s.startsWith("#")?lt(s):void 0,l=u?`${u.r}, ${u.g}, ${u.b}`:void 0;t.push(`--v-${a}: ${l??s}`)}return t}function un(e){const c=$(),n=$();if(Xe){const t=new ResizeObserver(a=>{e==null||e(a,t),a.length&&(n.value=a[0].contentRect)});jc(()=>{t.disconnect()}),ae(c,(a,s)=>{s&&(t.unobserve(s),n.value=void 0),a&&t.observe(a)},{flush:"post"})}return{resizeRef:c,contentRect:$a(n)}}const js=Symbol.for("vuetify:layout"),Sd=Symbol.for("vuetify:layout-item"),ao=1e3,Cd=he({overlaps:{type:Array,default:()=>[]},fullHeight:Boolean},"layout"),Kt=he({name:{type:String},order:{type:[Number,String],default:0},absolute:Boolean},"layout-item");function Oh(){const e=Ve(js);if(!e)throw new Error("[Vuetify] Could not find injected layout");return{getLayoutItem:e.getLayoutItem,mainRect:e.mainRect,mainStyles:e.mainStyles}}function Yt(e){const c=Ve(js);if(!c)throw new Error("[Vuetify] Could not find injected layout");const n=e.id??`layout-item-${yc()}`,t=lc("useLayoutItem");Ke(Sd,{id:n});const a=$(!1);u1(()=>a.value=!0),s1(()=>a.value=!1);const{layoutItemStyles:s,layoutItemScrimStyles:u}=c.register(t,{...e,active:h(()=>a.value?!1:e.active.value),id:n});return jc(()=>c.unregister(n)),{layoutItemStyles:s,layoutRect:c.layoutRect,layoutItemScrimStyles:u}}const Lh=(e,c,n,t)=>{let a={top:0,left:0,right:0,bottom:0};const s=[{id:"",layer:{...a}}];for(const u of e){const l=c.get(u),r=n.get(u),o=t.get(u);if(!l||!r||!o)continue;const i={...a,[l.value]:parseInt(a[l.value],10)+(o.value?parseInt(r.value,10):0)};s.push({id:u,layer:i}),a=i}return s};function _d(e){const c=Ve(js,null),n=h(()=>c?c.rootZIndex.value-100:ao),t=$([]),a=sc(new Map),s=sc(new Map),u=sc(new Map),l=sc(new Map),r=sc(new Map),{resizeRef:o,contentRect:i}=un(),d=h(()=>{const I=new Map,A=e.overlaps??[];for(const q of A.filter(C=>C.includes(":"))){const[C,w]=q.split(":");if(!t.value.includes(C)||!t.value.includes(w))continue;const V=a.get(C),_=a.get(w),M=s.get(C),N=s.get(w);!V||!_||!M||!N||(I.set(w,{position:V.value,amount:parseInt(M.value,10)}),I.set(C,{position:_.value,amount:-parseInt(N.value,10)}))}return I}),f=h(()=>{const I=[...new Set([...u.values()].map(q=>q.value))].sort((q,C)=>q-C),A=[];for(const q of I){const C=t.value.filter(w=>{var V;return((V=u.get(w))==null?void 0:V.value)===q});A.push(...C)}return Lh(A,a,s,l)}),v=h(()=>!Array.from(r.values()).some(I=>I.value)),y=h(()=>f.value[f.value.length-1].layer),b=h(()=>({"--v-layout-left":le(y.value.left),"--v-layout-right":le(y.value.right),"--v-layout-top":le(y.value.top),"--v-layout-bottom":le(y.value.bottom),...v.value?void 0:{transition:"none"}})),k=h(()=>f.value.slice(1).map((I,A)=>{let{id:q}=I;const{layer:C}=f.value[A],w=s.get(q),V=a.get(q);return{id:q,...C,size:Number(w.value),position:V.value}})),g=I=>k.value.find(A=>A.id===I),p=lc("createLayout"),j=$(!1);vc(()=>{j.value=!0}),Ke(js,{register:(I,A)=>{let{id:q,order:C,position:w,layoutSize:V,elementSize:_,active:M,disableTransitions:N,absolute:Z}=A;u.set(q,C),a.set(q,w),s.set(q,V),l.set(q,M),N&&r.set(q,N);const H=ba(Sd,p==null?void 0:p.vnode).indexOf(I);H>-1?t.value.splice(H,0,q):t.value.push(q);const D=h(()=>k.value.findIndex(z=>z.id===q)),J=h(()=>n.value+f.value.length*2-D.value*2),R=h(()=>{const z=w.value==="left"||w.value==="right",fe=w.value==="right",oe=w.value==="bottom",B={[w.value]:0,zIndex:J.value,transform:`translate${z?"X":"Y"}(${(M.value?0:-110)*(fe||oe?-1:1)}%)`,position:Z.value||n.value!==ao?"absolute":"fixed",...v.value?void 0:{transition:"none"}};if(!j.value)return B;const T=k.value[D.value];if(!T)throw new Error(`[Vuetify] Could not find layout item "${q}"`);const O=d.value.get(q);return O&&(T[O.position]+=O.amount),{...B,height:z?`calc(100% - ${T.top}px - ${T.bottom}px)`:_.value?`${_.value}px`:void 0,left:fe?void 0:`${T.left}px`,right:fe?`${T.right}px`:void 0,top:w.value!=="bottom"?`${T.top}px`:void 0,bottom:w.value!=="top"?`${T.bottom}px`:void 0,width:z?_.value?`${_.value}px`:void 0:`calc(100% - ${T.left}px - ${T.right}px)`}}),K=h(()=>({zIndex:J.value-1}));return{layoutItemStyles:R,layoutItemScrimStyles:K,zIndex:J}},unregister:I=>{u.delete(I),a.delete(I),s.delete(I),l.delete(I),r.delete(I),t.value=t.value.filter(A=>A!==I)},mainRect:y,mainStyles:b,getLayoutItem:g,items:k,layoutRect:i,rootZIndex:n});const P=h(()=>["v-layout",{"v-layout--full-height":e.fullHeight}]),x=h(()=>({zIndex:n.value,position:c?"relative":void 0,overflow:c?"hidden":void 0}));return{layoutClasses:P,layoutStyles:x,getLayoutItem:g,items:k,layoutRect:i,layoutRef:o}}function xd(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};const{blueprint:c,...n}=e,t=jn(c,n),{aliases:a={},components:s={},directives:u={}}=t,l=Rb(t.defaults),r=ph(t.display,t.ssr),o=Rh(t.theme),i=wh(t.icons),d=Gb(t.locale),f=qh(t.date);return{install:y=>{for(const b in u)y.directive(b,u[b]);for(const b in s)y.component(b,s[b]);for(const b in a)y.component(b,Mc({...a[b],name:b,aliasName:a[b].name}));if(o.install(y),y.provide(wa,l),y.provide(Yu,r),y.provide(Ia,o),y.provide(Gu,i),y.provide(Lt,d),y.provide(Hi,f),Xe&&t.ssr)if(y.$nuxt)y.$nuxt.hook("app:suspense:resolve",()=>{r.update()});else{const{mount:b}=y;y.mount=function(){const k=b(...arguments);return Oe(()=>r.update()),y.mount=b,k}}yc.reset(),y.mixin({computed:{$vuetify(){return sc({defaults:Ct.call(this,wa),display:Ct.call(this,Yu),theme:Ct.call(this,Ia),icons:Ct.call(this,Gu),locale:Ct.call(this,Lt),date:Ct.call(this,Hi)})}}})},defaults:l,display:r,theme:o,icons:i,locale:d,date:f}}const Fh="3.2.2";xd.version=Fh;function Ct(e){var t,a;const c=this.$,n=((t=c.parent)==null?void 0:t.provides)??((a=c.vnode.appContext)==null?void 0:a.provides);if(n&&e in n)return n[e]}const Nh=W()({name:"VApp",props:{...ne(),...Cd({fullHeight:!0}),...Ie()},setup(e,c){let{slots:n}=c;const t=Pe(e),{layoutClasses:a,layoutStyles:s,getLayoutItem:u,items:l,layoutRef:r}=_d(e),{rtlClasses:o}=_n();return X(()=>{var i;return m("div",{ref:r,class:["v-application",t.themeClasses.value,a.value,o.value,e.class],style:[s.value,e.style]},[m("div",{class:"v-application__wrap"},[(i=n.default)==null?void 0:i.call(n)])])}),{getLayoutItem:u,items:l,theme:t}}});const $e=W(!1)({name:"VDefaultsProvider",props:{defaults:Object,disabled:Boolean,reset:[Number,String],root:Boolean,scoped:Boolean},setup(e,c){let{slots:n}=c;const{defaults:t,disabled:a,reset:s,root:u,scoped:l}=Il(e);return Je(t,{reset:s,root:u,scoped:l,disabled:a}),()=>{var r;return(r=n.default)==null?void 0:r.call(n)}}});function Ic(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"center center",n=arguments.length>2?arguments[2]:void 0;return W()({name:e,props:{disabled:Boolean,group:Boolean,hideOnLeave:Boolean,leaveAbsolute:Boolean,mode:{type:String,default:n},origin:{type:String,default:c}},setup(t,a){let{slots:s}=a;const u={onBeforeEnter(l){l.style.transformOrigin=t.origin},onLeave(l){if(t.leaveAbsolute){const{offsetTop:r,offsetLeft:o,offsetWidth:i,offsetHeight:d}=l;l._transitionInitialStyles={position:l.style.position,top:l.style.top,left:l.style.left,width:l.style.width,height:l.style.height},l.style.position="absolute",l.style.top=`${r}px`,l.style.left=`${o}px`,l.style.width=`${i}px`,l.style.height=`${d}px`}t.hideOnLeave&&l.style.setProperty("display","none","important")},onAfterLeave(l){if(t.leaveAbsolute&&(l!=null&&l._transitionInitialStyles)){const{position:r,top:o,left:i,width:d,height:f}=l._transitionInitialStyles;delete l._transitionInitialStyles,l.style.position=r||"",l.style.top=o||"",l.style.left=i||"",l.style.width=d||"",l.style.height=f||""}}};return()=>{const l=t.group?E2:sn;return ln(l,{name:t.disabled?"":e,css:!t.disabled,...t.group?void 0:{mode:t.mode},...t.disabled?{}:u},s.default)}}})}function wd(e,c){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"in-out";return W()({name:e,props:{mode:{type:String,default:n},disabled:Boolean},setup(t,a){let{slots:s}=a;return()=>ln(sn,{name:t.disabled?"":e,css:!t.disabled,...t.disabled?{}:c},s.default)}})}function Vd(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"";const n=(arguments.length>1&&arguments[1]!==void 0?arguments[1]:!1)?"width":"height",t=$c(`offset-${n}`);return{onBeforeEnter(u){u._parent=u.parentNode,u._initialStyle={transition:u.style.transition,overflow:u.style.overflow,[n]:u.style[n]}},onEnter(u){const l=u._initialStyle;u.style.setProperty("transition","none","important"),u.style.overflow="hidden";const r=`${u[t]}px`;u.style[n]="0",u.offsetHeight,u.style.transition=l.transition,e&&u._parent&&u._parent.classList.add(e),requestAnimationFrame(()=>{u.style[n]=r})},onAfterEnter:s,onEnterCancelled:s,onLeave(u){u._initialStyle={transition:"",overflow:u.style.overflow,[n]:u.style[n]},u.style.overflow="hidden",u.style[n]=`${u[t]}px`,u.offsetHeight,requestAnimationFrame(()=>u.style[n]="0")},onAfterLeave:a,onLeaveCancelled:a};function a(u){e&&u._parent&&u._parent.classList.remove(e),s(u)}function s(u){const l=u._initialStyle[n];u.style.overflow=u._initialStyle.overflow,l!=null&&(u.style[n]=l),delete u._initialStyle}}const Os=W()({name:"VDialogTransition",props:{target:Object},setup(e,c){let{slots:n}=c;const t={onBeforeEnter(a){a.style.pointerEvents="none",a.style.visibility="hidden"},async onEnter(a,s){var f;await new Promise(v=>requestAnimationFrame(v)),await new Promise(v=>requestAnimationFrame(v)),a.style.visibility="";const{x:u,y:l,sx:r,sy:o,speed:i}=uo(e.target,a),d=ut(a,[{transform:`translate(${u}px, ${l}px) scale(${r}, ${o})`,opacity:0},{}],{duration:225*i,easing:Fb});(f=so(a))==null||f.forEach(v=>{ut(v,[{opacity:0},{opacity:0,offset:.33},{}],{duration:225*2*i,easing:Va})}),d.finished.then(()=>s())},onAfterEnter(a){a.style.removeProperty("pointer-events")},onBeforeLeave(a){a.style.pointerEvents="none"},async onLeave(a,s){var f;await new Promise(v=>requestAnimationFrame(v));const{x:u,y:l,sx:r,sy:o,speed:i}=uo(e.target,a);ut(a,[{},{transform:`translate(${u}px, ${l}px) scale(${r}, ${o})`,opacity:0}],{duration:125*i,easing:Nb}).finished.then(()=>s()),(f=so(a))==null||f.forEach(v=>{ut(v,[{},{opacity:0,offset:.2},{opacity:0}],{duration:125*2*i,easing:Va})})},onAfterLeave(a){a.style.removeProperty("pointer-events")}};return()=>e.target?m(sn,se({name:"dialog-transition"},t,{css:!1}),n):m(sn,{name:"dialog-transition"},n)}});function so(e){var n;const c=(n=e.querySelector(":scope > .v-card, :scope > .v-sheet, :scope > .v-list"))==null?void 0:n.children;return c&&[...c]}function uo(e,c){const n=e.getBoundingClientRect(),t=Gl(c),[a,s]=getComputedStyle(c).transformOrigin.split(" ").map(g=>parseFloat(g)),[u,l]=getComputedStyle(c).getPropertyValue("--v-overlay-anchor-origin").split(" ");let r=n.left+n.width/2;u==="left"||l==="left"?r-=n.width/2:(u==="right"||l==="right")&&(r+=n.width/2);let o=n.top+n.height/2;u==="top"||l==="top"?o-=n.height/2:(u==="bottom"||l==="bottom")&&(o+=n.height/2);const i=n.width/t.width,d=n.height/t.height,f=Math.max(1,i,d),v=i/f||0,y=d/f||0,b=t.width*t.height/(window.innerWidth*window.innerHeight),k=b>.12?Math.min(1.5,(b-.12)*10+1):1;return{x:r-(a+t.left),y:o-(s+t.top),sx:v,sy:y,speed:k}}const Dh=Ic("fab-transition","center center","out-in"),zh=Ic("dialog-bottom-transition"),Hh=Ic("dialog-top-transition"),Zu=Ic("fade-transition"),Id=Ic("scale-transition"),Uh=Ic("scroll-x-transition"),Wh=Ic("scroll-x-reverse-transition"),Kh=Ic("scroll-y-transition"),Yh=Ic("scroll-y-reverse-transition"),Gh=Ic("slide-x-transition"),Xh=Ic("slide-x-reverse-transition"),tr=Ic("slide-y-transition"),Zh=Ic("slide-y-reverse-transition"),Ls=wd("expand-transition",Vd()),ar=wd("expand-x-transition",Vd("",!0));const Rc=he({height:[Number,String],maxHeight:[Number,String],maxWidth:[Number,String],minHeight:[Number,String],minWidth:[Number,String],width:[Number,String]},"dimension");function Oc(e){return{dimensionStyles:h(()=>({height:le(e.height),maxHeight:le(e.maxHeight),maxWidth:le(e.maxWidth),minHeight:le(e.minHeight),minWidth:le(e.minWidth),width:le(e.width)}))}}function Qh(e){return{aspectStyles:h(()=>{const c=Number(e.aspectRatio);return c?{paddingBottom:String(1/c*100)+"%"}:void 0})}}const Ad=W()({name:"VResponsive",props:{aspectRatio:[String,Number],contentClass:String,...ne(),...Rc()},setup(e,c){let{slots:n}=c;const{aspectStyles:t}=Qh(e),{dimensionStyles:a}=Oc(e);return X(()=>{var s;return m("div",{class:["v-responsive",e.class],style:[a.value,e.style]},[m("div",{class:"v-responsive__sizer",style:t.value},null),(s=n.additional)==null?void 0:s.call(n),n.default&&m("div",{class:["v-responsive__content",e.contentClass]},[n.default()])])}),{}}});function Jh(e,c){if(!er)return;const n=c.modifiers||{},t=c.value,{handler:a,options:s}=typeof t=="object"?t:{handler:t,options:{}},u=new IntersectionObserver(function(){var d;let l=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[],r=arguments.length>1?arguments[1]:void 0;const o=(d=e._observe)==null?void 0:d[c.instance.$.uid];if(!o)return;const i=l.some(f=>f.isIntersecting);a&&(!n.quiet||o.init)&&(!n.once||i||o.init)&&a(i,l,r),i&&n.once?Ed(e,c):o.init=!0},s);e._observe=Object(e._observe),e._observe[c.instance.$.uid]={init:!1,observer:u},u.observe(e)}function Ed(e,c){var t;const n=(t=e._observe)==null?void 0:t[c.instance.$.uid];n&&(n.observer.unobserve(e),delete e._observe[c.instance.$.uid])}const Ba={mounted:Jh,unmounted:Ed},xn=he({transition:{type:[Boolean,String,Object],default:"fade-transition",validator:e=>e!==!0}},"transition"),Hc=(e,c)=>{let{slots:n}=c;const{transition:t,...a}=e,{component:s=sn,...u}=typeof t=="object"?t:{};return ln(s,se(typeof t=="string"?{name:t}:u,a),n)},Gt=W()({name:"VImg",directives:{intersect:Ba},props:{aspectRatio:[String,Number],alt:String,cover:Boolean,eager:Boolean,gradient:String,lazySrc:String,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},sizes:String,src:{type:[String,Object],default:""},srcset:String,width:[String,Number],...ne(),...xn()},emits:{loadstart:e=>!0,load:e=>!0,error:e=>!0},setup(e,c){let{emit:n,slots:t}=c;const a=$(""),s=$(),u=$(e.eager?"loading":"idle"),l=$(),r=$(),o=h(()=>e.src&&typeof e.src=="object"?{src:e.src.src,srcset:e.srcset||e.src.srcset,lazySrc:e.lazySrc||e.src.lazySrc,aspect:Number(e.aspectRatio||e.src.aspect||0)}:{src:e.src,srcset:e.srcset,lazySrc:e.lazySrc,aspect:Number(e.aspectRatio||0)}),i=h(()=>o.value.aspect||l.value/r.value||0);ae(()=>e.src,()=>{d(u.value!=="idle")}),ae(i,(q,C)=>{!q&&C&&s.value&&k(s.value)}),As(()=>d());function d(q){if(!(e.eager&&q)&&!(er&&!q&&!e.eager)){if(u.value="loading",o.value.lazySrc){const C=new Image;C.src=o.value.lazySrc,k(C,null)}o.value.src&&Oe(()=>{var C,w;if(n("loadstart",((C=s.value)==null?void 0:C.currentSrc)||o.value.src),(w=s.value)!=null&&w.complete){if(s.value.naturalWidth||v(),u.value==="error")return;i.value||k(s.value,null),f()}else i.value||k(s.value),y()})}}function f(){var q;y(),u.value="loaded",n("load",((q=s.value)==null?void 0:q.currentSrc)||o.value.src)}function v(){var q;u.value="error",n("error",((q=s.value)==null?void 0:q.currentSrc)||o.value.src)}function y(){const q=s.value;q&&(a.value=q.currentSrc||q.src)}let b=-1;function k(q){let C=arguments.length>1&&arguments[1]!==void 0?arguments[1]:100;const w=()=>{clearTimeout(b);const{naturalHeight:V,naturalWidth:_}=q;V||_?(l.value=_,r.value=V):!q.complete&&u.value==="loading"&&C!=null?b=window.setTimeout(w,C):(q.currentSrc.endsWith(".svg")||q.currentSrc.startsWith("data:image/svg+xml"))&&(l.value=1,r.value=1)};w()}const g=h(()=>({"v-img__img--cover":e.cover,"v-img__img--contain":!e.cover})),p=()=>{var w;if(!o.value.src||u.value==="idle")return null;const q=m("img",{class:["v-img__img",g.value],src:o.value.src,srcset:o.value.srcset,alt:e.alt,sizes:e.sizes,ref:s,onLoad:f,onError:v},null),C=(w=t.sources)==null?void 0:w.call(t);return m(Hc,{transition:e.transition,appear:!0},{default:()=>[He(C?m("picture",{class:"v-img__picture"},[C,q]):q,[[rn,u.value==="loaded"]])]})},j=()=>m(Hc,{transition:e.transition},{default:()=>[o.value.lazySrc&&u.value!=="loaded"&&m("img",{class:["v-img__img","v-img__img--preload",g.value],src:o.value.lazySrc,alt:e.alt},null)]}),P=()=>t.placeholder?m(Hc,{transition:e.transition,appear:!0},{default:()=>[(u.value==="loading"||u.value==="error"&&!t.error)&&m("div",{class:"v-img__placeholder"},[t.placeholder()])]}):null,x=()=>t.error?m(Hc,{transition:e.transition,appear:!0},{default:()=>[u.value==="error"&&m("div",{class:"v-img__error"},[t.error()])]}):null,I=()=>e.gradient?m("div",{class:"v-img__gradient",style:{backgroundImage:`linear-gradient(${e.gradient})`}},null):null,A=$(!1);{const q=ae(i,C=>{C&&(requestAnimationFrame(()=>{requestAnimationFrame(()=>{A.value=!0})}),q())})}return X(()=>He(m(Ad,{class:["v-img",{"v-img--booting":!A.value},e.class],style:[{width:le(e.width==="auto"?l.value:e.width)},e.style],aspectRatio:i.value,"aria-label":e.alt,role:e.alt?"img":void 0},{additional:()=>m(ve,null,[m(p,null,null),m(j,null,null),m(I,null,null),m(P,null,null),m(x,null,null)]),default:t.default}),[[pc("intersect"),{handler:d,options:e.options},null,{once:!0}]])),{currentSrc:a,image:s,state:u,naturalWidth:l,naturalHeight:r}}}),Se=he({tag:{type:String,default:"div"}},"tag"),Pd=he({text:String,...ne(),...Se()},"v-toolbar-title"),sr=W()({name:"VToolbarTitle",props:Pd(),setup(e,c){let{slots:n}=c;return X(()=>{const t=!!(n.default||n.text||e.text);return m(e.tag,{class:["v-toolbar-title",e.class],style:e.style},{default:()=>{var a;return[t&&m("div",{class:"v-toolbar-title__placeholder"},[n.text?n.text():e.text,(a=n.default)==null?void 0:a.call(n)])]}})}),{}}}),Ac=he({border:[Boolean,Number,String]},"border");function Lc(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();return{borderClasses:h(()=>{const t=We(e)?e.value:e.border,a=[];if(t===!0||t==="")a.push(`${c}--border`);else if(typeof t=="string"||t===0)for(const s of String(t).split(" "))a.push(`border-${s}`);return a})}}const cc=he({elevation:{type:[Number,String],validator(e){const c=parseInt(e);return!isNaN(c)&&c>=0&&c<=24}}},"elevation");function rc(e){return{elevationClasses:h(()=>{const n=We(e)?e.value:e.elevation,t=[];return n==null||t.push(`elevation-${n}`),t})}}const De=he({rounded:{type:[Boolean,Number,String],default:void 0}},"rounded");function Ue(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();return{roundedClasses:h(()=>{const t=We(e)?e.value:e.rounded,a=[];if(t===!0||t==="")a.push(`${c}--rounded`);else if(typeof t=="string"||t===0)for(const s of String(t).split(" "))a.push(`rounded-${s}`);return a})}}function ur(e){return Wl(()=>{const c=[],n={};return e.value.background&&(Fi(e.value.background)?n.backgroundColor=e.value.background:c.push(`bg-${e.value.background}`)),e.value.text&&(Fi(e.value.text)?(n.color=e.value.text,n.caretColor=e.value.text):c.push(`text-${e.value.text}`)),{colorClasses:c,colorStyles:n}})}function mc(e,c){const n=h(()=>({text:We(e)?e.value:c?e[c]:null})),{colorClasses:t,colorStyles:a}=ur(n);return{textColorClasses:t,textColorStyles:a}}function Ze(e,c){const n=h(()=>({background:We(e)?e.value:c?e[c]:null})),{colorClasses:t,colorStyles:a}=ur(n);return{backgroundColorClasses:t,backgroundColorStyles:a}}const eg=[null,"prominent","default","comfortable","compact"],Td=he({absolute:Boolean,collapse:Boolean,color:String,density:{type:String,default:"default",validator:e=>eg.includes(e)},extended:Boolean,extensionHeight:{type:[Number,String],default:48},flat:Boolean,floating:Boolean,height:{type:[Number,String],default:64},image:String,title:String,...Ac(),...ne(),...cc(),...De(),...Se({tag:"header"}),...Ie()},"v-toolbar"),Qu=W()({name:"VToolbar",props:Td(),setup(e,c){var f;let{slots:n}=c;const{backgroundColorClasses:t,backgroundColorStyles:a}=Ze(Y(e,"color")),{borderClasses:s}=Lc(e),{elevationClasses:u}=rc(e),{roundedClasses:l}=Ue(e),{themeClasses:r}=Pe(e),o=$(!!(e.extended||(f=n.extension)!=null&&f.call(n))),i=h(()=>parseInt(Number(e.height)+(e.density==="prominent"?Number(e.height):0)-(e.density==="comfortable"?8:0)-(e.density==="compact"?16:0),10)),d=h(()=>o.value?parseInt(Number(e.extensionHeight)+(e.density==="prominent"?Number(e.extensionHeight):0)-(e.density==="comfortable"?4:0)-(e.density==="compact"?8:0),10):0);return Je({VBtn:{variant:"text"}}),X(()=>{var k;const v=!!(e.title||n.title),y=!!(n.image||e.image),b=(k=n.extension)==null?void 0:k.call(n);return o.value=!!(e.extended||b),m(e.tag,{class:["v-toolbar",{"v-toolbar--absolute":e.absolute,"v-toolbar--collapse":e.collapse,"v-toolbar--flat":e.flat,"v-toolbar--floating":e.floating,[`v-toolbar--density-${e.density}`]:!0},t.value,s.value,u.value,l.value,r.value,e.class],style:[a.value,e.style]},{default:()=>[y&&m("div",{key:"image",class:"v-toolbar__image"},[n.image?m($e,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},n.image):m(Gt,{key:"image-img",cover:!0,src:e.image},null)]),m($e,{defaults:{VTabs:{height:le(i.value)}}},{default:()=>{var g,p,j;return[m("div",{class:"v-toolbar__content",style:{height:le(i.value)}},[n.prepend&&m("div",{class:"v-toolbar__prepend"},[(g=n.prepend)==null?void 0:g.call(n)]),v&&m(sr,{key:"title",text:e.title},{text:n.title}),(p=n.default)==null?void 0:p.call(n),n.append&&m("div",{class:"v-toolbar__append"},[(j=n.append)==null?void 0:j.call(n)])])]}}),m($e,{defaults:{VTabs:{height:le(d.value)}}},{default:()=>[m(Ls,null,{default:()=>[o.value&&m("div",{class:"v-toolbar__extension",style:{height:le(d.value)}},[b])]})]})]})}),{contentHeight:i,extensionHeight:d}}}),cg=he({scrollTarget:{type:String},scrollThreshold:{type:[String,Number],default:300}},"scroll");function ng(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};const{canScroll:n}=c;let t=0;const a=$(null),s=$(0),u=$(0),l=$(0),r=$(!1),o=$(!1),i=h(()=>Number(e.scrollThreshold)),d=h(()=>fc((i.value-s.value)/i.value||0)),f=()=>{const v=a.value;!v||n&&!n.value||(t=s.value,s.value="window"in v?v.pageYOffset:v.scrollTop,o.value=s.value<t,l.value=Math.abs(s.value-i.value))};return ae(o,()=>{u.value=u.value||s.value}),ae(r,()=>{u.value=0}),vc(()=>{ae(()=>e.scrollTarget,v=>{var b;const y=v?document.querySelector(v):window;if(!y){Ln(`Unable to locate element with identifier ${v}`,Ps());return}y!==a.value&&((b=a.value)==null||b.removeEventListener("scroll",f),a.value=y,a.value.addEventListener("scroll",f,{passive:!0}))},{immediate:!0})}),jc(()=>{var v;(v=a.value)==null||v.removeEventListener("scroll",f)}),n&&ae(n,f,{immediate:!0}),{scrollThreshold:i,currentScroll:s,currentThreshold:l,isScrollActive:r,scrollRatio:d,isScrollingUp:o,savedScroll:u}}function bt(){const e=$(!1);return vc(()=>{window.requestAnimationFrame(()=>{e.value=!0})}),{ssrBootStyles:h(()=>e.value?void 0:{transition:"none !important"}),isBooted:$a(e)}}const tg=W()({name:"VAppBar",props:{scrollBehavior:String,modelValue:{type:Boolean,default:!0},location:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},...Td(),...Kt(),...cg(),height:{type:[Number,String],default:64}},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=$(),a=pe(e,"modelValue"),s=h(()=>{var j;const p=new Set(((j=e.scrollBehavior)==null?void 0:j.split(" "))??[]);return{hide:p.has("hide"),inverted:p.has("inverted"),collapse:p.has("collapse"),elevate:p.has("elevate"),fadeImage:p.has("fade-image")}}),u=h(()=>{const p=s.value;return p.hide||p.inverted||p.collapse||p.elevate||p.fadeImage||!a.value}),{currentScroll:l,scrollThreshold:r,isScrollingUp:o,scrollRatio:i}=ng(e,{canScroll:u}),d=h(()=>e.collapse||s.value.collapse&&(s.value.inverted?i.value>0:i.value===0)),f=h(()=>e.flat||s.value.elevate&&(s.value.inverted?l.value>0:l.value===0)),v=h(()=>s.value.fadeImage?s.value.inverted?1-i.value:i.value:void 0),y=h(()=>{var P,x;if(s.value.hide&&s.value.inverted)return 0;const p=((P=t.value)==null?void 0:P.contentHeight)??0,j=((x=t.value)==null?void 0:x.extensionHeight)??0;return p+j});function b(){s.value.hide?s.value.inverted?a.value=l.value>r.value:a.value=o.value||l.value<r.value:a.value=!0}ae(l,b,{immediate:!0}),ae(s,b);const{ssrBootStyles:k}=bt(),{layoutItemStyles:g}=Yt({id:e.name,order:h(()=>parseInt(e.order,10)),position:Y(e,"location"),layoutSize:y,elementSize:$(void 0),active:a,absolute:Y(e,"absolute")});return X(()=>{const[p]=Qu.filterProps(e);return m(Qu,se({ref:t,class:["v-app-bar",{"v-app-bar--bottom":e.location==="bottom"},e.class],style:[{...g.value,"--v-toolbar-image-opacity":v.value,height:void 0,...k.value},e.style]},p,{collapse:d.value,flat:f.value}),n)}),{}}});const ag=[null,"default","comfortable","compact"],nc=he({density:{type:String,default:"default",validator:e=>ag.includes(e)}},"density");function bc(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();return{densityClasses:h(()=>`${c}--density-${e.density}`)}}const sg=["elevated","flat","tonal","outlined","text","plain"];function ht(e,c){return m(ve,null,[e&&m("span",{key:"overlay",class:`${c}__overlay`},null),m("span",{key:"underlay",class:`${c}__underlay`},null)])}const Fc=he({color:String,variant:{type:String,default:"elevated",validator:e=>sg.includes(e)}},"variant");function gt(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();const n=h(()=>{const{variant:s}=dc(e);return`${c}--variant-${s}`}),{colorClasses:t,colorStyles:a}=ur(h(()=>{const{variant:s,color:u}=dc(e);return{[["elevated","flat"].includes(s)?"background":"text"]:u}}));return{colorClasses:t,colorStyles:a,variantClasses:n}}const $d=he({divided:Boolean,...Ac(),...ne(),...nc(),...cc(),...De(),...Se(),...Ie(),...Fc()},"v-btn-group"),Ju=W()({name:"VBtnGroup",props:$d(),setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{densityClasses:a}=bc(e),{borderClasses:s}=Lc(e),{elevationClasses:u}=rc(e),{roundedClasses:l}=Ue(e);Je({VBtn:{height:"auto",color:Y(e,"color"),density:Y(e,"density"),flat:!0,variant:Y(e,"variant")}}),X(()=>m(e.tag,{class:["v-btn-group",{"v-btn-group--divided":e.divided},t.value,s.value,a.value,u.value,l.value,e.class],style:e.style},n))}}),Xt=he({modelValue:{type:null,default:void 0},multiple:Boolean,mandatory:[Boolean,String],max:Number,selectedClass:String,disabled:Boolean},"group"),Zt=he({value:null,disabled:Boolean,selectedClass:String},"group-item");function Qt(e,c){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!0;const t=lc("useGroupItem");if(!t)throw new Error("[Vuetify] useGroupItem composable must be used inside a component setup function");const a=yc();Ke(Symbol.for(`${c.description}:id`),a);const s=Ve(c,null);if(!s){if(!n)return s;throw new Error(`[Vuetify] Could not find useGroup injection with symbol ${c.description}`)}const u=Y(e,"value"),l=h(()=>s.disabled.value||e.disabled);s.register({id:a,value:u,disabled:l},t),jc(()=>{s.unregister(a)});const r=h(()=>s.isSelected(a)),o=h(()=>r.value&&[s.selectedClass.value,e.selectedClass]);return ae(r,i=>{t.emit("group:selected",{value:i})}),{id:a,isSelected:r,toggle:()=>s.select(a,!r.value),select:i=>s.select(a,i),selectedClass:o,value:u,disabled:l,group:s}}function jt(e,c){let n=!1;const t=sc([]),a=pe(e,"modelValue",[],f=>f==null?[]:Md(t,Tc(f)),f=>{const v=lg(t,f);return e.multiple?v:v[0]}),s=lc("useGroup");function u(f,v){const y=f,b=Symbol.for(`${c.description}:id`),g=ba(b,s==null?void 0:s.vnode).indexOf(v);g>-1?t.splice(g,0,y):t.push(y)}function l(f){if(n)return;r();const v=t.findIndex(y=>y.id===f);t.splice(v,1)}function r(){const f=t.find(v=>!v.disabled);f&&e.mandatory==="force"&&!a.value.length&&(a.value=[f.id])}vc(()=>{r()}),jc(()=>{n=!0});function o(f,v){const y=t.find(b=>b.id===f);if(!(v&&(y!=null&&y.disabled)))if(e.multiple){const b=a.value.slice(),k=b.findIndex(p=>p===f),g=~k;if(v=v??!g,g&&e.mandatory&&b.length<=1||!g&&e.max!=null&&b.length+1>e.max)return;k<0&&v?b.push(f):k>=0&&!v&&b.splice(k,1),a.value=b}else{const b=a.value.includes(f);if(e.mandatory&&b)return;a.value=v??!b?[f]:[]}}function i(f){if(e.multiple&&Ln('This method is not supported when using "multiple" prop'),a.value.length){const v=a.value[0],y=t.findIndex(g=>g.id===v);let b=(y+f)%t.length,k=t[b];for(;k.disabled&&b!==y;)b=(b+f)%t.length,k=t[b];if(k.disabled)return;a.value=[t[b].id]}else{const v=t.find(y=>!y.disabled);v&&(a.value=[v.id])}}const d={register:u,unregister:l,selected:a,select:o,disabled:Y(e,"disabled"),prev:()=>i(t.length-1),next:()=>i(1),isSelected:f=>a.value.includes(f),selectedClass:h(()=>e.selectedClass),items:h(()=>t),getItemIndex:f=>ug(t,f)};return Ke(c,d),d}function ug(e,c){const n=Md(e,[c]);return n.length?e.findIndex(t=>t.id===n[0]):-1}function Md(e,c){const n=[];for(let t=0;t<e.length;t++){const a=e[t];a.value!=null?c.find(s=>mt(s,a.value))!=null&&n.push(a.id):c.includes(t)&&n.push(a.id)}return n}function lg(e,c){const n=[];for(let t=0;t<e.length;t++){const a=e[t];c.includes(a.id)&&n.push(a.value!=null?a.value:t)}return n}const lr=Symbol.for("vuetify:v-btn-toggle"),rg=W()({name:"VBtnToggle",props:{...$d(),...Xt()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{isSelected:t,next:a,prev:s,select:u,selected:l}=jt(e,lr);return X(()=>{const[r]=Ju.filterProps(e);return m(Ju,se({class:["v-btn-toggle",e.class]},r,{style:e.style}),{default:()=>{var o;return[(o=n.default)==null?void 0:o.call(n,{isSelected:t,next:a,prev:s,select:u,selected:l})]}})}),{next:a,prev:s,select:u}}});const ig=["x-small","small","default","large","x-large"],wn=he({size:{type:[String,Number],default:"default"}},"size");function Jt(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();return Wl(()=>{let n,t;return bs(ig,e.size)?n=`${c}--size-${e.size}`:e.size&&(t={width:le(e.size),height:le(e.size)}),{sizeClasses:n,sizeStyles:t}})}const og=he({color:String,start:Boolean,end:Boolean,icon:je,...ne(),...wn(),...Se({tag:"i"}),...Ie()},"v-icon"),ze=W()({name:"VIcon",props:og(),setup(e,c){let{attrs:n,slots:t}=c;const a=$(),{themeClasses:s}=Pe(e),{iconData:u}=Vh(h(()=>a.value||e.icon)),{sizeClasses:l}=Jt(e),{textColorClasses:r,textColorStyles:o}=mc(Y(e,"color"));return X(()=>{var d,f;const i=(d=t.default)==null?void 0:d.call(t);return i&&(a.value=(f=i.filter(v=>v.type===Ma&&v.children&&typeof v.children=="string")[0])==null?void 0:f.children),m(u.value.component,{tag:e.tag,icon:u.value.icon,class:["v-icon","notranslate",s.value,l.value,r.value,{"v-icon--clickable":!!n.onClick,"v-icon--start":e.start,"v-icon--end":e.end},e.class],style:[l.value?void 0:{fontSize:le(e.size),height:le(e.size),width:le(e.size)},o.value,e.style],role:n.onClick?"button":void 0,"aria-hidden":!n.onClick},{default:()=>[i]})}),{}}});function rr(e,c){const n=$(),t=$(!1);if(er){const a=new IntersectionObserver(s=>{e==null||e(s,a),t.value=!!s.find(u=>u.isIntersecting)},c);jc(()=>{a.disconnect()}),ae(n,(s,u)=>{u&&(a.unobserve(u),t.value=!1),s&&a.observe(s)},{flush:"post"})}return{intersectionRef:n,isIntersecting:t}}const ir=W()({name:"VProgressCircular",props:{bgColor:String,color:String,indeterminate:[Boolean,String],modelValue:{type:[Number,String],default:0},rotate:{type:[Number,String],default:0},width:{type:[Number,String],default:4},...ne(),...wn(),...Se({tag:"div"}),...Ie()},setup(e,c){let{slots:n}=c;const t=20,a=2*Math.PI*t,s=$(),{themeClasses:u}=Pe(e),{sizeClasses:l,sizeStyles:r}=Jt(e),{textColorClasses:o,textColorStyles:i}=mc(Y(e,"color")),{textColorClasses:d,textColorStyles:f}=mc(Y(e,"bgColor")),{intersectionRef:v,isIntersecting:y}=rr(),{resizeRef:b,contentRect:k}=un(),g=h(()=>Math.max(0,Math.min(100,parseFloat(e.modelValue)))),p=h(()=>Number(e.width)),j=h(()=>r.value?Number(e.size):k.value?k.value.width:Math.max(p.value,32)),P=h(()=>t/(1-p.value/j.value)*2),x=h(()=>p.value/j.value*P.value),I=h(()=>le((100-g.value)/100*a));return Kc(()=>{v.value=s.value,b.value=s.value}),X(()=>m(e.tag,{ref:s,class:["v-progress-circular",{"v-progress-circular--indeterminate":!!e.indeterminate,"v-progress-circular--visible":y.value,"v-progress-circular--disable-shrink":e.indeterminate==="disable-shrink"},u.value,l.value,o.value,e.class],style:[r.value,i.value,e.style],role:"progressbar","aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":e.indeterminate?void 0:g.value},{default:()=>[m("svg",{style:{transform:`rotate(calc(-90deg + ${Number(e.rotate)}deg))`},xmlns:"http://www.w3.org/2000/svg",viewBox:`0 0 ${P.value} ${P.value}`},[m("circle",{class:["v-progress-circular__underlay",d.value],style:f.value,fill:"transparent",cx:"50%",cy:"50%",r:t,"stroke-width":x.value,"stroke-dasharray":a,"stroke-dashoffset":0},null),m("circle",{class:"v-progress-circular__overlay",fill:"transparent",cx:"50%",cy:"50%",r:t,"stroke-width":x.value,"stroke-dasharray":a,"stroke-dashoffset":I.value},null)]),n.default&&m("div",{class:"v-progress-circular__content"},[n.default({value:g.value})])]})),{}}});const el=Symbol("rippleStop"),dg=80;function lo(e,c){e.style.transform=c,e.style.webkitTransform=c}function cl(e){return e.constructor.name==="TouchEvent"}function Bd(e){return e.constructor.name==="KeyboardEvent"}const fg=function(e,c){var d;let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},t=0,a=0;if(!Bd(e)){const f=c.getBoundingClientRect(),v=cl(e)?e.touches[e.touches.length-1]:e;t=v.clientX-f.left,a=v.clientY-f.top}let s=0,u=.3;(d=c._ripple)!=null&&d.circle?(u=.15,s=c.clientWidth/2,s=n.center?s:s+Math.sqrt((t-s)**2+(a-s)**2)/4):s=Math.sqrt(c.clientWidth**2+c.clientHeight**2)/2;const l=`${(c.clientWidth-s*2)/2}px`,r=`${(c.clientHeight-s*2)/2}px`,o=n.center?l:`${t-s}px`,i=n.center?r:`${a-s}px`;return{radius:s,scale:u,x:o,y:i,centerX:l,centerY:r}},qs={show(e,c){var v;let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};if(!((v=c==null?void 0:c._ripple)!=null&&v.enabled))return;const t=document.createElement("span"),a=document.createElement("span");t.appendChild(a),t.className="v-ripple__container",n.class&&(t.className+=` ${n.class}`);const{radius:s,scale:u,x:l,y:r,centerX:o,centerY:i}=fg(e,c,n),d=`${s*2}px`;a.className="v-ripple__animation",a.style.width=d,a.style.height=d,c.appendChild(t);const f=window.getComputedStyle(c);f&&f.position==="static"&&(c.style.position="relative",c.dataset.previousPosition="static"),a.classList.add("v-ripple__animation--enter"),a.classList.add("v-ripple__animation--visible"),lo(a,`translate(${l}, ${r}) scale3d(${u},${u},${u})`),a.dataset.activated=String(performance.now()),setTimeout(()=>{a.classList.remove("v-ripple__animation--enter"),a.classList.add("v-ripple__animation--in"),lo(a,`translate(${o}, ${i}) scale3d(1,1,1)`)},0)},hide(e){var s;if(!((s=e==null?void 0:e._ripple)!=null&&s.enabled))return;const c=e.getElementsByClassName("v-ripple__animation");if(c.length===0)return;const n=c[c.length-1];if(n.dataset.isHiding)return;n.dataset.isHiding="true";const t=performance.now()-Number(n.dataset.activated),a=Math.max(250-t,0);setTimeout(()=>{n.classList.remove("v-ripple__animation--in"),n.classList.add("v-ripple__animation--out"),setTimeout(()=>{var l;e.getElementsByClassName("v-ripple__animation").length===1&&e.dataset.previousPosition&&(e.style.position=e.dataset.previousPosition,delete e.dataset.previousPosition),((l=n.parentNode)==null?void 0:l.parentNode)===e&&e.removeChild(n.parentNode)},300)},a)}};function Rd(e){return typeof e>"u"||!!e}function Aa(e){const c={},n=e.currentTarget;if(!(!(n!=null&&n._ripple)||n._ripple.touched||e[el])){if(e[el]=!0,cl(e))n._ripple.touched=!0,n._ripple.isTouch=!0;else if(n._ripple.isTouch)return;if(c.center=n._ripple.centered||Bd(e),n._ripple.class&&(c.class=n._ripple.class),cl(e)){if(n._ripple.showTimerCommit)return;n._ripple.showTimerCommit=()=>{qs.show(e,n,c)},n._ripple.showTimer=window.setTimeout(()=>{var t;(t=n==null?void 0:n._ripple)!=null&&t.showTimerCommit&&(n._ripple.showTimerCommit(),n._ripple.showTimerCommit=null)},dg)}else qs.show(e,n,c)}}function ro(e){e[el]=!0}function xc(e){const c=e.currentTarget;if(c!=null&&c._ripple){if(window.clearTimeout(c._ripple.showTimer),e.type==="touchend"&&c._ripple.showTimerCommit){c._ripple.showTimerCommit(),c._ripple.showTimerCommit=null,c._ripple.showTimer=window.setTimeout(()=>{xc(e)});return}window.setTimeout(()=>{c._ripple&&(c._ripple.touched=!1)}),qs.hide(c)}}function Od(e){const c=e.currentTarget;c!=null&&c._ripple&&(c._ripple.showTimerCommit&&(c._ripple.showTimerCommit=null),window.clearTimeout(c._ripple.showTimer))}let Ea=!1;function Ld(e){!Ea&&(e.keyCode===Pi.enter||e.keyCode===Pi.space)&&(Ea=!0,Aa(e))}function Fd(e){Ea=!1,xc(e)}function Nd(e){Ea&&(Ea=!1,xc(e))}function Dd(e,c,n){const{value:t,modifiers:a}=c,s=Rd(t);if(s||qs.hide(e),e._ripple=e._ripple??{},e._ripple.enabled=s,e._ripple.centered=a.center,e._ripple.circle=a.circle,Nu(t)&&t.class&&(e._ripple.class=t.class),s&&!n){if(a.stop){e.addEventListener("touchstart",ro,{passive:!0}),e.addEventListener("mousedown",ro);return}e.addEventListener("touchstart",Aa,{passive:!0}),e.addEventListener("touchend",xc,{passive:!0}),e.addEventListener("touchmove",Od,{passive:!0}),e.addEventListener("touchcancel",xc),e.addEventListener("mousedown",Aa),e.addEventListener("mouseup",xc),e.addEventListener("mouseleave",xc),e.addEventListener("keydown",Ld),e.addEventListener("keyup",Fd),e.addEventListener("blur",Nd),e.addEventListener("dragstart",xc,{passive:!0})}else!s&&n&&zd(e)}function zd(e){e.removeEventListener("mousedown",Aa),e.removeEventListener("touchstart",Aa),e.removeEventListener("touchend",xc),e.removeEventListener("touchmove",Od),e.removeEventListener("touchcancel",xc),e.removeEventListener("mouseup",xc),e.removeEventListener("mouseleave",xc),e.removeEventListener("keydown",Ld),e.removeEventListener("keyup",Fd),e.removeEventListener("dragstart",xc),e.removeEventListener("blur",Nd)}function mg(e,c){Dd(e,c,!1)}function vg(e){delete e._ripple,zd(e)}function yg(e,c){if(c.value===c.oldValue)return;const n=Rd(c.oldValue);Dd(e,c,n)}const Un={mounted:mg,unmounted:vg,updated:yg};const io={center:"center",top:"bottom",bottom:"top",left:"right",right:"left"},Wn=he({location:String},"location");function Kn(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!1,n=arguments.length>2?arguments[2]:void 0;const{isRtl:t}=_n();return{locationStyles:h(()=>{if(!e.location)return{};const{side:s,align:u}=zu(e.location.split(" ").length>1?e.location:`${e.location} center`,t.value);function l(o){return n?n(o):0}const r={};return s!=="center"&&(c?r[io[s]]=`calc(100% - ${l(s)}px)`:r[s]=0),u!=="center"?c?r[io[u]]=`calc(100% - ${l(u)}px)`:r[u]=0:(s==="center"?r.top=r.left="50%":r[{top:"left",bottom:"left",left:"top",right:"top"}[s]]="50%",r.transform={top:"translateX(-50%)",bottom:"translateX(-50%)",left:"translateY(-50%)",right:"translateY(-50%)",center:"translate(-50%, -50%)"}[s]),r})}}const or=W()({name:"VProgressLinear",props:{absolute:Boolean,active:{type:Boolean,default:!0},bgColor:String,bgOpacity:[Number,String],bufferValue:{type:[Number,String],default:0},clickable:Boolean,color:String,height:{type:[Number,String],default:4},indeterminate:Boolean,max:{type:[Number,String],default:100},modelValue:{type:[Number,String],default:0},reverse:Boolean,stream:Boolean,striped:Boolean,roundedBar:Boolean,...ne(),...Wn({location:"top"}),...De(),...Se(),...Ie()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),{isRtl:a}=_n(),{themeClasses:s}=Pe(e),{locationStyles:u}=Kn(e),{textColorClasses:l,textColorStyles:r}=mc(e,"color"),{backgroundColorClasses:o,backgroundColorStyles:i}=Ze(h(()=>e.bgColor||e.color)),{backgroundColorClasses:d,backgroundColorStyles:f}=Ze(e,"color"),{roundedClasses:v}=Ue(e),{intersectionRef:y,isIntersecting:b}=rr(),k=h(()=>parseInt(e.max,10)),g=h(()=>parseInt(e.height,10)),p=h(()=>parseFloat(e.bufferValue)/k.value*100),j=h(()=>parseFloat(t.value)/k.value*100),P=h(()=>a.value!==e.reverse),x=h(()=>e.indeterminate?"fade-transition":"slide-x-transition"),I=h(()=>e.bgOpacity==null?e.bgOpacity:parseFloat(e.bgOpacity));function A(q){if(!y.value)return;const{left:C,right:w,width:V}=y.value.getBoundingClientRect(),_=P.value?V-q.clientX+(w-V):q.clientX-C;t.value=Math.round(_/V*k.value)}return X(()=>m(e.tag,{ref:y,class:["v-progress-linear",{"v-progress-linear--absolute":e.absolute,"v-progress-linear--active":e.active&&b.value,"v-progress-linear--reverse":P.value,"v-progress-linear--rounded":e.rounded,"v-progress-linear--rounded-bar":e.roundedBar,"v-progress-linear--striped":e.striped},v.value,s.value,e.class],style:[{bottom:e.location==="bottom"?0:void 0,top:e.location==="top"?0:void 0,height:e.active?le(g.value):0,"--v-progress-linear-height":le(g.value),...u.value},e.style],role:"progressbar","aria-hidden":e.active?"false":"true","aria-valuemin":"0","aria-valuemax":e.max,"aria-valuenow":e.indeterminate?void 0:j.value,onClick:e.clickable&&A},{default:()=>[e.stream&&m("div",{key:"stream",class:["v-progress-linear__stream",l.value],style:{...r.value,[P.value?"left":"right"]:le(-g.value),borderTop:`${le(g.value/2)} dotted`,opacity:I.value,top:`calc(50% - ${le(g.value/4)})`,width:le(100-p.value,"%"),"--v-progress-linear-stream-to":le(g.value*(P.value?1:-1))}},null),m("div",{class:["v-progress-linear__background",o.value],style:[i.value,{opacity:I.value,width:le(e.stream?p.value:100,"%")}]},null),m(sn,{name:x.value},{default:()=>[e.indeterminate?m("div",{class:"v-progress-linear__indeterminate"},[["long","short"].map(q=>m("div",{key:q,class:["v-progress-linear__indeterminate",q,d.value],style:f.value},null))]):m("div",{class:["v-progress-linear__determinate",d.value],style:[f.value,{width:le(j.value,"%")}]},null)]}),n.default&&m("div",{class:"v-progress-linear__content"},[n.default({value:j.value,buffer:p.value})])]})),{}}}),dr=he({loading:[Boolean,String]},"loader");function Fs(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();return{loaderClasses:h(()=>({[`${c}--loading`]:e.loading}))}}function fr(e,c){var t;let{slots:n}=c;return m("div",{class:`${e.name}__loader`},[((t=n.default)==null?void 0:t.call(n,{color:e.color,isActive:e.active}))||m(or,{active:e.active,color:e.color,height:"2",indeterminate:!0},null)])}const bg=["static","relative","fixed","absolute","sticky"],ea=he({position:{type:String,validator:e=>bg.includes(e)}},"position");function ca(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();return{positionClasses:h(()=>e.position?`${c}--${e.position}`:void 0)}}function Hd(){var e,c;return(c=(e=lc("useRouter"))==null?void 0:e.proxy)==null?void 0:c.$router}function Ra(e,c){const n=I0("RouterLink"),t=h(()=>!!(e.href||e.to)),a=h(()=>(t==null?void 0:t.value)||Bi(c,"click")||Bi(e,"click"));if(typeof n=="string")return{isLink:t,isClickable:a,href:Y(e,"href")};const s=e.to?n.useLink(e):void 0;return{isLink:t,isClickable:a,route:s==null?void 0:s.route,navigate:s==null?void 0:s.navigate,isActive:s&&h(()=>{var u,l;return e.exact?(u=s.isExactActive)==null?void 0:u.value:(l=s.isActive)==null?void 0:l.value}),href:h(()=>e.to?s==null?void 0:s.route.value.href:e.href)}}const Oa=he({href:String,replace:Boolean,to:[String,Object],exact:Boolean},"router");let mu=!1;function hg(e,c){let n=!1,t,a;Xe&&(Oe(()=>{window.addEventListener("popstate",s),t=e==null?void 0:e.beforeEach((u,l,r)=>{mu?n?c(r):r():setTimeout(()=>n?c(r):r()),mu=!0}),a=e==null?void 0:e.afterEach(()=>{mu=!1})}),Vc(()=>{window.removeEventListener("popstate",s),t==null||t(),a==null||a()}));function s(u){var l;(l=u.state)!=null&&l.replaced||(n=!0,setTimeout(()=>n=!1))}}function gg(e,c){ae(()=>{var n;return(n=e.isActive)==null?void 0:n.value},n=>{e.isLink.value&&n&&c&&Oe(()=>{c(!0)})},{immediate:!0})}const mr=he({active:{type:Boolean,default:void 0},symbol:{type:null,default:lr},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:je,appendIcon:je,block:Boolean,stacked:Boolean,ripple:{type:Boolean,default:!0},text:String,...Ac(),...ne(),...nc(),...Rc(),...cc(),...Zt(),...dr(),...Wn(),...ea(),...De(),...Oa(),...wn(),...Se({tag:"button"}),...Ie(),...Fc({variant:"elevated"})},"v-btn"),gc=W()({name:"VBtn",directives:{Ripple:Un},props:mr(),emits:{"group:selected":e=>!0},setup(e,c){let{attrs:n,slots:t}=c;const{themeClasses:a}=Pe(e),{borderClasses:s}=Lc(e),{colorClasses:u,colorStyles:l,variantClasses:r}=gt(e),{densityClasses:o}=bc(e),{dimensionStyles:i}=Oc(e),{elevationClasses:d}=rc(e),{loaderClasses:f}=Fs(e),{locationStyles:v}=Kn(e),{positionClasses:y}=ca(e),{roundedClasses:b}=Ue(e),{sizeClasses:k,sizeStyles:g}=Jt(e),p=Qt(e,e.symbol,!1),j=Ra(e,n),P=h(()=>{var C;return e.active!==void 0?e.active:j.isLink.value?(C=j.isActive)==null?void 0:C.value:p==null?void 0:p.isSelected.value}),x=h(()=>(p==null?void 0:p.disabled.value)||e.disabled),I=h(()=>e.variant==="elevated"&&!(e.disabled||e.flat||e.border)),A=h(()=>{if(e.value!==void 0)return Object(e.value)===e.value?JSON.stringify(e.value,null,0):e.value});function q(C){var w;x.value||((w=j.navigate)==null||w.call(j,C),p==null||p.toggle())}return gg(j,p==null?void 0:p.select),X(()=>{var N,Z;const C=j.isLink.value?"a":e.tag,w=!!(e.prependIcon||t.prepend),V=!!(e.appendIcon||t.append),_=!!(e.icon&&e.icon!==!0),M=(p==null?void 0:p.isSelected.value)&&(!j.isLink.value||((N=j.isActive)==null?void 0:N.value))||!p||((Z=j.isActive)==null?void 0:Z.value);return He(m(C,{type:C==="a"?void 0:"button",class:["v-btn",p==null?void 0:p.selectedClass.value,{"v-btn--active":P.value,"v-btn--block":e.block,"v-btn--disabled":x.value,"v-btn--elevated":I.value,"v-btn--flat":e.flat,"v-btn--icon":!!e.icon,"v-btn--loading":e.loading,"v-btn--stacked":e.stacked},a.value,s.value,M?u.value:void 0,o.value,d.value,f.value,y.value,b.value,k.value,r.value,e.class],style:[M?l.value:void 0,i.value,v.value,g.value,e.style],disabled:x.value||void 0,href:j.href.value,onClick:q,value:A.value},{default:()=>{var F;return[ht(!0,"v-btn"),!e.icon&&w&&m("span",{key:"prepend",class:"v-btn__prepend"},[t.prepend?m($e,{key:"prepend-defaults",disabled:!e.prependIcon,defaults:{VIcon:{icon:e.prependIcon}}},t.prepend):m(ze,{key:"prepend-icon",icon:e.prependIcon},null)]),m("span",{class:"v-btn__content","data-no-activator":""},[!t.default&&_?m(ze,{key:"content-icon",icon:e.icon},null):m($e,{key:"content-defaults",disabled:!_,defaults:{VIcon:{icon:e.icon}}},{default:()=>{var H;return[((H=t.default)==null?void 0:H.call(t))??e.text]}})]),!e.icon&&V&&m("span",{key:"append",class:"v-btn__append"},[t.append?m($e,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VIcon:{icon:e.appendIcon}}},t.append):m(ze,{key:"append-icon",icon:e.appendIcon},null)]),!!e.loading&&m("span",{key:"loader",class:"v-btn__loader"},[((F=t.loader)==null?void 0:F.call(t))??m(ir,{color:typeof e.loading=="boolean"?void 0:e.loading,indeterminate:!0,size:"23",width:"2"},null)])]}}),[[pc("ripple"),!x.value&&e.ripple,null]])}),{}}}),jg=W()({name:"VAppBarNavIcon",props:mr({icon:"$menu",variant:"text"}),setup(e,c){let{slots:n}=c;return X(()=>m(gc,se(e,{class:["v-app-bar-nav-icon"]}),n)),{}}}),qg=W()({name:"VToolbarItems",props:{...ne(),...Fc({variant:"text"})},setup(e,c){let{slots:n}=c;return Je({VBtn:{color:Y(e,"color"),height:"inherit",variant:Y(e,"variant")}}),X(()=>{var t;return m("div",{class:["v-toolbar-items",e.class],style:e.style},[(t=n.default)==null?void 0:t.call(n)])}),{}}}),kg=W()({name:"VAppBarTitle",props:Pd(),setup(e,c){let{slots:n}=c;return X(()=>m(sr,se(e,{class:"v-app-bar-title"}),n)),{}}});const Ud=Yc("v-alert-title"),pg=["success","info","warning","error"],Sg=W()({name:"VAlert",props:{border:{type:[Boolean,String],validator:e=>typeof e=="boolean"||["top","end","bottom","start"].includes(e)},borderColor:String,closable:Boolean,closeIcon:{type:je,default:"$close"},closeLabel:{type:String,default:"$vuetify.close"},icon:{type:[Boolean,String,Function,Object],default:null},modelValue:{type:Boolean,default:!0},prominent:Boolean,title:String,text:String,type:{type:String,validator:e=>pg.includes(e)},...ne(),...nc(),...Rc(),...cc(),...Wn(),...ea(),...De(),...Se(),...Ie(),...Fc({variant:"flat"})},emits:{"click:close":e=>!0,"update:modelValue":e=>!0},setup(e,c){let{emit:n,slots:t}=c;const a=pe(e,"modelValue"),s=h(()=>{if(e.icon!==!1)return e.type?e.icon??`$${e.type}`:e.icon}),u=h(()=>({color:e.color??e.type,variant:e.variant})),{themeClasses:l}=Pe(e),{colorClasses:r,colorStyles:o,variantClasses:i}=gt(u),{densityClasses:d}=bc(e),{dimensionStyles:f}=Oc(e),{elevationClasses:v}=rc(e),{locationStyles:y}=Kn(e),{positionClasses:b}=ca(e),{roundedClasses:k}=Ue(e),{textColorClasses:g,textColorStyles:p}=mc(Y(e,"borderColor")),{t:j}=Bc(),P=h(()=>({"aria-label":j(e.closeLabel),onClick(x){a.value=!1,n("click:close",x)}}));return()=>{const x=!!(t.prepend||s.value),I=!!(t.title||e.title),A=!!(e.text||t.text),q=!!(t.close||e.closable);return a.value&&m(e.tag,{class:["v-alert",e.border&&{"v-alert--border":!!e.border,[`v-alert--border-${e.border===!0?"start":e.border}`]:!0},{"v-alert--prominent":e.prominent},l.value,r.value,d.value,v.value,b.value,k.value,i.value,e.class],style:[o.value,f.value,y.value,e.style],role:"alert"},{default:()=>{var C,w;return[ht(!1,"v-alert"),e.border&&m("div",{key:"border",class:["v-alert__border",g.value],style:p.value},null),x&&m("div",{key:"prepend",class:"v-alert__prepend"},[t.prepend?m($e,{key:"prepend-defaults",disabled:!s.value,defaults:{VIcon:{density:e.density,icon:s.value,size:e.prominent?44:28}}},t.prepend):m(ze,{key:"prepend-icon",density:e.density,icon:s.value,size:e.prominent?44:28},null)]),m("div",{class:"v-alert__content"},[I&&m(Ud,{key:"title"},{default:()=>{var V;return[((V=t.title)==null?void 0:V.call(t))??e.title]}}),A&&(((C=t.text)==null?void 0:C.call(t))??e.text),(w=t.default)==null?void 0:w.call(t)]),t.append&&m("div",{key:"append",class:"v-alert__append"},[t.append()]),q&&m("div",{key:"close",class:"v-alert__close"},[t.close?m($e,{key:"close-defaults",defaults:{VBtn:{icon:e.closeIcon,size:"x-small",variant:"text"}}},{default:()=>{var V;return[(V=t.close)==null?void 0:V.call(t,{props:P.value})]}}):m(gc,se({key:"close-btn",icon:e.closeIcon,size:"x-small",variant:"text"},P.value),null)])]}})}}});function Wd(e){const{t:c}=Bc();function n(t){let{name:a}=t;const s={prepend:"prependAction",prependInner:"prependAction",append:"appendAction",appendInner:"appendAction",clear:"clear"}[a],u=e[`onClick:${a}`],l=u&&s?c(`$vuetify.input.${s}`,e.label??""):void 0;return m(ze,{icon:e[`${a}Icon`],"aria-label":l,onClick:u},null)}return{InputIcon:n}}const na=W()({name:"VLabel",props:{text:String,clickable:Boolean,...ne(),...Ie()},setup(e,c){let{slots:n}=c;return X(()=>{var t;return m("label",{class:["v-label",{"v-label--clickable":e.clickable},e.class],style:e.style},[e.text,(t=n.default)==null?void 0:t.call(n)])}),{}}}),oa=W()({name:"VFieldLabel",props:{floating:Boolean,...ne()},setup(e,c){let{slots:n}=c;return X(()=>m(na,{class:["v-field-label",{"v-field-label--floating":e.floating},e.class],style:e.style,"aria-hidden":e.floating||void 0},n)),{}}}),Ns=he({focused:Boolean,"onUpdate:focused":an()},"focus");function Yn(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn();const n=pe(e,"focused"),t=h(()=>({[`${c}--focused`]:n.value}));function a(){n.value=!0}function s(){n.value=!1}return{focusClasses:t,isFocused:n,focus:a,blur:s}}const Cg=["underlined","outlined","filled","solo","solo-inverted","solo-filled","plain"],Ds=he({appendInnerIcon:je,bgColor:String,clearable:Boolean,clearIcon:{type:je,default:"$clear"},active:Boolean,color:String,baseColor:String,dirty:Boolean,disabled:Boolean,error:Boolean,flat:Boolean,label:String,persistentClear:Boolean,prependInnerIcon:je,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>Cg.includes(e)},"onClick:clear":an(),"onClick:appendInner":an(),"onClick:prependInner":an(),...ne(),...dr(),...De(),...Ie()},"v-field"),La=W()({name:"VField",inheritAttrs:!1,props:{id:String,...Ns(),...Ds()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,c){let{attrs:n,emit:t,slots:a}=c;const{themeClasses:s}=Pe(e),{loaderClasses:u}=Fs(e),{focusClasses:l,isFocused:r,focus:o,blur:i}=Yn(e),{InputIcon:d}=Wd(e),{roundedClasses:f}=Ue(e),v=h(()=>e.dirty||e.active),y=h(()=>!e.singleLine&&!!(e.label||a.label)),b=yc(),k=h(()=>e.id||`input-${b}`),g=h(()=>`${k.value}-messages`),p=$(),j=$(),P=$(),{backgroundColorClasses:x,backgroundColorStyles:I}=Ze(Y(e,"bgColor")),{textColorClasses:A,textColorStyles:q}=mc(h(()=>e.error||e.disabled?void 0:v.value&&r.value?e.color:e.baseColor));ae(v,V=>{if(y.value){const _=p.value.$el,M=j.value.$el;requestAnimationFrame(()=>{const N=Gl(_),Z=M.getBoundingClientRect(),F=Z.x-N.x,H=Z.y-N.y-(N.height/2-Z.height/2),D=Z.width/.75,J=Math.abs(D-N.width)>1?{maxWidth:le(D)}:void 0,R=getComputedStyle(_),K=getComputedStyle(M),z=parseFloat(R.transitionDuration)*1e3||150,fe=parseFloat(K.getPropertyValue("--v-field-label-scale")),oe=K.getPropertyValue("color");_.style.visibility="visible",M.style.visibility="hidden",ut(_,{transform:`translate(${F}px, ${H}px) scale(${fe})`,color:oe,...J},{duration:z,easing:Va,direction:V?"normal":"reverse"}).finished.then(()=>{_.style.removeProperty("visibility"),M.style.removeProperty("visibility")})})}},{flush:"post"});const C=h(()=>({isActive:v,isFocused:r,controlRef:P,blur:i,focus:o}));function w(V){V.target!==document.activeElement&&V.preventDefault()}return X(()=>{var F,H,D;const V=e.variant==="outlined",_=a["prepend-inner"]||e.prependInnerIcon,M=!!(e.clearable||a.clear),N=!!(a["append-inner"]||e.appendInnerIcon||M),Z=a.label?a.label({label:e.label,props:{for:k.value}}):e.label;return m("div",se({class:["v-field",{"v-field--active":v.value,"v-field--appended":N,"v-field--disabled":e.disabled,"v-field--dirty":e.dirty,"v-field--error":e.error,"v-field--flat":e.flat,"v-field--has-background":!!e.bgColor,"v-field--persistent-clear":e.persistentClear,"v-field--prepended":_,"v-field--reverse":e.reverse,"v-field--single-line":e.singleLine,"v-field--no-label":!Z,[`v-field--variant-${e.variant}`]:!0},s.value,x.value,l.value,u.value,f.value,e.class],style:[I.value,q.value,e.style],onClick:w},n),[m("div",{class:"v-field__overlay"},null),m(fr,{name:"v-field",active:!!e.loading,color:e.error?"error":e.color},{default:a.loader}),_&&m("div",{key:"prepend",class:"v-field__prepend-inner"},[e.prependInnerIcon&&m(d,{key:"prepend-icon",name:"prependInner"},null),(F=a["prepend-inner"])==null?void 0:F.call(a,C.value)]),m("div",{class:"v-field__field","data-no-activator":""},[["filled","solo","solo-inverted","solo-filled"].includes(e.variant)&&y.value&&m(oa,{key:"floating-label",ref:j,class:[A.value],floating:!0,for:k.value},{default:()=>[Z]}),m(oa,{ref:p,for:k.value},{default:()=>[Z]}),(H=a.default)==null?void 0:H.call(a,{...C.value,props:{id:k.value,class:"v-field__input","aria-describedby":g.value},focus:o,blur:i})]),M&&m(ar,{key:"clear"},{default:()=>[He(m("div",{class:"v-field__clearable",onMousedown:J=>{J.preventDefault(),J.stopPropagation()}},[a.clear?a.clear():m(d,{name:"clear"},null)]),[[rn,e.dirty]])]}),N&&m("div",{key:"append",class:"v-field__append-inner"},[(D=a["append-inner"])==null?void 0:D.call(a,C.value),e.appendInnerIcon&&m(d,{key:"append-icon",name:"appendInner"},null)]),m("div",{class:["v-field__outline",A.value]},[V&&m(ve,null,[m("div",{class:"v-field__outline__start"},null),y.value&&m("div",{class:"v-field__outline__notch"},[m(oa,{ref:j,floating:!0,for:k.value},{default:()=>[Z]})]),m("div",{class:"v-field__outline__end"},null)]),["plain","underlined"].includes(e.variant)&&y.value&&m(oa,{ref:j,floating:!0,for:k.value},{default:()=>[Z]})])])}),{controlRef:P}}});function vr(e){const c=Object.keys(La.props).filter(n=>!pb(n)&&n!=="class"&&n!=="style");return Wt(e,c)}const Kd=W()({name:"VMessages",props:{active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...ne(),...xn({transition:{component:tr,leaveAbsolute:!0,group:!0}})},setup(e,c){let{slots:n}=c;const t=h(()=>Tc(e.messages)),{textColorClasses:a,textColorStyles:s}=mc(h(()=>e.color));return X(()=>m(Hc,{transition:e.transition,tag:"div",class:["v-messages",a.value,e.class],style:[s.value,e.style],role:"alert","aria-live":"polite"},{default:()=>[e.active&&t.value.map((u,l)=>m("div",{class:"v-messages__message",key:`${l}-${t.value}`},[n.message?n.message({message:u}):u]))]})),{}}}),Yd=Symbol.for("vuetify:form"),_g=he({disabled:Boolean,fastFail:Boolean,readonly:Boolean,modelValue:{type:Boolean,default:null},validateOn:{type:String,default:"input"}},"form");function xg(e){const c=pe(e,"modelValue"),n=h(()=>e.disabled),t=h(()=>e.readonly),a=$(!1),s=$([]),u=$([]);async function l(){const i=[];let d=!0;u.value=[],a.value=!0;for(const f of s.value){const v=await f.validate();if(v.length>0&&(d=!1,i.push({id:f.id,errorMessages:v})),!d&&e.fastFail)break}return u.value=i,a.value=!1,{valid:d,errors:u.value}}function r(){s.value.forEach(i=>i.reset()),c.value=null}function o(){s.value.forEach(i=>i.resetValidation()),u.value=[],c.value=null}return ae(s,()=>{let i=0,d=0;const f=[];for(const v of s.value)v.isValid===!1?(d++,f.push({id:v.id,errorMessages:v.errorMessages})):v.isValid===!0&&i++;u.value=f,c.value=d>0?!1:i===s.value.length?!0:null},{deep:!0}),Ke(Yd,{register:i=>{let{id:d,validate:f,reset:v,resetValidation:y}=i;s.value.some(b=>b.id===d)&&Ln(`Duplicate input name "${d}"`),s.value.push({id:d,validate:f,reset:v,resetValidation:y,isValid:null,errorMessages:[]})},unregister:i=>{s.value=s.value.filter(d=>d.id!==i)},update:(i,d,f)=>{const v=s.value.find(y=>y.id===i);v&&(v.isValid=d,v.errorMessages=f)},isDisabled:n,isReadonly:t,isValidating:a,items:s,validateOn:Y(e,"validateOn")}),{errors:u,isDisabled:n,isReadonly:t,isValidating:a,items:s,validate:l,reset:r,resetValidation:o}}function zs(){return Ve(Yd,null)}const Gd=he({disabled:Boolean,error:Boolean,errorMessages:{type:[Array,String],default:()=>[]},maxErrors:{type:[Number,String],default:1},name:String,label:String,readonly:Boolean,rules:{type:Array,default:()=>[]},modelValue:null,validateOn:String,validationValue:null,...Ns()},"validation");function Xd(e){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Cn(),n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:yc();const t=pe(e,"modelValue"),a=h(()=>e.validationValue===void 0?t.value:e.validationValue),s=zs(),u=$([]),l=$(!0),r=h(()=>!!(Tc(t.value===""?null:t.value).length||Tc(a.value===""?null:a.value).length)),o=h(()=>!!(e.disabled||s!=null&&s.isDisabled.value)),i=h(()=>!!(e.readonly||s!=null&&s.isReadonly.value)),d=h(()=>e.errorMessages.length?Tc(e.errorMessages).slice(0,Math.max(0,+e.maxErrors)):u.value),f=h(()=>e.error||d.value.length?!1:e.rules.length&&l.value?null:!0),v=$(!1),y=h(()=>({[`${c}--error`]:f.value===!1,[`${c}--dirty`]:r.value,[`${c}--disabled`]:o.value,[`${c}--readonly`]:i.value})),b=h(()=>e.name??dc(n));As(()=>{s==null||s.register({id:b.value,validate:j,reset:g,resetValidation:p})}),jc(()=>{s==null||s.unregister(b.value)});const k=h(()=>e.validateOn||(s==null?void 0:s.validateOn.value)||"input");vc(()=>s==null?void 0:s.update(b.value,f.value,d.value)),Nn(()=>k.value==="input",()=>{ae(a,()=>{if(a.value!=null)j();else if(e.focused){const P=ae(()=>e.focused,x=>{x||j(),P()})}})}),Nn(()=>k.value==="blur",()=>{ae(()=>e.focused,P=>{P||j()})}),ae(f,()=>{s==null||s.update(b.value,f.value,d.value)});function g(){p(),t.value=null}function p(){l.value=!0,u.value=[]}async function j(){const P=[];v.value=!0;for(const x of e.rules){if(P.length>=+(e.maxErrors??1))break;const A=await(typeof x=="function"?x:()=>x)(a.value);if(A!==!0){if(typeof A!="string"){console.warn(`${A} is not a valid value. Rule functions must return boolean true or a string.`);continue}P.push(A)}}return u.value=P,v.value=!1,l.value=!1,u.value}return{errorMessages:d,isDirty:r,isDisabled:o,isReadonly:i,isPristine:l,isValid:f,isValidating:v,reset:g,resetValidation:p,validate:j,validationClasses:y}}const Vn=he({id:String,appendIcon:je,prependIcon:je,hideDetails:[Boolean,String],hint:String,persistentHint:Boolean,messages:{type:[Array,String],default:()=>[]},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},"onClick:prepend":an(),"onClick:append":an(),...ne(),...nc(),...Gd()},"v-input"),uc=W()({name:"VInput",props:{...Vn()},emits:{"update:modelValue":e=>!0},setup(e,c){let{attrs:n,slots:t,emit:a}=c;const{densityClasses:s}=bc(e),{InputIcon:u}=Wd(e),l=yc(),r=h(()=>e.id||`input-${l}`),o=h(()=>`${r.value}-messages`),{errorMessages:i,isDirty:d,isDisabled:f,isReadonly:v,isPristine:y,isValid:b,isValidating:k,reset:g,resetValidation:p,validate:j,validationClasses:P}=Xd(e,"v-input",r),x=h(()=>({id:r,messagesId:o,isDirty:d,isDisabled:f,isReadonly:v,isPristine:y,isValid:b,isValidating:k,reset:g,resetValidation:p,validate:j})),I=h(()=>i.value.length>0?i.value:e.hint&&(e.persistentHint||e.focused)?e.hint:e.messages);return X(()=>{var V,_,M,N;const A=!!(t.prepend||e.prependIcon),q=!!(t.append||e.appendIcon),C=I.value.length>0,w=!e.hideDetails||e.hideDetails==="auto"&&(C||!!t.details);return m("div",{class:["v-input",`v-input--${e.direction}`,s.value,P.value,e.class],style:e.style},[A&&m("div",{key:"prepend",class:"v-input__prepend"},[(V=t.prepend)==null?void 0:V.call(t,x.value),e.prependIcon&&m(u,{key:"prepend-icon",name:"prepend"},null)]),t.default&&m("div",{class:"v-input__control"},[(_=t.default)==null?void 0:_.call(t,x.value)]),q&&m("div",{key:"append",class:"v-input__append"},[e.appendIcon&&m(u,{key:"append-icon",name:"append"},null),(M=t.append)==null?void 0:M.call(t,x.value)]),w&&m("div",{class:"v-input__details"},[m(Kd,{id:o.value,active:C,messages:I.value},{message:t.message}),(N=t.details)==null?void 0:N.call(t,x.value)])])}),{reset:g,resetValidation:p,validate:j}}});const Hs=W()({name:"VCounter",functional:!0,props:{active:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...ne(),...xn({transition:{component:tr}})},setup(e,c){let{slots:n}=c;const t=h(()=>e.max?`${e.value} / ${e.max}`:String(e.value));return X(()=>m(Hc,{transition:e.transition},{default:()=>[He(m("div",{class:["v-counter",e.class],style:e.style},[n.default?n.default({counter:t.value,max:e.max,value:e.value}):t.value]),[[rn,e.active]])]})),{}}}),vu=Symbol("Forwarded refs");function yu(e,c){let n=e;for(;n;){const t=Reflect.getOwnPropertyDescriptor(n,c);if(t)return t;n=Object.getPrototypeOf(n)}}function Gc(e){for(var c=arguments.length,n=new Array(c>1?c-1:0),t=1;t<c;t++)n[t-1]=arguments[t];return e[vu]=n,new Proxy(e,{get(a,s){if(Reflect.has(a,s))return Reflect.get(a,s);if(!(typeof s=="symbol"||s.startsWith("__"))){for(const u of n)if(u.value&&Reflect.has(u.value,s)){const l=Reflect.get(u.value,s);return typeof l=="function"?l.bind(u.value):l}}},has(a,s){if(Reflect.has(a,s))return!0;if(typeof s=="symbol"||s.startsWith("__"))return!1;for(const u of n)if(u.value&&Reflect.has(u.value,s))return!0;return!1},getOwnPropertyDescriptor(a,s){var l;const u=Reflect.getOwnPropertyDescriptor(a,s);if(u)return u;if(!(typeof s=="symbol"||s.startsWith("__"))){for(const r of n){if(!r.value)continue;const o=yu(r.value,s)??("_"in r.value?yu((l=r.value._)==null?void 0:l.setupState,s):void 0);if(o)return o}for(const r of n){const o=r.value&&r.value[vu];if(!o)continue;const i=o.slice();for(;i.length;){const d=i.shift(),f=yu(d.value,s);if(f)return f;const v=d.value&&d.value[vu];v&&i.push(...v)}}}}})}const wg=["color","file","time","date","datetime-local","week","month"],Us=he({autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,suffix:String,type:{type:String,default:"text"},modelModifiers:Object,...Vn(),...Ds()},"v-text-field"),ft=W()({name:"VTextField",directives:{Intersect:Ba},inheritAttrs:!1,props:Us(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,c){let{attrs:n,emit:t,slots:a}=c;const s=pe(e,"modelValue"),{isFocused:u,focus:l,blur:r}=Yn(e),o=h(()=>typeof e.counterValue=="function"?e.counterValue(s.value):(s.value??"").toString().length),i=h(()=>{if(n.maxlength)return n.maxlength;if(!(!e.counter||typeof e.counter!="number"&&typeof e.counter!="string"))return e.counter});function d(x,I){var A,q;!e.autofocus||!x||(q=(A=I[0].target)==null?void 0:A.focus)==null||q.call(A)}const f=$(),v=$(),y=$(),b=h(()=>wg.includes(e.type)||e.persistentPlaceholder||u.value||e.active);function k(){var x;y.value!==document.activeElement&&((x=y.value)==null||x.focus()),u.value||l()}function g(x){t("mousedown:control",x),x.target!==y.value&&(k(),x.preventDefault())}function p(x){k(),t("click:control",x)}function j(x){x.stopPropagation(),k(),Oe(()=>{s.value=null,Kl(e["onClick:clear"],x)})}function P(x){var A;const I=x.target;if(s.value=I.value,(A=e.modelModifiers)!=null&&A.trim&&["text","search","password","tel","url"].includes(e.type)){const q=[I.selectionStart,I.selectionEnd];Oe(()=>{I.selectionStart=q[0],I.selectionEnd=q[1]})}}return X(()=>{const x=!!(a.counter||e.counter||e.counterValue),I=!!(x||a.details),[A,q]=vt(n),[{modelValue:C,...w}]=uc.filterProps(e),[V]=vr(e);return m(uc,se({ref:f,modelValue:s.value,"onUpdate:modelValue":_=>s.value=_,class:["v-text-field",{"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-text-field--flush-details":["plain","underlined"].includes(e.variant)},e.class],style:e.style},A,w,{focused:u.value}),{...a,default:_=>{let{id:M,isDisabled:N,isDirty:Z,isReadonly:F,isValid:H}=_;return m(La,se({ref:v,onMousedown:g,onClick:p,"onClick:clear":j,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"],role:"textbox"},V,{id:M.value,active:b.value||Z.value,dirty:Z.value||e.dirty,disabled:N.value,focused:u.value,error:H.value===!1}),{...a,default:D=>{let{props:{class:J,...R}}=D;const K=He(m("input",se({ref:y,value:s.value,onInput:P,autofocus:e.autofocus,readonly:F.value,disabled:N.value,name:e.name,placeholder:e.placeholder,size:1,type:e.type,onFocus:k,onBlur:r},R,q),null),[[pc("intersect"),{handler:d},null,{once:!0}]]);return m(ve,null,[e.prefix&&m("span",{class:"v-text-field__prefix"},[e.prefix]),a.default?m("div",{class:J,"data-no-activator":""},[a.default(),K]):hn(K,{class:J}),e.suffix&&m("span",{class:"v-text-field__suffix"},[e.suffix])])}})},details:I?_=>{var M;return m(ve,null,[(M=a.details)==null?void 0:M.call(a,_),x&&m(ve,null,[m("span",null,null),m(Hs,{active:e.persistentCounter||u.value,value:o.value,max:i.value},a.counter)])])}:void 0})}),Gc({},f,v,y)}});const Zd=Symbol.for("vuetify:selection-control-group"),yr=he({color:String,disabled:Boolean,error:Boolean,id:String,inline:Boolean,falseIcon:je,trueIcon:je,ripple:{type:Boolean,default:!0},multiple:{type:Boolean,default:null},name:String,readonly:Boolean,modelValue:null,type:String,valueComparator:{type:Function,default:mt},...Ie(),...nc()},"v-selection-control-group"),Qd=W()({name:"VSelectionControlGroup",props:{defaultsTarget:{type:String,default:"VSelectionControl"},...ne(),...yr()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),a=yc(),s=h(()=>e.id||`v-selection-control-group-${a}`),u=h(()=>e.name||s.value),l=new Set;return Ke(Zd,{modelValue:t,forceUpdate:()=>{l.forEach(r=>r())},onForceUpdate:r=>{l.add(r),Vc(()=>{l.delete(r)})}}),Je({[e.defaultsTarget]:{color:Y(e,"color"),disabled:Y(e,"disabled"),density:Y(e,"density"),error:Y(e,"error"),inline:Y(e,"inline"),modelValue:t,multiple:h(()=>!!e.multiple||e.multiple==null&&Array.isArray(t.value)),name:u,falseIcon:Y(e,"falseIcon"),trueIcon:Y(e,"trueIcon"),readonly:Y(e,"readonly"),ripple:Y(e,"ripple"),type:Y(e,"type"),valueComparator:Y(e,"valueComparator")}}),X(()=>{var r;return m("div",{class:["v-selection-control-group",{"v-selection-control-group--inline":e.inline},e.class],style:e.style,role:e.type==="radio"?"radiogroup":void 0},[(r=n.default)==null?void 0:r.call(n)])}),{}}}),Ws=he({label:String,trueValue:null,falseValue:null,value:null,...ne(),...yr()},"v-selection-control");function Vg(e){const c=Ve(Zd,void 0),{densityClasses:n}=bc(e),t=pe(e,"modelValue"),a=h(()=>e.trueValue!==void 0?e.trueValue:e.value!==void 0?e.value:!0),s=h(()=>e.falseValue!==void 0?e.falseValue:!1),u=h(()=>!!e.multiple||e.multiple==null&&Array.isArray(t.value)),l=h({get(){const d=c?c.modelValue.value:t.value;return u.value?d.some(f=>e.valueComparator(f,a.value)):e.valueComparator(d,a.value)},set(d){if(e.readonly)return;const f=d?a.value:s.value;let v=f;u.value&&(v=d?[...Tc(t.value),f]:Tc(t.value).filter(y=>!e.valueComparator(y,a.value))),c?c.modelValue.value=v:t.value=v}}),{textColorClasses:r,textColorStyles:o}=mc(h(()=>l.value&&!e.error&&!e.disabled?e.color:void 0)),i=h(()=>l.value?e.trueIcon:e.falseIcon);return{group:c,densityClasses:n,trueValue:a,falseValue:s,model:l,textColorClasses:r,textColorStyles:o,icon:i}}const Ft=W()({name:"VSelectionControl",directives:{Ripple:Un},inheritAttrs:!1,props:Ws(),emits:{"update:modelValue":e=>!0},setup(e,c){let{attrs:n,slots:t}=c;const{group:a,densityClasses:s,icon:u,model:l,textColorClasses:r,textColorStyles:o,trueValue:i}=Vg(e),d=yc(),f=h(()=>e.id||`input-${d}`),v=$(!1),y=$(!1),b=$();a==null||a.onForceUpdate(()=>{b.value&&(b.value.checked=l.value)});function k(j){v.value=!0,(!Ku||Ku&&j.target.matches(":focus-visible"))&&(y.value=!0)}function g(){v.value=!1,y.value=!1}function p(j){e.readonly&&a&&Oe(()=>a.forceUpdate()),l.value=j.target.checked}return X(()=>{var I,A;const j=t.label?t.label({label:e.label,props:{for:f.value}}):e.label,[P,x]=vt(n);return m("div",se({class:["v-selection-control",{"v-selection-control--dirty":l.value,"v-selection-control--disabled":e.disabled,"v-selection-control--error":e.error,"v-selection-control--focused":v.value,"v-selection-control--focus-visible":y.value,"v-selection-control--inline":e.inline},s.value,e.class]},P,{style:e.style}),[m("div",{class:["v-selection-control__wrapper",r.value],style:o.value},[(I=t.default)==null?void 0:I.call(t),He(m("div",{class:["v-selection-control__input"]},[u.value&&m(ze,{key:"icon",icon:u.value},null),m("input",se({ref:b,checked:l.value,disabled:e.disabled,id:f.value,onBlur:g,onFocus:k,onInput:p,"aria-disabled":e.readonly,type:e.type,value:i.value,name:e.name,"aria-checked":e.type==="checkbox"?l.value:void 0},x),null),(A=t.input)==null?void 0:A.call(t,{model:l,textColorClasses:r,textColorStyles:o,props:{onFocus:k,onBlur:g,id:f.value}})]),[[pc("ripple"),e.ripple&&[!e.disabled&&!e.readonly,null,["center","circle"]]]])]),j&&m(na,{for:f.value,clickable:!0},{default:()=>[j]})])}),{isFocused:v,input:b}}}),Jd=he({indeterminate:Boolean,indeterminateIcon:{type:je,default:"$checkboxIndeterminate"},...Ws({falseIcon:"$checkboxOff",trueIcon:"$checkboxOn"})},"v-checkbox-btn"),Nt=W()({name:"VCheckboxBtn",props:Jd(),emits:{"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"indeterminate"),a=pe(e,"modelValue");function s(r){t.value&&(t.value=!1)}const u=h(()=>e.indeterminate?e.indeterminateIcon:e.falseIcon),l=h(()=>e.indeterminate?e.indeterminateIcon:e.trueIcon);return X(()=>m(Ft,se(e,{modelValue:a.value,"onUpdate:modelValue":[r=>a.value=r,s],class:["v-checkbox-btn",e.class],style:e.style,type:"checkbox",falseIcon:u.value,trueIcon:l.value,"aria-checked":e.indeterminate?"mixed":void 0}),n)),{}}}),Ig=W()({name:"VCheckbox",inheritAttrs:!1,props:{...Vn(),...on(Jd(),["inline"])},emits:{"update:focused":e=>!0},setup(e,c){let{attrs:n,slots:t}=c;const{isFocused:a,focus:s,blur:u}=Yn(e),l=yc(),r=h(()=>e.id||`checkbox-${l}`);return X(()=>{const[o,i]=vt(n),[d,f]=uc.filterProps(e),[v,y]=Nt.filterProps(e);return m(uc,se({class:["v-checkbox",e.class]},o,d,{id:r.value,focused:a.value,style:e.style}),{...t,default:b=>{let{id:k,messagesId:g,isDisabled:p,isReadonly:j}=b;return m(Nt,se(v,{id:k.value,"aria-describedby":g.value,disabled:p.value,readonly:j.value},i,{onFocus:s,onBlur:u}),t)}})}),{}}});const Ag=he({start:Boolean,end:Boolean,icon:je,image:String,...ne(),...nc(),...De(),...wn(),...Se(),...Ie(),...Fc({variant:"flat"})},"v-avatar"),Dn=W()({name:"VAvatar",props:Ag(),setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{colorClasses:a,colorStyles:s,variantClasses:u}=gt(e),{densityClasses:l}=bc(e),{roundedClasses:r}=Ue(e),{sizeClasses:o,sizeStyles:i}=Jt(e);return X(()=>m(e.tag,{class:["v-avatar",{"v-avatar--start":e.start,"v-avatar--end":e.end},t.value,a.value,l.value,r.value,o.value,u.value,e.class],style:[s.value,i.value,e.style]},{default:()=>{var d;return[e.image?m(Gt,{key:"image",src:e.image,alt:"",cover:!0},null):e.icon?m(ze,{key:"icon",icon:e.icon},null):(d=n.default)==null?void 0:d.call(n),ht(!1,"v-avatar")]}})),{}}});const ef=Symbol.for("vuetify:v-chip-group"),Eg=W()({name:"VChipGroup",props:{column:Boolean,filter:Boolean,valueComparator:{type:Function,default:mt},...ne(),...Xt({selectedClass:"v-chip--selected"}),...Se(),...Ie(),...Fc({variant:"tonal"})},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{isSelected:a,select:s,next:u,prev:l,selected:r}=jt(e,ef);return Je({VChip:{color:Y(e,"color"),disabled:Y(e,"disabled"),filter:Y(e,"filter"),variant:Y(e,"variant")}}),X(()=>m(e.tag,{class:["v-chip-group",{"v-chip-group--column":e.column},t.value,e.class],style:e.style},{default:()=>{var o;return[(o=n.default)==null?void 0:o.call(n,{isSelected:a,select:s,next:u,prev:l,selected:r.value})]}})),{}}}),Fa=W()({name:"VChip",directives:{Ripple:Un},props:{activeClass:String,appendAvatar:String,appendIcon:je,closable:Boolean,closeIcon:{type:je,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:String,default:"$complete"},label:Boolean,link:{type:Boolean,default:void 0},pill:Boolean,prependAvatar:String,prependIcon:je,ripple:{type:Boolean,default:!0},text:String,modelValue:{type:Boolean,default:!0},onClick:an(),onClickOnce:an(),...Ac(),...ne(),...nc(),...cc(),...Zt(),...De(),...Oa(),...wn(),...Se({tag:"span"}),...Ie(),...Fc({variant:"tonal"})},emits:{"click:close":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0,click:e=>!0},setup(e,c){let{attrs:n,emit:t,slots:a}=c;const{t:s}=Bc(),{borderClasses:u}=Lc(e),{colorClasses:l,colorStyles:r,variantClasses:o}=gt(e),{densityClasses:i}=bc(e),{elevationClasses:d}=rc(e),{roundedClasses:f}=Ue(e),{sizeClasses:v}=Jt(e),{themeClasses:y}=Pe(e),b=pe(e,"modelValue"),k=Qt(e,ef,!1),g=Ra(e,n),p=h(()=>e.link!==!1&&g.isLink.value),j=h(()=>!e.disabled&&e.link!==!1&&(!!k||e.link||g.isClickable.value)),P=h(()=>({"aria-label":s(e.closeLabel),onClick(A){b.value=!1,t("click:close",A)}}));function x(A){var q;t("click",A),j.value&&((q=g.navigate)==null||q.call(g,A),k==null||k.toggle())}function I(A){(A.key==="Enter"||A.key===" ")&&(A.preventDefault(),x(A))}return()=>{const A=g.isLink.value?"a":e.tag,q=!!(e.appendIcon||e.appendAvatar),C=!!(q||a.append),w=!!(a.close||e.closable),V=!!(a.filter||e.filter)&&k,_=!!(e.prependIcon||e.prependAvatar),M=!!(_||a.prepend),N=!k||k.isSelected.value;return b.value&&He(m(A,{class:["v-chip",{"v-chip--disabled":e.disabled,"v-chip--label":e.label,"v-chip--link":j.value,"v-chip--filter":V,"v-chip--pill":e.pill},y.value,u.value,N?l.value:void 0,i.value,d.value,f.value,v.value,o.value,k==null?void 0:k.selectedClass.value,e.class],style:[N?r.value:void 0,e.style],disabled:e.disabled||void 0,draggable:e.draggable,href:g.href.value,tabindex:j.value?0:void 0,onClick:x,onKeydown:j.value&&!p.value&&I},{default:()=>{var Z;return[ht(j.value,"v-chip"),V&&m(ar,{key:"filter"},{default:()=>[He(m("div",{class:"v-chip__filter"},[a.filter?He(m($e,{key:"filter-defaults",disabled:!e.filterIcon,defaults:{VIcon:{icon:e.filterIcon}}},null),[[pc("slot"),a.filter,"default"]]):m(ze,{key:"filter-icon",icon:e.filterIcon},null)]),[[rn,k.isSelected.value]])]}),M&&m("div",{key:"prepend",class:"v-chip__prepend"},[a.prepend?m($e,{key:"prepend-defaults",disabled:!_,defaults:{VAvatar:{image:e.prependAvatar,start:!0},VIcon:{icon:e.prependIcon,start:!0}}},a.prepend):m(ve,null,[e.prependIcon&&m(ze,{key:"prepend-icon",icon:e.prependIcon,start:!0},null),e.prependAvatar&&m(Dn,{key:"prepend-avatar",image:e.prependAvatar,start:!0},null)])]),((Z=a.default)==null?void 0:Z.call(a,{isSelected:k==null?void 0:k.isSelected.value,selectedClass:k==null?void 0:k.selectedClass.value,select:k==null?void 0:k.select,toggle:k==null?void 0:k.toggle,value:k==null?void 0:k.value.value,disabled:e.disabled}))??e.text,C&&m("div",{key:"append",class:"v-chip__append"},[a.append?m($e,{key:"append-defaults",disabled:!q,defaults:{VAvatar:{end:!0,image:e.appendAvatar},VIcon:{end:!0,icon:e.appendIcon}}},a.append):m(ve,null,[e.appendIcon&&m(ze,{key:"append-icon",end:!0,icon:e.appendIcon},null),e.appendAvatar&&m(Dn,{key:"append-avatar",end:!0,image:e.appendAvatar},null)])]),w&&m("div",se({key:"close",class:"v-chip__close"},P.value),[a.close?m($e,{key:"close-defaults",defaults:{VIcon:{icon:e.closeIcon,size:"x-small"}}},a.close):m(ze,{key:"close-icon",icon:e.closeIcon,size:"x-small"},null)])]}}),[[pc("ripple"),j.value&&e.ripple,null]])}}});const cf=W()({name:"VDivider",props:{color:String,inset:Boolean,length:[Number,String],thickness:[Number,String],vertical:Boolean,...ne(),...Ie()},setup(e,c){let{attrs:n}=c;const{themeClasses:t}=Pe(e),{textColorClasses:a,textColorStyles:s}=mc(Y(e,"color")),u=h(()=>{const l={};return e.length&&(l[e.vertical?"maxHeight":"maxWidth"]=le(e.length)),e.thickness&&(l[e.vertical?"borderRightWidth":"borderTopWidth"]=le(e.thickness)),l});return X(()=>m("hr",{class:[{"v-divider":!0,"v-divider--inset":e.inset,"v-divider--vertical":e.vertical},t.value,a.value,e.class],style:[u.value,s.value,e.style],"aria-orientation":!n.role||n.role==="separator"?e.vertical?"vertical":"horizontal":void 0,role:`${n.role||"separator"}`},null)),{}}}),nl=Symbol.for("vuetify:list");function nf(){const e=Ve(nl,{hasPrepend:$(!1),updateHasPrepend:()=>null}),c={hasPrepend:$(!1),updateHasPrepend:n=>{n&&(c.hasPrepend.value=n)}};return Ke(nl,c),e}function tf(){return Ve(nl,null)}const Pg={open:e=>{let{id:c,value:n,opened:t,parents:a}=e;if(n){const s=new Set;s.add(c);let u=a.get(c);for(;u!=null;)s.add(u),u=a.get(u);return s}else return t.delete(c),t},select:()=>null},af={open:e=>{let{id:c,value:n,opened:t,parents:a}=e;if(n){let s=a.get(c);for(t.add(c);s!=null&&s!==c;)t.add(s),s=a.get(s);return t}else t.delete(c);return t},select:()=>null},Tg={open:af.open,select:e=>{let{id:c,value:n,opened:t,parents:a}=e;if(!n)return t;const s=[];let u=a.get(c);for(;u!=null;)s.push(u),u=a.get(u);return new Set(s)}},br=e=>{const c={select:n=>{let{id:t,value:a,selected:s}=n;if(t=Ce(t),e&&!a){const u=Array.from(s.entries()).reduce((l,r)=>{let[o,i]=r;return i==="on"?[...l,o]:l},[]);if(u.length===1&&u[0]===t)return s}return s.set(t,a?"on":"off"),s},in:(n,t,a)=>{let s=new Map;for(const u of n||[])s=c.select({id:u,value:!0,selected:new Map(s),children:t,parents:a});return s},out:n=>{const t=[];for(const[a,s]of n.entries())s==="on"&&t.push(a);return t}};return c},sf=e=>{const c=br(e);return{select:t=>{let{selected:a,id:s,...u}=t;s=Ce(s);const l=a.has(s)?new Map([[s,a.get(s)]]):new Map;return c.select({...u,id:s,selected:l})},in:(t,a,s)=>{let u=new Map;return t!=null&&t.length&&(u=c.in(t.slice(0,1),a,s)),u},out:(t,a,s)=>c.out(t,a,s)}},$g=e=>{const c=br(e);return{select:t=>{let{id:a,selected:s,children:u,...l}=t;return a=Ce(a),u.has(a)?s:c.select({id:a,selected:s,children:u,...l})},in:c.in,out:c.out}},Mg=e=>{const c=sf(e);return{select:t=>{let{id:a,selected:s,children:u,...l}=t;return a=Ce(a),u.has(a)?s:c.select({id:a,selected:s,children:u,...l})},in:c.in,out:c.out}},Bg=e=>{const c={select:n=>{let{id:t,value:a,selected:s,children:u,parents:l}=n;t=Ce(t);const r=new Map(s),o=[t];for(;o.length;){const d=o.shift();s.set(d,a?"on":"off"),u.has(d)&&o.push(...u.get(d))}let i=l.get(t);for(;i;){const d=u.get(i),f=d.every(y=>s.get(y)==="on"),v=d.every(y=>!s.has(y)||s.get(y)==="off");s.set(i,f?"on":v?"off":"indeterminate"),i=l.get(i)}return e&&!a&&Array.from(s.entries()).reduce((f,v)=>{let[y,b]=v;return b==="on"?[...f,y]:f},[]).length===0?r:s},in:(n,t,a)=>{let s=new Map;for(const u of n||[])s=c.select({id:u,value:!0,selected:new Map(s),children:t,parents:a});return s},out:(n,t)=>{const a=[];for(const[s,u]of n.entries())u==="on"&&!t.has(s)&&a.push(s);return a}};return c},Pa=Symbol.for("vuetify:nested"),uf={id:$(),root:{register:()=>null,unregister:()=>null,parents:$(new Map),children:$(new Map),open:()=>null,openOnSelect:()=>null,select:()=>null,opened:$(new Set),selected:$(new Map),selectedValues:$([])}},Rg=he({selectStrategy:[String,Function],openStrategy:[String,Object],opened:Array,selected:Array,mandatory:Boolean},"nested"),Og=e=>{let c=!1;const n=$(new Map),t=$(new Map),a=pe(e,"opened",e.opened,d=>new Set(d),d=>[...d.values()]),s=h(()=>{if(typeof e.selectStrategy=="object")return e.selectStrategy;switch(e.selectStrategy){case"single-leaf":return Mg(e.mandatory);case"leaf":return $g(e.mandatory);case"independent":return br(e.mandatory);case"single-independent":return sf(e.mandatory);case"classic":default:return Bg(e.mandatory)}}),u=h(()=>{if(typeof e.openStrategy=="object")return e.openStrategy;switch(e.openStrategy){case"list":return Tg;case"single":return Pg;case"multiple":default:return af}}),l=pe(e,"selected",e.selected,d=>s.value.in(d,n.value,t.value),d=>s.value.out(d,n.value,t.value));jc(()=>{c=!0});function r(d){const f=[];let v=d;for(;v!=null;)f.unshift(v),v=t.value.get(v);return f}const o=lc("nested"),i={id:$(),root:{opened:a,selected:l,selectedValues:h(()=>{const d=[];for(const[f,v]of l.value.entries())v==="on"&&d.push(f);return d}),register:(d,f,v)=>{f&&d!==f&&t.value.set(d,f),v&&n.value.set(d,[]),f!=null&&n.value.set(f,[...n.value.get(f)||[],d])},unregister:d=>{if(c)return;n.value.delete(d);const f=t.value.get(d);if(f){const v=n.value.get(f)??[];n.value.set(f,v.filter(y=>y!==d))}t.value.delete(d),a.value.delete(d)},open:(d,f,v)=>{o.emit("click:open",{id:d,value:f,path:r(d),event:v});const y=u.value.open({id:d,value:f,opened:new Set(a.value),children:n.value,parents:t.value,event:v});y&&(a.value=y)},openOnSelect:(d,f,v)=>{const y=u.value.select({id:d,value:f,selected:new Map(l.value),opened:new Set(a.value),children:n.value,parents:t.value,event:v});y&&(a.value=y)},select:(d,f,v)=>{o.emit("click:select",{id:d,value:f,path:r(d),event:v});const y=s.value.select({id:d,value:f,selected:new Map(l.value),children:n.value,parents:t.value,event:v});y&&(l.value=y),i.root.openOnSelect(d,f,v)},children:n,parents:t}};return Ke(Pa,i),i.root},lf=(e,c)=>{const n=Ve(Pa,uf),t=Symbol(yc()),a=h(()=>e.value??t),s={...n,id:a,open:(u,l)=>n.root.open(a.value,u,l),openOnSelect:(u,l)=>n.root.openOnSelect(a.value,u,l),isOpen:h(()=>n.root.opened.value.has(a.value)),parent:h(()=>n.root.parents.value.get(a.value)),select:(u,l)=>n.root.select(a.value,u,l),isSelected:h(()=>n.root.selected.value.get(Ce(a.value))==="on"),isIndeterminate:h(()=>n.root.selected.value.get(a.value)==="indeterminate"),isLeaf:h(()=>!n.root.children.value.get(a.value)),isGroupActivator:n.isGroupActivator};return!n.isGroupActivator&&n.root.register(a.value,n.id.value,c),jc(()=>{!n.isGroupActivator&&n.root.unregister(a.value)}),c&&Ke(Pa,s),s},Lg=()=>{const e=Ve(Pa,uf);Ke(Pa,{...e,isGroupActivator:!0})},Fg=Mc({name:"VListGroupActivator",setup(e,c){let{slots:n}=c;return Lg(),()=>{var t;return(t=n.default)==null?void 0:t.call(n)}}}),Ng=he({activeColor:String,color:String,collapseIcon:{type:je,default:"$collapse"},expandIcon:{type:je,default:"$expand"},prependIcon:je,appendIcon:je,fluid:Boolean,subgroup:Boolean,value:null,...ne(),...Se()},"v-list-group"),tl=W()({name:"VListGroup",props:{title:String,...Ng()},setup(e,c){let{slots:n}=c;const{isOpen:t,open:a,id:s}=lf(Y(e,"value"),!0),u=h(()=>`v-list-group--id-${String(s.value)}`),l=tf(),{isBooted:r}=bt();function o(v){a(!t.value,v)}const i=h(()=>({onClick:o,class:"v-list-group__header",id:u.value})),d=h(()=>t.value?e.collapseIcon:e.expandIcon),f=h(()=>({VListItem:{active:t.value,activeColor:e.activeColor,color:e.color,prependIcon:e.prependIcon||e.subgroup&&d.value,appendIcon:e.appendIcon||!e.subgroup&&d.value,title:e.title,value:e.value}}));return X(()=>m(e.tag,{class:["v-list-group",{"v-list-group--prepend":l==null?void 0:l.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup,"v-list-group--open":t.value},e.class],style:e.style},{default:()=>[n.activator&&m($e,{defaults:f.value},{default:()=>[m(Fg,null,{default:()=>[n.activator({props:i.value,isOpen:t.value})]})]}),m(Hc,{transition:{component:Ls},disabled:!r.value},{default:()=>{var v;return[He(m("div",{class:"v-list-group__items",role:"group","aria-labelledby":u.value},[(v=n.default)==null?void 0:v.call(n)]),[[rn,t.value]])]}})]})),{}}});const rf=Yc("v-list-item-subtitle"),of=Yc("v-list-item-title"),qn=W()({name:"VListItem",directives:{Ripple:Un},props:{active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:je,disabled:Boolean,lines:String,link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:je,ripple:{type:Boolean,default:!0},subtitle:[String,Number,Boolean],title:[String,Number,Boolean],value:null,onClick:an(),onClickOnce:an(),...Ac(),...ne(),...nc(),...Rc(),...cc(),...De(),...Oa(),...Se(),...Ie(),...Fc({variant:"text"})},emits:{click:e=>!0},setup(e,c){let{attrs:n,slots:t,emit:a}=c;const s=Ra(e,n),u=h(()=>e.value??s.href.value),{select:l,isSelected:r,isIndeterminate:o,isGroupActivator:i,root:d,parent:f,openOnSelect:v}=lf(u,!1),y=tf(),b=h(()=>{var H;return e.active!==!1&&(e.active||((H=s.isActive)==null?void 0:H.value)||r.value)}),k=h(()=>e.link!==!1&&s.isLink.value),g=h(()=>!e.disabled&&e.link!==!1&&(e.link||s.isClickable.value||e.value!=null&&!!y)),p=h(()=>e.rounded||e.nav),j=h(()=>({color:b.value?e.activeColor??e.color:e.color,variant:e.variant}));ae(()=>{var H;return(H=s.isActive)==null?void 0:H.value},H=>{H&&f.value!=null&&d.open(f.value,!0),H&&v(H)},{immediate:!0});const{themeClasses:P}=Pe(e),{borderClasses:x}=Lc(e),{colorClasses:I,colorStyles:A,variantClasses:q}=gt(j),{densityClasses:C}=bc(e),{dimensionStyles:w}=Oc(e),{elevationClasses:V}=rc(e),{roundedClasses:_}=Ue(p),M=h(()=>e.lines?`v-list-item--${e.lines}-line`:void 0),N=h(()=>({isActive:b.value,select:l,isSelected:r.value,isIndeterminate:o.value}));function Z(H){var D;a("click",H),!(i||!g.value)&&((D=s.navigate)==null||D.call(s,H),e.value!=null&&l(!r.value,H))}function F(H){(H.key==="Enter"||H.key===" ")&&(H.preventDefault(),Z(H))}return X(()=>{const H=k.value?"a":e.tag,D=!y||r.value||b.value,J=t.title||e.title,R=t.subtitle||e.subtitle,K=!!(e.appendAvatar||e.appendIcon),z=!!(K||t.append),fe=!!(e.prependAvatar||e.prependIcon),oe=!!(fe||t.prepend);return y==null||y.updateHasPrepend(oe),He(m(H,{class:["v-list-item",{"v-list-item--active":b.value,"v-list-item--disabled":e.disabled,"v-list-item--link":g.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!oe&&(y==null?void 0:y.hasPrepend.value),[`${e.activeClass}`]:e.activeClass&&b.value},P.value,x.value,D?I.value:void 0,C.value,V.value,M.value,_.value,q.value,e.class],style:[D?A.value:void 0,w.value,e.style],href:s.href.value,tabindex:g.value?0:void 0,onClick:Z,onKeydown:g.value&&!k.value&&F},{default:()=>{var B;return[ht(g.value||b.value,"v-list-item"),oe&&m("div",{key:"prepend",class:"v-list-item__prepend"},[t.prepend?m($e,{key:"prepend-defaults",disabled:!fe,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>{var T;return[(T=t.prepend)==null?void 0:T.call(t,N.value)]}}):m(ve,null,[e.prependAvatar&&m(Dn,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&m(ze,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),m("div",{class:"v-list-item__content","data-no-activator":""},[J&&m(of,{key:"title"},{default:()=>{var T;return[((T=t.title)==null?void 0:T.call(t,{title:e.title}))??e.title]}}),R&&m(rf,{key:"subtitle"},{default:()=>{var T;return[((T=t.subtitle)==null?void 0:T.call(t,{subtitle:e.subtitle}))??e.subtitle]}}),(B=t.default)==null?void 0:B.call(t,N.value)]),z&&m("div",{key:"append",class:"v-list-item__append"},[t.append?m($e,{key:"append-defaults",disabled:!K,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>{var T;return[(T=t.append)==null?void 0:T.call(t,N.value)]}}):m(ve,null,[e.appendIcon&&m(ze,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&m(Dn,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])]}}),[[pc("ripple"),g.value&&e.ripple]])}),{}}}),df=W()({name:"VListSubheader",props:{color:String,inset:Boolean,sticky:Boolean,title:String,...ne(),...Se()},setup(e,c){let{slots:n}=c;const{textColorClasses:t,textColorStyles:a}=mc(Y(e,"color"));return X(()=>{const s=!!(n.default||e.title);return m(e.tag,{class:["v-list-subheader",{"v-list-subheader--inset":e.inset,"v-list-subheader--sticky":e.sticky},t.value,e.class],style:[{textColorStyles:a},e.style]},{default:()=>{var u;return[s&&m("div",{class:"v-list-subheader__text"},[((u=n.default)==null?void 0:u.call(n))??e.title])]}})}),{}}}),ff=W()({name:"VListChildren",props:{items:Array},setup(e,c){let{slots:n}=c;return nf(),()=>{var t,a;return((t=n.default)==null?void 0:t.call(n))??((a=e.items)==null?void 0:a.map(s=>{var v,y;let{children:u,props:l,type:r,raw:o}=s;if(r==="divider")return((v=n.divider)==null?void 0:v.call(n,{props:l}))??m(cf,l,null);if(r==="subheader")return((y=n.subheader)==null?void 0:y.call(n,{props:l}))??m(df,l,{default:n.subheader});const i={subtitle:n.subtitle?b=>{var k;return(k=n.subtitle)==null?void 0:k.call(n,{...b,item:o})}:void 0,prepend:n.prepend?b=>{var k;return(k=n.prepend)==null?void 0:k.call(n,{...b,item:o})}:void 0,append:n.append?b=>{var k;return(k=n.append)==null?void 0:k.call(n,{...b,item:o})}:void 0,default:n.default?b=>{var k;return(k=n.default)==null?void 0:k.call(n,{...b,item:o})}:void 0,title:n.title?b=>{var k;return(k=n.title)==null?void 0:k.call(n,{...b,item:o})}:void 0},[d,f]=tl.filterProps(l);return u?m(tl,se({value:l==null?void 0:l.value},d),{activator:b=>{let{props:k}=b;return n.header?n.header({props:{...l,...k}}):m(qn,se(l,k),i)},default:()=>m(ff,{items:u},n)}):n.item?n.item(l):m(qn,l,i)}))}}}),mf=he({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean},"item");function Vt(e,c){const n=en(c,e.itemTitle,c),t=e.returnObject?c:en(c,e.itemValue,n),a=en(c,e.itemChildren),s=e.itemProps===!0?typeof c=="object"&&c!=null&&!Array.isArray(c)?"children"in c?Wt(c,["children"])[1]:c:void 0:en(c,e.itemProps),u={title:n,value:t,...s};return{title:String(u.title??""),value:u.value,props:u,children:Array.isArray(a)?vf(e,a):void 0,raw:c}}function vf(e,c){const n=[];for(const t of c)n.push(Vt(e,t));return n}function hr(e){const c=h(()=>vf(e,e.items));function n(a){return a.map(s=>c.value.find(l=>mt(s,l.value))??Vt(e,s))}function t(a){return a.map(s=>{let{props:u}=s;return u.value})}return{items:c,transformIn:n,transformOut:t}}function Dg(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function zg(e,c){const n=en(c,e.itemType,"item"),t=Dg(c)?c:en(c,e.itemTitle),a=en(c,e.itemValue,void 0),s=en(c,e.itemChildren),u=e.itemProps===!0?Wt(c,["children"])[1]:en(c,e.itemProps),l={title:t,value:a,...u};return{type:n,title:l.title,value:l.value,props:l,children:n==="item"&&s?yf(e,s):void 0,raw:c}}function yf(e,c){const n=[];for(const t of c)n.push(zg(e,t));return n}function Hg(e){return{items:h(()=>yf(e,e.items))}}const Ks=W()({name:"VList",props:{activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,lines:{type:[Boolean,String],default:"one"},nav:Boolean,...Rg({selectStrategy:"single-leaf",openStrategy:"list"}),...Ac(),...ne(),...nc(),...Rc(),...cc(),itemType:{type:String,default:"type"},...mf(),...De(),...Se(),...Ie(),...Fc({variant:"text"})},emits:{"update:selected":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:select":e=>!0},setup(e,c){let{slots:n}=c;const{items:t}=Hg(e),{themeClasses:a}=Pe(e),{backgroundColorClasses:s,backgroundColorStyles:u}=Ze(Y(e,"bgColor")),{borderClasses:l}=Lc(e),{densityClasses:r}=bc(e),{dimensionStyles:o}=Oc(e),{elevationClasses:i}=rc(e),{roundedClasses:d}=Ue(e),{open:f,select:v}=Og(e),y=h(()=>e.lines?`v-list--${e.lines}-line`:void 0),b=Y(e,"activeColor"),k=Y(e,"color");nf(),Je({VListGroup:{activeColor:b,color:k},VListItem:{activeClass:Y(e,"activeClass"),activeColor:b,color:k,density:Y(e,"density"),disabled:Y(e,"disabled"),lines:Y(e,"lines"),nav:Y(e,"nav"),variant:Y(e,"variant")}});const g=$(!1),p=$();function j(q){g.value=!0}function P(q){g.value=!1}function x(q){var C;!g.value&&!(q.relatedTarget&&((C=p.value)!=null&&C.contains(q.relatedTarget)))&&A()}function I(q){if(p.value){if(q.key==="ArrowDown")A("next");else if(q.key==="ArrowUp")A("prev");else if(q.key==="Home")A("first");else if(q.key==="End")A("last");else return;q.preventDefault()}}function A(q){if(p.value)return J1(p.value,q)}return X(()=>m(e.tag,{ref:p,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav},a.value,s.value,l.value,r.value,i.value,y.value,d.value,e.class],style:[u.value,o.value,e.style],role:"listbox","aria-activedescendant":void 0,onFocusin:j,onFocusout:P,onFocus:x,onKeydown:I},{default:()=>[m(ff,{items:t.value},n)]})),{open:f,select:v,focus:A}}}),Ug=Yc("v-list-img"),Wg=W()({name:"VListItemAction",props:{start:Boolean,end:Boolean,...ne(),...Se()},setup(e,c){let{slots:n}=c;return X(()=>m(e.tag,{class:["v-list-item-action",{"v-list-item-action--start":e.start,"v-list-item-action--end":e.end},e.class],style:e.style},n)),{}}}),Kg=W()({name:"VListItemMedia",props:{start:Boolean,end:Boolean,...ne(),...Se()},setup(e,c){let{slots:n}=c;return X(()=>m(e.tag,{class:["v-list-item-media",{"v-list-item-media--start":e.start,"v-list-item-media--end":e.end},e.class],style:e.style},n)),{}}});const bf=he({closeDelay:[Number,String],openDelay:[Number,String]},"delay");function hf(e,c){const n={},t=a=>()=>{if(!Xe)return Promise.resolve(!0);const s=a==="openDelay";return n.closeDelay&&window.clearTimeout(n.closeDelay),delete n.closeDelay,n.openDelay&&window.clearTimeout(n.openDelay),delete n.openDelay,new Promise(u=>{const l=parseInt(e[a]??0,10);n[a]=window.setTimeout(()=>{c==null||c(s),u(s)},l)})};return{runCloseDelay:t("closeDelay"),runOpenDelay:t("openDelay")}}const al=Symbol.for("vuetify:v-menu"),Yg=he({activator:[String,Object],activatorProps:{type:Object,default:()=>({})},openOnClick:{type:Boolean,default:void 0},openOnHover:Boolean,openOnFocus:{type:Boolean,default:void 0},closeOnContentClick:Boolean,...bf()},"v-overlay-activator");function Gg(e,c){let{isActive:n,isTop:t}=c;const a=$();let s=!1,u=!1,l=!0;const r=h(()=>e.openOnFocus||e.openOnFocus==null&&e.openOnHover),o=h(()=>e.openOnClick||e.openOnClick==null&&!e.openOnHover&&!r.value),{runOpenDelay:i,runCloseDelay:d}=hf(e,j=>{j===(e.openOnHover&&s||r.value&&u)&&!(e.openOnHover&&n.value&&!t.value)&&(n.value!==j&&(l=!0),n.value=j)}),f={click:j=>{j.stopPropagation(),a.value=j.currentTarget||j.target,n.value=!n.value},mouseenter:j=>{var P;(P=j.sourceCapabilities)!=null&&P.firesTouchEvents||(s=!0,a.value=j.currentTarget||j.target,i())},mouseleave:j=>{s=!1,d()},focus:j=>{Ku&&!j.target.matches(":focus-visible")||(u=!0,j.stopPropagation(),a.value=j.currentTarget||j.target,i())},blur:j=>{u=!1,j.stopPropagation(),d()}},v=h(()=>{const j={};return o.value&&(j.click=f.click),e.openOnHover&&(j.mouseenter=f.mouseenter,j.mouseleave=f.mouseleave),r.value&&(j.focus=f.focus,j.blur=f.blur),j}),y=h(()=>{const j={};if(e.openOnHover&&(j.mouseenter=()=>{s=!0,i()},j.mouseleave=()=>{s=!1,d()}),e.closeOnContentClick){const P=Ve(al,null);j.click=()=>{n.value=!1,P==null||P.closeParents()}}return j}),b=h(()=>{const j={};return e.openOnHover&&(j.mouseenter=()=>{l&&(s=!0,l=!1,i())},j.mouseleave=()=>{s=!1,d()}),j});ae(t,j=>{j&&(e.openOnHover&&!s&&(!r.value||!u)||r.value&&!u&&(!e.openOnHover||!s))&&(n.value=!1)});const k=$();Kc(()=>{k.value&&Oe(()=>{const j=k.value;a.value=hb(j)?j.$el:j})});const g=lc("useActivator");let p;return ae(()=>!!e.activator,j=>{j&&Xe?(p=ql(),p.run(()=>{Xg(e,g,{activatorEl:a,activatorEvents:v})})):p&&p.stop()},{flush:"post",immediate:!0}),Vc(()=>{p==null||p.stop()}),{activatorEl:a,activatorRef:k,activatorEvents:v,contentEvents:y,scrimEvents:b}}function Xg(e,c,n){let{activatorEl:t,activatorEvents:a}=n;ae(()=>e.activator,(r,o)=>{if(o&&r!==o){const i=l(o);i&&u(i)}r&&Oe(()=>s())},{immediate:!0}),ae(()=>e.activatorProps,()=>{s()}),Vc(()=>{u()});function s(){let r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:l(),o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:e.activatorProps;r&&(Object.entries(a.value).forEach(i=>{let[d,f]=i;r.addEventListener(d,f)}),Object.keys(o).forEach(i=>{o[i]==null?r.removeAttribute(i):r.setAttribute(i,o[i])}))}function u(){let r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:l(),o=arguments.length>1&&arguments[1]!==void 0?arguments[1]:e.activatorProps;r&&(Object.entries(a.value).forEach(i=>{let[d,f]=i;r.removeEventListener(d,f)}),Object.keys(o).forEach(i=>{r.removeAttribute(i)}))}function l(){var i,d;let r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:e.activator,o;if(r)if(r==="parent"){let f=(d=(i=c==null?void 0:c.proxy)==null?void 0:i.$el)==null?void 0:d.parentNode;for(;f.hasAttribute("data-no-activator");)f=f.parentNode;o=f}else typeof r=="string"?o=document.querySelector(r):"$el"in r?o=r.$el:o=r;return t.value=(o==null?void 0:o.nodeType)===Node.ELEMENT_NODE?o:null,t.value}}const Ys=he({eager:Boolean},"lazy");function gr(e,c){const n=$(!1),t=h(()=>n.value||e.eager||c.value);ae(c,()=>n.value=!0);function a(){e.eager||(n.value=!1)}return{isBooted:n,hasContent:t,onAfterLeave:a}}function bu(e,c){return{x:e.x+c.x,y:e.y+c.y}}function Zg(e,c){return{x:e.x-c.x,y:e.y-c.y}}function oo(e,c){if(e.side==="top"||e.side==="bottom"){const{side:n,align:t}=e,a=t==="left"?0:t==="center"?c.width/2:t==="right"?c.width:t,s=n==="top"?0:n==="bottom"?c.height:n;return bu({x:a,y:s},c)}else if(e.side==="left"||e.side==="right"){const{side:n,align:t}=e,a=n==="left"?0:n==="right"?c.width:n,s=t==="top"?0:t==="center"?c.height/2:t==="bottom"?c.height:t;return bu({x:a,y:s},c)}return bu({x:c.width/2,y:c.height/2},c)}const gf={static:e3,connected:n3},Qg=he({locationStrategy:{type:[String,Function],default:"static",validator:e=>typeof e=="function"||e in gf},location:{type:String,default:"bottom"},origin:{type:String,default:"auto"},offset:[Number,String,Array]},"v-overlay-location-strategies");function Jg(e,c){const n=$({}),t=$();Xe&&(Nn(()=>!!(c.isActive.value&&e.locationStrategy),s=>{var u,l;ae(()=>e.locationStrategy,s),Vc(()=>{t.value=void 0}),typeof e.locationStrategy=="function"?t.value=(u=e.locationStrategy(c,e,n))==null?void 0:u.updateLocation:t.value=(l=gf[e.locationStrategy](c,e,n))==null?void 0:l.updateLocation}),window.addEventListener("resize",a,{passive:!0}),Vc(()=>{window.removeEventListener("resize",a),t.value=void 0}));function a(s){var u;(u=t.value)==null||u.call(t,s)}return{contentStyles:n,updateLocation:t}}function e3(){}function c3(e,c){const n=Gl(e);return c?n.x+=parseFloat(e.style.right||0):n.x-=parseFloat(e.style.left||0),n.y-=parseFloat(e.style.top||0),n}function n3(e,c,n){Hb(e.activatorEl.value)&&Object.assign(n.value,{position:"fixed"});const{preferredAnchor:a,preferredOrigin:s}=Wl(()=>{const y=zu(c.location,e.isRtl.value),b=c.origin==="overlap"?y:c.origin==="auto"?ru(y):zu(c.origin,e.isRtl.value);return y.side===b.side&&y.align===iu(b).align?{preferredAnchor:Ri(y),preferredOrigin:Ri(b)}:{preferredAnchor:y,preferredOrigin:b}}),[u,l,r,o]=["minWidth","minHeight","maxWidth","maxHeight"].map(y=>h(()=>{const b=parseFloat(c[y]);return isNaN(b)?1/0:b})),i=h(()=>{if(Array.isArray(c.offset))return c.offset;if(typeof c.offset=="string"){const y=c.offset.split(" ").map(parseFloat);return y.length<2&&y.push(0),y}return typeof c.offset=="number"?[c.offset,0]:[0,0]});let d=!1;const f=new ResizeObserver(()=>{d&&v()});ae([e.activatorEl,e.contentEl],(y,b)=>{let[k,g]=y,[p,j]=b;p&&f.unobserve(p),k&&f.observe(k),j&&f.unobserve(j),g&&f.observe(g)},{immediate:!0}),Vc(()=>{f.disconnect()});function v(){if(d=!1,requestAnimationFrame(()=>{requestAnimationFrame(()=>d=!0)}),!e.activatorEl.value||!e.contentEl.value)return;const y=e.activatorEl.value.getBoundingClientRect(),b=c3(e.contentEl.value,e.isRtl.value),k=gs(e.contentEl.value),g=12;k.length||(k.push(document.documentElement),e.contentEl.value.style.top&&e.contentEl.value.style.left||(b.x+=parseFloat(document.documentElement.style.getPropertyValue("--v-body-scroll-x")||0),b.y+=parseFloat(document.documentElement.style.getPropertyValue("--v-body-scroll-y")||0)));const p=k.reduce((V,_)=>{const M=_.getBoundingClientRect(),N=new Tt({x:_===document.documentElement?0:M.x,y:_===document.documentElement?0:M.y,width:_.clientWidth,height:_.clientHeight});return V?new Tt({x:Math.max(V.left,N.left),y:Math.max(V.top,N.top),width:Math.min(V.right,N.right)-Math.max(V.left,N.left),height:Math.min(V.bottom,N.bottom)-Math.max(V.top,N.top)}):N},void 0);p.x+=g,p.y+=g,p.width-=g*2,p.height-=g*2;let j={anchor:a.value,origin:s.value};function P(V){const _=new Tt(b),M=oo(V.anchor,y),N=oo(V.origin,_);let{x:Z,y:F}=Zg(M,N);switch(V.anchor.side){case"top":F-=i.value[0];break;case"bottom":F+=i.value[0];break;case"left":Z-=i.value[0];break;case"right":Z+=i.value[0];break}switch(V.anchor.align){case"top":F-=i.value[1];break;case"bottom":F+=i.value[1];break;case"left":Z-=i.value[1];break;case"right":Z+=i.value[1];break}return _.x+=Z,_.y+=F,_.width=Math.min(_.width,r.value),_.height=Math.min(_.height,o.value),{overflows:Li(_,p),x:Z,y:F}}let x=0,I=0;const A={x:0,y:0},q={x:!1,y:!1};let C=-1;for(;;){if(C++>10){Uu("Infinite loop detected in connectedLocationStrategy");break}const{x:V,y:_,overflows:M}=P(j);x+=V,I+=_,b.x+=V,b.y+=_;{const N=Oi(j.anchor),Z=M.x.before||M.x.after,F=M.y.before||M.y.after;let H=!1;if(["x","y"].forEach(D=>{if(D==="x"&&Z&&!q.x||D==="y"&&F&&!q.y){const J={anchor:{...j.anchor},origin:{...j.origin}},R=D==="x"?N==="y"?iu:ru:N==="y"?ru:iu;J.anchor=R(J.anchor),J.origin=R(J.origin);const{overflows:K}=P(J);(K[D].before<=M[D].before&&K[D].after<=M[D].after||K[D].before+K[D].after<(M[D].before+M[D].after)/2)&&(j=J,H=q[D]=!0)}}),H)continue}M.x.before&&(x+=M.x.before,b.x+=M.x.before),M.x.after&&(x-=M.x.after,b.x-=M.x.after),M.y.before&&(I+=M.y.before,b.y+=M.y.before),M.y.after&&(I-=M.y.after,b.y-=M.y.after);{const N=Li(b,p);A.x=p.width-N.x.before-N.x.after,A.y=p.height-N.y.before-N.y.after,x+=N.x.before,b.x+=N.x.before,I+=N.y.before,b.y+=N.y.before}break}const w=Oi(j.anchor);return Object.assign(n.value,{"--v-overlay-anchor-origin":`${j.anchor.side} ${j.anchor.align}`,transformOrigin:`${j.origin.side} ${j.origin.align}`,top:le(hu(I)),left:e.isRtl.value?void 0:le(hu(x)),right:e.isRtl.value?le(hu(-x)):void 0,minWidth:le(w==="y"?Math.min(u.value,y.width):u.value),maxWidth:le(fo(fc(A.x,u.value===1/0?0:u.value,r.value))),maxHeight:le(fo(fc(A.y,l.value===1/0?0:l.value,o.value)))}),{available:A,contentBox:b}}return ae(()=>[a.value,s.value,c.offset,c.minWidth,c.minHeight,c.maxWidth,c.maxHeight],()=>v()),Oe(()=>{const y=v();if(!y)return;const{available:b,contentBox:k}=y;k.height>b.y&&requestAnimationFrame(()=>{v(),requestAnimationFrame(()=>{v()})})}),{updateLocation:v}}function hu(e){return Math.round(e*devicePixelRatio)/devicePixelRatio}function fo(e){return Math.ceil(e*devicePixelRatio)/devicePixelRatio}let sl=!0;const ks=[];function t3(e){!sl||ks.length?(ks.push(e),ul()):(sl=!1,e(),ul())}let mo=-1;function ul(){cancelAnimationFrame(mo),mo=requestAnimationFrame(()=>{const e=ks.shift();e&&e(),ks.length?ul():sl=!0})}const rs={none:null,close:u3,block:l3,reposition:r3},a3=he({scrollStrategy:{type:[String,Function],default:"block",validator:e=>typeof e=="function"||e in rs}},"v-overlay-scroll-strategies");function s3(e,c){if(!Xe)return;let n;Kc(async()=>{n==null||n.stop(),c.isActive.value&&e.scrollStrategy&&(n=ql(),await Oe(),n.active&&n.run(()=>{var t;typeof e.scrollStrategy=="function"?e.scrollStrategy(c,e,n):(t=rs[e.scrollStrategy])==null||t.call(rs,c,e,n)}))}),Vc(()=>{n==null||n.stop()})}function u3(e){function c(n){e.isActive.value=!1}jf(e.activatorEl.value??e.contentEl.value,c)}function l3(e,c){var u;const n=(u=e.root.value)==null?void 0:u.offsetParent,t=[...new Set([...gs(e.activatorEl.value,c.contained?n:void 0),...gs(e.contentEl.value,c.contained?n:void 0)])].filter(l=>!l.classList.contains("v-overlay-scroll-blocked")),a=window.innerWidth-document.documentElement.offsetWidth,s=(l=>Jl(l)&&l)(n||document.documentElement);s&&e.root.value.classList.add("v-overlay--scroll-blocked"),t.forEach((l,r)=>{l.style.setProperty("--v-body-scroll-x",le(-l.scrollLeft)),l.style.setProperty("--v-body-scroll-y",le(-l.scrollTop)),l.style.setProperty("--v-scrollbar-offset",le(a)),l.classList.add("v-overlay-scroll-blocked")}),Vc(()=>{t.forEach((l,r)=>{const o=parseFloat(l.style.getPropertyValue("--v-body-scroll-x")),i=parseFloat(l.style.getPropertyValue("--v-body-scroll-y"));l.style.removeProperty("--v-body-scroll-x"),l.style.removeProperty("--v-body-scroll-y"),l.style.removeProperty("--v-scrollbar-offset"),l.classList.remove("v-overlay-scroll-blocked"),l.scrollLeft=-o,l.scrollTop=-i}),s&&e.root.value.classList.remove("v-overlay--scroll-blocked")})}function r3(e,c,n){let t=!1,a=-1,s=-1;function u(l){t3(()=>{var i,d;const r=performance.now();(d=(i=e.updateLocation).value)==null||d.call(i,l),t=(performance.now()-r)/(1e3/60)>2})}s=(typeof requestIdleCallback>"u"?l=>l():requestIdleCallback)(()=>{n.run(()=>{jf(e.activatorEl.value??e.contentEl.value,l=>{t?(cancelAnimationFrame(a),a=requestAnimationFrame(()=>{a=requestAnimationFrame(()=>{u(l)})})):u(l)})})}),Vc(()=>{typeof cancelIdleCallback<"u"&&cancelIdleCallback(s),cancelAnimationFrame(a)})}function jf(e,c){const n=[document,...gs(e)];n.forEach(t=>{t.addEventListener("scroll",c,{passive:!0})}),Vc(()=>{n.forEach(t=>{t.removeEventListener("scroll",c)})})}function qf(){if(!Xe)return $(!1);const{ssr:e}=yt();if(e){const c=$(!1);return vc(()=>{c.value=!0}),c}else return $(!0)}function Na(){const c=lc("useScopeId").vnode.scopeId;return{scopeId:c?{[c]:""}:void 0}}const vo=Symbol.for("vuetify:stack"),ra=sc([]);function i3(e,c,n){const t=lc("useStack"),a=!n,s=Ve(vo,void 0),u=sc({activeChildren:new Set});Ke(vo,u);const l=$(+c.value);Nn(e,()=>{var d;const i=(d=ra.at(-1))==null?void 0:d[1];l.value=i?i+10:+c.value,a&&ra.push([t.uid,l.value]),s==null||s.activeChildren.add(t.uid),Vc(()=>{if(a){const f=Ce(ra).findIndex(v=>v[0]===t.uid);ra.splice(f,1)}s==null||s.activeChildren.delete(t.uid)})});const r=$(!0);a&&Kc(()=>{var d;const i=((d=ra.at(-1))==null?void 0:d[0])===t.uid;setTimeout(()=>r.value=i)});const o=h(()=>!u.activeChildren.size);return{globalTop:$a(r),localTop:o,stackStyles:h(()=>({zIndex:l.value}))}}function o3(e){return{teleportTarget:h(()=>{const n=e.value;if(n===!0||!Xe)return;const t=n===!1?document.body:typeof n=="string"?document.querySelector(n):n;if(t==null)return;let a=t.querySelector(":scope > .v-overlay-container");return a||(a=document.createElement("div"),a.className="v-overlay-container",t.appendChild(a)),a})}}function d3(){return!0}function kf(e,c,n){if(!e||pf(e,n)===!1)return!1;const t=md(c);if(typeof ShadowRoot<"u"&&t instanceof ShadowRoot&&t.host===e.target)return!1;const a=(typeof n.value=="object"&&n.value.include||(()=>[]))();return a.push(c),!a.some(s=>s==null?void 0:s.contains(e.target))}function pf(e,c){return(typeof c.value=="object"&&c.value.closeConditional||d3)(e)}function f3(e,c,n){const t=typeof n.value=="function"?n.value:n.value.handler;c._clickOutside.lastMousedownWasOutside&&kf(e,c,n)&&setTimeout(()=>{pf(e,n)&&t&&t(e)},0)}function yo(e,c){const n=md(e);c(document),typeof ShadowRoot<"u"&&n instanceof ShadowRoot&&c(n)}const Sf={mounted(e,c){const n=a=>f3(a,e,c),t=a=>{e._clickOutside.lastMousedownWasOutside=kf(a,e,c)};yo(e,a=>{a.addEventListener("click",n,!0),a.addEventListener("mousedown",t,!0)}),e._clickOutside||(e._clickOutside={lastMousedownWasOutside:!0}),e._clickOutside[c.instance.$.uid]={onClick:n,onMousedown:t}},unmounted(e,c){e._clickOutside&&(yo(e,n=>{var s;if(!n||!((s=e._clickOutside)!=null&&s[c.instance.$.uid]))return;const{onClick:t,onMousedown:a}=e._clickOutside[c.instance.$.uid];n.removeEventListener("click",t,!0),n.removeEventListener("mousedown",a,!0)}),delete e._clickOutside[c.instance.$.uid])}};function m3(e){const{modelValue:c,color:n,...t}=e;return m(sn,{name:"fade-transition",appear:!0},{default:()=>[e.modelValue&&m("div",se({class:["v-overlay__scrim",e.color.backgroundColorClasses.value],style:e.color.backgroundColorStyles.value},t),null)]})}const Da=he({absolute:Boolean,attach:[Boolean,String,Object],closeOnBack:{type:Boolean,default:!0},contained:Boolean,contentClass:null,contentProps:null,disabled:Boolean,noClickAnimation:Boolean,modelValue:Boolean,persistent:Boolean,scrim:{type:[String,Boolean],default:!0},zIndex:{type:[Number,String],default:2e3},...Yg(),...ne(),...Rc(),...Ys(),...Qg(),...a3(),...Ie(),...xn()},"v-overlay"),kn=W()({name:"VOverlay",directives:{ClickOutside:Sf},inheritAttrs:!1,props:{_disableGlobalStack:Boolean,...Da()},emits:{"click:outside":e=>!0,"update:modelValue":e=>!0,afterLeave:()=>!0},setup(e,c){let{slots:n,attrs:t,emit:a}=c;const s=pe(e,"modelValue"),u=h({get:()=>s.value,set:J=>{J&&e.disabled||(s.value=J)}}),{teleportTarget:l}=o3(h(()=>e.attach||e.contained)),{themeClasses:r}=Pe(e),{rtlClasses:o,isRtl:i}=_n(),{hasContent:d,onAfterLeave:f}=gr(e,u),v=Ze(h(()=>typeof e.scrim=="string"?e.scrim:null)),{globalTop:y,localTop:b,stackStyles:k}=i3(u,Y(e,"zIndex"),e._disableGlobalStack),{activatorEl:g,activatorRef:p,activatorEvents:j,contentEvents:P,scrimEvents:x}=Gg(e,{isActive:u,isTop:b}),{dimensionStyles:I}=Oc(e),A=qf(),{scopeId:q}=Na();ae(()=>e.disabled,J=>{J&&(u.value=!1)});const C=$(),w=$(),{contentStyles:V,updateLocation:_}=Jg(e,{isRtl:i,contentEl:w,activatorEl:g,isActive:u});s3(e,{root:C,contentEl:w,activatorEl:g,isActive:u,updateLocation:_});function M(J){a("click:outside",J),e.persistent?D():u.value=!1}function N(){return u.value&&y.value}Xe&&ae(u,J=>{J?window.addEventListener("keydown",Z):window.removeEventListener("keydown",Z)},{immediate:!0});function Z(J){J.key==="Escape"&&y.value&&(e.persistent?D():u.value=!1)}const F=Hd();Nn(()=>e.closeOnBack,()=>{hg(F,J=>{y.value&&u.value?(J(!1),e.persistent?D():u.value=!1):J()})});const H=$();ae(()=>u.value&&(e.absolute||e.contained)&&l.value==null,J=>{if(J){const R=yd(C.value);R&&R!==document.scrollingElement&&(H.value=R.scrollTop)}});function D(){e.noClickAnimation||w.value&&ut(w.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:Va})}return X(()=>{var J;return m(ve,null,[(J=n.activator)==null?void 0:J.call(n,{isActive:u.value,props:se({ref:p},Qs(j.value),e.activatorProps)}),A.value&&m(G0,{disabled:!l.value,to:l.value},{default:()=>[d.value&&m("div",se({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":u.value,"v-overlay--contained":e.contained},r.value,o.value,e.class],style:[k.value,{top:le(H.value)},e.style],ref:C},q,t),[m(m3,se({color:v,modelValue:u.value&&!!e.scrim},Qs(x.value)),null),m(Hc,{appear:!0,persisted:!0,transition:e.transition,target:g.value,onAfterLeave:()=>{f(),a("afterLeave")}},{default:()=>{var R;return[He(m("div",se({ref:w,class:["v-overlay__content",e.contentClass],style:[I.value,V.value]},Qs(P.value),e.contentProps),[(R=n.default)==null?void 0:R.call(n,{isActive:u})]),[[rn,u.value],[pc("click-outside"),{handler:M,closeConditional:N,include:()=>[g.value]}]])]}})])]})])}),{activatorEl:g,animateClick:D,contentEl:w,globalTop:y,localTop:b,updateLocation:_}}}),Gs=W()({name:"VMenu",props:{id:String,...on(Da({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:Os}}),["absolute"])},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),{scopeId:a}=Na(),s=yc(),u=h(()=>e.id||`v-menu-${s}`),l=$(),r=Ve(al,null),o=$(0);Ke(al,{register(){++o.value},unregister(){--o.value},closeParents(){setTimeout(()=>{o.value||(t.value=!1,r==null||r.closeParents())},40)}}),ae(t,f=>{f?r==null||r.register():r==null||r.unregister()});function i(){r==null||r.closeParents()}const d=h(()=>se({"aria-haspopup":"menu","aria-expanded":String(t.value),"aria-owns":u.value},e.activatorProps));return X(()=>{const[f]=kn.filterProps(e);return m(kn,se({ref:l,class:["v-menu",e.class],style:e.style},f,{modelValue:t.value,"onUpdate:modelValue":v=>t.value=v,absolute:!0,activatorProps:d.value,"onClick:outside":i},a),{activator:n.activator,default:function(){for(var v=arguments.length,y=new Array(v),b=0;b<v;b++)y[b]=arguments[b];return m($e,{root:!0},{default:()=>{var k;return[(k=n.default)==null?void 0:k.call(n,...y)]}})}})}),Gc({id:u,ΨopenChildren:o},l)}}),jr=he({chips:Boolean,closableChips:Boolean,eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,menu:Boolean,menuIcon:{type:je,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,valueComparator:{type:Function,default:mt},...mf({itemChildren:!1})},"v-select"),v3=W()({name:"VSelect",props:{...jr(),...on(Us({modelValue:null}),["validationValue","dirty","appendInnerIcon"]),...xn({transition:{component:Os}})},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,c){let{slots:n}=c;const{t}=Bc(),a=$(),s=$(),u=pe(e,"menu"),l=h({get:()=>u.value,set:V=>{var _;u.value&&!V&&((_=s.value)!=null&&_.ΨopenChildren)||(u.value=V)}}),{items:r,transformIn:o,transformOut:i}=hr(e),d=pe(e,"modelValue",[],V=>o(Tc(V)),V=>{const _=i(V);return e.multiple?_:_[0]??null}),f=zs(),v=h(()=>d.value.map(V=>r.value.find(_=>e.valueComparator(_.value,V.value))||V)),y=h(()=>v.value.map(V=>V.props.value)),b=$(!1);let k="",g;const p=h(()=>e.hideSelected?r.value.filter(V=>!v.value.some(_=>_===V)):r.value),j=$();function P(V){e.openOnClear&&(l.value=!0)}function x(){e.hideNoData&&!r.value.length||e.readonly||f!=null&&f.isReadonly.value||(l.value=!l.value)}function I(V){var F,H,D,J;if(e.readonly||f!=null&&f.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(V.key)&&V.preventDefault(),["Enter","ArrowDown"," "].includes(V.key)&&(l.value=!0),["Escape","Tab"].includes(V.key)&&(l.value=!1),V.key==="ArrowDown"?(F=j.value)==null||F.focus("next"):V.key==="ArrowUp"?(H=j.value)==null||H.focus("prev"):V.key==="Home"?(D=j.value)==null||D.focus("first"):V.key==="End"&&((J=j.value)==null||J.focus("last"));const _=1e3;function M(R){const K=R.key.length===1,z=!R.ctrlKey&&!R.metaKey&&!R.altKey;return K&&z}if(e.multiple||!M(V))return;const N=performance.now();N-g>_&&(k=""),k+=V.key.toLowerCase(),g=N;const Z=r.value.find(R=>R.title.toLowerCase().startsWith(k));Z!==void 0&&(d.value=[Z])}function A(V){if(e.multiple){const _=y.value.findIndex(M=>e.valueComparator(M,V.value));if(_===-1)d.value=[...d.value,V];else{const M=[...d.value];M.splice(_,1),d.value=M}}else d.value=[V],l.value=!1}function q(V){var _;(_=j.value)!=null&&_.$el.contains(V.relatedTarget)||(l.value=!1)}function C(V){b.value=!0}function w(V){var _;V.relatedTarget==null&&((_=a.value)==null||_.focus())}return X(()=>{const V=!!(e.chips||n.chip),_=!!(!e.hideNoData||p.value.length||n.prepend||n.append||n["no-data"]),M=d.value.length>0,[N]=ft.filterProps(e),Z=M||!b.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder;return m(ft,se({ref:a},N,{modelValue:d.value.map(F=>F.props.value).join(", "),"onUpdate:modelValue":F=>{F==null&&(d.value=[])},focused:b.value,"onUpdate:focused":F=>b.value=F,validationValue:d.externalValue,dirty:M,class:["v-select",{"v-select--active-menu":l.value,"v-select--chips":!!e.chips,[`v-select--${e.multiple?"multiple":"single"}`]:!0,"v-select--selected":d.value.length},e.class],style:e.style,appendInnerIcon:e.menuIcon,readonly:!0,placeholder:Z,"onClick:clear":P,"onMousedown:control":x,onBlur:q,onKeydown:I}),{...n,default:()=>m(ve,null,[m(Gs,se({ref:s,modelValue:l.value,"onUpdate:modelValue":F=>l.value=F,activator:"parent",contentClass:"v-select__content",eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition},e.menuProps),{default:()=>[_&&m(Ks,{ref:j,selected:y.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:F=>F.preventDefault(),onFocusin:C,onFocusout:w},{default:()=>{var F,H,D;return[!p.value.length&&!e.hideNoData&&(((F=n["no-data"])==null?void 0:F.call(n))??m(qn,{title:t(e.noDataText)},null)),(H=n["prepend-item"])==null?void 0:H.call(n),p.value.map((J,R)=>{var K;return n.item?(K=n.item)==null?void 0:K.call(n,{item:J,index:R,props:se(J.props,{onClick:()=>A(J)})}):m(qn,se({key:R},J.props,{onClick:()=>A(J)}),{prepend:z=>{let{isSelected:fe}=z;return m(ve,null,[e.multiple&&!e.hideSelected?m(Nt,{modelValue:fe,ripple:!1,tabindex:"-1"},null):void 0,J.props.prependIcon&&m(ze,{icon:J.props.prependIcon},null)])}})}),(D=n["append-item"])==null?void 0:D.call(n)]}})]}),v.value.map((F,H)=>{var R;function D(K){K.stopPropagation(),K.preventDefault(),A(F)}const J={"onClick:close":D,onMousedown(K){K.preventDefault(),K.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0};return m("div",{key:F.value,class:"v-select__selection"},[V?n.chip?m($e,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:F.title}}},{default:()=>{var K;return[(K=n.chip)==null?void 0:K.call(n,{item:F,index:H,props:J})]}}):m(Fa,se({key:"chip",closable:e.closableChips,size:"small",text:F.title},J),null):((R=n.selection)==null?void 0:R.call(n,{item:F,index:H}))??m("span",{class:"v-select__selection-text"},[F.title,e.multiple&&H<v.value.length-1&&m("span",{class:"v-select__selection-comma"},[ic(",")])])])})])})}),Gc({isFocused:b,menu:l,select:A},a)}}),y3=(e,c,n)=>e==null||c==null?-1:e.toString().toLocaleLowerCase().indexOf(c.toString().toLocaleLowerCase()),Cf=he({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter");function b3(e,c,n){var l;const t=[],a=(n==null?void 0:n.default)??y3,s=n!=null&&n.filterKeys?Tc(n.filterKeys):!1,u=Object.keys((n==null?void 0:n.customKeyFilter)??{}).length;if(!(e!=null&&e.length))return t;e:for(let r=0;r<e.length;r++){const o=e[r],i={},d={};let f=-1;if(c&&!(n!=null&&n.noFilter)){if(typeof o=="object"){const b=s||Object.keys(o);for(const k of b){const g=en(o,k,o),p=(l=n==null?void 0:n.customKeyFilter)==null?void 0:l[k];if(f=p?p(g,c,o):a(g,c,o),f!==-1&&f!==!1)p?i[k]=f:d[k]=f;else if((n==null?void 0:n.filterMode)==="every")continue e}}else f=a(o,c,o),f!==-1&&f!==!1&&(d.title=f);const v=Object.keys(d).length,y=Object.keys(i).length;if(!v&&!y||(n==null?void 0:n.filterMode)==="union"&&y!==u&&!v||(n==null?void 0:n.filterMode)==="intersection"&&(y!==u||!v))continue}t.push({index:r,matches:{...d,...i}})}return t}function _f(e,c,n,t){const a=h(()=>typeof(n==null?void 0:n.value)!="string"&&typeof(n==null?void 0:n.value)!="number"?"":String(n.value)),s=$([]),u=$(new Map);Kc(()=>{s.value=[],u.value=new Map;const r=dc(c);b3(r,a.value,{customKeyFilter:e.customKeyFilter,default:e.customFilter,filterKeys:dc(t==null?void 0:t.filterKeys)??e.filterKeys,filterMode:e.filterMode,noFilter:e.noFilter}).forEach(i=>{let{index:d,matches:f}=i;const v=r[d];s.value.push(v),u.value.set(v.value,f)})});function l(r){return u.value.get(r.value)}return{filteredItems:s,filteredMatches:u,getMatches:l}}function h3(e,c,n){if(c==null)return e;if(Array.isArray(c))throw new Error("Multiple matches is not implemented");return typeof c=="number"&&~c?m(ve,null,[m("span",{class:"v-autocomplete__unmask"},[e.substr(0,c)]),m("span",{class:"v-autocomplete__mask"},[e.substr(c,n)]),m("span",{class:"v-autocomplete__unmask"},[e.substr(c+n)])]):e}const g3=W()({name:"VAutocomplete",props:{search:String,...Cf({filterKeys:["title"]}),...jr(),...on(Us({modelValue:null}),["validationValue","dirty","appendInnerIcon"]),...xn({transition:!1})},emits:{"update:focused":e=>!0,"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,c){let{slots:n}=c;const{t}=Bc(),a=$(),s=$(!1),u=$(!0),l=$(),r=pe(e,"menu"),o=h({get:()=>r.value,set:R=>{var K;r.value&&!R&&((K=l.value)!=null&&K.ΨopenChildren)||(r.value=R)}}),i=$(-1),d=h(()=>{var R;return(R=a.value)==null?void 0:R.color}),{items:f,transformIn:v,transformOut:y}=hr(e),{textColorClasses:b,textColorStyles:k}=mc(d),g=pe(e,"search",""),p=pe(e,"modelValue",[],R=>v(Tc(R)),R=>{const K=y(R);return e.multiple?K:K[0]??null}),j=zs(),{filteredItems:P,getMatches:x}=_f(e,f,h(()=>u.value?void 0:g.value)),I=h(()=>p.value.map(R=>f.value.find(K=>e.valueComparator(K.value,R.value))||R)),A=h(()=>e.hideSelected?P.value.filter(R=>!I.value.some(K=>K.value===R.value)):P.value),q=h(()=>I.value.map(R=>R.props.value)),C=h(()=>I.value[i.value]),w=$();function V(R){e.openOnClear&&(o.value=!0),g.value=""}function _(){e.hideNoData&&!f.value.length||e.readonly||j!=null&&j.isReadonly.value||(o.value=!0)}function M(R){var fe,oe,B,T;if(e.readonly||j!=null&&j.isReadonly.value)return;const K=a.value.selectionStart,z=q.value.length;if((i.value>-1||["Enter","ArrowDown","ArrowUp"].includes(R.key))&&R.preventDefault(),["Enter","ArrowDown"].includes(R.key)&&(o.value=!0),["Escape"].includes(R.key)&&(o.value=!1),["Enter","Escape","Tab"].includes(R.key)&&(u.value=!0),R.key==="ArrowDown"?(fe=w.value)==null||fe.focus("next"):R.key==="ArrowUp"&&((oe=w.value)==null||oe.focus("prev")),!!e.multiple){if(["Backspace","Delete"].includes(R.key)){if(i.value<0){R.key==="Backspace"&&!g.value&&(i.value=z-1);return}const O=i.value;C.value&&J(C.value),i.value=O>=z-1?z-2:O}if(R.key==="ArrowLeft"){if(i.value<0&&K>0)return;const O=i.value>-1?i.value-1:z-1;I.value[O]?i.value=O:(i.value=-1,a.value.setSelectionRange((B=g.value)==null?void 0:B.length,(T=g.value)==null?void 0:T.length))}if(R.key==="ArrowRight"){if(i.value<0)return;const O=i.value+1;I.value[O]?i.value=O:(i.value=-1,a.value.setSelectionRange(0,0))}}}function N(R){g.value=R.target.value}function Z(){s.value&&(u.value=!0)}function F(R){s.value=!0}function H(R){var K;R.relatedTarget==null&&((K=a.value)==null||K.focus())}const D=$(!1);function J(R){if(e.multiple){const K=q.value.findIndex(z=>e.valueComparator(z,R.value));if(K===-1)p.value=[...p.value,R];else{const z=[...p.value];z.splice(K,1),p.value=z}}else p.value=[R],D.value=!0,n.selection||(g.value=R.title),o.value=!1,u.value=!0,Oe(()=>D.value=!1)}return ae(s,R=>{var K;R?(D.value=!0,g.value=e.multiple||n.selection?"":String(((K=I.value.at(-1))==null?void 0:K.props.title)??""),u.value=!0,Oe(()=>D.value=!1)):(!e.multiple&&!g.value&&(p.value=[]),o.value=!1,g.value="")}),ae(g,R=>{!s.value||D.value||(R&&(o.value=!0),u.value=!R)}),X(()=>{const R=!!(e.chips||n.chip),K=!!(!e.hideNoData||A.value.length||n.prepend||n.append||n["no-data"]),z=p.value.length>0,[fe]=ft.filterProps(e);return m(ft,se({ref:a},fe,{modelValue:g.value,"onUpdate:modelValue":oe=>{oe==null&&(p.value=[])},focused:s.value,"onUpdate:focused":oe=>s.value=oe,validationValue:p.externalValue,dirty:z,onInput:N,class:["v-autocomplete",{"v-autocomplete--active-menu":o.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selecting-index":i.value>-1,[`v-autocomplete--${e.multiple?"multiple":"single"}`]:!0,"v-autocomplete--selection-slot":!!n.selection},e.class],style:e.style,appendInnerIcon:e.menuIcon,readonly:e.readonly,placeholder:z?void 0:e.placeholder,"onClick:clear":V,"onMousedown:control":_,onKeydown:M}),{...n,default:()=>m(ve,null,[m(Gs,se({ref:l,modelValue:o.value,"onUpdate:modelValue":oe=>o.value=oe,activator:"parent",contentClass:"v-autocomplete__content",eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:Z},e.menuProps),{default:()=>[K&&m(Ks,{ref:w,selected:q.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:oe=>oe.preventDefault(),onFocusin:F,onFocusout:H},{default:()=>{var oe,B,T;return[!A.value.length&&!e.hideNoData&&(((oe=n["no-data"])==null?void 0:oe.call(n))??m(qn,{title:t(e.noDataText)},null)),(B=n["prepend-item"])==null?void 0:B.call(n),A.value.map(O=>{var re;return((re=n.item)==null?void 0:re.call(n,{item:O,props:se(O.props,{onClick:()=>J(O)})}))??m(qn,se({key:O.value},O.props,{onClick:()=>J(O)}),{prepend:ie=>{let{isSelected:xe}=ie;return m(ve,null,[e.multiple&&!e.hideSelected?m(Nt,{modelValue:xe,ripple:!1,tabindex:"-1"},null):void 0,O.props.prependIcon&&m(ze,{icon:O.props.prependIcon},null)])},title:()=>{var ie,xe;return u.value?O.title:h3(O.title,(ie=x(O))==null?void 0:ie.title,((xe=g.value)==null?void 0:xe.length)??0)}})}),(T=n["append-item"])==null?void 0:T.call(n)]}})]}),I.value.map((oe,B)=>{var re;function T(ie){ie.stopPropagation(),ie.preventDefault(),J(oe)}const O={"onClick:close":T,onMousedown(ie){ie.preventDefault(),ie.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0};return m("div",{key:oe.value,class:["v-autocomplete__selection",B===i.value&&["v-autocomplete__selection--selected",b.value]],style:B===i.value?k.value:{}},[R?n.chip?m($e,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:oe.title}}},{default:()=>{var ie;return[(ie=n.chip)==null?void 0:ie.call(n,{item:oe,index:B,props:O})]}}):m(Fa,se({key:"chip",closable:e.closableChips,size:"small",text:oe.title},O),null):((re=n.selection)==null?void 0:re.call(n,{item:oe,index:B}))??m("span",{class:"v-autocomplete__selection-text"},[oe.title,e.multiple&&B<I.value.length-1&&m("span",{class:"v-autocomplete__selection-comma"},[ic(",")])])])})])})}),Gc({isFocused:s,isPristine:u,menu:o,search:g,filteredItems:P,select:J},a)}});const j3=W()({name:"VBadge",inheritAttrs:!1,props:{bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:je,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...ne(),...Wn({location:"top end"}),...De(),...Se(),...Ie(),...xn({transition:"scale-rotate-transition"})},setup(e,c){const{backgroundColorClasses:n,backgroundColorStyles:t}=Ze(Y(e,"color")),{roundedClasses:a}=Ue(e),{t:s}=Bc(),{textColorClasses:u,textColorStyles:l}=mc(Y(e,"textColor")),{themeClasses:r}=pd(),{locationStyles:o}=Kn(e,!0,i=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(i)?+(e.offsetY??0):["left","right"].includes(i)?+(e.offsetX??0):0));return X(()=>{const i=Number(e.content),d=!e.max||isNaN(i)?e.content:i<=+e.max?i:`${e.max}+`,[f,v]=Wt(c.attrs,["aria-atomic","aria-label","aria-live","role","title"]);return m(e.tag,se({class:["v-badge",{"v-badge--bordered":e.bordered,"v-badge--dot":e.dot,"v-badge--floating":e.floating,"v-badge--inline":e.inline},e.class]},v,{style:e.style}),{default:()=>{var y,b;return[m("div",{class:"v-badge__wrapper"},[(b=(y=c.slots).default)==null?void 0:b.call(y),m(Hc,{transition:e.transition},{default:()=>{var k,g;return[He(m("span",se({class:["v-badge__badge",r.value,n.value,a.value,u.value],style:[t.value,l.value,e.inline?{}:o.value],"aria-atomic":"true","aria-label":s(e.label,i),"aria-live":"polite",role:"status"},f),[e.dot?void 0:c.slots.badge?(g=(k=c.slots).badge)==null?void 0:g.call(k):e.icon?m(ze,{icon:e.icon},null):d]),[[rn,e.modelValue]])]}})])]}})}),{}}});const xf=W()({name:"VBannerActions",props:{color:String,density:String,...ne()},setup(e,c){let{slots:n}=c;return Je({VBtn:{color:e.color,density:e.density,variant:"text"}}),X(()=>{var t;return m("div",{class:["v-banner-actions",e.class],style:e.style},[(t=n.default)==null?void 0:t.call(n)])}),{}}}),wf=Yc("v-banner-text"),q3=W()({name:"VBanner",props:{avatar:String,color:String,icon:je,lines:String,stacked:Boolean,sticky:Boolean,text:String,...Ac(),...ne(),...nc(),...Rc(),...cc(),...Wn(),...ea(),...De(),...Se(),...Ie()},setup(e,c){let{slots:n}=c;const{borderClasses:t}=Lc(e),{densityClasses:a}=bc(e),{mobile:s}=yt(),{dimensionStyles:u}=Oc(e),{elevationClasses:l}=rc(e),{locationStyles:r}=Kn(e),{positionClasses:o}=ca(e),{roundedClasses:i}=Ue(e),{themeClasses:d}=Pe(e),f=Y(e,"color"),v=Y(e,"density");Je({VBannerActions:{color:f,density:v}}),X(()=>{const y=!!(e.text||n.text),b=!!(e.avatar||e.icon),k=!!(b||n.prepend);return m(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||s.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},t.value,a.value,l.value,o.value,i.value,d.value,e.class],style:[u.value,r.value,e.style],role:"banner"},{default:()=>{var g;return[k&&m("div",{key:"prepend",class:"v-banner__prepend"},[n.prepend?m($e,{key:"prepend-defaults",disabled:!b,defaults:{VAvatar:{color:f.value,density:v.value,icon:e.icon,image:e.avatar}}},n.prepend):m(Dn,{key:"prepend-avatar",color:f.value,density:v.value,icon:e.icon,image:e.avatar},null)]),m("div",{class:"v-banner__content"},[y&&m(wf,{key:"text"},{default:()=>{var p;return[((p=n.text)==null?void 0:p.call(n))??e.text]}}),(g=n.default)==null?void 0:g.call(n)]),n.actions&&m(xf,{key:"actions"},n.actions)]}})})}});const k3=W()({name:"VBottomNavigation",props:{bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},active:{type:Boolean,default:!0},...Ac(),...ne(),...nc(),...cc(),...De(),...Kt({name:"bottom-navigation"}),...Se({tag:"header"}),...Xt({modelValue:!0,selectedClass:"v-btn--selected"}),...Ie()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{themeClasses:t}=pd(),{borderClasses:a}=Lc(e),{backgroundColorClasses:s,backgroundColorStyles:u}=Ze(Y(e,"bgColor")),{densityClasses:l}=bc(e),{elevationClasses:r}=rc(e),{roundedClasses:o}=Ue(e),{ssrBootStyles:i}=bt(),d=h(()=>Number(e.height)-(e.density==="comfortable"?8:0)-(e.density==="compact"?16:0)),f=Y(e,"active"),{layoutItemStyles:v}=Yt({id:e.name,order:h(()=>parseInt(e.order,10)),position:h(()=>"bottom"),layoutSize:h(()=>f.value?d.value:0),elementSize:d,active:f,absolute:Y(e,"absolute")});return jt(e,lr),Je({VBtn:{color:Y(e,"color"),density:Y(e,"density"),stacked:h(()=>e.mode!=="horizontal"),variant:"text"}},{scoped:!0}),X(()=>m(e.tag,{class:["v-bottom-navigation",{"v-bottom-navigation--active":f.value,"v-bottom-navigation--grow":e.grow,"v-bottom-navigation--shift":e.mode==="shift"},t.value,s.value,a.value,l.value,r.value,o.value,e.class],style:[u.value,v.value,{height:le(d.value),transform:`translateY(${le(f.value?0:100,"%")})`},i.value,e.style]},{default:()=>[n.default&&m("div",{class:"v-bottom-navigation__content"},[n.default()])]})),{}}});const Vf=W()({name:"VBreadcrumbsDivider",props:{divider:[Number,String],...ne()},setup(e,c){let{slots:n}=c;return X(()=>{var t;return m("li",{class:["v-breadcrumbs-divider",e.class],style:e.style},[((t=n==null?void 0:n.default)==null?void 0:t.call(n))??e.divider])}),{}}}),If=W()({name:"VBreadcrumbsItem",props:{active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...ne(),...Oa(),...Se({tag:"li"})},setup(e,c){let{slots:n,attrs:t}=c;const a=Ra(e,t),s=h(()=>{var o;return e.active||((o=a.isActive)==null?void 0:o.value)}),u=h(()=>s.value?e.activeColor:e.color),{textColorClasses:l,textColorStyles:r}=mc(u);return X(()=>{const o=a.isLink.value?"a":e.tag;return m(o,{class:["v-breadcrumbs-item",{"v-breadcrumbs-item--active":s.value,"v-breadcrumbs-item--disabled":e.disabled,"v-breadcrumbs-item--link":a.isLink.value,[`${e.activeClass}`]:s.value&&e.activeClass},l.value,e.class],style:[r.value,e.style],href:a.href.value,"aria-current":s.value?"page":void 0,onClick:a.navigate},{default:()=>{var i;return[((i=n.default)==null?void 0:i.call(n))??e.title]}})}),{}}}),p3=W()({name:"VBreadcrumbs",props:{activeClass:String,activeColor:String,bgColor:String,color:String,disabled:Boolean,divider:{type:String,default:"/"},icon:je,items:{type:Array,default:()=>[]},...ne(),...nc(),...De(),...Se({tag:"ul"})},setup(e,c){let{slots:n}=c;const{backgroundColorClasses:t,backgroundColorStyles:a}=Ze(Y(e,"bgColor")),{densityClasses:s}=bc(e),{roundedClasses:u}=Ue(e);Je({VBreadcrumbsDivider:{divider:Y(e,"divider")},VBreadcrumbsItem:{activeClass:Y(e,"activeClass"),activeColor:Y(e,"activeColor"),color:Y(e,"color"),disabled:Y(e,"disabled")}});const l=h(()=>e.items.map(r=>typeof r=="string"?{item:{title:r},raw:r}:{item:r,raw:r}));return X(()=>{const r=!!(n.prepend||e.icon);return m(e.tag,{class:["v-breadcrumbs",t.value,s.value,u.value,e.class],style:[a.value,e.style]},{default:()=>{var o;return[r&&m("div",{key:"prepend",class:"v-breadcrumbs__prepend"},[n.prepend?m($e,{key:"prepend-defaults",disabled:!e.icon,defaults:{VIcon:{icon:e.icon,start:!0}}},n.prepend):m(ze,{key:"prepend-icon",start:!0,icon:e.icon},null)]),l.value.map((i,d,f)=>{let{item:v,raw:y}=i;return m(ve,null,[m(If,se({key:v.title,disabled:d>=f.length-1},v),{default:n.title?()=>{var b;return(b=n.title)==null?void 0:b.call(n,{item:y,index:d})}:void 0}),d<f.length-1&&m(Vf,null,{default:n.divider?()=>{var b;return(b=n.divider)==null?void 0:b.call(n,{item:y,index:d})}:void 0})])}),(o=n.default)==null?void 0:o.call(n)]}})}),{}}});const Af=W()({name:"VCardActions",props:ne(),setup(e,c){let{slots:n}=c;return Je({VBtn:{variant:"text"}}),X(()=>{var t;return m("div",{class:["v-card-actions",e.class],style:e.style},[(t=n.default)==null?void 0:t.call(n)])}),{}}}),Ef=Yc("v-card-subtitle"),Pf=Yc("v-card-title"),Tf=W()({name:"VCardItem",props:{appendAvatar:String,appendIcon:je,prependAvatar:String,prependIcon:je,subtitle:String,title:String,...ne(),...nc()},setup(e,c){let{slots:n}=c;return X(()=>{var o;const t=!!(e.prependAvatar||e.prependIcon),a=!!(t||n.prepend),s=!!(e.appendAvatar||e.appendIcon),u=!!(s||n.append),l=!!(e.title||n.title),r=!!(e.subtitle||n.subtitle);return m("div",{class:["v-card-item",e.class],style:e.style},[a&&m("div",{key:"prepend",class:"v-card-item__prepend"},[n.prepend?m($e,{key:"prepend-defaults",disabled:!t,defaults:{VAvatar:{density:e.density,icon:e.prependIcon,image:e.prependAvatar}}},n.prepend):t&&m(Dn,{key:"prepend-avatar",density:e.density,icon:e.prependIcon,image:e.prependAvatar},null)]),m("div",{class:"v-card-item__content"},[l&&m(Pf,{key:"title"},{default:()=>{var i;return[((i=n.title)==null?void 0:i.call(n))??e.title]}}),r&&m(Ef,{key:"subtitle"},{default:()=>{var i;return[((i=n.subtitle)==null?void 0:i.call(n))??e.subtitle]}}),(o=n.default)==null?void 0:o.call(n)]),u&&m("div",{key:"append",class:"v-card-item__append"},[n.append?m($e,{key:"append-defaults",disabled:!s,defaults:{VAvatar:{density:e.density,icon:e.appendIcon,image:e.appendAvatar}}},n.append):s&&m(Dn,{key:"append-avatar",density:e.density,icon:e.appendIcon,image:e.appendAvatar},null)])])}),{}}}),$f=Yc("v-card-text"),S3=W()({name:"VCard",directives:{Ripple:Un},props:{appendAvatar:String,appendIcon:je,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:je,ripple:{type:Boolean,default:!0},subtitle:String,text:String,title:String,...Ac(),...ne(),...nc(),...Rc(),...cc(),...dr(),...Wn(),...ea(),...De(),...Oa(),...Se(),...Ie(),...Fc({variant:"elevated"})},setup(e,c){let{attrs:n,slots:t}=c;const{themeClasses:a}=Pe(e),{borderClasses:s}=Lc(e),{colorClasses:u,colorStyles:l,variantClasses:r}=gt(e),{densityClasses:o}=bc(e),{dimensionStyles:i}=Oc(e),{elevationClasses:d}=rc(e),{loaderClasses:f}=Fs(e),{locationStyles:v}=Kn(e),{positionClasses:y}=ca(e),{roundedClasses:b}=Ue(e),k=Ra(e,n),g=h(()=>e.link!==!1&&k.isLink.value),p=h(()=>!e.disabled&&e.link!==!1&&(e.link||k.isClickable.value));return X(()=>{const j=g.value?"a":e.tag,P=!!(t.title||e.title),x=!!(t.subtitle||e.subtitle),I=P||x,A=!!(t.append||e.appendAvatar||e.appendIcon),q=!!(t.prepend||e.prependAvatar||e.prependIcon),C=!!(t.image||e.image),w=I||q||A,V=!!(t.text||e.text);return He(m(j,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":p.value},a.value,s.value,u.value,o.value,d.value,f.value,y.value,b.value,r.value,e.class],style:[l.value,i.value,v.value,e.style],href:k.href.value,onClick:p.value&&k.navigate,tabindex:e.disabled?-1:void 0},{default:()=>{var _;return[C&&m("div",{key:"image",class:"v-card__image"},[t.image?m($e,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},t.image):m(Gt,{key:"image-img",cover:!0,src:e.image},null)]),m(fr,{name:"v-card",active:!!e.loading,color:typeof e.loading=="boolean"?void 0:e.loading},{default:t.loader}),w&&m(Tf,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:t.item,prepend:t.prepend,title:t.title,subtitle:t.subtitle,append:t.append}),V&&m($f,{key:"text"},{default:()=>{var M;return[((M=t.text)==null?void 0:M.call(t))??e.text]}}),(_=t.default)==null?void 0:_.call(t),t.actions&&m(Af,null,{default:t.actions}),ht(p.value,"v-card")]}}),[[pc("ripple"),p.value&&e.ripple]])}),{}}});const C3=e=>{const{touchstartX:c,touchendX:n,touchstartY:t,touchendY:a}=e,s=.5,u=16;e.offsetX=n-c,e.offsetY=a-t,Math.abs(e.offsetY)<s*Math.abs(e.offsetX)&&(e.left&&n<c-u&&e.left(e),e.right&&n>c+u&&e.right(e)),Math.abs(e.offsetX)<s*Math.abs(e.offsetY)&&(e.up&&a<t-u&&e.up(e),e.down&&a>t+u&&e.down(e))};function _3(e,c){var t;const n=e.changedTouches[0];c.touchstartX=n.clientX,c.touchstartY=n.clientY,(t=c.start)==null||t.call(c,{originalEvent:e,...c})}function x3(e,c){var t;const n=e.changedTouches[0];c.touchendX=n.clientX,c.touchendY=n.clientY,(t=c.end)==null||t.call(c,{originalEvent:e,...c}),C3(c)}function w3(e,c){var t;const n=e.changedTouches[0];c.touchmoveX=n.clientX,c.touchmoveY=n.clientY,(t=c.move)==null||t.call(c,{originalEvent:e,...c})}function V3(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};const c={touchstartX:0,touchstartY:0,touchendX:0,touchendY:0,touchmoveX:0,touchmoveY:0,offsetX:0,offsetY:0,left:e.left,right:e.right,up:e.up,down:e.down,start:e.start,move:e.move,end:e.end};return{touchstart:n=>_3(n,c),touchend:n=>x3(n,c),touchmove:n=>w3(n,c)}}function I3(e,c){var l;const n=c.value,t=n!=null&&n.parent?e.parentElement:e,a=(n==null?void 0:n.options)??{passive:!0},s=(l=c.instance)==null?void 0:l.$.uid;if(!t||!s)return;const u=V3(c.value);t._touchHandlers=t._touchHandlers??Object.create(null),t._touchHandlers[s]=u,Q1(u).forEach(r=>{t.addEventListener(r,u[r],a)})}function A3(e,c){var s,u;const n=(s=c.value)!=null&&s.parent?e.parentElement:e,t=(u=c.instance)==null?void 0:u.$.uid;if(!(n!=null&&n._touchHandlers)||!t)return;const a=n._touchHandlers[t];Q1(a).forEach(l=>{n.removeEventListener(l,a[l])}),delete n._touchHandlers[t]}const qr={mounted:I3,unmounted:A3},Mf=Symbol.for("vuetify:v-window"),Bf=Symbol.for("vuetify:v-window-group"),Rf=he({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>typeof e=="boolean"||e==="hover"},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{default:"force"},...ne(),...Se(),...Ie()},"v-window"),Of=W()({name:"VWindow",directives:{Touch:qr},props:Rf(),emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{isRtl:a}=_n(),{t:s}=Bc(),u=jt(e,Bf),l=$(),r=h(()=>a.value?!e.reverse:e.reverse),o=$(!1),i=h(()=>{const P=e.direction==="vertical"?"y":"x",I=(r.value?!o.value:o.value)?"-reverse":"";return`v-window-${P}${I}-transition`}),d=$(0),f=$(void 0),v=h(()=>u.items.value.findIndex(P=>u.selected.value.includes(P.id)));ae(v,(P,x)=>{const I=u.items.value.length,A=I-1;I<=2?o.value=P<x:P===A&&x===0?o.value=!0:P===0&&x===A?o.value=!1:o.value=P<x}),Ke(Mf,{transition:i,isReversed:o,transitionCount:d,transitionHeight:f,rootRef:l});const y=h(()=>e.continuous||v.value!==0),b=h(()=>e.continuous||v.value!==u.items.value.length-1);function k(){y.value&&u.prev()}function g(){b.value&&u.next()}const p=h(()=>{const P=[],x={icon:a.value?e.nextIcon:e.prevIcon,class:`v-window__${r.value?"right":"left"}`,onClick:u.prev,ariaLabel:s("$vuetify.carousel.prev")};P.push(y.value?n.prev?n.prev({props:x}):m(gc,x,null):m("div",null,null));const I={icon:a.value?e.prevIcon:e.nextIcon,class:`v-window__${r.value?"left":"right"}`,onClick:u.next,ariaLabel:s("$vuetify.carousel.next")};return P.push(b.value?n.next?n.next({props:I}):m(gc,I,null):m("div",null,null)),P}),j=h(()=>e.touch===!1?e.touch:{...{left:()=>{r.value?k():g()},right:()=>{r.value?g():k()},start:x=>{let{originalEvent:I}=x;I.stopPropagation()}},...e.touch===!0?{}:e.touch});return X(()=>He(m(e.tag,{ref:l,class:["v-window",{"v-window--show-arrows-on-hover":e.showArrows==="hover"},t.value,e.class],style:e.style},{default:()=>{var P,x;return[m("div",{class:"v-window__container",style:{height:f.value}},[(P=n.default)==null?void 0:P.call(n,{group:u}),e.showArrows!==!1&&m("div",{class:"v-window__controls"},[p.value])]),(x=n.additional)==null?void 0:x.call(n,{group:u})]}}),[[pc("touch"),j.value]])),{group:u}}}),E3=W()({name:"VCarousel",props:{color:String,cycle:Boolean,delimiterIcon:{type:je,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>Number(e)>0},progress:[Boolean,String],verticalDelimiters:[Boolean,String],...Rf({continuous:!0,mandatory:"force",showArrows:!0})},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),{t:a}=Bc(),s=$();let u=-1;ae(t,r),ae(()=>e.interval,r),ae(()=>e.cycle,o=>{o?r():window.clearTimeout(u)}),vc(l);function l(){!e.cycle||!s.value||(u=window.setTimeout(s.value.group.next,+e.interval>0?+e.interval:6e3))}function r(){window.clearTimeout(u),window.requestAnimationFrame(l)}return X(()=>m(Of,{ref:s,modelValue:t.value,"onUpdate:modelValue":o=>t.value=o,class:["v-carousel",{"v-carousel--hide-delimiter-background":e.hideDelimiterBackground,"v-carousel--vertical-delimiters":e.verticalDelimiters},e.class],style:[{height:le(e.height)},e.style],continuous:!0,mandatory:"force",showArrows:e.showArrows},{default:n.default,additional:o=>{let{group:i}=o;return m(ve,null,[!e.hideDelimiters&&m("div",{class:"v-carousel__controls",style:{left:e.verticalDelimiters==="left"&&e.verticalDelimiters?0:"auto",right:e.verticalDelimiters==="right"?0:"auto"}},[i.items.value.length>0&&m($e,{defaults:{VBtn:{color:e.color,icon:e.delimiterIcon,size:"x-small",variant:"text"}},scoped:!0},{default:()=>[i.items.value.map((d,f)=>{const v={id:`carousel-item-${d.id}`,"aria-label":a("$vuetify.carousel.ariaLabel.delimiter",f+1,i.items.value.length),class:[i.isSelected(d.id)&&"v-btn--active"],onClick:()=>i.select(d.id,!0)};return n.item?n.item({props:v,item:d}):m(gc,se(d,v),null)})]})]),e.progress&&m(or,{class:"v-carousel__progress",color:typeof e.progress=="string"?e.progress:void 0,modelValue:(i.getItemIndex(t.value)+1)/i.items.value.length*100},null)])},prev:n.prev,next:n.next})),{}}}),Lf=W()({name:"VWindowItem",directives:{Touch:qr},props:{reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...ne(),...Zt(),...Ys()},emits:{"group:selected":e=>!0},setup(e,c){let{slots:n}=c;const t=Ve(Mf),a=Qt(e,Bf),{isBooted:s}=bt();if(!t||!a)throw new Error("[Vuetify] VWindowItem must be used inside VWindow");const u=$(!1),l=h(()=>t.isReversed.value?e.reverseTransition!==!1:e.transition!==!1);function r(){!u.value||!t||(u.value=!1,t.transitionCount.value>0&&(t.transitionCount.value-=1,t.transitionCount.value===0&&(t.transitionHeight.value=void 0)))}function o(){var y;u.value||!t||(u.value=!0,t.transitionCount.value===0&&(t.transitionHeight.value=le((y=t.rootRef.value)==null?void 0:y.clientHeight)),t.transitionCount.value+=1)}function i(){r()}function d(y){u.value&&Oe(()=>{!l.value||!u.value||!t||(t.transitionHeight.value=le(y.clientHeight))})}const f=h(()=>{const y=t.isReversed.value?e.reverseTransition:e.transition;return l.value?{name:typeof y!="string"?t.transition.value:y,onBeforeEnter:o,onAfterEnter:r,onEnterCancelled:i,onBeforeLeave:o,onAfterLeave:r,onLeaveCancelled:i,onEnter:d}:!1}),{hasContent:v}=gr(e,a.isSelected);return X(()=>m(Hc,{transition:f.value,disabled:!s.value},{default:()=>{var y;return[He(m("div",{class:["v-window-item",a.selectedClass.value,e.class],style:e.style},[v.value&&((y=n.default)==null?void 0:y.call(n))]),[[rn,a.isSelected.value]])]}})),{}}}),P3=W()({name:"VCarouselItem",inheritAttrs:!1,props:{value:null,...ne()},setup(e,c){let{slots:n,attrs:t}=c;X(()=>m(Lf,{class:["v-carousel-item",e.class],style:e.style,value:e.value},{default:()=>[m(Gt,t,n)]}))}});const T3=Yc("v-code");const Ff=he({color:String,...Ac(),...ne(),...Rc(),...cc(),...Wn(),...ea(),...De(),...Se(),...Ie()},"v-sheet"),ll=W()({name:"VSheet",props:{...Ff()},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{backgroundColorClasses:a,backgroundColorStyles:s}=Ze(Y(e,"color")),{borderClasses:u}=Lc(e),{dimensionStyles:l}=Oc(e),{elevationClasses:r}=rc(e),{locationStyles:o}=Kn(e),{positionClasses:i}=ca(e),{roundedClasses:d}=Ue(e);return X(()=>m(e.tag,{class:["v-sheet",t.value,a.value,u.value,r.value,i.value,d.value,e.class],style:[s.value,l.value,o.value,e.style]},n)),{}}});const $3=Mc({name:"VColorPickerCanvas",props:{color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300},...ne()},emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,c){let{emit:n}=c;const t=$(!1),a=$(!1),s=$({x:0,y:0}),u=h(()=>{const{x:g,y:p}=s.value,j=parseInt(e.dotSize,10)/2;return{width:le(e.dotSize),height:le(e.dotSize),transform:`translate(${le(g-j)}, ${le(p-j)})`}}),l=$(),r=$(parseFloat(e.width)),o=$(parseFloat(e.height)),{resizeRef:i}=un(g=>{var P;if(!((P=i.value)!=null&&P.offsetParent))return;const{width:p,height:j}=g[0].contentRect;r.value=p,o.value=j});function d(g,p,j){const{left:P,top:x,width:I,height:A}=j;s.value={x:fc(g-P,0,I),y:fc(p-x,0,A)}}function f(g){e.disabled||!l.value||d(g.clientX,g.clientY,l.value.getBoundingClientRect())}function v(g){g.preventDefault(),!e.disabled&&(t.value=!0,window.addEventListener("mousemove",y),window.addEventListener("mouseup",b),window.addEventListener("touchmove",y),window.addEventListener("touchend",b))}function y(g){if(e.disabled||!l.value)return;t.value=!0;const p=qb(g);d(p.clientX,p.clientY,l.value.getBoundingClientRect())}function b(){window.removeEventListener("mousemove",y),window.removeEventListener("mouseup",b),window.removeEventListener("touchmove",y),window.removeEventListener("touchend",b)}ae(s,()=>{var j,P;if(a.value){a.value=!1;return}if(!l.value)return;const{x:g,y:p}=s.value;n("update:color",{h:((j=e.color)==null?void 0:j.h)??0,s:fc(g,0,r.value)/r.value,v:1-fc(p,0,o.value)/o.value,a:((P=e.color)==null?void 0:P.a)??1})});function k(){var x;if(!l.value)return;const g=l.value,p=g.getContext("2d");if(!p)return;const j=p.createLinearGradient(0,0,g.width,0);j.addColorStop(0,"hsla(0, 0%, 100%, 1)"),j.addColorStop(1,`hsla(${((x=e.color)==null?void 0:x.h)??0}, 100%, 50%, 1)`),p.fillStyle=j,p.fillRect(0,0,g.width,g.height);const P=p.createLinearGradient(0,0,0,g.height);P.addColorStop(0,"hsla(0, 0%, 100%, 0)"),P.addColorStop(1,"hsla(0, 0%, 0%, 1)"),p.fillStyle=P,p.fillRect(0,0,g.width,g.height)}return ae(()=>{var g;return(g=e.color)==null?void 0:g.h},k,{immediate:!0}),ae(()=>[r.value,o.value],(g,p)=>{k(),s.value={x:s.value.x*g[0]/p[0],y:s.value.y*g[1]/p[1]}},{flush:"post"}),ae(()=>e.color,()=>{if(t.value){t.value=!1;return}a.value=!0,s.value=e.color?{x:e.color.s*r.value,y:(1-e.color.v)*o.value}:{x:0,y:0}},{deep:!0,immediate:!0}),vc(()=>k()),X(()=>m("div",{ref:i,class:["v-color-picker-canvas",e.class],style:e.style,onClick:f,onMousedown:v,onTouchstart:v},[m("canvas",{ref:l,width:r.value,height:o.value},null),e.color&&m("div",{class:["v-color-picker-canvas__dot",{"v-color-picker-canvas__dot--disabled":e.disabled}],style:u.value},null)])),{}}});function rt(e,c){return c.every(n=>e.hasOwnProperty(n))}function Nf(e){if(!e)return null;let c=null;if(typeof e=="string"){const n=fd(e);c=od(n)}return typeof e=="object"&&(rt(e,["r","g","b"])?c=Zl(e):rt(e,["h","s","l"])?c=ud(e):rt(e,["h","s","v"])&&(c=e)),c}function M3(e,c){if(c){const{a:n,...t}=e;return t}return e}function B3(e,c){if(c==null||typeof c=="string"){const n=dd(e);return e.a===1?n.slice(0,7):n}if(typeof c=="object"){let n;return rt(c,["r","g","b"])?n=Ms(e):rt(c,["h","s","l"])?n=sd(e):rt(c,["h","s","v"])&&(n=e),M3(n,!rt(c,["a"])&&e.a===1)}return e}const ha={h:0,s:0,v:1,a:1},rl={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,c)=>({...e,r:Number(c)})},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,c)=>({...e,g:Number(c)})},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,c)=>({...e,b:Number(c)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:c}=e;return c?Math.round(c*100)/100:1},getColor:(e,c)=>({...e,a:Number(c)})}],to:Ms,from:Zl};var Co;const R3={...rl,inputs:(Co=rl.inputs)==null?void 0:Co.slice(0,3)},il={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,c)=>({...e,h:Number(c)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(e.s*100)/100,getColor:(e,c)=>({...e,s:Number(c)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(e.l*100)/100,getColor:(e,c)=>({...e,l:Number(c)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:c}=e;return c?Math.round(c*100)/100:1},getColor:(e,c)=>({...e,a:Number(c)})}],to:sd,from:ud},O3={...il,inputs:il.inputs.slice(0,3)},Df={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,c)=>c}],to:dd,from:od},L3={...Df,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,c)=>c}]},it={rgb:R3,rgba:rl,hsl:O3,hsla:il,hex:L3,hexa:Df},F3=e=>{let{label:c,...n}=e;return m("div",{class:"v-color-picker-edit__input"},[m("input",n,null),m("span",null,[c])])},N3=Mc({name:"VColorPickerEdit",props:{color:Object,disabled:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(it).includes(e)},modes:{type:Array,default:()=>Object.keys(it),validator:e=>Array.isArray(e)&&e.every(c=>Object.keys(it).includes(c))},...ne()},emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,c){let{emit:n}=c;const t=h(()=>e.modes.map(s=>({...it[s],name:s}))),a=h(()=>{var l;const s=t.value.find(r=>r.name===e.mode);if(!s)return[];const u=e.color?s.to(e.color):null;return(l=s.inputs)==null?void 0:l.map(r=>{let{getValue:o,getColor:i,...d}=r;return{...s.inputProps,...d,disabled:e.disabled,value:u&&o(u),onChange:f=>{const v=f.target;v&&n("update:color",s.from(i(u??ha,v.value)))}}})});return X(()=>{var s;return m("div",{class:["v-color-picker-edit",e.class],style:e.style},[(s=a.value)==null?void 0:s.map(u=>m(F3,u,null)),t.value.length>1&&m(gc,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const u=t.value.findIndex(l=>l.name===e.mode);n("update:mode",t.value[(u+1)%t.value.length].name)}},null)])}),{}}});const kr=Symbol.for("vuetify:v-slider");function ol(e,c,n){const t=n==="vertical",a=c.getBoundingClientRect(),s="touches"in e?e.touches[0]:e;return t?s.clientY-(a.top+a.height/2):s.clientX-(a.left+a.width/2)}function D3(e,c){return"touches"in e&&e.touches.length?e.touches[0][c]:"changedTouches"in e&&e.changedTouches.length?e.changedTouches[0][c]:e[c]}const zf=he({disabled:Boolean,error:Boolean,readonly:Boolean,max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>typeof e=="boolean"||e==="always"},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>typeof e=="boolean"||e==="always"},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...De(),...cc({elevation:2})},"slider"),Hf=e=>{const c=h(()=>parseFloat(e.min)),n=h(()=>parseFloat(e.max)),t=h(()=>+e.step>0?parseFloat(e.step):0),a=h(()=>Math.max(Ti(t.value),Ti(c.value)));function s(u){if(t.value<=0)return u;const l=fc(u,c.value,n.value),r=c.value%t.value,o=Math.round((l-r)/t.value)*t.value+r;return parseFloat(Math.min(o,n.value).toFixed(a.value))}return{min:c,max:n,step:t,decimals:a,roundValue:s}},Uf=e=>{let{props:c,steps:n,onSliderStart:t,onSliderMove:a,onSliderEnd:s,getActiveThumb:u}=e;const{isRtl:l}=_n(),r=Y(c,"reverse"),o=h(()=>{let T=l.value?"rtl":"ltr";return c.reverse&&(T=T==="rtl"?"ltr":"rtl"),T}),{min:i,max:d,step:f,decimals:v,roundValue:y}=n,b=h(()=>parseInt(c.thumbSize,10)),k=h(()=>parseInt(c.tickSize,10)),g=h(()=>parseInt(c.trackSize,10)),p=h(()=>(d.value-i.value)/f.value),j=Y(c,"disabled"),P=h(()=>c.direction==="vertical"),x=h(()=>c.error||c.disabled?void 0:c.thumbColor??c.color),I=h(()=>c.error||c.disabled?void 0:c.trackColor??c.color),A=h(()=>c.error||c.disabled?void 0:c.trackFillColor??c.color),q=$(!1),C=$(0),w=$(),V=$();function _(T){var U;const O=c.direction==="vertical",re=O?"top":"left",ie=O?"height":"width",xe=O?"clientY":"clientX",{[re]:me,[ie]:S}=(U=w.value)==null?void 0:U.$el.getBoundingClientRect(),E=D3(T,xe);let L=Math.min(Math.max((E-me-C.value)/S,0),1)||0;return(O||o.value==="rtl")&&(L=1-L),y(i.value+L*(d.value-i.value))}const M=T=>{s({value:_(T)}),q.value=!1,C.value=0},N=T=>{V.value=u(T),V.value&&(V.value.focus(),q.value=!0,V.value.contains(T.target)?C.value=ol(T,V.value,c.direction):(C.value=0,a({value:_(T)})),t({value:_(T)}))},Z={passive:!0,capture:!0};function F(T){a({value:_(T)})}function H(T){T.stopPropagation(),T.preventDefault(),M(T),window.removeEventListener("mousemove",F,Z),window.removeEventListener("mouseup",H)}function D(T){var O;M(T),window.removeEventListener("touchmove",F,Z),(O=T.target)==null||O.removeEventListener("touchend",D)}function J(T){var O;N(T),window.addEventListener("touchmove",F,Z),(O=T.target)==null||O.addEventListener("touchend",D,{passive:!1})}function R(T){T.preventDefault(),N(T),window.addEventListener("mousemove",F,Z),window.addEventListener("mouseup",H,{passive:!1})}const K=T=>{const O=(T-i.value)/(d.value-i.value)*100;return fc(isNaN(O)?0:O,0,100)},z=Y(c,"showTicks"),fe=h(()=>z.value?c.ticks?Array.isArray(c.ticks)?c.ticks.map(T=>({value:T,position:K(T),label:T.toString()})):Object.keys(c.ticks).map(T=>({value:parseFloat(T),position:K(parseFloat(T)),label:c.ticks[T]})):p.value!==1/0?tn(p.value+1).map(T=>{const O=i.value+T*f.value;return{value:O,position:K(O)}}):[]:[]),oe=h(()=>fe.value.some(T=>{let{label:O}=T;return!!O})),B={activeThumbRef:V,color:Y(c,"color"),decimals:v,disabled:j,direction:Y(c,"direction"),elevation:Y(c,"elevation"),hasLabels:oe,horizontalDirection:o,isReversed:r,min:i,max:d,mousePressed:q,numTicks:p,onSliderMousedown:R,onSliderTouchstart:J,parsedTicks:fe,parseMouseMove:_,position:K,readonly:Y(c,"readonly"),rounded:Y(c,"rounded"),roundValue:y,showTicks:z,startOffset:C,step:f,thumbSize:b,thumbColor:x,thumbLabel:Y(c,"thumbLabel"),ticks:Y(c,"ticks"),tickSize:k,trackColor:I,trackContainerRef:w,trackFillColor:A,trackSize:g,vertical:P};return Ke(kr,B),B},dl=W()({name:"VSliderThumb",directives:{Ripple:Un},props:{focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:Boolean,default:!0},...ne()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n,emit:t}=c;const a=Ve(kr);if(!a)throw new Error("[Vuetify] v-slider-thumb must be used inside v-slider or v-range-slider");const{thumbColor:s,step:u,vertical:l,disabled:r,thumbSize:o,thumbLabel:i,direction:d,readonly:f,elevation:v,isReversed:y,horizontalDirection:b,mousePressed:k,decimals:g}=a,{textColorClasses:p,textColorStyles:j}=mc(s),{pageup:P,pagedown:x,end:I,home:A,left:q,right:C,down:w,up:V}=Du,_=[P,x,I,A,q,C,w,V],M=h(()=>u.value?[1,2,3]:[1,5,10]);function N(F,H){if(!_.includes(F.key))return;F.preventDefault();const D=u.value||.1,J=(e.max-e.min)/D;if([q,C,w,V].includes(F.key)){const K=(b.value==="rtl"?[q,V]:[C,V]).includes(F.key)?1:-1,z=F.shiftKey?2:F.ctrlKey?1:0;H=H+K*D*M.value[z]}else if(F.key===A)H=e.min;else if(F.key===I)H=e.max;else{const R=F.key===x?1:-1;H=H-R*D*(J>100?J/10:10)}return Math.max(e.min,Math.min(e.max,H))}function Z(F){const H=N(F,e.modelValue);H!=null&&t("update:modelValue",H)}return X(()=>{const F=le(l.value||y.value?100-e.position:e.position,"%"),{elevationClasses:H}=rc(h(()=>r.value?void 0:v.value));return m("div",{class:["v-slider-thumb",{"v-slider-thumb--focused":e.focused,"v-slider-thumb--pressed":e.focused&&k.value},e.class],style:[{"--v-slider-thumb-position":F,"--v-slider-thumb-size":le(o.value)},e.style],role:"slider",tabindex:r.value?-1:0,"aria-valuemin":e.min,"aria-valuemax":e.max,"aria-valuenow":e.modelValue,"aria-readonly":f.value,"aria-orientation":d.value,onKeydown:f.value?void 0:Z},[m("div",{class:["v-slider-thumb__surface",p.value,H.value],style:{...j.value}},null),He(m("div",{class:["v-slider-thumb__ripple",p.value],style:j.value},null),[[pc("ripple"),e.ripple,null,{circle:!0,center:!0}]]),m(Id,{origin:"bottom center"},{default:()=>{var D;return[He(m("div",{class:"v-slider-thumb__label-container"},[m("div",{class:["v-slider-thumb__label"]},[m("div",null,[((D=n["thumb-label"])==null?void 0:D.call(n,{modelValue:e.modelValue}))??e.modelValue.toFixed(u.value?g.value:1)])])]),[[rn,i.value&&e.focused||i.value==="always"]])]}})])}),{}}});const Wf=W()({name:"VSliderTrack",props:{start:{type:Number,required:!0},stop:{type:Number,required:!0},...ne()},emits:{},setup(e,c){let{slots:n}=c;const t=Ve(kr);if(!t)throw new Error("[Vuetify] v-slider-track must be inside v-slider or v-range-slider");const{color:a,horizontalDirection:s,parsedTicks:u,rounded:l,showTicks:r,tickSize:o,trackColor:i,trackFillColor:d,trackSize:f,vertical:v,min:y,max:b}=t,{roundedClasses:k}=Ue(l),{backgroundColorClasses:g,backgroundColorStyles:p}=Ze(d),{backgroundColorClasses:j,backgroundColorStyles:P}=Ze(i),x=h(()=>`inset-${v.value?"block-end":"inline-start"}`),I=h(()=>v.value?"height":"width"),A=h(()=>({[x.value]:"0%",[I.value]:"100%"})),q=h(()=>e.stop-e.start),C=h(()=>({[x.value]:le(e.start,"%"),[I.value]:le(q.value,"%")})),w=h(()=>r.value?(v.value?u.value.slice().reverse():u.value).map((_,M)=>{var F;const N=v.value?"bottom":"margin-inline-start",Z=_.value!==y.value&&_.value!==b.value?le(_.position,"%"):void 0;return m("div",{key:_.value,class:["v-slider-track__tick",{"v-slider-track__tick--filled":_.position>=e.start&&_.position<=e.stop,"v-slider-track__tick--first":_.value===y.value,"v-slider-track__tick--last":_.value===b.value}],style:{[N]:Z}},[(_.label||n["tick-label"])&&m("div",{class:"v-slider-track__tick-label"},[((F=n["tick-label"])==null?void 0:F.call(n,{tick:_,index:M}))??_.label])])}):[]);return X(()=>m("div",{class:["v-slider-track",k.value,e.class],style:[{"--v-slider-track-size":le(f.value),"--v-slider-tick-size":le(o.value),direction:v.value?void 0:s.value},e.style]},[m("div",{class:["v-slider-track__background",j.value,{"v-slider-track__background--opacity":!!a.value||!d.value}],style:{...A.value,...P.value}},null),m("div",{class:["v-slider-track__fill",g.value],style:{...C.value,...p.value}},null),r.value&&m("div",{class:["v-slider-track__ticks",{"v-slider-track__ticks--always-show":r.value==="always"}]},[w.value])])),{}}}),fl=W()({name:"VSlider",props:{...Ns(),...zf(),...Vn(),modelValue:{type:[Number,String],default:0}},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,start:e=>!0,end:e=>!0},setup(e,c){let{slots:n,emit:t}=c;const a=$(),s=Hf(e),u=pe(e,"modelValue",void 0,x=>{const I=typeof x=="string"?parseFloat(x):x??s.min.value;return s.roundValue(I)}),{min:l,max:r,mousePressed:o,roundValue:i,onSliderMousedown:d,onSliderTouchstart:f,trackContainerRef:v,position:y,hasLabels:b,readonly:k}=Uf({props:e,steps:s,onSliderStart:()=>{t("start",u.value)},onSliderEnd:x=>{let{value:I}=x;const A=i(I);u.value=A,t("end",A)},onSliderMove:x=>{let{value:I}=x;return u.value=i(I)},getActiveThumb:()=>{var x;return(x=a.value)==null?void 0:x.$el}}),{isFocused:g,focus:p,blur:j}=Yn(e),P=h(()=>y(u.value));return X(()=>{const[x,I]=uc.filterProps(e),A=!!(e.label||n.label||n.prepend);return m(uc,se({class:["v-slider",{"v-slider--has-labels":!!n["tick-label"]||b.value,"v-slider--focused":g.value,"v-slider--pressed":o.value,"v-slider--disabled":e.disabled},e.class],style:e.style},x,{focused:g.value}),{...n,prepend:A?q=>{var C,w;return m(ve,null,[((C=n.label)==null?void 0:C.call(n,q))??e.label?m(na,{id:q.id.value,class:"v-slider__label",text:e.label},null):void 0,(w=n.prepend)==null?void 0:w.call(n,q)])}:void 0,default:q=>{let{id:C,messagesId:w}=q;return m("div",{class:"v-slider__container",onMousedown:k.value?void 0:d,onTouchstartPassive:k.value?void 0:f},[m("input",{id:C.value,name:e.name||C.value,disabled:e.disabled,readonly:e.readonly,tabindex:"-1",value:u.value},null),m(Wf,{ref:v,start:0,stop:P.value},{"tick-label":n["tick-label"]}),m(dl,{ref:a,"aria-describedby":w.value,focused:g.value,min:l.value,max:r.value,modelValue:u.value,"onUpdate:modelValue":V=>u.value=V,position:P.value,elevation:e.elevation,onFocus:p,onBlur:j},{"thumb-label":n["thumb-label"]})])}})}),{}}}),z3=Mc({name:"VColorPickerPreview",props:{color:{type:Object},disabled:Boolean,hideAlpha:Boolean,...ne()},emits:{"update:color":e=>!0},setup(e,c){let{emit:n}=c;return X(()=>{var t,a;return m("div",{class:["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class],style:e.style},[m("div",{class:"v-color-picker-preview__dot"},[m("div",{style:{background:ld(e.color??ha)}},null)]),m("div",{class:"v-color-picker-preview__sliders"},[m(fl,{class:"v-color-picker-preview__track v-color-picker-preview__hue",modelValue:(t=e.color)==null?void 0:t.h,"onUpdate:modelValue":s=>n("update:color",{...e.color??ha,h:s}),step:0,min:0,max:360,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&m(fl,{class:"v-color-picker-preview__track v-color-picker-preview__alpha",modelValue:((a=e.color)==null?void 0:a.a)??1,"onUpdate:modelValue":s=>n("update:color",{...e.color??ha,a:s}),step:1/256,min:0,max:1,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])])}),{}}});const H3=Object.freeze({base:"#f44336",lighten5:"#ffebee",lighten4:"#ffcdd2",lighten3:"#ef9a9a",lighten2:"#e57373",lighten1:"#ef5350",darken1:"#e53935",darken2:"#d32f2f",darken3:"#c62828",darken4:"#b71c1c",accent1:"#ff8a80",accent2:"#ff5252",accent3:"#ff1744",accent4:"#d50000"}),U3=Object.freeze({base:"#e91e63",lighten5:"#fce4ec",lighten4:"#f8bbd0",lighten3:"#f48fb1",lighten2:"#f06292",lighten1:"#ec407a",darken1:"#d81b60",darken2:"#c2185b",darken3:"#ad1457",darken4:"#880e4f",accent1:"#ff80ab",accent2:"#ff4081",accent3:"#f50057",accent4:"#c51162"}),W3=Object.freeze({base:"#9c27b0",lighten5:"#f3e5f5",lighten4:"#e1bee7",lighten3:"#ce93d8",lighten2:"#ba68c8",lighten1:"#ab47bc",darken1:"#8e24aa",darken2:"#7b1fa2",darken3:"#6a1b9a",darken4:"#4a148c",accent1:"#ea80fc",accent2:"#e040fb",accent3:"#d500f9",accent4:"#aa00ff"}),K3=Object.freeze({base:"#673ab7",lighten5:"#ede7f6",lighten4:"#d1c4e9",lighten3:"#b39ddb",lighten2:"#9575cd",lighten1:"#7e57c2",darken1:"#5e35b1",darken2:"#512da8",darken3:"#4527a0",darken4:"#311b92",accent1:"#b388ff",accent2:"#7c4dff",accent3:"#651fff",accent4:"#6200ea"}),Y3=Object.freeze({base:"#3f51b5",lighten5:"#e8eaf6",lighten4:"#c5cae9",lighten3:"#9fa8da",lighten2:"#7986cb",lighten1:"#5c6bc0",darken1:"#3949ab",darken2:"#303f9f",darken3:"#283593",darken4:"#1a237e",accent1:"#8c9eff",accent2:"#536dfe",accent3:"#3d5afe",accent4:"#304ffe"}),G3=Object.freeze({base:"#2196f3",lighten5:"#e3f2fd",lighten4:"#bbdefb",lighten3:"#90caf9",lighten2:"#64b5f6",lighten1:"#42a5f5",darken1:"#1e88e5",darken2:"#1976d2",darken3:"#1565c0",darken4:"#0d47a1",accent1:"#82b1ff",accent2:"#448aff",accent3:"#2979ff",accent4:"#2962ff"}),X3=Object.freeze({base:"#03a9f4",lighten5:"#e1f5fe",lighten4:"#b3e5fc",lighten3:"#81d4fa",lighten2:"#4fc3f7",lighten1:"#29b6f6",darken1:"#039be5",darken2:"#0288d1",darken3:"#0277bd",darken4:"#01579b",accent1:"#80d8ff",accent2:"#40c4ff",accent3:"#00b0ff",accent4:"#0091ea"}),Z3=Object.freeze({base:"#00bcd4",lighten5:"#e0f7fa",lighten4:"#b2ebf2",lighten3:"#80deea",lighten2:"#4dd0e1",lighten1:"#26c6da",darken1:"#00acc1",darken2:"#0097a7",darken3:"#00838f",darken4:"#006064",accent1:"#84ffff",accent2:"#18ffff",accent3:"#00e5ff",accent4:"#00b8d4"}),Q3=Object.freeze({base:"#009688",lighten5:"#e0f2f1",lighten4:"#b2dfdb",lighten3:"#80cbc4",lighten2:"#4db6ac",lighten1:"#26a69a",darken1:"#00897b",darken2:"#00796b",darken3:"#00695c",darken4:"#004d40",accent1:"#a7ffeb",accent2:"#64ffda",accent3:"#1de9b6",accent4:"#00bfa5"}),J3=Object.freeze({base:"#4caf50",lighten5:"#e8f5e9",lighten4:"#c8e6c9",lighten3:"#a5d6a7",lighten2:"#81c784",lighten1:"#66bb6a",darken1:"#43a047",darken2:"#388e3c",darken3:"#2e7d32",darken4:"#1b5e20",accent1:"#b9f6ca",accent2:"#69f0ae",accent3:"#00e676",accent4:"#00c853"}),e4=Object.freeze({base:"#8bc34a",lighten5:"#f1f8e9",lighten4:"#dcedc8",lighten3:"#c5e1a5",lighten2:"#aed581",lighten1:"#9ccc65",darken1:"#7cb342",darken2:"#689f38",darken3:"#558b2f",darken4:"#33691e",accent1:"#ccff90",accent2:"#b2ff59",accent3:"#76ff03",accent4:"#64dd17"}),c4=Object.freeze({base:"#cddc39",lighten5:"#f9fbe7",lighten4:"#f0f4c3",lighten3:"#e6ee9c",lighten2:"#dce775",lighten1:"#d4e157",darken1:"#c0ca33",darken2:"#afb42b",darken3:"#9e9d24",darken4:"#827717",accent1:"#f4ff81",accent2:"#eeff41",accent3:"#c6ff00",accent4:"#aeea00"}),n4=Object.freeze({base:"#ffeb3b",lighten5:"#fffde7",lighten4:"#fff9c4",lighten3:"#fff59d",lighten2:"#fff176",lighten1:"#ffee58",darken1:"#fdd835",darken2:"#fbc02d",darken3:"#f9a825",darken4:"#f57f17",accent1:"#ffff8d",accent2:"#ffff00",accent3:"#ffea00",accent4:"#ffd600"}),t4=Object.freeze({base:"#ffc107",lighten5:"#fff8e1",lighten4:"#ffecb3",lighten3:"#ffe082",lighten2:"#ffd54f",lighten1:"#ffca28",darken1:"#ffb300",darken2:"#ffa000",darken3:"#ff8f00",darken4:"#ff6f00",accent1:"#ffe57f",accent2:"#ffd740",accent3:"#ffc400",accent4:"#ffab00"}),a4=Object.freeze({base:"#ff9800",lighten5:"#fff3e0",lighten4:"#ffe0b2",lighten3:"#ffcc80",lighten2:"#ffb74d",lighten1:"#ffa726",darken1:"#fb8c00",darken2:"#f57c00",darken3:"#ef6c00",darken4:"#e65100",accent1:"#ffd180",accent2:"#ffab40",accent3:"#ff9100",accent4:"#ff6d00"}),s4=Object.freeze({base:"#ff5722",lighten5:"#fbe9e7",lighten4:"#ffccbc",lighten3:"#ffab91",lighten2:"#ff8a65",lighten1:"#ff7043",darken1:"#f4511e",darken2:"#e64a19",darken3:"#d84315",darken4:"#bf360c",accent1:"#ff9e80",accent2:"#ff6e40",accent3:"#ff3d00",accent4:"#dd2c00"}),u4=Object.freeze({base:"#795548",lighten5:"#efebe9",lighten4:"#d7ccc8",lighten3:"#bcaaa4",lighten2:"#a1887f",lighten1:"#8d6e63",darken1:"#6d4c41",darken2:"#5d4037",darken3:"#4e342e",darken4:"#3e2723"}),l4=Object.freeze({base:"#607d8b",lighten5:"#eceff1",lighten4:"#cfd8dc",lighten3:"#b0bec5",lighten2:"#90a4ae",lighten1:"#78909c",darken1:"#546e7a",darken2:"#455a64",darken3:"#37474f",darken4:"#263238"}),r4=Object.freeze({base:"#9e9e9e",lighten5:"#fafafa",lighten4:"#f5f5f5",lighten3:"#eeeeee",lighten2:"#e0e0e0",lighten1:"#bdbdbd",darken1:"#757575",darken2:"#616161",darken3:"#424242",darken4:"#212121"}),i4=Object.freeze({black:"#000000",white:"#ffffff",transparent:"#ffffff00"}),o4=Object.freeze({red:H3,pink:U3,purple:W3,deepPurple:K3,indigo:Y3,blue:G3,lightBlue:X3,cyan:Z3,teal:Q3,green:J3,lightGreen:e4,lime:c4,yellow:n4,amber:t4,orange:a4,deepOrange:s4,brown:u4,blueGrey:l4,grey:r4,shades:i4});function d4(e){return Object.keys(e).map(c=>{const n=e[c];return n.base?[n.base,n.darken4,n.darken3,n.darken2,n.darken1,n.lighten1,n.lighten2,n.lighten3,n.lighten4,n.lighten5]:[n.black,n.white,n.transparent]})}const f4=Mc({name:"VColorPickerSwatches",props:{swatches:{type:Array,default:()=>d4(o4)},disabled:Boolean,color:Object,maxHeight:[Number,String],...ne()},emits:{"update:color":e=>!0},setup(e,c){let{emit:n}=c;return X(()=>m("div",{class:["v-color-picker-swatches",e.class],style:[{maxHeight:le(e.maxHeight)},e.style]},[m("div",null,[e.swatches.map(t=>m("div",{class:"v-color-picker-swatches__swatch"},[t.map(a=>{const s=Nf(a);return m("div",{class:"v-color-picker-swatches__color",onClick:()=>s&&n("update:color",s)},[m("div",{style:{background:a}},[e.color&&mt(e.color,s)?m(ze,{size:"x-small",icon:"$success",color:Bb(a,"#FFFFFF")>2?"white":"black"},null):void 0])])})]))])])),{}}}),m4=Mc({name:"VColorPicker",props:{canvasHeight:{type:[String,Number],default:150},disabled:Boolean,dotSize:{type:[Number,String],default:10},hideCanvas:Boolean,hideSliders:Boolean,hideInputs:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(it).includes(e)},modes:{type:Array,default:()=>Object.keys(it),validator:e=>Array.isArray(e)&&e.every(c=>Object.keys(it).includes(c))},showSwatches:Boolean,swatches:Array,swatchesMaxHeight:{type:[Number,String],default:150},modelValue:{type:[Object,String]},...on(Ff({width:300}),["height","location","minHeight","maxHeight","minWidth","maxWidth"])},emits:{"update:modelValue":e=>!0,"update:mode":e=>!0},setup(e){const c=pe(e,"mode"),n=$(null),t=pe(e,"modelValue",void 0,s=>{let u=Nf(s);return u?(n.value&&(u={...u,h:n.value.h},n.value=null),u):null},s=>s?B3(s,e.modelValue):null),a=s=>{t.value=s,n.value=s};return vc(()=>{e.modes.includes(c.value)||(c.value=e.modes[0])}),Je({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),X(()=>{const[s]=ll.filterProps(e);return m(ll,se({rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker",e.class],style:[{"--v-color-picker-color-hsv":ld({...t.value??ha,a:1})},e.style]},s,{maxWidth:e.width}),{default:()=>[!e.hideCanvas&&m($3,{key:"canvas",color:t.value,"onUpdate:color":a,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&m("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&m(z3,{key:"preview",color:t.value,"onUpdate:color":a,hideAlpha:!c.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&m(N3,{key:"edit",modes:e.modes,mode:c.value,"onUpdate:mode":u=>c.value=u,color:t.value,"onUpdate:color":a,disabled:e.disabled},null)]),e.showSwatches&&m(f4,{key:"swatches",color:t.value,"onUpdate:color":a,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]})}),{}}});function v4(e,c,n){if(c==null)return e;if(Array.isArray(c))throw new Error("Multiple matches is not implemented");return typeof c=="number"&&~c?m(ve,null,[m("span",{class:"v-combobox__unmask"},[e.substr(0,c)]),m("span",{class:"v-combobox__mask"},[e.substr(c,n)]),m("span",{class:"v-combobox__unmask"},[e.substr(c+n)])]):e}const y4=W()({name:"VCombobox",props:{delimiters:Array,...Cf({filterKeys:["title"]}),...jr({hideNoData:!0,returnObject:!0}),...on(Us({modelValue:null}),["validationValue","dirty","appendInnerIcon"]),...xn({transition:!1})},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,c){var K;let{emit:n,slots:t}=c;const{t:a}=Bc(),s=$(),u=$(!1),l=$(!0),r=$(),o=pe(e,"menu"),i=h({get:()=>o.value,set:z=>{var fe;o.value&&!z&&((fe=r.value)!=null&&fe.ΨopenChildren)||(o.value=z)}}),d=$(-1);let f=!1;const v=h(()=>{var z;return(z=s.value)==null?void 0:z.color}),{items:y,transformIn:b,transformOut:k}=hr(e),{textColorClasses:g,textColorStyles:p}=mc(v),j=pe(e,"modelValue",[],z=>b(Tc(z)),z=>{const fe=k(z);return e.multiple?fe:fe[0]??null}),P=zs(),x=$(e.multiple?"":((K=j.value[0])==null?void 0:K.title)??""),I=h({get:()=>x.value,set:z=>{var fe;if(x.value=z,e.multiple||(j.value=[Vt(e,z)]),z&&e.multiple&&((fe=e.delimiters)!=null&&fe.length)){const oe=z.split(new RegExp(`(?:${e.delimiters.join("|")})+`));oe.length>1&&(oe.forEach(B=>{B=B.trim(),B&&D(Vt(e,B))}),x.value="")}z||(d.value=-1),l.value=!z}});ae(x,z=>{f?Oe(()=>f=!1):u.value&&!i.value&&(i.value=!0),n("update:search",z)}),ae(j,z=>{var fe;e.multiple||(x.value=((fe=z[0])==null?void 0:fe.title)??"")});const{filteredItems:A,getMatches:q}=_f(e,y,h(()=>l.value?void 0:I.value)),C=h(()=>j.value.map(z=>y.value.find(fe=>e.valueComparator(fe.value,z.value))||z)),w=h(()=>e.hideSelected?A.value.filter(z=>!C.value.some(fe=>fe.value===z.value)):A.value),V=h(()=>C.value.map(z=>z.props.value)),_=h(()=>C.value[d.value]),M=$();function N(z){f=!0,e.openOnClear&&(i.value=!0)}function Z(){e.hideNoData&&!y.value.length||e.readonly||P!=null&&P.isReadonly.value||(i.value=!0)}function F(z){var B,T;if(e.readonly||P!=null&&P.isReadonly.value)return;const fe=s.value.selectionStart,oe=V.value.length;if((d.value>-1||["Enter","ArrowDown","ArrowUp"].includes(z.key))&&z.preventDefault(),["Enter","ArrowDown"].includes(z.key)&&(i.value=!0),["Escape"].includes(z.key)&&(i.value=!1),["Enter","Escape","Tab"].includes(z.key)&&(l.value=!0),z.key==="ArrowDown"?(B=M.value)==null||B.focus("next"):z.key==="ArrowUp"&&((T=M.value)==null||T.focus("prev")),!!e.multiple){if(["Backspace","Delete"].includes(z.key)){if(d.value<0){z.key==="Backspace"&&!I.value&&(d.value=oe-1);return}const O=d.value;_.value&&D(_.value),d.value=O>=oe-1?oe-2:O}if(z.key==="ArrowLeft"){if(d.value<0&&fe>0)return;const O=d.value>-1?d.value-1:oe-1;C.value[O]?d.value=O:(d.value=-1,s.value.setSelectionRange(I.value.length,I.value.length))}if(z.key==="ArrowRight"){if(d.value<0)return;const O=d.value+1;C.value[O]?d.value=O:(d.value=-1,s.value.setSelectionRange(0,0))}z.key==="Enter"&&I.value&&(D(Vt(e,I.value)),I.value="")}}function H(){u.value&&(l.value=!0)}function D(z){if(e.multiple){const fe=V.value.findIndex(oe=>e.valueComparator(oe,z.value));if(fe===-1)j.value=[...j.value,z];else{const oe=[...j.value];oe.splice(fe,1),j.value=oe}I.value=""}else j.value=[z],x.value=z.title,Oe(()=>{i.value=!1,l.value=!0})}function J(z){u.value=!0}function R(z){var fe;z.relatedTarget==null&&((fe=s.value)==null||fe.focus())}return ae(A,z=>{!z.length&&e.hideNoData&&(i.value=!1)}),ae(u,z=>{if(z)d.value=-1;else{if(i.value=!1,!e.multiple||!I.value)return;j.value=[...j.value,Vt(e,I.value)],I.value=""}}),X(()=>{const z=!!(e.chips||t.chip),fe=!!(!e.hideNoData||w.value.length||t.prepend||t.append||t["no-data"]),oe=j.value.length>0,[B]=ft.filterProps(e);return m(ft,se({ref:s},B,{modelValue:I.value,"onUpdate:modelValue":[T=>I.value=T,T=>{T==null&&(j.value=[])}],focused:u.value,"onUpdate:focused":T=>u.value=T,validationValue:j.externalValue,dirty:oe,class:["v-combobox",{"v-combobox--active-menu":i.value,"v-combobox--chips":!!e.chips,"v-combobox--selecting-index":d.value>-1,[`v-combobox--${e.multiple?"multiple":"single"}`]:!0},e.class],style:e.style,appendInnerIcon:e.items.length?e.menuIcon:void 0,readonly:e.readonly,placeholder:oe?void 0:e.placeholder,"onClick:clear":N,"onMousedown:control":Z,onKeydown:F}),{...t,default:()=>m(ve,null,[m(Gs,se({ref:r,modelValue:i.value,"onUpdate:modelValue":T=>i.value=T,activator:"parent",contentClass:"v-combobox__content",eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:H},e.menuProps),{default:()=>[fe&&m(Ks,{ref:M,selected:V.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:T=>T.preventDefault(),onFocusin:J,onFocusout:R},{default:()=>{var T,O,re;return[!w.value.length&&!e.hideNoData&&(((T=t["no-data"])==null?void 0:T.call(t))??m(qn,{title:a(e.noDataText)},null)),(O=t["prepend-item"])==null?void 0:O.call(t),w.value.map(ie=>{var xe;return((xe=t.item)==null?void 0:xe.call(t,{item:ie,props:se(ie.props,{onClick:()=>D(ie)})}))??m(qn,se({key:ie.value},ie.props,{onClick:()=>D(ie)}),{prepend:me=>{let{isSelected:S}=me;return m(ve,null,[e.multiple&&!e.hideSelected?m(Nt,{modelValue:S,ripple:!1,tabindex:"-1"},null):void 0,ie.props.prependIcon&&m(ze,{icon:ie.props.prependIcon},null)])},title:()=>{var me,S;return l.value?ie.title:v4(ie.title,(me=q(ie))==null?void 0:me.title,((S=I.value)==null?void 0:S.length)??0)}})}),(re=t["append-item"])==null?void 0:re.call(t)]}})]}),C.value.map((T,O)=>{var xe;function re(me){me.stopPropagation(),me.preventDefault(),D(T)}const ie={"onClick:close":re,onMousedown(me){me.preventDefault(),me.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0};return m("div",{key:T.value,class:["v-combobox__selection",O===d.value&&["v-combobox__selection--selected",g.value]],style:O===d.value?p.value:{}},[z?t.chip?m($e,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:T.title}}},{default:()=>{var me;return[(me=t.chip)==null?void 0:me.call(t,{item:T,index:O,props:ie})]}}):m(Fa,se({key:"chip",closable:e.closableChips,size:"small",text:T.title},ie),null):((xe=t.selection)==null?void 0:xe.call(t,{item:T,index:O}))??m("span",{class:"v-combobox__selection-text"},[T.title,e.multiple&&O<C.value.length-1&&m("span",{class:"v-combobox__selection-comma"},[ic(",")])])])})])})}),Gc({isFocused:u,isPristine:l,menu:i,search:I,selectionIndex:d,filteredItems:A,select:D},s)}});const b4=W()({name:"VDialog",props:{fullscreen:Boolean,retainFocus:{type:Boolean,default:!0},scrollable:Boolean,...Da({origin:"center center",scrollStrategy:"block",transition:{component:Os},zIndex:2400})},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),{scopeId:a}=Na(),s=$();function u(r){var d,f;const o=r.relatedTarget,i=r.target;if(o!==i&&((d=s.value)!=null&&d.contentEl)&&((f=s.value)!=null&&f.globalTop)&&![document,s.value.contentEl].includes(i)&&!s.value.contentEl.contains(i)){const v=Yl(s.value.contentEl);if(!v.length)return;const y=v[0],b=v[v.length-1];o===y?b.focus():y.focus()}}Xe&&ae(()=>t.value&&e.retainFocus,r=>{r?document.addEventListener("focusin",u):document.removeEventListener("focusin",u)},{immediate:!0}),ae(t,async r=>{var o,i;await Oe(),r?(o=s.value.contentEl)==null||o.focus({preventScroll:!0}):(i=s.value.activatorEl)==null||i.focus({preventScroll:!0})});const l=h(()=>se({"aria-haspopup":"dialog","aria-expanded":String(t.value)},e.activatorProps));return X(()=>{const[r]=kn.filterProps(e);return m(kn,se({ref:s,class:["v-dialog",{"v-dialog--fullscreen":e.fullscreen,"v-dialog--scrollable":e.scrollable},e.class],style:e.style},r,{modelValue:t.value,"onUpdate:modelValue":o=>t.value=o,"aria-modal":"true",activatorProps:l.value,role:"dialog"},a),{activator:n.activator,default:function(){for(var o=arguments.length,i=new Array(o),d=0;d<o;d++)i[d]=arguments[d];return m($e,{root:!0},{default:()=>{var f;return[(f=n.default)==null?void 0:f.call(n,...i)]}})}})}),Gc({},s)}});const Ta=Symbol.for("vuetify:v-expansion-panel"),h4=["default","accordion","inset","popout"],g4=W()({name:"VExpansionPanels",props:{color:String,variant:{type:String,default:"default",validator:e=>h4.includes(e)},readonly:Boolean,...ne(),...Xt(),...Se(),...Ie()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;jt(e,Ta);const{themeClasses:t}=Pe(e),a=h(()=>e.variant&&`v-expansion-panels--variant-${e.variant}`);return Je({VExpansionPanel:{color:Y(e,"color")},VExpansionPanelTitle:{readonly:Y(e,"readonly")}}),X(()=>m(e.tag,{class:["v-expansion-panels",t.value,a.value,e.class],style:e.style},n)),{}}}),Kf=he({color:String,expandIcon:{type:je,default:"$expand"},collapseIcon:{type:je,default:"$collapse"},hideActions:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean},"v-expansion-panel-title"),Yf=W()({name:"VExpansionPanelTitle",directives:{Ripple:Un},props:{...ne(),...Kf()},setup(e,c){let{slots:n}=c;const t=Ve(Ta);if(!t)throw new Error("[Vuetify] v-expansion-panel-title needs to be placed inside v-expansion-panel");const{backgroundColorClasses:a,backgroundColorStyles:s}=Ze(e,"color"),u=h(()=>({collapseIcon:e.collapseIcon,disabled:t.disabled.value,expanded:t.isSelected.value,expandIcon:e.expandIcon,readonly:e.readonly}));return X(()=>{var l;return He(m("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":t.isSelected.value},a.value,e.class],style:[s.value,e.style],type:"button",tabindex:t.disabled.value?-1:void 0,disabled:t.disabled.value,"aria-expanded":t.isSelected.value,onClick:e.readonly?void 0:t.toggle},[m("span",{class:"v-expansion-panel-title__overlay"},null),(l=n.default)==null?void 0:l.call(n,u.value),!e.hideActions&&m("span",{class:"v-expansion-panel-title__icon"},[n.actions?n.actions(u.value):m(ze,{icon:t.isSelected.value?e.collapseIcon:e.expandIcon},null)])]),[[pc("ripple"),e.ripple]])}),{}}}),Gf=W()({name:"VExpansionPanelText",props:{...ne(),...Ys()},setup(e,c){let{slots:n}=c;const t=Ve(Ta);if(!t)throw new Error("[Vuetify] v-expansion-panel-text needs to be placed inside v-expansion-panel");const{hasContent:a,onAfterLeave:s}=gr(e,t.isSelected);return X(()=>m(Ls,{onAfterLeave:s},{default:()=>{var u;return[He(m("div",{class:["v-expansion-panel-text",e.class],style:e.style},[n.default&&a.value&&m("div",{class:"v-expansion-panel-text__wrapper"},[(u=n.default)==null?void 0:u.call(n)])]),[[rn,t.isSelected.value]])]}})),{}}}),j4=W()({name:"VExpansionPanel",props:{title:String,text:String,bgColor:String,...ne(),...cc(),...Zt(),...Ys(),...De(),...Se(),...Kf()},emits:{"group:selected":e=>!0},setup(e,c){let{slots:n}=c;const t=Qt(e,Ta),{backgroundColorClasses:a,backgroundColorStyles:s}=Ze(e,"bgColor"),{elevationClasses:u}=rc(e),{roundedClasses:l}=Ue(e),r=h(()=>(t==null?void 0:t.disabled.value)||e.disabled),o=h(()=>t.group.items.value.reduce((f,v,y)=>(t.group.selected.value.includes(v.id)&&f.push(y),f),[])),i=h(()=>{const f=t.group.items.value.findIndex(v=>v.id===t.id);return!t.isSelected.value&&o.value.some(v=>v-f===1)}),d=h(()=>{const f=t.group.items.value.findIndex(v=>v.id===t.id);return!t.isSelected.value&&o.value.some(v=>v-f===-1)});return Ke(Ta,t),X(()=>{const f=!!(n.text||e.text),v=!!(n.title||e.title);return m(e.tag,{class:["v-expansion-panel",{"v-expansion-panel--active":t.isSelected.value,"v-expansion-panel--before-active":i.value,"v-expansion-panel--after-active":d.value,"v-expansion-panel--disabled":r.value},l.value,a.value,e.class],style:[s.value,e.style],"aria-expanded":t.isSelected.value},{default:()=>{var y;return[m("div",{class:["v-expansion-panel__shadow",...u.value]},null),v&&m(Yf,{key:"title",collapseIcon:e.collapseIcon,color:e.color,expandIcon:e.expandIcon,hideActions:e.hideActions,ripple:e.ripple},{default:()=>[n.title?n.title():e.title]}),f&&m(Gf,{key:"text",eager:e.eager},{default:()=>[n.text?n.text():e.text]}),(y=n.default)==null?void 0:y.call(n)]}})}),{}}});const q4=W()({name:"VFileInput",inheritAttrs:!1,props:{chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},multiple:Boolean,showSize:{type:[Boolean,Number],default:!1,validator:e=>typeof e=="boolean"||[1e3,1024].includes(e)},...Vn({prependIcon:"$file"}),modelValue:{type:Array,default:()=>[],validator:e=>Tc(e).every(c=>c!=null&&typeof c=="object")},...Ds({clearable:!0})},emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,c){let{attrs:n,emit:t,slots:a}=c;const{t:s}=Bc(),u=pe(e,"modelValue"),{isFocused:l,focus:r,blur:o}=Yn(e),i=h(()=>typeof e.showSize!="boolean"?e.showSize:void 0),d=h(()=>(u.value??[]).reduce((q,C)=>{let{size:w=0}=C;return q+w},0)),f=h(()=>Mi(d.value,i.value)),v=h(()=>(u.value??[]).map(q=>{const{name:C="",size:w=0}=q;return e.showSize?`${C} (${Mi(w,i.value)})`:C})),y=h(()=>{var C;const q=((C=u.value)==null?void 0:C.length)??0;return e.showSize?s(e.counterSizeString,q,f.value):s(e.counterString,q)}),b=$(),k=$(),g=$(),p=h(()=>l.value||e.active);function j(){var q;g.value!==document.activeElement&&((q=g.value)==null||q.focus()),l.value||r()}function P(q){I(q)}function x(q){t("mousedown:control",q)}function I(q){var C;(C=g.value)==null||C.click(),t("click:control",q)}function A(q){q.stopPropagation(),j(),Oe(()=>{u.value=[],Kl(e["onClick:clear"],q)})}return ae(u,q=>{(!Array.isArray(q)||!q.length)&&g.value&&(g.value.value="")}),X(()=>{const q=!!(a.counter||e.counter),C=!!(q||a.details),[w,V]=vt(n),[{modelValue:_,...M}]=uc.filterProps(e),[N]=vr(e);return m(uc,se({ref:b,modelValue:u.value,"onUpdate:modelValue":Z=>u.value=Z,class:["v-file-input",e.class],style:e.style,"onClick:prepend":P},w,M,{focused:l.value}),{...a,default:Z=>{let{id:F,isDisabled:H,isDirty:D,isReadonly:J,isValid:R}=Z;return m(La,se({ref:k,"prepend-icon":e.prependIcon,onMousedown:x,onClick:I,"onClick:clear":A,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},N,{id:F.value,active:p.value||D.value,dirty:D.value,disabled:H.value,focused:l.value,error:R.value===!1}),{...a,default:K=>{var oe;let{props:{class:z,...fe}}=K;return m(ve,null,[m("input",se({ref:g,type:"file",readonly:J.value,disabled:H.value,multiple:e.multiple,name:e.name,onClick:B=>{B.stopPropagation(),j()},onChange:B=>{if(!B.target)return;const T=B.target;u.value=[...T.files??[]]},onFocus:j,onBlur:o},fe,V),null),m("div",{class:z},[!!((oe=u.value)!=null&&oe.length)&&(a.selection?a.selection({fileNames:v.value,totalBytes:d.value,totalBytesReadable:f.value}):e.chips?v.value.map(B=>m(Fa,{key:B,size:"small",color:e.color},{default:()=>[B]})):v.value.join(", "))])])}})},details:C?Z=>{var F,H;return m(ve,null,[(F=a.details)==null?void 0:F.call(a,Z),q&&m(ve,null,[m("span",null,null),m(Hs,{active:!!((H=u.value)!=null&&H.length),value:y.value},a.counter)])])}:void 0})}),Gc({},b,k,g)}});const k4=W()({name:"VFooter",props:{app:Boolean,color:String,height:{type:[Number,String],default:"auto"},...Ac(),...ne(),...cc(),...Kt(),...De(),...Se({tag:"footer"}),...Ie()},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{backgroundColorClasses:a,backgroundColorStyles:s}=Ze(Y(e,"color")),{borderClasses:u}=Lc(e),{elevationClasses:l}=rc(e),{roundedClasses:r}=Ue(e),o=$(32),{resizeRef:i}=un(v=>{v.length&&(o.value=v[0].target.clientHeight)}),d=h(()=>e.height==="auto"?o.value:parseInt(e.height,10)),{layoutItemStyles:f}=Yt({id:e.name,order:h(()=>parseInt(e.order,10)),position:h(()=>"bottom"),layoutSize:d,elementSize:h(()=>e.height==="auto"?void 0:d.value),active:h(()=>e.app),absolute:Y(e,"absolute")});return X(()=>m(e.tag,{ref:i,class:["v-footer",t.value,a.value,u.value,l.value,r.value,e.class],style:[s.value,e.app?f.value:void 0,e.style]},n)),{}}}),p4=W()({name:"VForm",props:{...ne(),..._g()},emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,c){let{slots:n,emit:t}=c;const a=xg(e),s=$();function u(r){r.preventDefault(),a.reset()}function l(r){const o=r,i=a.validate();o.then=i.then.bind(i),o.catch=i.catch.bind(i),o.finally=i.finally.bind(i),t("submit",o),o.defaultPrevented||i.then(d=>{var v;let{valid:f}=d;f&&((v=s.value)==null||v.submit())}),o.preventDefault()}return X(()=>{var r;return m("form",{ref:s,class:["v-form",e.class],style:e.style,novalidate:!0,onReset:u,onSubmit:l},[(r=n.default)==null?void 0:r.call(n,a)])}),Gc(a,s)}});const S4=W()({name:"VContainer",props:{fluid:{type:Boolean,default:!1},...ne(),...Se()},setup(e,c){let{slots:n}=c;return X(()=>m(e.tag,{class:["v-container",{"v-container--fluid":e.fluid},e.class],style:e.style},n)),{}}}),Xf=(()=>Bs.reduce((e,c)=>(e[c]={type:[Boolean,String,Number],default:!1},e),{}))(),Zf=(()=>Bs.reduce((e,c)=>{const n="offset"+pn(c);return e[n]={type:[String,Number],default:null},e},{}))(),Qf=(()=>Bs.reduce((e,c)=>{const n="order"+pn(c);return e[n]={type:[String,Number],default:null},e},{}))(),bo={col:Object.keys(Xf),offset:Object.keys(Zf),order:Object.keys(Qf)};function C4(e,c,n){let t=e;if(!(n==null||n===!1)){if(c){const a=c.replace(e,"");t+=`-${a}`}return e==="col"&&(t="v-"+t),e==="col"&&(n===""||n===!0)||(t+=`-${n}`),t.toLowerCase()}}const _4=["auto","start","end","center","baseline","stretch"],x4=W()({name:"VCol",props:{cols:{type:[Boolean,String,Number],default:!1},...Xf,offset:{type:[String,Number],default:null},...Zf,order:{type:[String,Number],default:null},...Qf,alignSelf:{type:String,default:null,validator:e=>_4.includes(e)},...ne(),...Se()},setup(e,c){let{slots:n}=c;const t=h(()=>{const a=[];let s;for(s in bo)bo[s].forEach(l=>{const r=e[l],o=C4(s,l,r);o&&a.push(o)});const u=a.some(l=>l.startsWith("v-col-"));return a.push({"v-col":!u||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),a});return()=>{var a;return ln(e.tag,{class:[t.value,e.class],style:e.style},(a=n.default)==null?void 0:a.call(n))}}}),pr=["start","end","center"],Jf=["space-between","space-around","space-evenly"];function Sr(e,c){return Bs.reduce((n,t)=>{const a=e+pn(t);return n[a]=c(),n},{})}const w4=[...pr,"baseline","stretch"],em=e=>w4.includes(e),cm=Sr("align",()=>({type:String,default:null,validator:em})),V4=[...pr,...Jf],nm=e=>V4.includes(e),tm=Sr("justify",()=>({type:String,default:null,validator:nm})),I4=[...pr,...Jf,"stretch"],am=e=>I4.includes(e),sm=Sr("alignContent",()=>({type:String,default:null,validator:am})),ho={align:Object.keys(cm),justify:Object.keys(tm),alignContent:Object.keys(sm)},A4={align:"align",justify:"justify",alignContent:"align-content"};function E4(e,c,n){let t=A4[e];if(n!=null){if(c){const a=c.replace(e,"");t+=`-${a}`}return t+=`-${n}`,t.toLowerCase()}}const P4=W()({name:"VRow",props:{dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:em},...cm,justify:{type:String,default:null,validator:nm},...tm,alignContent:{type:String,default:null,validator:am},...sm,...ne(),...Se()},setup(e,c){let{slots:n}=c;const t=h(()=>{const a=[];let s;for(s in ho)ho[s].forEach(u=>{const l=e[u],r=E4(s,u,l);r&&a.push(r)});return a.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),a});return()=>{var a;return ln(e.tag,{class:["v-row",t.value,e.class],style:e.style},(a=n.default)==null?void 0:a.call(n))}}}),T4=Yc("flex-grow-1","div","VSpacer"),$4=W()({name:"VHover",props:{disabled:Boolean,modelValue:{type:Boolean,default:void 0},...bf()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),{runOpenDelay:a,runCloseDelay:s}=hf(e,u=>!e.disabled&&(t.value=u));return()=>{var u;return(u=n.default)==null?void 0:u.call(n,{isHovering:t.value,props:{onMouseenter:a,onMouseleave:s}})}}});const um=Symbol.for("vuetify:v-item-group"),M4=W()({name:"VItemGroup",props:{...ne(),...Xt({selectedClass:"v-item--selected"}),...Se(),...Ie()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{isSelected:a,select:s,next:u,prev:l,selected:r}=jt(e,um);return()=>m(e.tag,{class:["v-item-group",t.value,e.class],style:e.style},{default:()=>{var o;return[(o=n.default)==null?void 0:o.call(n,{isSelected:a,select:s,next:u,prev:l,selected:r.value})]}})}}),B4=W()({name:"VItem",props:Zt(),emits:{"group:selected":e=>!0},setup(e,c){let{slots:n}=c;const{isSelected:t,select:a,toggle:s,selectedClass:u,value:l,disabled:r}=Qt(e,um);return()=>{var o;return(o=n.default)==null?void 0:o.call(n,{isSelected:t.value,selectedClass:u.value,select:a,toggle:s,value:l.value,disabled:r.value})}}});const R4=Yc("v-kbd");const O4=W()({name:"VLayout",props:{...ne(),...Cd()},setup(e,c){let{slots:n}=c;const{layoutClasses:t,layoutStyles:a,getLayoutItem:s,items:u,layoutRef:l}=_d(e);return X(()=>{var r;return m("div",{ref:l,class:[t.value,e.class],style:[a.value,e.style]},[(r=n.default)==null?void 0:r.call(n)])}),{getLayoutItem:s,items:u}}});const L4=W()({name:"VLayoutItem",props:{position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...ne(),...Kt()},setup(e,c){let{slots:n}=c;const{layoutItemStyles:t}=Yt({id:e.name,order:h(()=>parseInt(e.order,10)),position:Y(e,"position"),elementSize:Y(e,"size"),layoutSize:Y(e,"size"),active:Y(e,"modelValue"),absolute:Y(e,"absolute")});return()=>{var a;return m("div",{class:["v-layout-item",e.class],style:[t.value,e.style]},[(a=n.default)==null?void 0:a.call(n)])}}}),F4=W()({name:"VLazy",directives:{intersect:Ba},props:{modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...ne(),...Rc(),...Se(),...xn({transition:"fade-transition"})},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{dimensionStyles:t}=Oc(e),a=pe(e,"modelValue");function s(u){a.value||(a.value=u)}return X(()=>He(m(e.tag,{class:["v-lazy",e.class],style:[t.value,e.style]},{default:()=>[a.value&&m(Hc,{transition:e.transition,appear:!0},{default:()=>{var u;return[(u=n.default)==null?void 0:u.call(n)]}})]}),[[pc("intersect"),{handler:s,options:e.options},null]])),{}}});const N4=W()({name:"VLocaleProvider",props:{locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...ne()},setup(e,c){let{slots:n}=c;const{rtlClasses:t}=Xb(e);return X(()=>{var a;return m("div",{class:["v-locale-provider",t.value,e.class],style:e.style},[(a=n.default)==null?void 0:a.call(n)])}),{}}});const D4=W()({name:"VMain",props:{scrollable:Boolean,...ne(),...Se({tag:"main"})},setup(e,c){let{slots:n}=c;const{mainStyles:t}=Oh(),{ssrBootStyles:a}=bt();return X(()=>m(e.tag,{class:["v-main",{"v-main--scrollable":e.scrollable},e.class],style:[t.value,a.value,e.style]},{default:()=>{var s,u;return[e.scrollable?m("div",{class:"v-main__scroller"},[(s=n.default)==null?void 0:s.call(n)]):(u=n.default)==null?void 0:u.call(n)]}})),{}}});function z4(e){let{rootEl:c,isSticky:n,layoutItemStyles:t}=e;const a=$(!1),s=$(0),u=h(()=>{const o=typeof a.value=="boolean"?"top":a.value;return[n.value?{top:"auto",bottom:"auto",height:void 0}:void 0,a.value?{[o]:le(s.value)}:{top:t.value.top}]});vc(()=>{ae(n,o=>{o?window.addEventListener("scroll",r,{passive:!0}):window.removeEventListener("scroll",r)},{immediate:!0})}),jc(()=>{document.removeEventListener("scroll",r)});let l=0;function r(){const o=l>window.scrollY?"up":"down",i=c.value.getBoundingClientRect(),d=parseFloat(t.value.top??0),f=window.scrollY-Math.max(0,s.value-d),v=i.height+Math.max(s.value,d)-window.scrollY-window.innerHeight;i.height<window.innerHeight-d?(a.value="top",s.value=d):o==="up"&&a.value==="bottom"||o==="down"&&a.value==="top"?(s.value=window.scrollY+i.top,a.value=!0):o==="down"&&v<=0?(s.value=0,a.value="bottom"):o==="up"&&f<=0&&(s.value=i.top+f,a.value="top"),l=window.scrollY}return{isStuck:a,stickyStyles:u}}const H4=100,U4=20;function go(e){const c=1.41421356237;return(e<0?-1:1)*Math.sqrt(Math.abs(e))*c}function jo(e){if(e.length<2)return 0;if(e.length===2)return e[1].t===e[0].t?0:(e[1].d-e[0].d)/(e[1].t-e[0].t);let c=0;for(let n=e.length-1;n>0;n--){if(e[n].t===e[n-1].t)continue;const t=go(c),a=(e[n].d-e[n-1].d)/(e[n].t-e[n-1].t);c+=(a-t)*Math.abs(a),n===e.length-1&&(c*=.5)}return go(c)*1e3}function W4(){const e={};function c(a){Array.from(a.changedTouches).forEach(s=>{(e[s.identifier]??(e[s.identifier]=new jb(U4))).push([a.timeStamp,s])})}function n(a){Array.from(a.changedTouches).forEach(s=>{delete e[s.identifier]})}function t(a){var o;const s=(o=e[a])==null?void 0:o.values().reverse();if(!s)throw new Error(`No samples for touch id ${a}`);const u=s[0],l=[],r=[];for(const i of s){if(u[0]-i[0]>H4)break;l.push({t:i[0],d:i[1].clientX}),r.push({t:i[0],d:i[1].clientY})}return{x:jo(l),y:jo(r),get direction(){const{x:i,y:d}=this,[f,v]=[Math.abs(i),Math.abs(d)];return f>v&&i>=0?"right":f>v&&i<=0?"left":v>f&&d>=0?"down":v>f&&d<=0?"up":K4()}}}return{addMovement:c,endTouch:n,getVelocity:t}}function K4(){throw new Error}function Y4(e){let{isActive:c,isTemporary:n,width:t,touchless:a,position:s}=e;vc(()=>{window.addEventListener("touchstart",g,{passive:!0}),window.addEventListener("touchmove",p,{passive:!1}),window.addEventListener("touchend",j,{passive:!0})}),jc(()=>{window.removeEventListener("touchstart",g),window.removeEventListener("touchmove",p),window.removeEventListener("touchend",j)});const u=h(()=>["left","right"].includes(s.value)),{addMovement:l,endTouch:r,getVelocity:o}=W4();let i=!1;const d=$(!1),f=$(0),v=$(0);let y;function b(x,I){return(s.value==="left"?x:s.value==="right"?document.documentElement.clientWidth-x:s.value==="top"?x:s.value==="bottom"?document.documentElement.clientHeight-x:_t())-(I?t.value:0)}function k(x){let I=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0;const A=s.value==="left"?(x-v.value)/t.value:s.value==="right"?(document.documentElement.clientWidth-x-v.value)/t.value:s.value==="top"?(x-v.value)/t.value:s.value==="bottom"?(document.documentElement.clientHeight-x-v.value)/t.value:_t();return I?Math.max(0,Math.min(1,A)):A}function g(x){if(a.value)return;const I=x.changedTouches[0].clientX,A=x.changedTouches[0].clientY,q=25,C=s.value==="left"?I<q:s.value==="right"?I>document.documentElement.clientWidth-q:s.value==="top"?A<q:s.value==="bottom"?A>document.documentElement.clientHeight-q:_t(),w=c.value&&(s.value==="left"?I<t.value:s.value==="right"?I>document.documentElement.clientWidth-t.value:s.value==="top"?A<t.value:s.value==="bottom"?A>document.documentElement.clientHeight-t.value:_t());(C||w||c.value&&n.value)&&(i=!0,y=[I,A],v.value=b(u.value?I:A,c.value),f.value=k(u.value?I:A),r(x),l(x))}function p(x){const I=x.changedTouches[0].clientX,A=x.changedTouches[0].clientY;if(i){if(!x.cancelable){i=!1;return}const C=Math.abs(I-y[0]),w=Math.abs(A-y[1]);(u.value?C>w&&C>3:w>C&&w>3)?(d.value=!0,i=!1):(u.value?w:C)>3&&(i=!1)}if(!d.value)return;x.preventDefault(),l(x);const q=k(u.value?I:A,!1);f.value=Math.max(0,Math.min(1,q)),q>1?v.value=b(u.value?I:A,!0):q<0&&(v.value=b(u.value?I:A,!1))}function j(x){if(i=!1,!d.value)return;l(x),d.value=!1;const I=o(x.changedTouches[0].identifier),A=Math.abs(I.x),q=Math.abs(I.y);(u.value?A>q&&A>400:q>A&&q>3)?c.value=I.direction===({left:"right",right:"left",top:"down",bottom:"up"}[s.value]||_t()):c.value=f.value>.5}const P=h(()=>d.value?{transform:s.value==="left"?`translateX(calc(-100% + ${f.value*t.value}px))`:s.value==="right"?`translateX(calc(100% - ${f.value*t.value}px))`:s.value==="top"?`translateY(calc(-100% + ${f.value*t.value}px))`:s.value==="bottom"?`translateY(calc(100% - ${f.value*t.value}px))`:_t(),transition:"none"}:void 0);return{isDragging:d,dragProgress:f,dragStyles:P}}function _t(){throw new Error}const G4=["start","end","left","right","top","bottom"],X4=W()({name:"VNavigationDrawer",props:{color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[String,Boolean],default:!0},image:String,temporary:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>G4.includes(e)},sticky:Boolean,...Ac(),...ne(),...cc(),...Kt(),...De(),...Se({tag:"nav"}),...Ie()},emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,c){let{attrs:n,emit:t,slots:a}=c;const{isRtl:s}=_n(),{themeClasses:u}=Pe(e),{borderClasses:l}=Lc(e),{backgroundColorClasses:r,backgroundColorStyles:o}=Ze(Y(e,"color")),{elevationClasses:i}=rc(e),{mobile:d}=yt(),{roundedClasses:f}=Ue(e),v=Hd(),y=pe(e,"modelValue",null,D=>!!D),{ssrBootStyles:b}=bt(),k=$(),g=$(!1),p=h(()=>e.rail&&e.expandOnHover&&g.value?Number(e.width):Number(e.rail?e.railWidth:e.width)),j=h(()=>Hu(e.location,s.value)),P=h(()=>!e.permanent&&(d.value||e.temporary)),x=h(()=>e.sticky&&!P.value&&j.value!=="bottom");e.expandOnHover&&e.rail!=null&&ae(g,D=>t("update:rail",!D)),e.disableResizeWatcher||ae(P,D=>!e.permanent&&Oe(()=>y.value=!D)),!e.disableRouteWatcher&&v&&ae(v.currentRoute,()=>P.value&&(y.value=!1)),ae(()=>e.permanent,D=>{D&&(y.value=!0)}),As(()=>{e.modelValue!=null||P.value||(y.value=e.permanent||!d.value)});const{isDragging:I,dragProgress:A,dragStyles:q}=Y4({isActive:y,isTemporary:P,width:p,touchless:Y(e,"touchless"),position:j}),C=h(()=>{const D=P.value?0:e.rail&&e.expandOnHover?Number(e.railWidth):p.value;return I.value?D*A.value:D}),{layoutItemStyles:w,layoutItemScrimStyles:V}=Yt({id:e.name,order:h(()=>parseInt(e.order,10)),position:j,layoutSize:C,elementSize:p,active:h(()=>y.value||I.value),disableTransitions:h(()=>I.value),absolute:h(()=>e.absolute||x.value&&typeof _.value!="string")}),{isStuck:_,stickyStyles:M}=z4({rootEl:k,isSticky:x,layoutItemStyles:w}),N=Ze(h(()=>typeof e.scrim=="string"?e.scrim:null)),Z=h(()=>({...I.value?{opacity:A.value*.2,transition:"none"}:void 0,...V.value}));Je({VList:{bgColor:"transparent"}});function F(){g.value=!0}function H(){g.value=!1}return X(()=>{const D=a.image||e.image;return m(ve,null,[m(e.tag,se({ref:k,onMouseenter:F,onMouseleave:H,class:["v-navigation-drawer",`v-navigation-drawer--${j.value}`,{"v-navigation-drawer--expand-on-hover":e.expandOnHover,"v-navigation-drawer--floating":e.floating,"v-navigation-drawer--is-hovering":g.value,"v-navigation-drawer--rail":e.rail,"v-navigation-drawer--temporary":P.value,"v-navigation-drawer--active":y.value,"v-navigation-drawer--sticky":x.value},u.value,r.value,l.value,i.value,f.value,e.class],style:[o.value,w.value,q.value,b.value,M.value,e.style]},n),{default:()=>{var J,R,K,z;return[D&&m("div",{key:"image",class:"v-navigation-drawer__img"},[a.image?(J=a.image)==null?void 0:J.call(a,{image:e.image}):m("img",{src:e.image,alt:""},null)]),a.prepend&&m("div",{class:"v-navigation-drawer__prepend"},[(R=a.prepend)==null?void 0:R.call(a)]),m("div",{class:"v-navigation-drawer__content"},[(K=a.default)==null?void 0:K.call(a)]),a.append&&m("div",{class:"v-navigation-drawer__append"},[(z=a.append)==null?void 0:z.call(a)])]}}),m(sn,{name:"fade-transition"},{default:()=>[P.value&&(I.value||y.value)&&!!e.scrim&&m("div",{class:["v-navigation-drawer__scrim",N.backgroundColorClasses.value],style:[Z.value,N.backgroundColorStyles.value],onClick:()=>y.value=!1},null)]})])}),{isStuck:_}}}),Z4=Mc({name:"VNoSsr",setup(e,c){let{slots:n}=c;const t=qf();return()=>{var a;return t.value&&((a=n.default)==null?void 0:a.call(n))}}});function Q4(){const e=$([]);r1(()=>e.value=[]);function c(n,t){e.value[t]=n}return{refs:e,updateRef:c}}const J4=W()({name:"VPagination",props:{activeColor:String,start:{type:[Number,String],default:1},modelValue:{type:Number,default:e=>e.start},disabled:Boolean,length:{type:[Number,String],default:1,validator:e=>e%1===0},totalVisible:[Number,String],firstIcon:{type:je,default:"$first"},prevIcon:{type:je,default:"$prev"},nextIcon:{type:je,default:"$next"},lastIcon:{type:je,default:"$last"},ariaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.root"},pageAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.page"},currentPageAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.currentPage"},firstAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.first"},previousAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.previous"},nextAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.next"},lastAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.last"},ellipsis:{type:String,default:"..."},showFirstLastPage:Boolean,...Ac(),...ne(),...nc(),...cc(),...De(),...wn(),...Se({tag:"nav"}),...Ie(),...Fc({variant:"text"})},emits:{"update:modelValue":e=>!0,first:e=>!0,prev:e=>!0,next:e=>!0,last:e=>!0},setup(e,c){let{slots:n,emit:t}=c;const a=pe(e,"modelValue"),{t:s,n:u}=Bc(),{isRtl:l}=_n(),{themeClasses:r}=Pe(e),{width:o}=yt(),i=$(-1);Je(void 0,{scoped:!0});const{resizeRef:d}=un(q=>{if(!q.length)return;const{target:C,contentRect:w}=q[0],V=C.querySelector(".v-pagination__list > *");if(!V)return;const _=w.width,M=V.offsetWidth+parseFloat(getComputedStyle(V).marginRight)*2;i.value=b(_,M)}),f=h(()=>parseInt(e.length,10)),v=h(()=>parseInt(e.start,10)),y=h(()=>e.totalVisible?parseInt(e.totalVisible,10):i.value>=0?i.value:b(o.value,58));function b(q,C){const w=e.showFirstLastPage?5:3;return Math.max(0,Math.floor(+((q-C*w)/C).toFixed(2)))}const k=h(()=>{if(f.value<=0||isNaN(f.value)||f.value>Number.MAX_SAFE_INTEGER)return[];if(y.value<=1)return[a.value];if(f.value<=y.value)return tn(f.value,v.value);const q=y.value%2===0,C=q?y.value/2:Math.floor(y.value/2),w=q?C:C+1,V=f.value-C;if(w-a.value>=0)return[...tn(Math.max(1,y.value-1),v.value),e.ellipsis,f.value];if(a.value-V>=(q?1:0)){const _=y.value-1,M=f.value-_+v.value;return[v.value,e.ellipsis,...tn(_,M)]}else{const _=Math.max(1,y.value-3),M=_===1?a.value:a.value-Math.ceil(_/2)+v.value;return[v.value,e.ellipsis,...tn(_,M),e.ellipsis,f.value]}});function g(q,C,w){q.preventDefault(),a.value=C,w&&t(w,C)}const{refs:p,updateRef:j}=Q4();Je({VPaginationBtn:{color:Y(e,"color"),border:Y(e,"border"),density:Y(e,"density"),size:Y(e,"size"),variant:Y(e,"variant"),rounded:Y(e,"rounded"),elevation:Y(e,"elevation")}});const P=h(()=>k.value.map((q,C)=>{const w=V=>j(V,C);if(typeof q=="string")return{isActive:!1,key:`ellipsis-${C}`,page:q,props:{ref:w,ellipsis:!0,icon:!0,disabled:!0}};{const V=q===a.value;return{isActive:V,key:q,page:u(q),props:{ref:w,ellipsis:!1,icon:!0,disabled:!!e.disabled||+e.length<2,color:V?e.activeColor:e.color,ariaCurrent:V,ariaLabel:s(V?e.currentPageAriaLabel:e.pageAriaLabel,q),onClick:_=>g(_,q)}}}})),x=h(()=>{const q=!!e.disabled||a.value<=v.value,C=!!e.disabled||a.value>=v.value+f.value-1;return{first:e.showFirstLastPage?{icon:l.value?e.lastIcon:e.firstIcon,onClick:w=>g(w,v.value,"first"),disabled:q,ariaLabel:s(e.firstAriaLabel),ariaDisabled:q}:void 0,prev:{icon:l.value?e.nextIcon:e.prevIcon,onClick:w=>g(w,a.value-1,"prev"),disabled:q,ariaLabel:s(e.previousAriaLabel),ariaDisabled:q},next:{icon:l.value?e.prevIcon:e.nextIcon,onClick:w=>g(w,a.value+1,"next"),disabled:C,ariaLabel:s(e.nextAriaLabel),ariaDisabled:C},last:e.showFirstLastPage?{icon:l.value?e.firstIcon:e.lastIcon,onClick:w=>g(w,v.value+f.value-1,"last"),disabled:C,ariaLabel:s(e.lastAriaLabel),ariaDisabled:C}:void 0}});function I(){var C;const q=a.value-v.value;(C=p.value[q])==null||C.$el.focus()}function A(q){q.key===Du.left&&!e.disabled&&a.value>+e.start?(a.value=a.value-1,Oe(I)):q.key===Du.right&&!e.disabled&&a.value<v.value+f.value-1&&(a.value=a.value+1,Oe(I))}return X(()=>m(e.tag,{ref:d,class:["v-pagination",r.value,e.class],style:e.style,role:"navigation","aria-label":s(e.ariaLabel),onKeydown:A,"data-test":"v-pagination-root"},{default:()=>[m("ul",{class:"v-pagination__list"},[e.showFirstLastPage&&m("li",{key:"first",class:"v-pagination__first","data-test":"v-pagination-first"},[n.first?n.first(x.value.first):m(gc,se({_as:"VPaginationBtn"},x.value.first),null)]),m("li",{key:"prev",class:"v-pagination__prev","data-test":"v-pagination-prev"},[n.prev?n.prev(x.value.prev):m(gc,se({_as:"VPaginationBtn"},x.value.prev),null)]),P.value.map((q,C)=>m("li",{key:q.key,class:["v-pagination__item",{"v-pagination__item--is-active":q.isActive}],"data-test":"v-pagination-item"},[n.item?n.item(q):m(gc,se({_as:"VPaginationBtn"},q.props),{default:()=>[q.page]})])),m("li",{key:"next",class:"v-pagination__next","data-test":"v-pagination-next"},[n.next?n.next(x.value.next):m(gc,se({_as:"VPaginationBtn"},x.value.next),null)]),e.showFirstLastPage&&m("li",{key:"last",class:"v-pagination__last","data-test":"v-pagination-last"},[n.last?n.last(x.value.last):m(gc,se({_as:"VPaginationBtn"},x.value.last),null)])])]})),{}}});function e5(e){return Math.floor(Math.abs(e))*Math.sign(e)}const c5=W()({name:"VParallax",props:{scale:{type:[Number,String],default:.5},...ne()},setup(e,c){let{slots:n}=c;const{intersectionRef:t,isIntersecting:a}=rr(),{resizeRef:s,contentRect:u}=un(),{height:l}=yt(),r=$();Kc(()=>{var v;t.value=s.value=(v=r.value)==null?void 0:v.$el});let o;ae(a,v=>{v?(o=yd(t.value),o=o===document.scrollingElement?document:o,o.addEventListener("scroll",f,{passive:!0}),f()):o.removeEventListener("scroll",f)}),jc(()=>{o==null||o.removeEventListener("scroll",f)}),ae(l,f),ae(()=>{var v;return(v=u.value)==null?void 0:v.height},f);const i=h(()=>1-fc(+e.scale));let d=-1;function f(){a.value&&(cancelAnimationFrame(d),d=requestAnimationFrame(()=>{var x;const v=((x=r.value)==null?void 0:x.$el).querySelector(".v-img__img");if(!v)return;const y=o instanceof Document?document.documentElement.clientHeight:o.clientHeight,b=o instanceof Document?window.scrollY:o.scrollTop,k=t.value.getBoundingClientRect().top+b,g=u.value.height,p=k+(g-y)/2,j=e5((b-p)*i.value),P=Math.max(1,(i.value*(y-g)+g)/g);v.style.setProperty("transform",`translateY(${j}px) scale(${P})`)}))}return X(()=>m(Gt,{class:["v-parallax",{"v-parallax--active":a.value},e.class],style:e.style,ref:r,cover:!0,onLoadstart:f,onLoad:f},n)),{}}}),n5=W()({name:"VRadio",props:{...Ws({falseIcon:"$radioOff",trueIcon:"$radioOn"})},setup(e,c){let{slots:n}=c;return X(()=>m(Ft,se(e,{class:["v-radio",e.class],style:e.style,type:"radio"}),n)),{}}});const t5=W()({name:"VRadioGroup",inheritAttrs:!1,props:{height:{type:[Number,String],default:"auto"},...Vn(),...on(yr(),["multiple"]),trueIcon:{type:je,default:"$radioOn"},falseIcon:{type:je,default:"$radioOff"},type:{type:String,default:"radio"}},emits:{"update:modelValue":e=>!0},setup(e,c){let{attrs:n,slots:t}=c;const a=yc(),s=h(()=>e.id||`radio-group-${a}`),u=pe(e,"modelValue");return X(()=>{const[l,r]=vt(n),[o,i]=uc.filterProps(e),[d,f]=Ft.filterProps(e),v=t.label?t.label({label:e.label,props:{for:s.value}}):e.label;return m(uc,se({class:["v-radio-group",e.class],style:e.style},l,o,{modelValue:u.value,"onUpdate:modelValue":y=>u.value=y,id:s.value}),{...t,default:y=>{let{id:b,messagesId:k,isDisabled:g,isReadonly:p}=y;return m(ve,null,[v&&m(na,{id:b.value},{default:()=>[v]}),m(Qd,se(d,{id:b.value,"aria-describedby":k.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:g.value,readonly:p.value,"aria-labelledby":v?b.value:void 0,multiple:!1},r,{modelValue:u.value,"onUpdate:modelValue":j=>u.value=j}),t)])}})}),{}}}),a5=W()({name:"VRangeSlider",props:{...Ns(),...Vn(),...zf(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,c){let{slots:n,emit:t}=c;const a=$(),s=$(),u=$();function l(q){if(!a.value||!s.value)return;const C=ol(q,a.value.$el,e.direction),w=ol(q,s.value.$el,e.direction),V=Math.abs(C),_=Math.abs(w);return V<_||V===_&&C<0?a.value.$el:s.value.$el}const r=Hf(e),o=pe(e,"modelValue",void 0,q=>q!=null&&q.length?q.map(C=>r.roundValue(C)):[0,0]),{activeThumbRef:i,hasLabels:d,max:f,min:v,mousePressed:y,onSliderMousedown:b,onSliderTouchstart:k,position:g,trackContainerRef:p}=Uf({props:e,steps:r,onSliderStart:()=>{t("start",o.value)},onSliderEnd:q=>{var V;let{value:C}=q;const w=i.value===((V=a.value)==null?void 0:V.$el)?[C,o.value[1]]:[o.value[0],C];o.value=w,t("end",w)},onSliderMove:q=>{var _,M,N,Z;let{value:C}=q;const[w,V]=o.value;!e.strict&&w===V&&w!==v.value&&(i.value=C>w?(_=s.value)==null?void 0:_.$el:(M=a.value)==null?void 0:M.$el,(N=i.value)==null||N.focus()),i.value===((Z=a.value)==null?void 0:Z.$el)?o.value=[Math.min(C,V),V]:o.value=[w,Math.max(w,C)]},getActiveThumb:l}),{isFocused:j,focus:P,blur:x}=Yn(e),I=h(()=>g(o.value[0])),A=h(()=>g(o.value[1]));return X(()=>{const[q,C]=uc.filterProps(e),w=!!(e.label||n.label||n.prepend);return m(uc,se({class:["v-slider","v-range-slider",{"v-slider--has-labels":!!n["tick-label"]||d.value,"v-slider--focused":j.value,"v-slider--pressed":y.value,"v-slider--disabled":e.disabled},e.class],style:e.style,ref:u},q,{focused:j.value}),{...n,prepend:w?V=>{var _,M;return m(ve,null,[((_=n.label)==null?void 0:_.call(n,V))??e.label?m(na,{class:"v-slider__label",text:e.label},null):void 0,(M=n.prepend)==null?void 0:M.call(n,V)])}:void 0,default:V=>{var N,Z;let{id:_,messagesId:M}=V;return m("div",{class:"v-slider__container",onMousedown:b,onTouchstartPassive:k},[m("input",{id:`${_.value}_start`,name:e.name||_.value,disabled:e.disabled,readonly:e.readonly,tabindex:"-1",value:o.value[0]},null),m("input",{id:`${_.value}_stop`,name:e.name||_.value,disabled:e.disabled,readonly:e.readonly,tabindex:"-1",value:o.value[1]},null),m(Wf,{ref:p,start:I.value,stop:A.value},{"tick-label":n["tick-label"]}),m(dl,{ref:a,"aria-describedby":M.value,focused:j&&i.value===((N=a.value)==null?void 0:N.$el),modelValue:o.value[0],"onUpdate:modelValue":F=>o.value=[F,o.value[1]],onFocus:F=>{var H,D,J,R;P(),i.value=(H=a.value)==null?void 0:H.$el,o.value[0]===o.value[1]&&o.value[1]===v.value&&F.relatedTarget!==((D=s.value)==null?void 0:D.$el)&&((J=a.value)==null||J.$el.blur(),(R=s.value)==null||R.$el.focus())},onBlur:()=>{x(),i.value=void 0},min:v.value,max:o.value[1],position:I.value},{"thumb-label":n["thumb-label"]}),m(dl,{ref:s,"aria-describedby":M.value,focused:j&&i.value===((Z=s.value)==null?void 0:Z.$el),modelValue:o.value[1],"onUpdate:modelValue":F=>o.value=[o.value[0],F],onFocus:F=>{var H,D,J,R;P(),i.value=(H=s.value)==null?void 0:H.$el,o.value[0]===o.value[1]&&o.value[0]===f.value&&F.relatedTarget!==((D=a.value)==null?void 0:D.$el)&&((J=s.value)==null||J.$el.blur(),(R=a.value)==null||R.$el.focus())},onBlur:()=>{x(),i.value=void 0},min:o.value[0],max:f.value,position:A.value},{"thumb-label":n["thumb-label"]})])}})}),{}}});const s5=W()({name:"VRating",props:{name:String,itemAriaLabel:{type:String,default:"$vuetify.rating.ariaLabel.item"},activeColor:String,color:String,clearable:Boolean,disabled:Boolean,emptyIcon:{type:je,default:"$ratingEmpty"},fullIcon:{type:je,default:"$ratingFull"},halfIncrements:Boolean,hover:Boolean,length:{type:[Number,String],default:5},readonly:Boolean,modelValue:{type:[Number,String],default:0},itemLabels:Array,itemLabelPosition:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},ripple:Boolean,...ne(),...nc(),...wn(),...Se(),...Ie()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{t}=Bc(),{themeClasses:a}=Pe(e),s=pe(e,"modelValue"),u=h(()=>fc(parseFloat(s.value),0,+e.length)),l=h(()=>tn(Number(e.length),1)),r=h(()=>l.value.flatMap(b=>e.halfIncrements?[b-.5,b]:[b])),o=$(-1),i=h(()=>r.value.map(b=>{const k=e.hover&&o.value>-1,g=u.value>=b,p=o.value>=b,P=(k?p:g)?e.fullIcon:e.emptyIcon,x=e.activeColor??e.color,I=g||p?x:e.color;return{isFilled:g,isHovered:p,icon:P,color:I}})),d=h(()=>[0,...r.value].map(b=>{function k(){o.value=b}function g(){o.value=-1}function p(){e.disabled||e.readonly||(s.value=u.value===b&&e.clearable?0:b)}return{onMouseenter:e.hover?k:void 0,onMouseleave:e.hover?g:void 0,onClick:p}})),f=h(()=>e.name??`v-rating-${yc()}`);function v(b){var q,C;let{value:k,index:g,showStar:p=!0}=b;const{onMouseenter:j,onMouseleave:P,onClick:x}=d.value[g+1],I=`${f.value}-${String(k).replace(".","-")}`,A={color:(q=i.value[g])==null?void 0:q.color,density:e.density,disabled:e.disabled,icon:(C=i.value[g])==null?void 0:C.icon,ripple:e.ripple,size:e.size,variant:"plain"};return m(ve,null,[m("label",{for:I,class:{"v-rating__item--half":e.halfIncrements&&k%1>0,"v-rating__item--full":e.halfIncrements&&k%1===0},onMouseenter:j,onMouseleave:P,onClick:x},[m("span",{class:"v-rating__hidden"},[t(e.itemAriaLabel,k,e.length)]),p?n.item?n.item({...i.value[g],props:A,value:k,index:g,rating:u.value}):m(gc,A,null):void 0]),m("input",{class:"v-rating__hidden",name:f.value,id:I,type:"radio",value:k,checked:u.value===k,tabindex:-1,readonly:e.readonly,disabled:e.disabled},null)])}function y(b){return n["item-label"]?n["item-label"](b):b.label?m("span",null,[b.label]):m("span",null,[ic(" ")])}return X(()=>{var k;const b=!!((k=e.itemLabels)!=null&&k.length)||n["item-label"];return m(e.tag,{class:["v-rating",{"v-rating--hover":e.hover,"v-rating--readonly":e.readonly},a.value,e.class],style:e.style},{default:()=>[m(v,{value:0,index:-1,showStar:!1},null),l.value.map((g,p)=>{var j,P;return m("div",{class:"v-rating__wrapper"},[b&&e.itemLabelPosition==="top"?y({value:g,index:p,label:(j=e.itemLabels)==null?void 0:j[p]}):void 0,m("div",{class:"v-rating__item"},[e.halfIncrements?m(ve,null,[m(v,{value:g-.5,index:p*2},null),m(v,{value:g,index:p*2+1},null)]):m(v,{value:g,index:p},null)]),b&&e.itemLabelPosition==="bottom"?y({value:g,index:p,label:(P=e.itemLabels)==null?void 0:P[p]}):void 0])})]})}),{}}});function qo(e){const n=Math.abs(e);return Math.sign(e)*(n/((1/.501-2)*(1-n)+1))}function ko(e){let{selectedElement:c,containerSize:n,contentSize:t,isRtl:a,currentScrollOffset:s,isHorizontal:u}=e;const l=u?c.clientWidth:c.clientHeight,r=u?c.offsetLeft:c.offsetTop,o=a&&u?t-r-l:r,i=n+s,d=l+o,f=l*.4;return o<=s?s=Math.max(o-f,0):i<=d&&(s=Math.min(s-(i-d-f),t-n)),s}function u5(e){let{selectedElement:c,containerSize:n,contentSize:t,isRtl:a,isHorizontal:s}=e;const u=s?c.clientWidth:c.clientHeight,l=s?c.offsetLeft:c.offsetTop,r=a&&s?t-l-u/2-n/2:l+u/2-n/2;return Math.min(t-n,Math.max(0,r))}const lm=Symbol.for("vuetify:v-slide-group"),rm=he({centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:lm},nextIcon:{type:je,default:"$next"},prevIcon:{type:je,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>typeof e=="boolean"||["always","desktop","mobile"].includes(e)},...ne(),...Se(),...Xt({selectedClass:"v-slide-group-item--active"})},"v-slide-group"),ml=W()({name:"VSlideGroup",props:rm(),emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const{isRtl:t}=_n(),{mobile:a}=yt(),s=jt(e,e.symbol),u=$(!1),l=$(0),r=$(0),o=$(0),i=h(()=>e.direction==="horizontal"),{resizeRef:d,contentRect:f}=un(),{resizeRef:v,contentRect:y}=un(),b=h(()=>s.selected.value.length?s.items.value.findIndex(R=>R.id===s.selected.value[0]):-1),k=h(()=>s.selected.value.length?s.items.value.findIndex(R=>R.id===s.selected.value[s.selected.value.length-1]):-1);if(Xe){let R=-1;ae(()=>[s.selected.value,f.value,y.value,i.value],()=>{cancelAnimationFrame(R),R=requestAnimationFrame(()=>{if(f.value&&y.value){const K=i.value?"width":"height";r.value=f.value[K],o.value=y.value[K],u.value=r.value+1<o.value}if(b.value>=0&&v.value){const K=v.value.children[k.value];b.value===0||!u.value?l.value=0:e.centerActive?l.value=u5({selectedElement:K,containerSize:r.value,contentSize:o.value,isRtl:t.value,isHorizontal:i.value}):u.value&&(l.value=ko({selectedElement:K,containerSize:r.value,contentSize:o.value,isRtl:t.value,currentScrollOffset:l.value,isHorizontal:i.value}))}})})}const g=$(!1);let p=0,j=0;function P(R){const K=i.value?"clientX":"clientY";j=(t.value&&i.value?-1:1)*l.value,p=R.touches[0][K],g.value=!0}function x(R){if(!u.value)return;const K=i.value?"clientX":"clientY",z=t.value&&i.value?-1:1;l.value=z*(j+p-R.touches[0][K])}function I(R){const K=o.value-r.value;l.value<0||!u.value?l.value=0:l.value>=K&&(l.value=K),g.value=!1}function A(){d.value&&(d.value[i.value?"scrollLeft":"scrollTop"]=0)}const q=$(!1);function C(R){if(q.value=!0,!(!u.value||!v.value)){for(const K of R.composedPath())for(const z of v.value.children)if(z===K){l.value=ko({selectedElement:z,containerSize:r.value,contentSize:o.value,isRtl:t.value,currentScrollOffset:l.value,isHorizontal:i.value});return}}}function w(R){q.value=!1}function V(R){var K;!q.value&&!(R.relatedTarget&&((K=v.value)!=null&&K.contains(R.relatedTarget)))&&M()}function _(R){v.value&&(i.value?R.key==="ArrowRight"?M(t.value?"prev":"next"):R.key==="ArrowLeft"&&M(t.value?"next":"prev"):R.key==="ArrowDown"?M("next"):R.key==="ArrowUp"&&M("prev"),R.key==="Home"?M("first"):R.key==="End"&&M("last"))}function M(R){var K,z,fe,oe,B;if(v.value)if(!R)(K=Yl(v.value)[0])==null||K.focus();else if(R==="next"){const T=(z=v.value.querySelector(":focus"))==null?void 0:z.nextElementSibling;T?T.focus():M("first")}else if(R==="prev"){const T=(fe=v.value.querySelector(":focus"))==null?void 0:fe.previousElementSibling;T?T.focus():M("last")}else R==="first"?(oe=v.value.firstElementChild)==null||oe.focus():R==="last"&&((B=v.value.lastElementChild)==null||B.focus())}function N(R){const K=l.value+(R==="prev"?-1:1)*r.value;l.value=fc(K,0,o.value-r.value)}const Z=h(()=>{let R=l.value>o.value-r.value?-(o.value-r.value)+qo(o.value-r.value-l.value):-l.value;l.value<=0&&(R=qo(-l.value));const K=t.value&&i.value?-1:1;return{transform:`translate${i.value?"X":"Y"}(${K*R}px)`,transition:g.value?"none":"",willChange:g.value?"transform":""}}),F=h(()=>({next:s.next,prev:s.prev,select:s.select,isSelected:s.isSelected})),H=h(()=>{switch(e.showArrows){case"always":return!0;case"desktop":return!a.value;case!0:return u.value||Math.abs(l.value)>0;case"mobile":return a.value||u.value||Math.abs(l.value)>0;default:return!a.value&&(u.value||Math.abs(l.value)>0)}}),D=h(()=>Math.abs(l.value)>0),J=h(()=>o.value>Math.abs(l.value)+r.value);return X(()=>m(e.tag,{class:["v-slide-group",{"v-slide-group--vertical":!i.value,"v-slide-group--has-affixes":H.value,"v-slide-group--is-overflowing":u.value},e.class],style:e.style,tabindex:q.value||s.selected.value.length?-1:0,onFocus:V},{default:()=>{var R,K,z;return[H.value&&m("div",{key:"prev",class:["v-slide-group__prev",{"v-slide-group__prev--disabled":!D.value}],onClick:()=>N("prev")},[((R=n.prev)==null?void 0:R.call(n,F.value))??m(Zu,null,{default:()=>[m(ze,{icon:t.value?e.nextIcon:e.prevIcon},null)]})]),m("div",{key:"container",ref:d,class:"v-slide-group__container",onScroll:A},[m("div",{ref:v,class:"v-slide-group__content",style:Z.value,onTouchstartPassive:P,onTouchmovePassive:x,onTouchendPassive:I,onFocusin:C,onFocusout:w,onKeydown:_},[(K=n.default)==null?void 0:K.call(n,F.value)])]),H.value&&m("div",{key:"next",class:["v-slide-group__next",{"v-slide-group__next--disabled":!J.value}],onClick:()=>N("next")},[((z=n.next)==null?void 0:z.call(n,F.value))??m(Zu,null,{default:()=>[m(ze,{icon:t.value?e.prevIcon:e.nextIcon},null)]})])]}})),{selected:s.selected,scrollTo:N,scrollOffset:l,focus:M}}}),l5=W()({name:"VSlideGroupItem",props:{...Zt()},emits:{"group:selected":e=>!0},setup(e,c){let{slots:n}=c;const t=Qt(e,lm);return()=>{var a;return(a=n.default)==null?void 0:a.call(n,{isSelected:t.isSelected.value,select:t.select,toggle:t.toggle,selectedClass:t.selectedClass.value})}}});const r5=W()({name:"VSnackbar",props:{multiLine:Boolean,timeout:{type:[Number,String],default:5e3},vertical:Boolean,...Wn({location:"bottom"}),...ea(),...De(),...Fc(),...Ie(),...on(Da({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),{locationStyles:a}=Kn(e),{positionClasses:s}=ca(e),{scopeId:u}=Na(),{themeClasses:l}=Pe(e),{colorClasses:r,colorStyles:o,variantClasses:i}=gt(e),{roundedClasses:d}=Ue(e),f=$();ae(t,y),ae(()=>e.timeout,y),vc(()=>{t.value&&y()});let v=-1;function y(){window.clearTimeout(v);const k=Number(e.timeout);!t.value||k===-1||(v=window.setTimeout(()=>{t.value=!1},k))}function b(){window.clearTimeout(v)}return X(()=>{const[k]=kn.filterProps(e);return m(kn,se({ref:f,class:["v-snackbar",{"v-snackbar--active":t.value,"v-snackbar--multi-line":e.multiLine&&!e.vertical,"v-snackbar--vertical":e.vertical},s.value,e.class],style:e.style},k,{modelValue:t.value,"onUpdate:modelValue":g=>t.value=g,contentProps:se({class:["v-snackbar__wrapper",l.value,r.value,d.value,i.value],style:[a.value,o.value],onPointerenter:b,onPointerleave:y},k.contentProps),persistent:!0,noClickAnimation:!0,scrim:!1,scrollStrategy:"none",_disableGlobalStack:!0},u),{default:()=>[ht(!1,"v-snackbar"),n.default&&m("div",{class:"v-snackbar__content",role:"status","aria-live":"polite"},[n.default()]),n.actions&&m($e,{defaults:{VBtn:{variant:"text",ripple:!1}}},{default:()=>[m("div",{class:"v-snackbar__actions"},[n.actions()])]})],activator:n.activator})}),Gc({},f)}});const i5=W()({name:"VSwitch",inheritAttrs:!1,props:{indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...Vn(),...Ws()},emits:{"update:focused":e=>!0,"update:modelValue":()=>!0,"update:indeterminate":e=>!0},setup(e,c){let{attrs:n,slots:t}=c;const a=pe(e,"indeterminate"),s=pe(e,"modelValue"),{loaderClasses:u}=Fs(e),{isFocused:l,focus:r,blur:o}=Yn(e),i=h(()=>typeof e.loading=="string"&&e.loading!==""?e.loading:e.color),d=yc(),f=h(()=>e.id||`switch-${d}`);function v(){a.value&&(a.value=!1)}return X(()=>{const[y,b]=vt(n),[k,g]=uc.filterProps(e),[p,j]=Ft.filterProps(e),P=$();function x(I){var A,q;I.stopPropagation(),I.preventDefault(),(q=(A=P.value)==null?void 0:A.input)==null||q.click()}return m(uc,se({class:["v-switch",{"v-switch--inset":e.inset},{"v-switch--indeterminate":a.value},u.value,e.class],style:e.style},y,k,{id:f.value,focused:l.value}),{...t,default:I=>{let{id:A,messagesId:q,isDisabled:C,isReadonly:w,isValid:V}=I;return m(Ft,se({ref:P},p,{modelValue:s.value,"onUpdate:modelValue":[_=>s.value=_,v],id:A.value,"aria-describedby":q.value,type:"checkbox","aria-checked":a.value?"mixed":void 0,disabled:C.value,readonly:w.value,onFocus:r,onBlur:o},b),{...t,default:()=>m("div",{class:"v-switch__track",onClick:x},null),input:_=>{let{textColorClasses:M,textColorStyles:N}=_;return m("div",{class:["v-switch__thumb",M.value],style:N.value},[e.loading&&m(fr,{name:"v-switch",active:!0,color:V.value===!1?void 0:i.value},{default:Z=>t.loader?t.loader(Z):m(ir,{active:Z.isActive,color:Z.color,indeterminate:!0,size:"16",width:"2"},null)})])}})}})}),{}}});const o5=W()({name:"VSystemBar",props:{color:String,height:[Number,String],window:Boolean,...ne(),...cc(),...Kt(),...De(),...Se(),...Ie()},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{backgroundColorClasses:a,backgroundColorStyles:s}=Ze(Y(e,"color")),{elevationClasses:u}=rc(e),{roundedClasses:l}=Ue(e),{ssrBootStyles:r}=bt(),o=h(()=>e.height??(e.window?32:24)),{layoutItemStyles:i}=Yt({id:e.name,order:h(()=>parseInt(e.order,10)),position:$("top"),layoutSize:o,elementSize:o,active:h(()=>!0),absolute:Y(e,"absolute")});return X(()=>m(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},t.value,a.value,u.value,l.value,e.class],style:[s.value,i.value,r.value,e.style]},n)),{}}});const im=Symbol.for("vuetify:v-tabs"),om=W()({name:"VTab",props:{fixed:Boolean,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...on(mr({selectedClass:"v-tab--selected",variant:"text"}),["active","block","flat","location","position","symbol"])},setup(e,c){let{slots:n,attrs:t}=c;const{textColorClasses:a,textColorStyles:s}=mc(e,"sliderColor"),u=h(()=>e.direction==="horizontal"),l=$(!1),r=$(),o=$();function i(d){var v,y;let{value:f}=d;if(l.value=f,f){const b=(y=(v=r.value)==null?void 0:v.$el.parentElement)==null?void 0:y.querySelector(".v-tab--selected .v-tab__slider"),k=o.value;if(!b||!k)return;const g=getComputedStyle(b).color,p=b.getBoundingClientRect(),j=k.getBoundingClientRect(),P=u.value?"x":"y",x=u.value?"X":"Y",I=u.value?"right":"bottom",A=u.value?"width":"height",q=p[P],C=j[P],w=q>C?p[I]-j[I]:p[P]-j[P],V=Math.sign(w)>0?u.value?"right":"bottom":Math.sign(w)<0?u.value?"left":"top":"center",M=(Math.abs(w)+(Math.sign(w)<0?p[A]:j[A]))/Math.max(p[A],j[A]),N=p[A]/j[A],Z=1.5;ut(k,{backgroundColor:[g,""],transform:[`translate${x}(${w}px) scale${x}(${N})`,`translate${x}(${w/Z}px) scale${x}(${(M-1)/Z+1})`,""],transformOrigin:Array(3).fill(V)},{duration:225,easing:Va})}}return X(()=>{const[d]=gc.filterProps(e);return m(gc,se({symbol:im,ref:r,class:["v-tab",e.class],style:e.style,tabindex:l.value?0:-1,role:"tab","aria-selected":String(l.value),active:!1,block:e.fixed,maxWidth:e.fixed?300:void 0,rounded:0},d,t,{"onGroup:selected":i}),{default:()=>{var f;return[((f=n.default)==null?void 0:f.call(n))??e.text,!e.hideSlider&&m("div",{ref:o,class:["v-tab__slider",a.value],style:s.value},null)]}})}),{}}});function d5(e){return e?e.map(c=>typeof c=="string"?{title:c,value:c}:c):[]}const f5=W()({name:"VTabs",props:{alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...rm({mandatory:"force"}),...nc(),...Se()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),a=h(()=>d5(e.items)),{densityClasses:s}=bc(e),{backgroundColorClasses:u,backgroundColorStyles:l}=Ze(Y(e,"bgColor"));return Je({VTab:{color:Y(e,"color"),direction:Y(e,"direction"),stacked:Y(e,"stacked"),fixed:Y(e,"fixedTabs"),sliderColor:Y(e,"sliderColor"),hideSlider:Y(e,"hideSlider")}}),X(()=>{const[r]=ml.filterProps(e);return m(ml,se(r,{modelValue:t.value,"onUpdate:modelValue":o=>t.value=o,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--stacked":e.stacked},s.value,u.value,e.class],style:[{"--v-tabs-height":le(e.height)},l.value,e.style],role:"tablist",symbol:im}),{default:()=>[n.default?n.default():a.value.map(o=>m(om,se(o,{key:o.title}),null))]})}),{}}});const m5=W()({name:"VTable",props:{fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...ne(),...nc(),...Se(),...Ie()},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{densityClasses:a}=bc(e);return X(()=>m(e.tag,{class:["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!n.top,"v-table--has-bottom":!!n.bottom,"v-table--hover":e.hover},t.value,a.value,e.class],style:e.style},{default:()=>{var s,u,l;return[(s=n.top)==null?void 0:s.call(n),n.default?m("div",{class:"v-table__wrapper",style:{height:le(e.height)}},[m("table",null,[n.default()])]):(u=n.wrapper)==null?void 0:u.call(n),(l=n.bottom)==null?void 0:l.call(n)]}})),{}}});const v5=W()({name:"VTextarea",directives:{Intersect:Ba},inheritAttrs:!1,props:{autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...Vn(),...Ds()},emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,c){let{attrs:n,emit:t,slots:a}=c;const s=pe(e,"modelValue"),{isFocused:u,focus:l,blur:r}=Yn(e),o=h(()=>typeof e.counterValue=="function"?e.counterValue(s.value):(s.value||"").toString().length),i=h(()=>{if(n.maxlength)return n.maxlength;if(!(!e.counter||typeof e.counter!="number"&&typeof e.counter!="string"))return e.counter});function d(C,w){var V,_;!e.autofocus||!C||(_=(V=w[0].target)==null?void 0:V.focus)==null||_.call(V)}const f=$(),v=$(),y=$(""),b=$(),k=h(()=>e.persistentPlaceholder||u.value||e.active);function g(){var C;b.value!==document.activeElement&&((C=b.value)==null||C.focus()),u.value||l()}function p(C){g(),t("click:control",C)}function j(C){t("mousedown:control",C)}function P(C){C.stopPropagation(),g(),Oe(()=>{s.value="",Kl(e["onClick:clear"],C)})}function x(C){var V;const w=C.target;if(s.value=w.value,(V=e.modelModifiers)!=null&&V.trim){const _=[w.selectionStart,w.selectionEnd];Oe(()=>{w.selectionStart=_[0],w.selectionEnd=_[1]})}}const I=$();function A(){e.autoGrow&&Oe(()=>{if(!I.value||!v.value)return;const C=getComputedStyle(I.value),w=getComputedStyle(v.value.$el),V=parseFloat(C.getPropertyValue("--v-field-padding-top"))+parseFloat(C.getPropertyValue("--v-input-padding-top"))+parseFloat(C.getPropertyValue("--v-field-padding-bottom")),_=I.value.scrollHeight,M=parseFloat(C.lineHeight),N=Math.max(parseFloat(e.rows)*M+V,parseFloat(w.getPropertyValue("--v-input-control-height"))),Z=parseFloat(e.maxRows)*M+V||1/0;y.value=le(fc(_??0,N,Z))})}vc(A),ae(s,A),ae(()=>e.rows,A),ae(()=>e.maxRows,A),ae(()=>e.density,A);let q;return ae(I,C=>{C?(q=new ResizeObserver(A),q.observe(I.value)):q==null||q.disconnect()}),jc(()=>{q==null||q.disconnect()}),X(()=>{const C=!!(a.counter||e.counter||e.counterValue),w=!!(C||a.details),[V,_]=vt(n),[{modelValue:M,...N}]=uc.filterProps(e),[Z]=vr(e);return m(uc,se({ref:f,modelValue:s.value,"onUpdate:modelValue":F=>s.value=F,class:["v-textarea v-text-field",{"v-textarea--prefixed":e.prefix,"v-textarea--suffixed":e.suffix,"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-textarea--auto-grow":e.autoGrow,"v-textarea--no-resize":e.noResize||e.autoGrow,"v-text-field--flush-details":["plain","underlined"].includes(e.variant)},e.class],style:e.style},V,N,{focused:u.value}),{...a,default:F=>{let{isDisabled:H,isDirty:D,isReadonly:J,isValid:R}=F;return m(La,se({ref:v,style:{"--v-textarea-control-height":y.value},onClick:p,onMousedown:j,"onClick:clear":P,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"],role:"textbox"},Z,{active:k.value||D.value,dirty:D.value||e.dirty,disabled:H.value,focused:u.value,error:R.value===!1}),{...a,default:K=>{let{props:{class:z,...fe}}=K;return m(ve,null,[e.prefix&&m("span",{class:"v-text-field__prefix"},[e.prefix]),He(m("textarea",se({ref:b,class:z,value:s.value,onInput:x,autofocus:e.autofocus,readonly:J.value,disabled:H.value,placeholder:e.placeholder,rows:e.rows,name:e.name,onFocus:g,onBlur:r},fe,_),null),[[pc("intersect"),{handler:d},null,{once:!0}]]),e.autoGrow&&He(m("textarea",{class:[z,"v-textarea__sizer"],"onUpdate:modelValue":oe=>s.value=oe,ref:I,readonly:!0,"aria-hidden":"true"},null),[[R2,s.value]]),e.suffix&&m("span",{class:"v-text-field__suffix"},[e.suffix])])}})},details:w?F=>{var H;return m(ve,null,[(H=a.details)==null?void 0:H.call(a,F),C&&m(ve,null,[m("span",null,null),m(Hs,{active:e.persistentCounter||u.value,value:o.value,max:i.value},a.counter)])])}:void 0})}),Gc({},f,v,b)}});const y5=W()({name:"VThemeProvider",props:{withBackground:Boolean,...ne(),...Ie(),...Se()},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e);return()=>{var a;return e.withBackground?m(e.tag,{class:["v-theme-provider",t.value,e.class],style:e.style},{default:()=>{var s;return[(s=n.default)==null?void 0:s.call(n)]}}):(a=n.default)==null?void 0:a.call(n)}}});const b5=W()({name:"VTimeline",props:{align:{type:String,default:"center",validator:e=>["center","start"].includes(e)},direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},justify:{type:String,default:"auto",validator:e=>["auto","center"].includes(e)},side:{type:String,validator:e=>e==null||["start","end"].includes(e)},lineInset:{type:[String,Number],default:0},lineThickness:{type:[String,Number],default:2},lineColor:String,truncateLine:{type:String,validator:e=>["start","end","both"].includes(e)},...ne(),...nc(),...Se(),...Ie()},setup(e,c){let{slots:n}=c;const{themeClasses:t}=Pe(e),{densityClasses:a}=bc(e);Je({VTimelineDivider:{lineColor:Y(e,"lineColor")},VTimelineItem:{density:Y(e,"density"),lineInset:Y(e,"lineInset")}});const s=h(()=>{const l=e.side?e.side:e.density!=="default"?"end":null;return l&&`v-timeline--side-${l}`}),u=h(()=>{const l=["v-timeline--truncate-line-start","v-timeline--truncate-line-end"];switch(e.truncateLine){case"both":return l;case"start":return l[0];case"end":return l[1];default:return null}});return X(()=>m(e.tag,{class:["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,u.value,{"v-timeline--inset-line":!!e.lineInset},t.value,a.value,s.value,e.class],style:[{"--v-timeline-line-thickness":le(e.lineThickness)},e.style]},n)),{}}}),h5=W()({name:"VTimelineDivider",props:{dotColor:String,fillDot:Boolean,hideDot:Boolean,icon:je,iconColor:String,lineColor:String,...ne(),...De(),...wn(),...cc()},setup(e,c){let{slots:n}=c;const{sizeClasses:t,sizeStyles:a}=Jt(e,"v-timeline-divider__dot"),{backgroundColorStyles:s,backgroundColorClasses:u}=Ze(Y(e,"dotColor")),{roundedClasses:l}=Ue(e,"v-timeline-divider__dot"),{elevationClasses:r}=rc(e),{backgroundColorClasses:o,backgroundColorStyles:i}=Ze(Y(e,"lineColor"));return X(()=>m("div",{class:["v-timeline-divider",{"v-timeline-divider--fill-dot":e.fillDot},e.class],style:e.style},[m("div",{class:["v-timeline-divider__before",o.value],style:i.value},null),!e.hideDot&&m("div",{key:"dot",class:["v-timeline-divider__dot",r.value,l.value,t.value],style:a.value},[m("div",{class:["v-timeline-divider__inner-dot",u.value,l.value],style:s.value},[n.default?m($e,{key:"icon-defaults",disabled:!e.icon,defaults:{VIcon:{color:e.iconColor,icon:e.icon,size:e.size}}},n.default):m(ze,{key:"icon",color:e.iconColor,icon:e.icon,size:e.size},null)])]),m("div",{class:["v-timeline-divider__after",o.value],style:i.value},null)])),{}}}),g5=W()({name:"VTimelineItem",props:{density:String,dotColor:String,fillDot:Boolean,hideDot:Boolean,hideOpposite:{type:Boolean,default:void 0},icon:je,iconColor:String,lineInset:[Number,String],...ne(),...Rc(),...cc(),...De(),...wn(),...Se()},setup(e,c){let{slots:n}=c;const{dimensionStyles:t}=Oc(e),a=$(0),s=$();return ae(s,u=>{var l;u&&(a.value=((l=u.$el.querySelector(".v-timeline-divider__dot"))==null?void 0:l.getBoundingClientRect().width)??0)},{flush:"post"}),X(()=>{var u,l;return m("div",{class:["v-timeline-item",{"v-timeline-item--fill-dot":e.fillDot},e.class],style:[{"--v-timeline-dot-size":le(a.value),"--v-timeline-line-inset":e.lineInset?`calc(var(--v-timeline-dot-size) / 2 + ${le(e.lineInset)})`:le(0)},e.style]},[m("div",{class:"v-timeline-item__body",style:t.value},[(u=n.default)==null?void 0:u.call(n)]),m(h5,{ref:s,hideDot:e.hideDot,icon:e.icon,iconColor:e.iconColor,size:e.size,elevation:e.elevation,dotColor:e.dotColor,fillDot:e.fillDot,rounded:e.rounded},{default:n.icon}),e.density!=="compact"&&m("div",{class:"v-timeline-item__opposite"},[!e.hideOpposite&&((l=n.opposite)==null?void 0:l.call(n))])])}),{}}});const j5=W()({name:"VTooltip",props:{id:String,text:String,...on(Da({closeOnBack:!1,location:"end",locationStrategy:"connected",eager:!0,minWidth:0,offset:10,openOnClick:!1,openOnHover:!0,origin:"auto",scrim:!1,scrollStrategy:"reposition",transition:!1}),["absolute","persistent"])},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=pe(e,"modelValue"),{scopeId:a}=Na(),s=yc(),u=h(()=>e.id||`v-tooltip-${s}`),l=$(),r=h(()=>e.location.split(" ").length>1?e.location:e.location+" center"),o=h(()=>e.origin==="auto"||e.origin==="overlap"||e.origin.split(" ").length>1||e.location.split(" ").length>1?e.origin:e.origin+" center"),i=h(()=>e.transition?e.transition:t.value?"scale-transition":"fade-transition"),d=h(()=>se({"aria-describedby":u.value},e.activatorProps));return X(()=>{const[f]=kn.filterProps(e);return m(kn,se({ref:l,class:["v-tooltip",e.class],style:e.style,id:u.value},f,{modelValue:t.value,"onUpdate:modelValue":v=>t.value=v,transition:i.value,absolute:!0,location:r.value,origin:o.value,persistent:!0,role:"tooltip",activatorProps:d.value,_disableGlobalStack:!0},a),{activator:n.activator,default:function(){var k;for(var v=arguments.length,y=new Array(v),b=0;b<v;b++)y[b]=arguments[b];return((k=n.default)==null?void 0:k.call(n,...y))??e.text}})}),Gc({},l)}}),q5=W()({name:"VValidation",props:{...Gd()},emits:{"update:modelValue":e=>!0},setup(e,c){let{slots:n}=c;const t=Xd(e,"validation");return()=>{var a;return(a=n.default)==null?void 0:a.call(n,t)}}});const k5=W()({name:"VVirtualScrollItem",props:{dynamicHeight:Boolean,...ne()},emits:{"update:height":e=>!0},setup(e,c){let{emit:n,slots:t}=c;const{resizeRef:a,contentRect:s}=un();Nn(()=>e.dynamicHeight,()=>{ae(()=>{var l;return(l=s.value)==null?void 0:l.height},l=>{l!=null&&n("update:height",l)})});function u(){e.dynamicHeight&&s.value&&n("update:height",s.value.height)}Ml(u),X(()=>{var l;return m("div",{ref:e.dynamicHeight?a:void 0,class:["v-virtual-scroll__item",e.class],style:e.style},[(l=t.default)==null?void 0:l.call(t)])})}}),po=-1,So=1,p5=W()({name:"VVirtualScroll",props:{items:{type:Array,default:()=>[]},itemHeight:[Number,String],...ne(),...Rc()},setup(e,c){let{slots:n}=c;const t=$(0),a=$(e.itemHeight),s=h({get:()=>parseInt(a.value??0,10),set(C){a.value=C}}),u=$(),{resizeRef:l,contentRect:r}=un();Kc(()=>{l.value=u.value});const o=yt(),i=new Map;let d=tn(e.items.length).map(()=>s.value);const f=h(()=>{var C;return Math.max(12,Math.ceil((((C=r.value)==null?void 0:C.height)??o.height.value)/s.value*1.7+1))});function v(C,w){s.value=Math.max(s.value,w),d[C]=w,i.set(e.items[C],w)}function y(C){return d.slice(0,C).reduce((w,V)=>w+(V||s.value),0)}function b(C){const w=e.items.length;let V=0,_=0;for(;_<C&&V<w;)_+=d[V++]||s.value;return V-1}let k=0;function g(){if(!u.value||!r.value)return;const C=r.value.height,w=u.value.scrollTop,V=w<k?po:So,_=b(w+C/2),M=Math.round(f.value/3);V===po&&_<=t.value+M*2-1?t.value=fc(_-M,0,e.items.length):V===So&&_>=t.value+M*2-1&&(t.value=fc(_-M,0,e.items.length-f.value)),k=u.value.scrollTop}function p(C){if(!u.value)return;const w=y(C);u.value.scrollTop=w}const j=h(()=>e.items.map((C,w)=>({raw:C,index:w}))),P=h(()=>Math.min(e.items.length,t.value+f.value)),x=h(()=>j.value.slice(t.value,P.value)),I=h(()=>y(t.value)),A=h(()=>y(e.items.length)-y(P.value)),{dimensionStyles:q}=Oc(e);return vc(()=>{s.value||(s.value=d.slice(t.value,P.value).reduce((C,w)=>C+w,0)/f.value)}),ae(()=>e.items.length,()=>{d=tn(e.items.length).map(()=>s.value),i.forEach((C,w)=>{const V=e.items.indexOf(w);V===-1?i.delete(w):d[V]=C})}),X(()=>m("div",{ref:u,class:["v-virtual-scroll",e.class],onScroll:g,style:[q.value,e.style]},[m("div",{class:"v-virtual-scroll__container",style:{paddingTop:le(I.value),paddingBottom:le(A.value)}},[x.value.map(C=>m(k5,{key:C.index,dynamicHeight:!e.itemHeight,"onUpdate:height":w=>v(C.index,w)},{default:()=>{var w;return[(w=n.default)==null?void 0:w.call(n,{item:C.raw,index:C.index})]}}))])])),{scrollToIndex:p}}}),S5=Object.freeze(Object.defineProperty({__proto__:null,VAlert:Sg,VAlertTitle:Ud,VApp:Nh,VAppBar:tg,VAppBarNavIcon:jg,VAppBarTitle:kg,VAutocomplete:g3,VAvatar:Dn,VBadge:j3,VBanner:q3,VBannerActions:xf,VBannerText:wf,VBottomNavigation:k3,VBreadcrumbs:p3,VBreadcrumbsDivider:Vf,VBreadcrumbsItem:If,VBtn:gc,VBtnGroup:Ju,VBtnToggle:rg,VCard:S3,VCardActions:Af,VCardItem:Tf,VCardSubtitle:Ef,VCardText:$f,VCardTitle:Pf,VCarousel:E3,VCarouselItem:P3,VCheckbox:Ig,VCheckboxBtn:Nt,VChip:Fa,VChipGroup:Eg,VClassIcon:nr,VCode:T3,VCol:x4,VColorPicker:m4,VCombobox:y4,VComponentIcon:Xu,VContainer:S4,VCounter:Hs,VDefaultsProvider:$e,VDialog:b4,VDialogBottomTransition:zh,VDialogTopTransition:Hh,VDialogTransition:Os,VDivider:cf,VExpandTransition:Ls,VExpandXTransition:ar,VExpansionPanel:j4,VExpansionPanelText:Gf,VExpansionPanelTitle:Yf,VExpansionPanels:g4,VFabTransition:Dh,VFadeTransition:Zu,VField:La,VFieldLabel:oa,VFileInput:q4,VFooter:k4,VForm:p4,VHover:$4,VIcon:ze,VImg:Gt,VInput:uc,VItem:B4,VItemGroup:M4,VKbd:R4,VLabel:na,VLayout:O4,VLayoutItem:L4,VLazy:F4,VLigatureIcon:_h,VList:Ks,VListGroup:tl,VListImg:Ug,VListItem:qn,VListItemAction:Wg,VListItemMedia:Kg,VListItemSubtitle:rf,VListItemTitle:of,VListSubheader:df,VLocaleProvider:N4,VMain:D4,VMenu:Gs,VMessages:Kd,VNavigationDrawer:X4,VNoSsr:Z4,VOverlay:kn,VPagination:J4,VParallax:c5,VProgressCircular:ir,VProgressLinear:or,VRadio:n5,VRadioGroup:t5,VRangeSlider:a5,VRating:s5,VResponsive:Ad,VRow:P4,VScaleTransition:Id,VScrollXReverseTransition:Wh,VScrollXTransition:Uh,VScrollYReverseTransition:Yh,VScrollYTransition:Kh,VSelect:v3,VSelectionControl:Ft,VSelectionControlGroup:Qd,VSheet:ll,VSlideGroup:ml,VSlideGroupItem:l5,VSlideXReverseTransition:Xh,VSlideXTransition:Gh,VSlideYReverseTransition:Zh,VSlideYTransition:tr,VSlider:fl,VSnackbar:r5,VSpacer:T4,VSvgIcon:cr,VSwitch:i5,VSystemBar:o5,VTab:om,VTable:m5,VTabs:f5,VTextField:ft,VTextarea:v5,VThemeProvider:y5,VTimeline:b5,VTimelineItem:g5,VToolbar:Qu,VToolbarItems:qg,VToolbarTitle:sr,VTooltip:j5,VValidation:q5,VVirtualScroll:p5,VWindow:Of,VWindowItem:Lf},Symbol.toStringTag,{value:"Module"}));function C5(e,c){const n=c.modifiers||{},t=c.value,{once:a,immediate:s,...u}=n,l=!Object.keys(u).length,{handler:r,options:o}=typeof t=="object"?t:{handler:t,options:{attributes:(u==null?void 0:u.attr)??l,characterData:(u==null?void 0:u.char)??l,childList:(u==null?void 0:u.child)??l,subtree:(u==null?void 0:u.sub)??l}},i=new MutationObserver(function(){let d=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[],f=arguments.length>1?arguments[1]:void 0;r==null||r(d,f),a&&dm(e,c)});s&&(r==null||r([],i)),e._mutate=Object(e._mutate),e._mutate[c.instance.$.uid]={observer:i},i.observe(e,o)}function dm(e,c){var n;(n=e._mutate)!=null&&n[c.instance.$.uid]&&(e._mutate[c.instance.$.uid].observer.disconnect(),delete e._mutate[c.instance.$.uid])}const _5={mounted:C5,unmounted:dm};function x5(e,c){var a,s;const n=c.value,t={passive:!((a=c.modifiers)!=null&&a.active)};window.addEventListener("resize",n,t),e._onResize=Object(e._onResize),e._onResize[c.instance.$.uid]={handler:n,options:t},(s=c.modifiers)!=null&&s.quiet||n()}function w5(e,c){var a;if(!((a=e._onResize)!=null&&a[c.instance.$.uid]))return;const{handler:n,options:t}=e._onResize[c.instance.$.uid];window.removeEventListener("resize",n,t),delete e._onResize[c.instance.$.uid]}const V5={mounted:x5,unmounted:w5};function fm(e,c){const{self:n=!1}=c.modifiers??{},t=c.value,a=typeof t=="object"&&t.options||{passive:!0},s=typeof t=="function"||"handleEvent"in t?t:t.handler,u=n?e:c.arg?document.querySelector(c.arg):window;u&&(u.addEventListener("scroll",s,a),e._onScroll=Object(e._onScroll),e._onScroll[c.instance.$.uid]={handler:s,options:a,target:n?void 0:u})}function mm(e,c){var s;if(!((s=e._onScroll)!=null&&s[c.instance.$.uid]))return;const{handler:n,options:t,target:a=e}=e._onScroll[c.instance.$.uid];a.removeEventListener("scroll",n,t),delete e._onScroll[c.instance.$.uid]}function I5(e,c){c.value!==c.oldValue&&(mm(e,c),fm(e,c))}const A5={mounted:fm,unmounted:mm,updated:I5},E5=Object.freeze(Object.defineProperty({__proto__:null,ClickOutside:Sf,Intersect:Ba,Mutate:_5,Resize:V5,Ripple:Un,Scroll:A5,Touch:qr},Symbol.toStringTag,{value:"Module"})),P5=xd({components:S5,directives:E5}),Cr=F2(Kv);Cr.use(fb);Cr.use(P5);Cr.mount("#app");
